  ...
  s.script_phase = [
    {
      ...
      :name => 'Download nnue',
      :script => "cd \"${PODS_TARGET_SRCROOT}/Stockfish/src\" && [ -e 'nn-1a298aa575a0.nnue' ] || curl --location --remote-name 'https://tests.stockfishchess.org/api/nn/nn-1a298aa575a0.nnue'"
    },
  ]
  s.xcconfig = {
