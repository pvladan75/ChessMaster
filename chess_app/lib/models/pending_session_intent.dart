...
class PendingSessionIntent {
  ...
  const PendingSessionIntent._(this.action,
      {this.roomCode, this.role, this.studentId});
  ...
  const PendingSessionIntent.showCreateRoomDialog()
      : this._(PendingSessionAction.showCreateRoomDialog);

  const PendingSessionIntent.joinRoomByCode(String code)
      : this._(PendingSessionAction.joinRoomByCode, roomCode: code);
  ...
  const PendingSessionIntent.inviteStudent(int studentId)
      : this._(PendingSessionAction.inviteStudent, studentId: studentId);
}
