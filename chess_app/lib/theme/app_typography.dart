...
abstract final class AppText {
  ...
  static const TextStyle captionBold = TextStyle(fontSize: 11, fontWeight: FontWeight.bold);

  /// 12px. Default body text within cards and panels.
  static const TextStyle body = TextStyle(fontSize: 12);
  static const TextStyle bodyBold = TextStyle(fontSize: 12, fontWeight: FontWeight.bold);

  /// 13px. Slightly emphasized body — list tile titles, active values.
  static const TextStyle bodyLarge = TextStyle(fontSize: 13);
  static const TextStyle bodyLargeBold = TextStyle(fontSize: 13, fontWeight: FontWeight.bold);
  ...
  static const TextStyle title = TextStyle(fontSize: 16, fontWeight: FontWeight.bold);

  /// 18px. Screen-level headings.
  static const TextStyle headline = TextStyle(fontSize: 18, fontWeight: FontWeight.bold);

  /// 22-24px. Rare — top-level numbers/avatars initials.
  static const TextStyle display = TextStyle(fontSize: 22, fontWeight: FontWeight.bold);
}
