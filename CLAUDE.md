...
```bash
cd chess_app && flutter test          # 2712 tests, 1 skipped, rest green
...
owner's four decisions on it, and the merge of `feat/repertoire-engine-count-pgn`
(`docs/STANJE-RADA.md`, „Tri prijave o repertoaru"). Every change of these numbers,
