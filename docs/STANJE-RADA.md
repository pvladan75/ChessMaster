...
## Materijal: pozicije, zadaci i zagonetke — jedan model, tri glagola — 23.9.2026, plan, faze 0–3 u kodu
...
1794 → 1799. Provera uživo: stavka 233. Sledeća je faza 4 (zagonetke iz
partije postaju zadaci; puzzle sets se brišu — **traži brojanje i vlasnikovo
da** pre `DROP TABLE`).
