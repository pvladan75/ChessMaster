...
## Materijal: pozicije, zadaci i zagonetke — jedan model, tri glagola — 23.9.2026, plan, faza 0 u kodu
...
sve kao u `CLAUDE.md`). Proverava se uživo u okviru stavke 231. Sledeća je
faza 1.
