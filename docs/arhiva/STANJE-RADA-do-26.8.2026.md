# Stanje rada — arhiva zaključno sa 26.8.2026

Ovo je istorijski deo [STANJE-RADA.md](../STANJE-RADA.md), izdvojen 27.8.2026.
Sadrži odeljke koji opisuju **završen** posao: popravke sa datumom, merenja, i
razloge zbog kojih je nešto dobilo baš taj oblik.

**Ne čita se unapred.** Čita se kad treba *zašto* neke starije odluke — najbrže
`grep`-om po naslovu ili pojmu. Šta je trenutno stanje i šta sledi stoji u
[STANJE-RADA.md](../STANJE-RADA.md).

Redosled je onaj iz izvornog dokumenta. Unutrašnje upućivanje („odeljak iznad",
„odeljak niže") ponegde pokazuje preko granice dva fajla.
