# TODO — stari spisak provera, do 25.9.2026

Ovo je `TODO-provera.md` onakav kakav je bio 25.9.2026, ceo i istim redom, pre
nego što je spisak preuređen po mestu u aplikaciji. Svakoj stavci koja je tada
bila otvorena dopisano je šta je s njom:

- **[x] … — ✅ vlasnik, u alatu za proveru, datum** — vlasnik je stavku
  potvrdio u alatu za proveru (van repozitorijuma), a odgovor do tada nije bio
  prenet ovde. Takvih je bilo najviše.
- **prevaziđeno (25.9.2026): …** — funkcija je promenjena ili uklonjena pre
  nego što je stavka proverena; razlog piše uz stavku.
- **prepisano 25.9.2026 u novi spisak: oblast — ekran, stavka N** — stavka još
  važi. U [TODO-provera.md](../TODO-provera.md) je prepisana sa putanjom i
  koracima, a uz nju stoji njen stari broj, npr. [243.2].
- Stavke koje su i ranije bile štiklirane ostale su kakve su bile.

Brojevi odeljaka i stavki su zadržani: drugi dokumenti i komentari u kodu
upućuju na njih („TODO-provera 177.2"). Zato brojevi i ovde preskaču.

**Ne čita se unapred**; `grep` po broju ili naslovu kad treba dokaz da je nešto
provereno, ili zašto je otpalo.
...
- [x] `6k1/5p2/7p/8/4r2P/2Q5/6K1/8 w - - 9 55` (QueenVsRook, dobitak): `Qc8+`
      mora da bude prihvaćen, uz `Qf3` i `Qg3+`. Ranije je vraćao „netačno". — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Neka sedmofiguraška pozicija i dalje nosi oznaku „Tačno iz tablica". — ✅ vlasnik, u alatu za proveru, 30.8.2026.
...
- [x] Nedostupna tablica: postaviti `LICHESS_TABLEBASE_URL` na nepostojeći host,
      ...
      nepresuđen potez da stoji kao presuđen. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [ ] Na telefonu: tri dugmeta vežbe u jednom redu na 360 dp. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 20.*
...
- [x] Pozicija sa greškom kaže „U partiji je odigrano X i remi je izgubljen",
      uz čip sa rejtingom. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Na takvoj poziciji stoje **oba** dugmeta: „Odigraj do kraja" i „Kazni". — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] „Kazni" postavlja poziciju **posle** greške, okreće tablu na stranu koja
      dobija, i naslov postaje „Kaznite grešku". — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Kazna se odigra do mata — protivnik brani tablično najbolje. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [ ] „Ispočetka" u kazni vraća poziciju posle greške, ne početnu. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 8.*
- [x] „Nazad na zadatak" vraća početnu poziciju **i početni smer table**. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [ ] Pozicija tipa „dobitak → remi" nema dugme „Kazni" (nema šta da se uzme). — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 21.*
...
- [x] **„Vrati potez"** posle greške u vežbi vraća položaj pre tog poteza i
      pušta da se nastavi. Dosad je jedini izlaz bio „Ispočetka", što na
      dvadeset osmom potezu baca dvadeset sedam poteza koji su bili tačni. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [ ] Čip **„Greške: N"** raste sa svakim vraćanjem — vraćanje je besplatno,
      ali nije nevidljivo. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 22.*
- [x] **Koordinate na tabli**: slova linija ispod, brojevi redova levo. Kad se
      tabla okrene, oznake se okreću s njom. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Na 360 dp koordinate ne smeju da prošire tablu preko ekrana — traka se
      uzima iz veličine koju ekran već daje, ne dodaje se na nju. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
...
- [x] Naslov kaže ko je pogrešio i šta je odigrao („Crni je ovde odigrao Rd3 i
      izgubio remi"), ispod stoji šta se traži. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Pogrešan potez se odbija i tabla ostaje na istom položaju. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Prihvata se **svaki** potez koji drži, ne samo prvi iz spiska. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Posle tačnog odgovora tabla **ne skače** na sledeću grešku — ostaje gde
      jeste, pa se potezi odigraju jedan po jedan. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Igranje staje tačno na sledećoj grešci i tabla tu postaje živa. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Dodirivanje trake za kretanje **preuzima kontrolu** — igranje prestaje i
      dalje se korača ručno. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Ručno se ne može preko neodgovorene greške, ni tasterom „na kraj". — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] **Ispod table nema dugmadi sa potezima** — potezi se vide na tabli. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Tabla se **ne okreće sama** kad grešku napravi drugi igrač; okreće je
      dugme u traci. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] „Na grešku" se pojavljuje kad se stoji iza neodgovorene greške i vraća na
      nju. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] „Pokaži" otvara prolaz, imenuje poteze koji su držali, i broji se
      odvojeno od nađenih. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Posle **poslednje** greške ostatak partije je otključan do kraja: traka
      ...
      poteza posle poslednje greške, a najduža sto pedeset pet. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Na 360 dp ništa ne izlazi iz ekrana. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
...
- [x] Sa isključenim prekidačem aplikacija ćuti, i posle restarta je i dalje
      isključeno. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [ ] Bez instaliranog glasa panel kaže da ga nema i kako se dodaje — a ne
      ćuti i ne čita engleskim glasom. — *prepisano 25.9.2026 u novi spisak: Podešavanja i izgled — Settings, stavka 1.*
- [ ] Posle instaliranja hrvatskog glasa spisak jezika ga nudi i „Probaj" ga
      ...
      dugmetom „Potraži glasove ponovo". — *prepisano 25.9.2026 u novi spisak: Podešavanja i izgled — Settings, stavka 5.*
- [x] „Probaj" pročita `Rd3` kao „top de tri", a `Kf2` kao „kralj ef dva". — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Linija `g` se čuje kao g u „gitara" (zapis `gje`), a ne kao englesko „dž". — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] U treneru završnica se presuda čuje čim se pojavi u panelu. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Nova presuda prekida prethodnu, ne čeka je da se dovrši. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Ista poruka se ne ponavlja kad se prozor promeni ili panel prerisuje. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Brzina čitanja se čuje kad se pomeri klizač. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Isto na telefonu, sa srpskim glasom iz Google-ovog mehanizma —
      **prošlo 23.8.2026**, uz dve zamerke ispod.
- [x] Brojevi u padežu: „Postoje još 2 takva poteza" (ne „2 takvih poteza"),
      „Postoji još 1 takav potez", „Postoji još 5 takvih poteza". — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] `e6.` na kraju rečenice se čuje kao „e šest", ne „e šesti". — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Kazna kaže „Ovako se kažnjava potez Qxb2", sa potezom na kraju. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Isključivanje govora u Podešavanjima **pre nego što je išta rečeno** ne
      ruši aplikaciju (ovo je bio pravi pad, `stop()` pre prvog `speak()`). — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [ ] „Zašto je loše" pa „Preskoči": nova partija se igra normalno, bez
      zaostalog dugmeta „Nazad na partiju". — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 5.*
- [ ] Dok kazna traje panel piše da se tabla tu ne igra. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 6.*
- [x] Rečenica se čuje do kraja: tabla ne odigra sledeći potez preko nje, i
      sledeća poruka je ne preseca nego sačeka. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Govor prestaje kad korisnik dodirne traku za kretanje, odigra potez, ili
      izađe sa ekrana — i ne nastavlja se posle toga. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [ ] Izbor glasa koji nije stvarno instaliran **ne ruši aplikaciju** — ni pri
      biranju, ni pri sledećem ulasku u Podešavanja; panel kaže da glasa nema. — *prepisano 25.9.2026 u novi spisak: Podešavanja i izgled — Settings, stavka 2.*
- [x] Prekidač „Uključi i online partije" u izboru završnica: isključen daje
      samo partije za tablom, uključen i online. Isto važi za šetnju kroz
      partiju, koja se ne otvara kroz taj ekran. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] U spisku glasova uz srpski/hrvatski piše „čita srpski", a strani glas
      sme da se izabere i tada čita naš tekst svojom fonetikom. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Tabla čeka da se rečenica dovrši pa tek onda odigra sledeći potez — i u
      šetnji kroz partiju i u prikazu kazne. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [ ] Ako glas ne javi kraj izgovora, šetnja se ipak nastavi (rok iz dužine
      rečenice), a u dnevniku stoji red o tome. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 7.*

## 0p. Desktop prečice — 24.8.2026, nije viđeno uživo

- [x] **Esc** zatvara ono što je otvoreno preko rada (podešavanja, vežbu,
      analizu) i vraća tačno gde si bio. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] **Esc na ljusci ne radi ništa** — prozor se ne prazni. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] **Ctrl+,** otvara podešavanja; držanje prečice ih ne otvara dvaput.
      (Nije radilo pri prvoj probi — vezano je i za fizički taster.) — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [ ] **Strelice** u šetnji kroz partiju: levo/desno potez, gore/dole krajevi. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 10.*
- [x] Dok je fokus u polju za tekst, strelice pripadaju polju. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] **Desni klik na tablu** kopira FEN i kaže da je kopiran — probaj na više
      ekrana (analiza, soba, završnice). — ✅ vlasnik, u alatu za proveru, 30.8.2026.

## 0o. Četiri taba — 24.8.2026, nije viđeno uživo

- [x] Aplikacija se otvara na **Treningu**, ne na sobama. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Izlazak iz vežbe **strelicom u ekranu** vraća na Trening sa tabovima —
      i u punom prozoru i u uskom. (Ovo je puklo pri prvoj probi 24.8.2026.) — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Podešavanja se otvaraju **iz podnožja rail-a** u punom prozoru, i iz
      trake u uskom. (Na Windows-u ih posle prve izmene nije bilo nigde.) — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Statistika naloga je u Podešavanjima, u odeljku „NALOG", i brojevi su
      tačni (isti kao ranije na Početnoj). — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Na „Časovima" te statistike više nema. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Traka „Nastavi" se pojavi kad soba traje ili kad postoji sačuvana
      analiza, a inače se **ne vidi uopšte**. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Dodir na „Nastavi čas" vraća u sobu, na „Nastavi analizu" u analizu. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Tabovi su: Trening, Časovi, Biblioteka, Ljudi — i na traci dole i na
      rail-u sa strane. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Podešavanja se otvaraju ikonicom u traci i **vraćaju tamo gde si bio**. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Na 360 dp četiri odredišta staju bez preklapanja teksta. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Sve što je bilo na staroj Početnoj i dalje radi iz „Časova": nova sesija,
      pridruživanje kodom, Studio, moji zadaci, ponavljanje, snimci. — ✅ vlasnik, u alatu za proveru, 30.8.2026.

## 0n. Zadaci dobili putanje — 24.8.2026, nije viđeno uživo

- [x] „Moji zadaci" sa Početne se otvaraju i „nazad" vraća na Početnu. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Otvaranje zadatka iz liste radi kao i pre (objekat se prosleđuje, nema
      novog dohvatanja i nema treptaja). — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Ocena zadatka se otvara sa sva tri mesta: iz liste, iz pregleda pozicija
      i iz napretka učenika. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] „Ponavljanje" sa Početne radi, a značka se osveži po povratku. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Napredak učenika prikazuje ime u naslovu (stiže kroz `?name=`). — ✅ vlasnik, u alatu za proveru, 30.8.2026.

## 0m. Raskrsnica Treninga izdvojena — 24.8.2026, nije viđeno uživo

- [x] Kartica „Trening" otvara listu kartica, bez table ispod. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Svaka od sedam kartica vodi tamo gde piše, a „nazad" vraća na listu. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Mat u 1/2/3 otvara zadatu dubinu; osnovno matiranje zadatu težinu. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Red dugmadi ispod table (`Analiza`, `Probaj Ponovo`, `Naredna Pozicija`)
      staje na 360 dp — pre ovoga se prelivao za 80 piksela. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Izlazak iz vežbe usred motorovog razmišljanja ništa ne ostavlja za sobom. — ✅ vlasnik, u alatu za proveru, 30.8.2026.

- [x] Zadatak sa zagonetkama se otvara iz liste i nastavlja **tamo gde je
      stalo**, ne iz početka. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Zadatak kojem je sve rešeno kaže da je završen umesto da otvori praznu
      vežbu. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Izlazak iz vežbe usred motorove analize ništa ne ostavlja za sobom
      (`basic_mate` je do 24.8.2026. ostavljao tajmer). — ✅ vlasnik, u alatu za proveru, 30.8.2026.

## 0l. Nalaz tablica i „Zaključi remi" — napisano 24.8.2026, nije viđeno uživo

- [x] „Nalaz tablica" u vežbi otvara spisak: prvo potezi koji drže, među njima
      prvo oni koji nuliraju brojač (zvezdica), pa oni koji gube. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Na Windows-u je to **panel pored table**, ispod info panela, i **ostaje**
      dok se igra; dugme se pretvara u „Sakrij nalaz". — ✅ vlasnik, u alatu za proveru, 30.8.2026.
...
- [ ] U KRP–KR koje pređe u KR–KR pojavi se „Zaključi remi" i zatvori vežbu. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 9.*
- [x] U poziciji sa pešakom tog dugmeta nema. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [ ] Kad remi nije mrtav, dugme kaže **koji potez** još gubi i postavi brojač
      „Do remija: 8"; posle osam održanih poteza vežba se zatvori sama. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 10.*
- [ ] Ako se remi u međuvremenu ispusti, brojač nestaje i vežba staje kao i
      inače. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 11.*
- [ ] Kad se pozicija ponovi tri puta, poruka kaže „ponovila se", a ne
      „pedeset poteza". — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 12.*
...
- [ ] Dugme stoji **i pre i posle odgovora**, u treneru i u šetnji. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 25.*
- [x] Posle klika piše da je zapamćeno, dugme postaje „Zapamćeno" i ne može
      dvaput da sačuva istu poziciju. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Sledeća pozicija vraća dugme u početno stanje. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] U „Mojim pozicijama" se pojavljuje sa oznakom **Nejasno**, a opis nosi
      kontekst: šta je odigrano, šta je držalo, pravilo, rejting, partija. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Ista pozicija se otvara u Analysis Studiju iz biblioteke. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [ ] Kad server ne odgovara, kaže se to i dugme ostaje aktivno. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 26.*
...
- [x] Dugme se pojavljuje **tek kad je greška odgovorena**, ne dok stojiš na
      njoj (tada bi bilo rešenje). — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Kazna se odigrava na tabli, potez po potez, iz pozicije **posle** greške. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Traka za kretanje kroz partiju **nestaje** dok kazna traje — ona hoda
      partiju, a ovo nije partija. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] „Nazad na partiju" vraća tablu tačno tamo gde je bila. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Ako tablica ne odgovara, kaže se to i tabla se ne dira. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
...
- [ ] Rečenica se pojavljuje uz odgovor, i u treneru i u šetnji. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 27.*
- [x] **Ne pojavljuje se dok je pozicija otvorena** — pre odgovora bi bila
      nagoveštaj, i to jak. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Kad drži samo jedan potez, ne piše „drže samo potezi kralja" (množina o
      jednom potezu), ali pravilo o liniji sme da stoji. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Kod otprilike **polovine pozicija rečenice nema** — to je namerno, a ne
      kvar: ćutanje je bolje od izmišljene pouke. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Ako je pozicija iz stvarne greške, rečenica bira ono pravilo koje je
      odigrani potez prekršio (npr. potez kralja kad drže samo topovi). — ✅ vlasnik, u alatu za proveru, 30.8.2026.
...
- [x] Otvara se sa **svim uključenim**, i „Počni" odmah radi kao ranije. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Prva porodica je otvorena, ostale sklopljene; strelica ih otvara. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Kvačica na porodici pali i gasi sve njene vrste; kad je deo izabran,
      kvačica je na crtici. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Broj u dnu se menja **odmah** i tačan je — bez novog zahteva serveru. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [ ] Izbor nivoa menja i broj u dnu i brojeve uz svaku vrstu. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 28.*
- [ ] Kad se sve isključi, „Počni" je ugašen i piše da ništa ne odgovara. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 29.*
- [ ] „Počni" sa sve uključenim daje isto ponašanje kao pre ovog ekrana. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 30.*
- [ ] „Počni" sa uskim izborom (npr. samo `KRPvKR`) stvarno servira samo te
      pozicije — proveriti čip sa tipom na nekoliko uzastopnih. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 31.*
- [ ] Prekidač „samo raznobojni lovci" se vidi (u zbirci ih je 43) i radi. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 32.*
- [x] Na 360 dp lista i donja traka staju bez prelivanja. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
...
- [x] Na desktopu (prozor preko 840 dp): panel je **desno** od table, a zadatak,
      čipovi i odgovor su u njemu — iznad i ispod table nema teksta. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Suzi prozor ispod 840 dp: panel pređe **ispod** table, i tabla se ne
      pomeri kad se odgovor pojavi ili nestane. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Isto važi na sva tri ulaza: „Dobij", „Održi remi" i „Greške iz partija". — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Tabla je na širokom prozoru i dalje dovoljno velika — panel uzima 280 dp. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Na 360 dp ništa ne izlazi iz ekrana ni u jednom od tri ekrana. — ✅ vlasnik, u alatu za proveru, 30.8.2026.

Ispravljeno posle prve probe na desktopu 23.8.2026, **nije viđeno uživo**:

- [x] Panel je **uz tablu**, ne odgurnut na ivicu ekrana. Tabla se širi do 720 dp
      umesto do 560, a razmak do panela je 16 dp bez obzira na širinu prozora. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Redosled u panelu: **partija gore, šta se traži ispod, odgovor na dnu**. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] U šetnji, kad stojiš između dve greške, naslov kaže **„Idite napred do
      sledeće greške"** i ispod piše koliko poteza — a dugme **„Na grešku" se
      pojavljuje**. Ranije se nije pojavljivalo nikad. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Kad stojiš na grešci, piše **„Odigrajte na tabli potez koji drži remi"** —
      dakle šta da uradiš, ne samo šta se desilo. — ✅ vlasnik, u alatu za proveru, 30.8.2026.

Iz druge probe na desktopu 23.8.2026, **nije viđeno uživo**:

- [x] Kad se stigne na grešku, **stara poruka „Tačno" nestaje**. Ranije je
      stajala ispod novog pitanja i čitala se kao odgovor na njega. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Na grešci se **crvenom strelicom** označi potez koji je izgubio rezultat,
      i strelica se **sama skloni posle četiri sekunde** — pre nego što počneš
      da probaš poteze po tim istim poljima. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Strelica se pojavi i kad se do greške dođe ručno, trakom. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Kad se dođe do kraja partije: **„Kraj partije — nema više poteza"**, sa
      brojem nađenih. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Ako je poslednja greška ujedno i poslednji potez, poruka to kaže, a ne
      nudi da se prolazi ostatak kog nema. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
...
- [x] Na Windows-u su podaci sada u `AppData\Roaming\rs.pejovic\chess_app` —
      preuzeti Stockfish je ostao na staroj putanji. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
...
- [ ] **Da li se drugi mat priznaje.** Najlakše na #122 (knjiga `Qe6#`, ali i
      ...
      knjizi". Logika je pokrivena testovima, ali okom nije viđena. — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 1.*
...
- [ ] Da li se traka „nema veze sa serverom" sama povuče kad server krene
      (ponavlja proveru na 10 s, a povezivanje socketa je računa kao dokaz). — *prepisano 25.9.2026 u novi spisak: Home — Home i obaveštenja, stavka 2.*
...
- [ ] Knjiga sa **drugim fontom** — mapa za `TacticsCourse.pdf` nije završena,
      pa je sve mereno na jednoj knjizi. — **prevaziđeno (25.9.2026):** Mapa fonta za TacticsCourse.pdf je završena 20.8.2026 (dan posle ove stavke) i od tada je u spisku aktivnih mapa; naknadno je dodata i treća knjiga (NICRoest, 23.9.2026). Napomena u README-u skenera da mapa „nije završena" je zastareo pasus, protivrečan samom kodu i istoriji commit-ova.
- [ ] Šta se dešava kad se pošalje PDF **bez ijednog dijagrama** ili zaštićen
      lozinkom. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 1.*
- [ ] Filter „traži pogled" nad **mešanim** skupom — dosad je bio ili 0/120 ili
      120/120, nikad delimičan. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 3.*
...
- [ ] Kad je server ugašen, birač kaže **„Nije moguće doći do servera"**, a ne
      „Nema sačuvanih pozicija". — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 23.*
...
- [x] U Analysis Studio-u uđi u varijantu pa pritisni `<<`: mora da te vrati na
      **mesto gde se varijanta odvojila**, a ne na prvi potez partije. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [ ] **Dijalog sa linijom motora** (Analysis Studio → klik na liniju) — dugmad
      su sada `<` i `>` kao svugde (ranije druge ikone), brojač `3 / 8` stoji
      između njih, okretanje table na kraju reda. — *prepisano 25.9.2026 u novi spisak: Analyse — Motor, linije i tablebase, stavka 1.*
...
- [x] Odbijanje i dalje radi isto, i sad se takođe vidi odmah. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Ugasi aplikaciju kod A, pa neka B odgovori, pa je upali: obaveštenje je
      tu. Soket je samo gurac, red u bazi je ono što se pamti. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [ ] Restartuj backend dok su oba naloga otvorena, pa odgovori na zahtev:
      ništa ne puca, a posle ponovnog povezivanja gurac opet radi. — *prepisano 25.9.2026 u novi spisak: Server i alati — Server, stavka 5.*
...
- [x] Isto i za zadatak od trenerovih **skeniranih pozicija**, i za **lekciju**. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Učenik uradi **poslednju** stavku zadatka → **treneru** stigne „<ime> je
      uradio zadatak: <naslov>".
- [x] Učenik ponovo otvori taj isti, već gotov zadatak i prošeta kroz njega →
      **ne stiže drugo obaveštenje**. Sme da bude tačno jedno. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
...
- [x] Poziv na čas i zakazan čas i dalje rade, i sada takođe stižu odmah. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Ono što se **ne** očekuje: učenik koji stoji u „Moji zadaci" neće videti
      nov zadatak u spisku dok se ne vrati na njega. Zvonce hoće. To je poznato
      i zapisano. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
...
- [x] Sa **jednim neodgovorenim zahtevom**: posle čitanja značka treba da
      ...
      prvi put kad neko pošalje zahtev. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
...
- [ ] **N** — sledeća pozicija, isto što i dugme „Sledeća" / „Preskoči". Radi
      **odmah po otvaranju ekrana**, bez ijednog klika pre toga. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 14.*
- [ ] **H** — pomoć; poruka kaže na koje polje potez vodi. Kad je pozicija
      rešena, dugmeta „Pomoć" nema — pa ni **H** ne sme ništa da uradi. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 15.*
- [ ] **R** — „Pokušaj ponovo" posle netačnog poteza; u igranju do kraja
      „Ispočetka". Kad tog dugmeta nema, taster ćuti. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 16.*
- [ ] **T** — „Nalaz tablica", i to samo dok se pozicija igra do kraja. Na
      širokom prozoru drugi pritisak zatvara panel, isto što i „Sakrij nalaz". — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 17.*
- [ ] **U** — „Vrati potez", i to tek pošto je neki potez ispustio rezultat. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 18.*
- [ ] Dok tablica odgovara (tabla je zaključana), N, R i U ne rade — isto kao
      što su i dugmad tada ugašena. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 19.*

Reprodukcija snimka (ekran sa snimljenim časom):

- [ ] **Razmak** pušta i pauzira snimak, isto što i dugme ispod table. — *prepisano 25.9.2026 u novi spisak: Home — Reprodukcija snimka, stavka 7.*
- [ ] Kliknuti prvo na neko dugme na tom ekranu, pa pritisnuti razmak: razmak
      ...
      da može da pritisne ono na čemu je stao. — *prepisano 25.9.2026 u novi spisak: Home — Reprodukcija snimka, stavka 8.*
...
- [ ] Analiza, pozicija sa **crnim na potezu** u kojoj beli stoji bolje (npr.
      ...
      kao i sa nativnim. Ranije je bila negativna. — *prepisano 25.9.2026 u novi spisak: Analyse — Motor, linije i tablebase, stavka 2.*
- [ ] Ista pozicija, prebaciti motor sa onlajn na nativni i nazad: broj se ne
      prevrće oko nule. — *prepisano 25.9.2026 u novi spisak: Analyse — Motor, linije i tablebase, stavka 3.*
- [ ] Pozicija sa matom za crnog i crnim na potezu (1.f3 e5 2.g4): onlajn motor
      piše mat za **crnog** (`-M1`), ne za belog. — *prepisano 25.9.2026 u novi spisak: Analyse — Motor, linije i tablebase, stavka 4.*
...
- [ ] „Novi" otvara ekran sa tablom. Odigrati otvaranje potezima, na primer
      `1.e4 c5 2.d4 cxd4 3.c3 dxc3 4.Nxc3`; linija se ispisuje ispod table. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 38.*
- [ ] Ime se **samo predloži** iz baze otvaranja (npr. „Sicilian Defense — crni"); dovoljno je pritisnuti „Napravi". Kad se ime otkuca ručno, predlog ga više ne menja. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 39.*
- [ ] „Nađi otvaranje" → ukucati „Smith-Morra": klik na rezultat postavi celu liniju na tablu, izabere stranu koja je na potezu i predloži ime. Ista pretraga koja je u Analizi. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 40.*
- [ ] „Nazad" vraća jedan potez, „Ispočetka" celu liniju. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 41.*
- [ ] Dugme „Napravi" je **ugašeno** dok na potezu nije strana za koju se gradi,
      a rečenica iznad kaže čiji je potez. Promena strane ga oživi. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 42.*
- [ ] „Nalepi FEN" postavlja poziciju iz niza; neispravan niz kaže da nije
      ispravan, a ne „nije sačuvano". — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 43.*
- [ ] Dok je ime prazno, dugme je ugašeno **i ispod table piše zašto** („Upišite ime repertoara.“).
      Nađeno pri prvoj upotrebi: pozicija je bila u redu, red ispod table zelen, a dugme sivo bez ijedne reči. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 44.*
- [x] Na širokom prozoru polje za ime stoji uz tablu, a ne razvučeno preko celog ekrana. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [ ] Napravljen repertoar se odmah otvara; ime stoji u naslovu. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 45.*
- [ ] Isto ime drugi put → **„Već imate repertoar sa tim imenom."** — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 46.*
- [ ] Ugašen backend → **„Server nije dostupan — proverite da li backend radi."**
      Tri uzroka, tri rečenice; ovo je bila greška nađena pri prvoj upotrebi. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 47.*
...
- [ ] Tabla je okrenuta prema izabranoj boji, a pitanje glasi „Šta igrate
      crnim?". — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 37.*
- [ ] Odigran potez se **odmah** sudi; brojač u uglu poraste za jedan. — **prevaziđeno (25.9.2026):** Ceo stari „čarobnjak" za gradnju repertoara (brojač poteza u uglu, dugmad „Uzmi"/„Odbaci", skočni spisak „Šta se ovde igra" sa procentima, i dugme „Ne znam") je ukinut 16.9.2026: repertoar se od tada gradi isključivo potezima odigranim na tabli, knjiga otvaranja je stalan red čipova (kao u Analizi) pored table, a sopstveni potez odmah postaje deo repertoara, markiran zvezdicom.
- [ ] „Uzmi" ga dodaje kao čip sa zvezdicom (glavni). Drugi uzet potez dobija
      praznu zvezdicu — klik na njega ga postavlja za glavnog. — **prevaziđeno (25.9.2026):** Ceo stari „čarobnjak" za gradnju repertoara (brojač poteza u uglu, dugmad „Uzmi"/„Odbaci", skočni spisak „Šta se ovde igra" sa procentima, i dugme „Ne znam") je ukinut 16.9.2026: repertoar se od tada gradi isključivo potezima odigranim na tabli, knjiga otvaranja je stalan red čipova (kao u Analizi) pored table, a sopstveni potez odmah postaje deo repertoara, markiran zvezdicom.
- [ ] „Odbaci" ga ne dodaje, ali ga zabeleži: to se vidi kasnije u drillu, a
      sada bar ne sme ništa da padne. — **prevaziđeno (25.9.2026):** Ceo stari „čarobnjak" za gradnju repertoara (brojač poteza u uglu, dugmad „Uzmi"/„Odbaci", skočni spisak „Šta se ovde igra" sa procentima, i dugme „Ne znam") je ukinut 16.9.2026: repertoar se od tada gradi isključivo potezima odigranim na tabli, knjiga otvaranja je stalan red čipova (kao u Analizi) pored table, a sopstveni potez odmah postaje deo repertoara, markiran zvezdicom.
- [ ] **Čim se potez odigra, spisak „Šta se ovde igra" iskoči sam**, sa procentom partija i procentom učinka za stranu na potezu; potez koji ste upravo odigrali je označen strelicom, a već uzeti zvezdicom. — **prevaziđeno (25.9.2026):** Ceo stari „čarobnjak" za gradnju repertoara (brojač poteza u uglu, dugmad „Uzmi"/„Odbaci", skočni spisak „Šta se ovde igra" sa procentima, i dugme „Ne znam") je ukinut 16.9.2026: repertoar se od tada gradi isključivo potezima odigranim na tabli, knjiga otvaranja je stalan red čipova (kao u Analizi) pored table, a sopstveni potez odmah postaje deo repertoara, markiran zvezdicom.
- [ ] „Ne znam" pokaže isti spisak **pre** odluke — i samo se to broji kao rešeno gledanjem. — **prevaziđeno (25.9.2026):** Ceo stari „čarobnjak" za gradnju repertoara (brojač poteza u uglu, dugmad „Uzmi"/„Odbaci", skočni spisak „Šta se ovde igra" sa procentima, i dugme „Ne znam") je ukinut 16.9.2026: repertoar se od tada gradi isključivo potezima odigranim na tabli, knjiga otvaranja je stalan red čipova (kao u Analizi) pored table, a sopstveni potez odmah postaje deo repertoara, markiran zvezdicom.
- [ ] **Rokada:** odigrati O-O i proveriti da je u spisku označena kao vaš potez (strelica), a ne da piše „nije među ovim potezima". Isto i u panelu Analize: klik na „O-O" u bazi otvaranja odigra rokadu. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 38.*
- [ ] „Pitaj motor" daje linije na izabranoj **dubini** i u izabranom **broju linija**; obe kontrole su u panelu. Klik na liniju odigra njen prvi potez i on prolazi kroz isti sud kao potez odigran rukom. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 42.*
- [ ] Motor radi i kad Lichess token nije unet — lokalni je i ne troši kvotu. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 43.*
- [ ] **Promena dubine odmah ponovo pokreće motor** (ne ostaje stari odgovor). Isto i promena broja linija. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 44.*
- [ ] **Pitati motor na dubini 28, pa preći na sledeću poziciju pre nego što odgovori:** stari odgovor se ne sme pojaviti u novoj poziciji. Ovo je bila greška nađena na slici — motor je nudio potez koji u novoj poziciji nije ni moguć. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 45.*
- [ ] Uzeti drugi potez u istoj poziciji pa dodirnuti red sa njim: postaje glavni (zvezdica se pomeri). To je ono što će drill tražiti. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 39.*
- [ ] „Dalje" otvara odgovore belog i javlja koliko je pokriveno i koliko je
      poteza ostalo van toga; sledeća pozicija je opet sa crnim na potezu. — **prevaziđeno (25.9.2026):** Dugme „Dalje" koje je talasno otvaralo odgovore belog uz procenat pokrivenosti je ukinuto 16.9.2026 zajedno sa celim starim modelom; danas postoji „Next position", koje samo prelazi na sledeću još neodgovorenu poziciju u redu i pokazuje prost broj odlučenih pozicija, bez procenta — pa nema više šta da se „zadrži" kao poslednji izveštaj o pokrivenosti kad se red isprazni.
- [ ] Kad se red isprazni, ekran to kaže i **zadrži** poslednji izveštaj o
      pokrivenosti. — **prevaziđeno (25.9.2026):** Dugme „Dalje" koje je talasno otvaralo odgovore belog uz procenat pokrivenosti je ukinuto 16.9.2026 zajedno sa celim starim modelom; danas postoji „Next position", koje samo prelazi na sledeću još neodgovorenu poziciju u redu i pokazuje prost broj odlučenih pozicija, bez procenta — pa nema više šta da se „zadrži" kao poslednji izveštaj o pokrivenosti kad se red isprazni.

Ono što se lako previdi:

- [ ] Isti potez uzet dvaput ne pravi duplikat. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 40.*
- [ ] Zatvaranje i ponovno otvaranje repertoara: izabrani potezi su tu (red
      pozicija nije — to je namerno). — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 41.*
- [x] Na telefonu 360 dp: tabla i dugmad staju bez sečenja. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
...
- [ ] Pre vežbe izgraditi bar tri-četiri pozicije, inače drill nema šta da pita
      ...
      proverava). — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 51.*
- [ ] Pitanje dolazi **bez odgovora**: nigde na ekranu ne piše koji je potez
      izabran dok se ne odigra ili ne pritisne „Pokaži". — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 52.*
- [ ] Tačan potez → „Tačno" i rečenica kad se pozicija vraća. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 53.*
- [ ] Alternativa koju ste sami uzeli → „I to je vaše", uz ime glavnog poteza. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 54.*
- [ ] **Dobar potez koji nije vaš** (npr. potpuno zdrav razvojni potez koji
      niste uzeli) → „Nije to", uz vaš potez. Ovo je namerno i vredi videti. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 55.*
- [ ] „Pokaži" pa zatim tačan potez → i dalje prolaz, ali se pozicija vraća
      ranije nego kad se pogodi iz glave. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 56.*
- [ ] Protivnik odgovori sam, i ponekad odgovori nešto što niste pokrili — tada
      to piše žutim („to niste pokrili"). — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 57.*
- [ ] „Nastavi liniju" nastavlja iz pozicije u kojoj se stalo. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 58.*
- [ ] Kad se dođe do pozicije koju niste gradili: „Ovu poziciju niste pokrili" i
      dugme „Izgradi ovu poziciju" otvara izgradnju **baš tu**, ne od početka. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 59.*
- [ ] Posle nekoliko odgovora, brojač „na redu / novo" u naslovu se menja. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 60.*
- [ ] Isključiti internet i vežbati dalje — pitanja i ocene rade, jer je sve
      naše; padne samo ako backend nije dostupan. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 61.*
- [ ] Na telefonu 360 dp: tabla, poruka i tri dugmeta staju bez sečenja. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 62.*
...
- [ ] Registrovati nalog **trenera** i nalog **deteta** (SMTP radi lokalno, pa
      kodovi za verifikaciju stvarno stižu). — *prepisano 25.9.2026 u novi spisak: Nalog i prijava — Prijava i registracija, stavka 1.*
- [ ] **Odjaviti se na svakom uređaju pre registracije**, ili obrisati podatke
      ...
      prijavljeno. — *prepisano 25.9.2026 u novi spisak: Nalog i prijava — Prijava i registracija, stavka 4.*
- [ ] Ako treba admin: `UPDATE users SET role = 'admin' WHERE email = ...`.
      Bootstrap-a nema, i to je jedini put. Uloga se od 25.8.2026 čita **iz
      reda**, ne iz tokena, pa važi odmah — bez ponovne prijave. — *prepisano 25.9.2026 u novi spisak: Server i alati — Server, stavka 6.*
- [ ] Za stavku 36 podesiti `PUBLIC_BASE_URL` u `chess_backend/.env`. — *prepisano 25.9.2026 u novi spisak: Server i alati — Saglasnost roditelja, stavka 5.*
...
- [ ] Trener napravi sobu, učenik sa **prihvaćenom vezom** uđe kodom — radi kao
      i pre. — **prevaziđeno (25.9.2026):** Ulazak u sobu kucanjem koda je ukinut 21-22.9.2026 (docs/PLAN-SESIJA.md, faza 1): nema više `POST /rooms/join` niti polja za kod u aplikaciji; učenik danas ulazi preko poziva/obaveštenja ili Home-ove kartice „In a session now", pa se ne može proveriti prihvaćena/neprihvaćena veza, gost ni nepostojeći kod kucanjem koda.
- [ ] Nalog **bez veze** sa trenerom uđe istim kodom → poruka „Niste na spisku
      za ovu sobu" i vraćanje nazad, a ne večno „povezivanje". — **prevaziđeno (25.9.2026):** Ulazak u sobu kucanjem koda je ukinut 21-22.9.2026 (docs/PLAN-SESIJA.md, faza 1): nema više `POST /rooms/join` niti polja za kod u aplikaciji; učenik danas ulazi preko poziva/obaveštenja ili Home-ove kartice „In a session now", pa se ne može proveriti prihvaćena/neprihvaćena veza, gost ni nepostojeći kod kucanjem koda.
- [ ] **Neprijavljen gost** sa kodom → „Ova soba ne prima goste". (Ranije je
      ulazio i u tablu i u glas.) — **prevaziđeno (25.9.2026):** Ulazak u sobu kucanjem koda je ukinut 21-22.9.2026 (docs/PLAN-SESIJA.md, faza 1): nema više `POST /rooms/join` niti polja za kod u aplikaciji; učenik danas ulazi preko poziva/obaveštenja ili Home-ove kartice „In a session now", pa se ne može proveriti prihvaćena/neprihvaćena veza, gost ni nepostojeći kod kucanjem koda.
- [ ] Nepostojeći kod → „Ne postoji soba sa tim kodom". — **prevaziđeno (25.9.2026):** Ulazak u sobu kucanjem koda je ukinut 21-22.9.2026 (docs/PLAN-SESIJA.md, faza 1): nema više `POST /rooms/join` niti polja za kod u aplikaciji; učenik danas ulazi preko poziva/obaveštenja ili Home-ove kartice „In a session now", pa se ne može proveriti prihvaćena/neprihvaćena veza, gost ni nepostojeći kod kucanjem koda.
- [ ] U dnevniku backenda za svako odbijanje stoji `[SOBA] Odbijen ulazak` ili
      `[AUDIO] Odbijen ulazak` sa razlogom. — *prepisano 25.9.2026 u novi spisak: Server i alati — Nalozi, sobe i saglasnost, stavka 5.*
- [ ] Glas: odbijeni nalog ne može da uđe ni u glas ni kad pokuša direktno. — *prepisano 25.9.2026 u novi spisak: Server i alati — Nalozi, sobe i saglasnost, stavka 6.*

Grupe i spisak zvanica (ekrani napisani 25.8.2026):

- [ ] „Ljudi" → dugme sa grupama otvara ekran; napraviti grupu, preimenovati je, dodati dva učenika, izbaciti jednog. — *prepisano 25.9.2026 u novi spisak: Teach — Učenici, grupe i obaveštenja, stavka 5.*
- [ ] U biraču se nude **samo prihvaćeni** učenici — onaj koji nije potvrdio vezu se ne pojavljuje. — *prepisano 25.9.2026 u novi spisak: Sesija — Ulazak u sesiju i pozivi, stavka 4.*
- [ ] Nigde u tim spiskovima ne stoji tuđ email. — *prepisano 25.9.2026 u novi spisak: Sesija — Ulazak u sesiju i pozivi, stavka 5.*
- [ ] U sobi, trener → „Ko sme u sobu": prazan spisak kaže da soba prima sve njegove učenike. — *prepisano 25.9.2026 u novi spisak: Sesija — Ulazak u sesiju i pozivi, stavka 6.*
- [ ] Pozvati **celu grupu** jednim klikom; poruka se promeni u „Ulaze samo oni sa ovog spiska". — *prepisano 25.9.2026 u novi spisak: Sesija — Ulazak u sesiju i pozivi, stavka 9.*
- [ ] Učenik **iz te grupe** uđe kodom; učenik istog trenera **van grupe** dobije „Niste na spisku za ovu sobu". — *prepisano 25.9.2026 u novi spisak: Sesija — Ulazak u sesiju i pozivi, stavka 7.*
- [ ] Pozvati i **jednog** učenika poimence — ulazi i on. — *prepisano 25.9.2026 u novi spisak: Sesija — Ulazak u sesiju i pozivi, stavka 10.*
- [ ] Skinuti grupu sa spiska: kad spisak ostane prazan, soba se opet otvara svim učenicima tog trenera. — *prepisano 25.9.2026 u novi spisak: Sesija — Ulazak u sesiju i pozivi, stavka 8.*
...
- [ ] U tabu „Ljudi" i u biračima učenika **više ne piše tuđ email** — stoji
      ...
      email-u i dalje postoji i radi. — *prepisano 25.9.2026 u novi spisak: Teach — Učenici, grupe i obaveštenja, stavka 4.*
...
- [ ] Trener → „Ko sme u sobu": pri dnu stoji prekidač **Soba prima goste**,
      **isključen**, uz rečenicu „ulaze samo prijavljeni koje ste pozvali". — **prevaziđeno (25.9.2026):** Prekidač za goste se od faze 1 docs/PLAN-SESIJA.md (21.9.2026) više ne nudi za novu sobu: svaka nova soba počinje sa allow_guests = FALSE, a dijalog ga tada uopšte ne iscrtava — sam kod kaže „Guests are not offered any more". Ostaje samo kao mogućnost da se ugasi već otvorena (stara) soba, kojih u probnom nalogu (testna faza sa jednim korisnikom) više nema, pa se uključivanje, čuvanje uključenog stanja, ulaz gosta/nepovezanog naloga i isključivanje ne mogu više proveriti na način opisan u ovim stavkama.
- [ ] Uključiti ga: tekst se menja u onaj koji kaže da ulazi **svako ko zna kod**
      i da je i to u snimku, a pri vrhu dijaloga se pojavi upozorenje. — **prevaziđeno (25.9.2026):** Prekidač za goste se od faze 1 docs/PLAN-SESIJA.md (21.9.2026) više ne nudi za novu sobu: svaka nova soba počinje sa allow_guests = FALSE, a dijalog ga tada uopšte ne iscrtava — sam kod kaže „Guests are not offered any more". Ostaje samo kao mogućnost da se ugasi već otvorena (stara) soba, kojih u probnom nalogu (testna faza sa jednim korisnikom) više nema, pa se uključivanje, čuvanje uključenog stanja, ulaz gosta/nepovezanog naloga i isključivanje ne mogu više proveriti na način opisan u ovim stavkama.
- [ ] Zatvoriti i ponovo otvoriti dijalog — prekidač je i dalje uključen (dakle
      sačuvan u bazi, a ne samo na ekranu). — **prevaziđeno (25.9.2026):** Prekidač za goste se od faze 1 docs/PLAN-SESIJA.md (21.9.2026) više ne nudi za novu sobu: svaka nova soba počinje sa allow_guests = FALSE, a dijalog ga tada uopšte ne iscrtava — sam kod kaže „Guests are not offered any more". Ostaje samo kao mogućnost da se ugasi već otvorena (stara) soba, kojih u probnom nalogu (testna faza sa jednim korisnikom) više nema, pa se uključivanje, čuvanje uključenog stanja, ulaz gosta/nepovezanog naloga i isključivanje ne mogu više proveriti na način opisan u ovim stavkama.
- [ ] Dok je uključen: **neprijavljen** gost sa kodom ulazi i vidi tablu; u
      dnevniku backenda stoji `[SOBA] … gosti dozvoljeni`. — **prevaziđeno (25.9.2026):** Prekidač za goste se od faze 1 docs/PLAN-SESIJA.md (21.9.2026) više ne nudi za novu sobu: svaka nova soba počinje sa allow_guests = FALSE, a dijalog ga tada uopšte ne iscrtava — sam kod kaže „Guests are not offered any more". Ostaje samo kao mogućnost da se ugasi već otvorena (stara) soba, kojih u probnom nalogu (testna faza sa jednim korisnikom) više nema, pa se uključivanje, čuvanje uključenog stanja, ulaz gosta/nepovezanog naloga i isključivanje ne mogu više proveriti na način opisan u ovim stavkama.
- [ ] Dok je uključen: **prijavljen nalog bez veze** sa trenerom takođe ulazi —
      ...
      dok je neprijavljeni stranac ulazio; to je bilo naopako. — **prevaziđeno (25.9.2026):** Prekidač za goste se od faze 1 docs/PLAN-SESIJA.md (21.9.2026) više ne nudi za novu sobu: svaka nova soba počinje sa allow_guests = FALSE, a dijalog ga tada uopšte ne iscrtava — sam kod kaže „Guests are not offered any more". Ostaje samo kao mogućnost da se ugasi već otvorena (stara) soba, kojih u probnom nalogu (testna faza sa jednim korisnikom) više nema, pa se uključivanje, čuvanje uključenog stanja, ulaz gosta/nepovezanog naloga i isključivanje ne mogu više proveriti na način opisan u ovim stavkama.
...
- [ ] Sa **spiskom zvanica** i uključenim prekidačem: učenik van spiska ulazi kao
      ...
      bira ko je *učenik* u sobi, prekidač da li iko sme da gleda. — **prevaziđeno (25.9.2026):** Prekidač za goste se od faze 1 docs/PLAN-SESIJA.md (21.9.2026) više ne nudi za novu sobu: svaka nova soba počinje sa allow_guests = FALSE, a dijalog ga tada uopšte ne iscrtava — sam kod kaže „Guests are not offered any more". Ostaje samo kao mogućnost da se ugasi već otvorena (stara) soba, kojih u probnom nalogu (testna faza sa jednim korisnikom) više nema, pa se uključivanje, čuvanje uključenog stanja, ulaz gosta/nepovezanog naloga i isključivanje ne mogu više proveriti na način opisan u ovim stavkama.
- [ ] Ugasiti backend i otvoriti dijalog: umesto isključenog prekidača stoji
      ...
      prekidač bi ovde bio laž o tome ko sme unutra.) — *prepisano 25.9.2026 u novi spisak: Sesija — Ulazak u sesiju i pozivi, stavka 3.*
...
- [ ] Isti taj nalog pošalje zahtev kao **učenik** punoletnom treneru → prolazi
      normalno. — *prepisano 25.9.2026 u novi spisak: Nalog i prijava — Veza trener–učenik i roditelj, stavka 5.*
...
- [ ] `AGE_OF_CONSENT=20` u `.env` → **server ne startuje**, uz jasnu poruku u
      ...
      da važi.) Vratiti na 16 posle provere. — *prepisano 25.9.2026 u novi spisak: Server i alati — Nalozi, sobe i saglasnost, stavka 3.*
...
- [ ] U aplikaciji se ništa nije promenilo: tab „Ljudi" radi kao pre, jer tu
      rutu nikad nije ni zvao. — *prepisano 25.9.2026 u novi spisak: Teach — Učenici, grupe i obaveštenja, stavka 3.*
- [ ] Zakazivanje časa u **tuđoj** sobi (curl, sa kodom sobe drugog trenera) →
      **403**, i taj nalog i dalje ne može da uđe u tu sobu. — **prevaziđeno (25.9.2026):** Zakazivanje časa (i sam pojam „zakazana sesija") je u potpunosti ukinuto 21-22.9.2026 — POST /sessions/schedule i „4. vrata" provere mayJoinRoom su obrisani zajedno sa čitaocem u trainerPanelService.js; ništa u aplikaciji više ne zove tu rutu, pa ni pokušaj preko curl-a nema šta da odbije osim generičkog 404.
- [ ] Poziv (`POST /invitations/send`) nekome ko nije u prihvaćenoj vezi →
      **403**, i toj osobi ne stiže zvonce. — *prepisano 25.9.2026 u novi spisak: Server i alati — Nalozi, sobe i saglasnost, stavka 4.*
...
- [ ] Isto i posle prijave kroz **Google** — nalog koji nikad nije video formu
      za registraciju. — *prepisano 25.9.2026 u novi spisak: Nalog i prijava — Godina rođenja, stavka 7.*
...
- [ ] **Gost** (bez prijave) ne dobija pitanje. — *prepisano 25.9.2026 u novi spisak: Nalog i prijava — Godina rođenja, stavka 4.*
...
- [ ] Nemoguća godina (`2999`, `1899`, prazno) → poruka, i **ništa se ne šalje
      na server**. — *prepisano 25.9.2026 u novi spisak: Nalog i prijava — Godina rođenja, stavka 1.*
- [ ] Ugašen backend pa pokušaj čuvanja → pitanje **ostaje**, uz poruku da server
      ...
      identično uspehu i ostavilo nalog tačno u stanju zbog kog gate postoji.) — *prepisano 25.9.2026 u novi spisak: Nalog i prijava — Godina rođenja, stavka 2.*
- [ ] **Odjavi se** na tom ekranu radi — nalog na koji se greškom ušlo nije
      ćorsokak. — *prepisano 25.9.2026 u novi spisak: Nalog i prijava — Godina rođenja, stavka 8.*
- [ ] Podešavanja → **NALOG → Godina rođenja** pokazuje upisanu godinu; otvara
      ...
      Podešavanjima. — *prepisano 25.9.2026 u novi spisak: Podešavanja i izgled — Settings, stavka 4.*
- [ ] Prag iz `.env` se vidi na ekranu: `AGE_OF_CONSENT=13` → tekst kaže
      „mlađe od 13". (Vratiti na 16.) — *prepisano 25.9.2026 u novi spisak: Nalog i prijava — Godina rođenja, stavka 3.*
...
- [ ] `PUBLIC_BASE_URL` sa smećem umesto adrese (`primer.rs`, bez šeme) →
      **server ne startuje**, uz jasnu poruku. Isto i `PARENT_CONSENT_VERSION`
      sa razmakom u sebi. (Vratiti ispravne vrednosti.) — *prepisano 25.9.2026 u novi spisak: Server i alati — Nalozi, sobe i saglasnost, stavka 2.*
- [ ] `PUBLIC_BASE_URL` **prazan** → server radi, ali prihvatanje veze sa
      maloletnikom kaže da poruka nije poslata. Veza ipak stoji na
      „čeka roditelja". (Tiho prelaženje u „prihvaćeno" je ono što ovde ne sme.) — *prepisano 25.9.2026 u novi spisak: Nalog i prijava — Veza trener–učenik i roditelj, stavka 4.*
...
- [ ] Trener ne može da zada domaći tom detetu i ne vidi mu napredak. — *prepisano 25.9.2026 u novi spisak: Teach — Učenici, grupe i obaveštenja, stavka 2.*
- [ ] Dete ne može da uđe u trenerovu sobu (spisak zvanica traži
      **prihvaćenu** vezu). — *prepisano 25.9.2026 u novi spisak: Sesija — Ulazak u sesiju i pozivi, stavka 1.*
...
- [ ] Druga veza, pa na stranici „Ne dajem saglasnost" → veza ostaje
      ...
      `friends`. — *prepisano 25.9.2026 u novi spisak: Server i alati — Saglasnost roditelja, stavka 1.*
- [ ] Izmišljen token u URL-u → „Link nije prepoznat", bez ijednog traga u bazi. — *prepisano 25.9.2026 u novi spisak: Server i alati — Saglasnost roditelja, stavka 2.*
- [ ] Istekao link: `UPDATE parent_consent_requests SET expires_at = NOW() -
      INTERVAL '1 day' WHERE ...` → „Link je istekao", drugačija poruka od
      prethodne. — *prepisano 25.9.2026 u novi spisak: Server i alati — Saglasnost roditelja, stavka 3.*
- [ ] Ime deteta postavljeno na nešto sa `<b>` u sebi → na stranici se vidi kao
      tekst, ne kao podebljano. (Ime je ono što je neko ukucao u registraciju.) — *prepisano 25.9.2026 u novi spisak: Server i alati — Saglasnost roditelja, stavka 4.*
- [x] Stranica se čita i na uskom telefonu i u tamnoj temi. — ✅ vlasnik, u alatu za proveru, 30.8.2026.

Adresa roditelja:

- [ ] Dete **bez** upisane adrese roditelja prihvati poziv → poruka kaže da
      adrese nema, veza stoji na `awaiting_parent`, i **nijedan mejl ne odlazi**. — *prepisano 25.9.2026 u novi spisak: Nalog i prijava — Veza trener–učenik i roditelj, stavka 2.*
- [x] Dete dodirne taj red → otvara se pitanje za email roditelja. Unese
      adresu → **poruka odlazi odmah**, bez ijedne dodatne radnje. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [ ] Ista adresa se vidi i u Podešavanjima → NALOG → **Email roditelja**, i
      taj red se punoletnom nalogu **ne prikazuje**. — *prepisano 25.9.2026 u novi spisak: Podešavanja i izgled — Settings, stavka 6.*
- [ ] Neispravna adresa (`roditelj`, prazno) → poruka, ništa se ne šalje. — *prepisano 25.9.2026 u novi spisak: Podešavanja i izgled — Settings, stavka 7.*
...
- [ ] Nalog sa **već prihvaćenom** vezom upiše godinu maloletnika → treneru
      ...
      `voice_level` te veze ostaju **nepromenjeni**. — *prepisano 25.9.2026 u novi spisak: Nalog i prijava — Godina rođenja, stavka 5.*
- [ ] Punoletan nalog upiše godinu → **nikakvo** obaveštenje ne odlazi. — *prepisano 25.9.2026 u novi spisak: Nalog i prijava — Godina rođenja, stavka 6.*
...
Stari spisak je u
[arhiva/TODO-provera-do-26.8.2026.md](TODO-provera-do-26.8.2026.md)
...
- [ ] Punoletan trener **sam u sobi** → „Započni snimanje" je upaljeno, ispod
      njega ne piše ništa. — **prevaziđeno (25.9.2026):** Snimanje u živoj sobi je potpuno uklonjeno 22.9.2026 (faza 5a plana sesije) — snima se isključivo lekcija u Preparation, gde je vlasnik sobe uvek sam, pa provera ko je još u sobi i ruta za čuvanje snimka sobe (POST /recordings/save) više ne postoje.
- [ ] Uđe **učenik** → dugme se gasi, a ispod piše rečenica koja **imenuje** ko
      ...
      niko ne može da postupi.) — **prevaziđeno (25.9.2026):** Snimanje u živoj sobi je potpuno uklonjeno 22.9.2026 (faza 5a plana sesije) — snima se isključivo lekcija u Preparation, gde je vlasnik sobe uvek sam, pa provera ko je još u sobi i ruta za čuvanje snimka sobe (POST /recordings/save) više ne postoje.
- [ ] Učenik izađe → dugme se **samo** vraća, bez osvežavanja ekrana. — **prevaziđeno (25.9.2026):** Snimanje u živoj sobi je potpuno uklonjeno 22.9.2026 (faza 5a plana sesije) — snima se isključivo lekcija u Preparation, gde je vlasnik sobe uvek sam, pa provera ko je još u sobi i ruta za čuvanje snimka sobe (POST /recordings/save) više ne postoje.
- [ ] Uđe **gost bez naloga** → dugme se gasi isto kao za učenika, a gost je u
      ...
      bio nevidljiv jer nema nalog ni godine. — **prevaziđeno (25.9.2026):** Snimanje u živoj sobi je potpuno uklonjeno 22.9.2026 (faza 5a plana sesije) — snima se isključivo lekcija u Preparation, gde je vlasnik sobe uvek sam, pa provera ko je još u sobi i ruta za čuvanje snimka sobe (POST /recordings/save) više ne postoje.
- [ ] Nalog **bez upisane godine** sam u sobi → dugme je **ugašeno**, uz poruku
      ...
      kao „da".) — **prevaziđeno (25.9.2026):** Snimanje u živoj sobi je potpuno uklonjeno 22.9.2026 (faza 5a plana sesije) — snima se isključivo lekcija u Preparation, gde je vlasnik sobe uvek sam, pa provera ko je još u sobi i ruta za čuvanje snimka sobe (POST /recordings/save) više ne postoje.
- [ ] Nalog sa godinom **ispod 18** sam u sobi → ugašeno, uz poruku da je
      ...
      to je drugo pitanje i druga brojka. — **prevaziđeno (25.9.2026):** Snimanje u živoj sobi je potpuno uklonjeno 22.9.2026 (faza 5a plana sesije) — snima se isključivo lekcija u Preparation, gde je vlasnik sobe uvek sam, pa provera ko je još u sobi i ruta za čuvanje snimka sobe (POST /recordings/save) više ne postoje.
...
- [ ] Trener pokrene snimanje **pa** neko uđe → stiže `recording_must_stop`,
      ...
      čuvanje onoga što je snimljeno pre njegovog ulaska — u tom delu ga nema. — **prevaziđeno (25.9.2026):** Snimanje u živoj sobi je potpuno uklonjeno 22.9.2026 (faza 5a plana sesije) — snima se isključivo lekcija u Preparation, gde je vlasnik sobe uvek sam, pa provera ko je još u sobi i ruta za čuvanje snimka sobe (POST /recordings/save) više ne postoje.
- [ ] Snimanje pokrenuto bez prava → stiže `recording_denied`, snimak se
      **baca**, ne nudi se „Sačuvaj". (Odbijen snimak koji ostane na uređaju i
      čeka dugme je odbijen snimak koji će biti sačuvan.) — **prevaziđeno (25.9.2026):** Snimanje u živoj sobi je potpuno uklonjeno 22.9.2026 (faza 5a plana sesije) — snima se isključivo lekcija u Preparation, gde je vlasnik sobe uvek sam, pa provera ko je još u sobi i ruta za čuvanje snimka sobe (POST /recordings/save) više ne postoje.
- [ ] Isto sa pauzom: pokreni, pauziraj, pusti nekoga unutra, nastavi →
      snimanje ne kreće ponovo. — **prevaziđeno (25.9.2026):** Snimanje u živoj sobi je potpuno uklonjeno 22.9.2026 (faza 5a plana sesije) — snima se isključivo lekcija u Preparation, gde je vlasnik sobe uvek sam, pa provera ko je još u sobi i ruta za čuvanje snimka sobe (POST /recordings/save) više ne postoje.
...
- [ ] `POST /recordings/save` za sobu u kojoj je bio još neko → **403**, i u
      ...
      hvata.) — **prevaziđeno (25.9.2026):** Snimanje u živoj sobi je potpuno uklonjeno 22.9.2026 (faza 5a plana sesije) — snima se isključivo lekcija u Preparation, gde je vlasnik sobe uvek sam, pa provera ko je još u sobi i ruta za čuvanje snimka sobe (POST /recordings/save) više ne postoje.
- [ ] Isti pokušaj iz aplikacije → snimak ostaje na uređaju, u dnevniku piše
      `Odbijen snimak`, i **ne pokušava ponovo** pri svakoj sinhronizaciji. — **prevaziđeno (25.9.2026):** Snimanje u živoj sobi je potpuno uklonjeno 22.9.2026 (faza 5a plana sesije) — snima se isključivo lekcija u Preparation, gde je vlasnik sobe uvek sam, pa provera ko je još u sobi i ruta za čuvanje snimka sobe (POST /recordings/save) više ne postoje.
- [ ] Restart backend-a usred snimanja, pa čuvanje → snimak **prolazi**, uz
      ...
      snimak zbog tuđeg restarta; tiho prolaženje bi bilo laž.) — **prevaziđeno (25.9.2026):** Snimanje u živoj sobi je potpuno uklonjeno 22.9.2026 (faza 5a plana sesije) — snima se isključivo lekcija u Preparation, gde je vlasnik sobe uvek sam, pa provera ko je još u sobi i ruta za čuvanje snimka sobe (POST /recordings/save) više ne postoje.
...
- [ ] **U aplikaciji:** uređaj sa zapamćenim tokenom obrisanog naloga, pa
      ...
      više ne postoji na serveru". (Ovo je jedino što `curl` ne pokriva.) — *prepisano 25.9.2026 u novi spisak: Nalog i prijava — Prijava i registracija, stavka 2.*
- [ ] **Backend ugašen** sa istim uređajem → **ne** odjavljuje se, nego kaže da
      ...
      „nalog je obrisan" — inače jedan ispad odjavi sve.) — *prepisano 25.9.2026 u novi spisak: Nalog i prijava — Veza trener–učenik i roditelj, stavka 1.*
- [ ] Oduzimanje admin uloge (`UPDATE users SET role = 'korisnik' ...`) važi
      **odmah**, bez ponovne prijave: admin rute odbijaju na sledeći zahtev. — *prepisano 25.9.2026 u novi spisak: Server i alati — Nalozi, sobe i saglasnost, stavka 1.*
...
- [ ] Instalacija debug-a preko release-a (ili obrnuto) → skripta prepozna sukob
      ...
      podešavanja**, umesto golog „Instalacija nije uspela". — *prepisano 25.9.2026 u novi spisak: Server i alati — Server, stavka 2.*
- [ ] Build iz prljavog radnog stabla ima `+` na kraju commita. — *prepisano 25.9.2026 u novi spisak: Server i alati — Server, stavka 8.*
- [x] `flutter run` ili APK iz CI-ja → piše „build nije označen". Verzija se
      **ne** prikazuje sama, jer `1.1.0+2` je isti niz na svim gradnjama ove
      nedelje i izgledao bi kao odgovor. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
...
- [ ] `-Install` napravi kopiju u `%LOCALAPPDATA%\Mislisha` i prečicu u Start
      meniju, a `-Uninstall` ih ukloni. — *prepisano 25.9.2026 u novi spisak: Server i alati — Server, stavka 3.*
- [ ] **Grana koja sama briše zaostao font sa ikonama nije se okinula** — font
      ...
      da li se ispiše brisanje i ponovna gradnja, pa da ikona ne izađe prazna. — *prepisano 25.9.2026 u novi spisak: Server i alati — Server, stavka 4.*
...
- [x] Uspravno, `Šahovski studio` i `Časovi → Nova sesija`: tabla stoji, a
      **sve ispod nje se skroluje zajedno** — navigacija, motor, bočni panel.
      Traka je do sada bila zakucana i jela ~64 dp na telefonu. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [ ] Položeno: leva kolona je **samo tabla**, desna sve ostalo uključujući
      ...
      su bili odsečeni jer je traka delila levu kolonu sa tablom. — **prevaziđeno (25.9.2026):** Stari raspored uspravno/položeno (traka koja je jela ~64dp i sekla redove 7/8, tabla na 84% uz traku evaluacije) je zamenjen 16.9.2026 zajedničkim widget-om LandscapeBoardLayout na svim tablama (soba, Preparation, Analysis Studio i drugi), čije je ponašanje već provereno kroz stavke 172-173 docs/TODO-provera.md.
- [ ] Ista dva rasporeda i sa uključenom evaluacionom linijom (tabla se tada
      ...
      preko 1.0. — **prevaziđeno (25.9.2026):** Stari raspored uspravno/položeno (traka koja je jela ~64dp i sekla redove 7/8, tabla na 84% uz traku evaluacije) je zamenjen 16.9.2026 zajedničkim widget-om LandscapeBoardLayout na svim tablama (soba, Preparation, Analysis Studio i drugi), čije je ponašanje već provereno kroz stavke 172-173 docs/TODO-provera.md.
- [ ] Natpis „Igrate kao Beli (Host)" je nestao sa sva tri rasporeda. — *prepisano 25.9.2026 u novi spisak: Sesija — Preparation, stavka 3.*

**Stablo poteza i komentari — glavni deo posla:**

- [x] Odigrati liniju, vratiti se dva poteza, odigrati drugi potez → **izvorni
      nastavak se i dalje vidi** u „Stablo poteza", u zagradi, i dodir na njega
      vraća tablu na njega. To je stavka zbog koje je sve ostalo pisano. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [ ] „U glavnu liniju" okreće **sve račve do korena**, ne samo najbližu. — *prepisano 25.9.2026 u novi spisak: Sesija — Preparation, stavka 4.*
- [ ] „Obriši varijantu" seče i vraća na roditelja. — *prepisano 25.9.2026 u novi spisak: Sesija — Preparation, stavka 5.*
- [ ] Komentar se kuca u polje ispod stabla; zaglavlje imenuje potez. Prelazak
      na drugi potez pa nazad → komentar je i dalje tu. — *prepisano 25.9.2026 u novi spisak: Sesija — Preparation, stavka 6.*
- [ ] U sobi (ne studiju): komentar stiže i drugom učesniku, i to **tek pošto
      se prestane kucati** (600 ms), a ne po slovu. — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 19.*
- [ ] Sačuvati kao lekciju → dodeliti učeniku → učenik u pregledaču vidi
      **trenerov komentar ispod table** za potez na kom stoji, i **linija je
      ...
      varijacijama; vredi ga proći sa lekcijom koja **ima** varijaciju. — *prepisano 25.9.2026 u novi spisak: Sesija — Preparation, stavka 7.*
...
- [ ] Dugme na redu linije i „Ubaci kao varijaciju" u dijalogu → linija ulazi
      ...
      gde je bio**. — *prepisano 25.9.2026 u novi spisak: Sesija — Preparation, stavka 8.*
- [ ] Ista linija dvaput → „Linija je već bila u stablu", bez druge iste grane. — *prepisano 25.9.2026 u novi spisak: Sesija — Preparation, stavka 9.*
- [ ] „Ubaci evaluaciju u komentar" dopisuje `[+2.22 / dubina 24]`. — *prepisano 25.9.2026 u novi spisak: Sesija — Preparation, stavka 10.*
...
- [ ] Strelice: ponovo povučena ista strelica se briše; „Poništi strelicu" vraća
      ...
      se promena emituje, i u studiju, gde se ne emituje. — *prepisano 25.9.2026 u novi spisak: Sesija — Preparation, stavka 11.*
- [x] Postavljanje pozicije: dodir na polje sa **istom** figurom je uklanja, dug
      pritisak i desni klik prazne polje bez brisača. Oba dijaloga — sobin i onaj
      u Analysis Studio-u. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [ ] „Uvezi PGN (fajl ili tekst)" otvara dijalog; nalepljena partija se učita, a
      nalepljen izvoz sa više partija ponudi izbor (to staro polje nije umelo). — *prepisano 25.9.2026 u novi spisak: Sesija — Preparation, stavka 12.*
- [x] „Taktika po vašoj meri" izgovara poruke kao „Završnice" — i **ćuti** kad se
      pređe na sledeću zagonetku ili napusti ekran. Windows bez srpskog glasa i
      dalje ćuti, kao i dosad. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [ ] Traka sa čipovima poteza („Početak", „1. Bd1", …) više se ne pojavljuje
      **nigde**, a grafičko stablo rešenja u „Mat u N poteza" je netaknuto. — *prepisano 25.9.2026 u novi spisak: Practise — AI Studio i zagonetke, stavka 7.*
...
- [ ] Pobeda **posle** zamene strana: matirati novom stranom → mora „POBEDA",
      ne poraz. — *prepisano 25.9.2026 u novi spisak: Practise — AI Studio i zagonetke, stavka 3.*
- [ ] Pat/remi posle zamene → „🤝 Pat / Remi u poziciji", bez ijednog dijaloga. — **prevaziđeno (25.9.2026):** Remi/pat posle zamene strana od 17.9.2026 prikazuje pun dijalog "Draw" sa telom "The game is drawn: … Try again.", a ne više obaveštenje bez dijaloga kako je stavka tražila — poraz i remi sada nose istu težinu odgovora kao pobeda.
- [ ] „Pokušaj ponovo" u dijalogu poraza vraća **istu** poziciju, a „Sledeća
      Pozicija" učitava novu. — *prepisano 25.9.2026 u novi spisak: Practise — AI Studio i zagonetke, stavka 4.*
- [ ] Da traka o zameni **ne** iskoči kad se igra normalno, od prvog do
      poslednjeg poteza svojom stranom. — *prepisano 25.9.2026 u novi spisak: Practise — AI Studio i zagonetke, stavka 5.*
...
- [ ] **Traka evaluacije, obe orijentacije.** Belo je dole kad je tabla okrenuta
      ...
      traku za pola korisnika, a svi testovi ostaju zeleni. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 16.*
- [ ] **Vodoravna traka evaluacije** u AI studiju — bela i crna polovina, broj
      preko granice između njih mora da se čita (nosi crni poteg). — *prepisano 25.9.2026 u novi spisak: Practise — AI Studio i zagonetke, stavka 2.*
- [ ] **Traka ishoda u eksploreru otvaranja**: tri polja, belo / remi / crno,
      moraju da se razlikuju međusobno i od panela iza. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 20.*
- [ ] **Birač strelica**: izabrani krug ima svetlu ivicu i kvačicu. — *prepisano 25.9.2026 u novi spisak: Sesija — Preparation, stavka 2.*
- [ ] Galerija dizajna, maketa trake evaluacije — ista slika kao prava traka. — *prepisano 25.9.2026 u novi spisak: Podešavanja i izgled — Cela aplikacija, stavka 3.*
- [ ] **Traka sa ciljem u AI studiju (paket 44) sada ima jednu boju umesto
      ...
      čitljiva na telefonu. — *prepisano 25.9.2026 u novi spisak: Practise — AI Studio i zagonetke, stavka 6.*
- [ ] Traka faze u Analysis Studiju (završnica) — indigo panel je sada
      `groupedContainer`; ivica i ikonica moraju da se vide na njemu. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 7.*
- [ ] Traka sa vežbama u Analysis Studiju — bila teal, sada `surfaceRaised`,
      dakle neutralna. Proveriti da se i dalje razlikuje od panela ispod. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 8.*
...
- [ ] Podešavanja, prijava, početni ekran, Analysis Studio, AI Studio, traka
      koraka u kursu. — *prepisano 25.9.2026 u novi spisak: Podešavanja i izgled — Cela aplikacija, stavka 4.*
- [x] **Na telefonu, i to prvo u DEBUG buildu.** Ovo je ispravka onoga što je
      ...
      tom telefonu. Sporost i trzanje u debug buildu **nisu** nalaz. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
...
- [x] Telefon, tab „Ručno Slaganje“: sva četiri čipa za rokadu (`K`, `Q`, `k`,
      `q`) moraju da se vide i da se mogu dodirnuti. Do 29.8.2026. su tri bila
      iza desne ivice — u release buildu bez ijednog traga da postoje. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Telefon: dijalog je sada širi (inset 12 umesto 40 po strani), tabla bi
      trebalo da dobije oko 56 piksela. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Windows: „Postavi poziciju“ ide u dve kolone (tabla levo, paleta i
      kontrole desno) i **ne sme da traži skrolovanje** da bi se stiglo do
      „Učitaj na tablu“. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [x] Windows: „Unos Pozicije (Board Setup)“ je 760 širok umesto 550. — ✅ vlasnik, u alatu za proveru, 30.8.2026.

### Info panel posle skeniranja (ISSUE-012)

- [ ] Skeniraj pozicije → Sačuvaj: traka ima **X** i može da se sklonu, pa se
      vidi poslednji red pozicija. — **prevaziđeno (25.9.2026):** Obaveštenje posle skeniranja i čuvanja pozicija je zamenjeno SnackBar-om "In the Library: …." sa dugmetom View (umesto stare trajne trake sa X), a odredište "Moje pozicije" je ukinuto 23.9.2026 — Biblioteka (Library) ga je preuzela (plan materijala, faza 3).
- [ ] Napustiti ekran dok traka stoji → traka nestaje sama. — **prevaziđeno (25.9.2026):** Obaveštenje posle skeniranja i čuvanja pozicija je zamenjeno SnackBar-om "In the Library: …." sa dugmetom View (umesto stare trajne trake sa X), a odredište "Moje pozicije" je ukinuto 23.9.2026 — Biblioteka (Library) ga je preuzela (plan materijala, faza 3).
- [ ] „Pogledaj“ vodi u „Moje pozicije“ i posle promene ekrana, umesto da pukne
      ...
      postoji. — **prevaziđeno (25.9.2026):** Obaveštenje posle skeniranja i čuvanja pozicija je zamenjeno SnackBar-om "In the Library: …." sa dugmetom View (umesto stare trajne trake sa X), a odredište "Moje pozicije" je ukinuto 23.9.2026 — Biblioteka (Library) ga je preuzela (plan materijala, faza 3).

### Navigacija (ISSUE-013 i ISSUE-014)

- [x] Windows i telefon u pejzažu: uz ikone u rail-u stoje i nazivi (Trening,
      Časovi, Biblioteka, Ljudi), i rail time nije pojeo previše širine. — ✅ vlasnik, u alatu za proveru, 30.8.2026.
- [ ] Sva četiri taba imaju naslov na vrhu, na istom mestu i istim stilom. — **prevaziđeno (25.9.2026):** Zajednička traka školjke (naslov i dugmad iznad svakog taba) je skinuta sa svakog taba 18.9.2026 — tab Analyse namerno nema deljeni naslov jer njegov ekran ima sopstvenu traku, pa "sva četiri taba imaju isti naslov" više nije pravilo koje kod prati.
- [ ] Prvi tab (Trening) ima **jedan** naslov, ne dva — njegov sopstveni AppBar
      se unutar tabova više ne crta. — *prepisano 25.9.2026 u novi spisak: Practise — Practise — ostalo, stavka 3.*
- [ ] Trening otvoren kao ruta (ne kao tab) i dalje ima svoj AppBar sa putem
      nazad. — *prepisano 25.9.2026 u novi spisak: Server i alati — Server, stavka 1.*
...
0. [ ] **Otpremanje fajla je glavni put** (`POST /games/import/file`,
   ...
   zaista briše kad run završi. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 33.*
1. [ ] **`POST /games/import` vrati 202 i `importId` odmah**, ne posle četiri
   minuta. Ako čeka, ruta ne radi ono zbog čega je napisana. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 34.*
2. [ ] **Cela arhiva stigne.** Na kraju `GET /games/imports/:id` mora imati
   ...
   nula preskočenih — na PGN fajlu od 29.8.2026 modul nije odbio nijednu. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 35.*
3. [ ] **Drugi uvoz odmah zatim povuče skoro ništa.** Ovo je provera da
   ...
   igralo u međuvremenu. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 36.*
4. [ ] **Drugi uvoz *tokom* prvog vrati 409**, a ne dva paralelna streama. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 37.*
5. [ ] **Nepostojeći nalog** vrati 404 sa porukom koja imenuje nalog, i run
   ostane `failed` sa tim razlogom upisanim. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 38.*
6. [ ] **Sat i otvaranje su stvarno u redovima.** `GET /games/stats` treba da
   ...
   tablebase` oko 11% (na merenoj arhivi 471 od 4126). — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 39.*
7. [ ] **Server ostaje odazivan dok uvoz traje.** Uvoz je pozadinski posao u
   ...
   nego što se pusti korisnicima. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 40.*
8. [ ] **Veličina.** Posle uvoza pogledati koliko je `user_games` zauzeo na
   ...
   tabela koja raste sa istorijom korisnika, ne sa njegovim radom u aplikaciji. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 41.*
...
- [ ] **Četiri brojača stoje na telefonu od 360 dp i sabiraju se.** Test to
  ...
  viđeno kroz pravi uvoz. — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 9.*
- [ ] **`preskočeno` nije go broj.** Uvesti PGN u koji je namerno ubačena
  ...
  „preskočeno 2: 1 nije standardni šah, 1 bez poteza". — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 10.*
- [ ] **`importId` prolazi.** `user_game_imports.id` je `BIGSERIAL`, a
  ...
  nijedan widget test je ne može uhvatiti, jer lažni servis vraća `int`. — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 11.*
- [ ] **Anketa na 2 s ne ostaje da radi** kad se ekran napusti usred uvoza. — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 12.*
- [ ] **Dugme „Pogledaj rupe u otvaranju"** se pojavi tek kad je run `done` i
  vodi na izveštaj sa istim korisničkim imenom pod kojim je uvoz išao. — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 13.*
...
1. [ ] **`GET /games/openings/leaks?subject=...` vrati nalaze.** Očekivano na
   ...
   `gamesWithoutNodes` — to znači da čvorovi nisu upisani, ne da nema slabosti. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 27.*
2. [ ] **`gamesWithoutNodes` je 0 posle uvoza**, i različit od nule za partije
   ...
   `POST /games/openings/backfill`, pa opet provera da je palo na nulu. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 28.*
3. [ ] **Prozor se ne da proširiti.** `&toPly=30` mora da vrati 400 sa
   objašnjenjem, a ne kraći izveštaj. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 29.*
4. [ ] **Brzina upita.** Ovo je prvi `GROUP BY` nad tabelom koja po korisniku
   ...
   li radi. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 30.*
5. [ ] **Suđenje bez tokena ne obara izveštaj.** `&judge=true` bez
   `X-Lichess-Token` mora da vrati brojeve i `judge.reason = 'no-token'`. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 31.*
6. [ ] **Suđenje sa tokenom** — proveriti da je deset zahteva zaista deset, i
   da `unknown` ostaje `unknown` umesto da se prikaže kao greška. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 32.*
7. [ ] **Nalaz ima smisla za igrača.** Jedina provera koju kod ne može da
   ...
   vlasnik projekta misli da igra loše. — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 16.*
...
- [ ] **Tabla u redu je okrenuta prema boji.** Crtana je kroz `BoardThumbnail`,
  ...
  i da polja nisu zamenila boje. — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 17.*
- [ ] **Suđenje se ne pokreće samo od sebe.** Izveštaj se otvara samo sa
  ...
  videti da se posle klika zaista pojavi presuda i da dugme nestane. — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 18.*
- [ ] **Bez tokena izveštaj ostaje.** Kliknuti „Presudi poteze" bez tokena u
  ...
  njih, ne umesto njih. — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 19.*
- [ ] **`unknown` se ne crta kao greška.** Nema značke „Sumnjiv potez" nad
  pozicijom koju niko nije ocenio. — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 20.*
- [ ] **Boja nije jedini kanal.** Svaka značka nosi i ikonu i srpski naziv
  ...
  provera koju samo on može da uradi. — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 21.*
- [ ] **Dugme za dopunu** se pojavi kad je `gamesWithoutNodes > 0` i nestane
  posle dopune. — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 22.*
...
1. [ ] **`POST /games/endgame/audit` vrati 202 odmah**, pa
   ...
   10–11 minuta prvi put. — **prevaziđeno (25.9.2026):** Provera završnica preko Syzygy tablica (POST /games/endgame/audit i sve što se na nju oslanja) je uklonjena 31.8.2026 zajedno sa sejanjem repertoara — sekcija je i u samom docs/TODO-provera.md označena kao uklonjena.
2. [ ] **Drugi prolaz je gotovo trenutan.** `cache_hits` mora da bude blizu
   ...
   nije, keš ne radi i to je jedina stvar koja ovu funkciju čini ponovljivom. — **prevaziđeno (25.9.2026):** Provera završnica preko Syzygy tablica (POST /games/endgame/audit i sve što se na nju oslanja) je uklonjena 31.8.2026 zajedno sa sejanjem repertoara — sekcija je i u samom docs/TODO-provera.md označena kao uklonjena.
3. [ ] **`positions_unknown` je vidljiv i nije nula bez objašnjenja.** Ako
   ...
   nestane. — **prevaziđeno (25.9.2026):** Provera završnica preko Syzygy tablica (POST /games/endgame/audit i sve što se na nju oslanja) je uklonjena 31.8.2026 zajedno sa sejanjem repertoara — sekcija je i u samom docs/TODO-provera.md označena kao uklonjena.
4. [ ] **Nalazi imaju smisla.** `GET /games/endgame/mistakes` vraća pozicije
   ...
   uradi umesto čoveka. — **prevaziđeno (25.9.2026):** Provera završnica preko Syzygy tablica (POST /games/endgame/audit i sve što se na nju oslanja) je uklonjena 31.8.2026 zajedno sa sejanjem repertoara — sekcija je i u samom docs/TODO-provera.md označena kao uklonjena.
5. [ ] **Presude su rekonstruisane iz `mistake_reviews`**, sa `wdl_before` i
   ...
   `user_id, game_id, ply`). — **prevaziđeno (25.9.2026):** Provera završnica preko Syzygy tablica (POST /games/endgame/audit i sve što se na nju oslanja) je uklonjena 31.8.2026 zajedno sa sejanjem repertoara — sekcija je i u samom docs/TODO-provera.md označena kao uklonjena.
6. [ ] **Tablica koja padne ne ostavlja poluzavršen posao kao uspešan** — run
   mora da završi kao `failed` sa razlogom, a ne kao `done`. — **prevaziđeno (25.9.2026):** Provera završnica preko Syzygy tablica (POST /games/endgame/audit i sve što se na nju oslanja) je uklonjena 31.8.2026 zajedno sa sejanjem repertoara — sekcija je i u samom docs/TODO-provera.md označena kao uklonjena.
7. [ ] **Server ostaje odazivan** dok deset minuta traje pozadinski posao u
   istom procesu. Isto pitanje kao kod uvoza, i još nije odgovoreno. — **prevaziđeno (25.9.2026):** Provera završnica preko Syzygy tablica (POST /games/endgame/audit i sve što se na nju oslanja) je uklonjena 31.8.2026 zajedno sa sejanjem repertoara — sekcija je i u samom docs/TODO-provera.md označena kao uklonjena.
...
1. [ ] **Nalazi iz provere završnica su odmah na redu za ponavljanje.**
   ...
   provera završnica ih upisuje sa `due_at` na sada. — **prevaziđeno (25.9.2026):** Izvor koji je odmah upisivao nalaze sa due_at=sada — provera završnica preko Syzygy tablica — je uklonjen 31.8.2026; danas red za ponavljanje sopstvenih grešaka pune isključivo otvaračke navike (losing habits) iz opening judgements (plan partija, §9.4), ne više provera završnica.
2. [ ] **Ocena pomera rok.** Oceniti istu stavku sa „good" pa proveriti da je
   ...
   provera da se vratila u isti dan. — *prepisano 25.9.2026 u novi spisak: Practise — My mistakes, stavka 9.*
3. [ ] **Isti SM-2 kao lekcije.** Ista ocena nad stavkom sa istim
   ...
   lekcija. Ovo test već tvrdi, ali vredi videti brojeve jednom uživo. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 23.*
4. [ ] **Tuđa partija se ne može podmetnuti.** `POST /games/mistakes` sa
   ...
   ne da upiše red. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 24.*
5. [ ] **Tally se slaže.** Poslati paket u kome je nekoliko nalaza namerno
   ...
   razlozi imenovani. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 25.*
6. [ ] **`recurrence` daje rečenicu koja ima smisla.** Za arhivu vlasnika
   ...
   provera koju kod ne može da uradi. — *prepisano 25.9.2026 u novi spisak: Practise — My mistakes, stavka 2.*
7. [ ] **Ponovni upis istog nalaza ne pravi duplikat** (isti
   `user_id, game_id, ply`). — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 26.*
...
1. [ ] **Prvo `dryRun`.** `POST /games/repertoire/seed` sa `dryRun: true` mora
   ...
   oko 648 pozicija i 1132 poteza pri podrazumevanom pragu. — **prevaziđeno (25.9.2026):** Sejanje repertoara iz arhive (POST /games/repertoire/seed i sve što se na njega oslanja) je uklonjeno 31.8.2026; poređenje (diff) je zadržano i van je ove stavke.
2. [ ] **Sejanje ne gazi ručni repertoar.** Napraviti jednu poziciju ručno sa
   ...
   potezi da uđu kao `alternate`. — **prevaziđeno (25.9.2026):** Sejanje repertoara iz arhive (POST /games/repertoire/seed i sve što se na njega oslanja) je uklonjeno 31.8.2026; poređenje (diff) je zadržano i van je ove stavke.
3. [ ] **Koliko traje.** 1132 poteza je 2264 upita; izmeriti stvarno vreme na
   ...
   pozadinskog posla, isti kao uvoz i provera završnica. — **prevaziđeno (25.9.2026):** Sejanje repertoara iz arhive (POST /games/repertoire/seed i sve što se na njega oslanja) je uklonjeno 31.8.2026; poređenje (diff) je zadržano i van je ove stavke.
4. [ ] **Ponovno sejanje ništa ne kvari** — drugi prolaz treba da doda nula
   novih poteza i ne promeni nijednu ulogu. — **prevaziđeno (25.9.2026):** Sejanje repertoara iz arhive (POST /games/repertoire/seed i sve što se na njega oslanja) je uklonjeno 31.8.2026; poređenje (diff) je zadržano i van je ove stavke.
5. [ ] **Diff daje rečenicu.** `GET /games/repertoire/diff` mora da vrati tri
   ...
   pripremu i koliko je izašlo. Proveriti da zbir prve dve daje treću. — **prevaziđeno (25.9.2026):** Sejanje repertoara iz arhive (POST /games/repertoire/seed i sve što se na njega oslanja) je uklonjeno 31.8.2026; poređenje (diff) je zadržano i van je ove stavke.
6. [ ] **Rupa nije izlazak.** Pozicija koju repertoar ne pokriva ne sme da se
   pojavi u diff-u. — **prevaziđeno (25.9.2026):** Sejanje repertoara iz arhive (POST /games/repertoire/seed i sve što se na njega oslanja) je uklonjeno 31.8.2026; poređenje (diff) je zadržano i van je ove stavke.
7. [ ] **Drill radi nad zasejanim repertoarom.** Postojeći trenažer repertoara
   ...
   radi, sejanje piše nešto što drill ne ume da pročita. — **prevaziđeno (25.9.2026):** Sejanje repertoara iz arhive (POST /games/repertoire/seed i sve što se na njega oslanja) je uklonjeno 31.8.2026; poređenje (diff) je zadržano i van je ove stavke.
...
1. [ ] **`GET /games/profile?username=` vraća brojeve koji se poklapaju sa
   ...
   Ako se razlikuju, ne veruj ni jednom broju dok se ne nađe zašto. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 19.*
2. [ ] **Sat.** `clock.atMove20` treba da da gradijent 23,8% → 48,2% → 50,9% →
   53,7%, a `clock.hurriedShare` oko 0,379. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 20.*
3. [ ] **Uzorak je ograničen i prijavljen.** `clock.sampled` ne sme tiho da
   ...
   se vidi u interfejsu. — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 14.*
4. [ ] **Brzina.** Sedam `GROUP BY` upita plus čitanje do 2000 nizova sa satom;
   izmeriti koliko traje na dropletu. Nizovi su ono što ovde nosi bajtove. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 21.*
5. [ ] **Partije bez sata ne kvare profil** — starije od trenutka kad ih je
   ...
   u proseke. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 22.*
6. [ ] **Dva broja se ne smeju prikazati kao nalaz**: red „ispod 30 s" (21
   ...
   pitanje a ne odgovor. — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 15.*
...
1. [ ] **Nepovezani trener ne prolazi.** `POST /assignments/from-archive` sa
   ...
   ostane nijedan novi red u `custom_puzzles` ni u `assignments`. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 14.*
2. [ ] **Veza koja čeka odgovor ne prolazi.** Isto to sa vezom u stanju
   `pending` — mora 403. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 15.*
3. [ ] **Prvo `dryRun`.** Sa `dryRun: true` trener vidi izabrane pozicije i
   ništa se ne upisuje; kvota se vraća. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 16.*
4. [ ] **Zadatak stigne detetu.** Bez `dryRun`, učenik dobija obaveštenje i
   ...
   („U ovoj poziciji si odigrao … Nađi bolji potez."). — *prepisano 25.9.2026 u novi spisak: Practise — Svoji zadaci i domaći, stavka 8.*
5. [ ] **Skup nije osam istih zadataka.** Pogledati zadatih osam pozicija —
   treba da pokrivaju različite teme, ne isti motiv osam puta. — *prepisano 25.9.2026 u novi spisak: Practise — Svoji zadaci i domaći, stavka 9.*
6. [ ] **Tuđa arhiva ne ulazi.** Ako učenik uveze protivnikove partije
   ...
   trenerskom pregledu. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 17.*
7. [ ] **Ponovno generisanje ne pravi duplikate pozicija** — `puzzle_id` se
   ...
   pozicije. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 18.*
8. [ ] **Trenerski pregled**: `GET /assignments/student/:id/archive` daje
   ...
   prikazan kao „pre i posle" — to je pitanje za interfejs, a odgovor je ne. — *prepisano 25.9.2026 u novi spisak: Teach — Domaći i napredak učenika, stavka 13.*
...
1. [ ] **Isključeno znači odbijeno, ne prazno.** `POST /games/prep/import` bez
   ...
   koji isključena funkcija ne sme da da. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 1.*
2. [ ] **Ništa se ne dohvata dok je isključeno.** Proveriti da u `user_games`
   nije upisan nijedan red posle odbijenog poziva. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 2.*
3. [ ] **`subject_is_owner = FALSE` na svakom uvezenom redu**, i — odmah zatim —
   ...
   zbog koje je `services/archiveScope.js` i napisan. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 3.*
4. [ ] **`vs=` vraća samo međusobne partije.** Uvesti protivnika sa
   ...
   pokazuje na profilu, a ne ceo arhiv. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 4.*
5. [ ] **`opening=true` zaista donosi `[ECO]` i `[Opening]`.** Kolone `eco` i
   ...
   29.8.2026 ih nema samo zato što je izvezen bez te zastavice. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 5.*
6. [ ] **Pogrešan `perfType` je odbijen, ne prećutan.** `perfType=bliz` mora da
   ...
   isto kao ispravan odgovor. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 6.*
7. [ ] **Rejting prag odbija pre nego što išta upiše.** Sa
   ...
   odbijemo. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 7.*
8. [ ] **Odbijenica ne odaje rejting.** Poruka sme da imenuje prag, ne i broj
   koji je taj čovek dobio. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 8.*
9. [ ] **Dnevni limit broji ljude, ne uvoze.** Dva uvoza istog protivnika su
   jedan čovek. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 9.*
10. [ ] **Retencija briše samo protivnike.** Postaviti
    ...
    jedina stvar ovde koja se ne može ponovo dohvatiti. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 10.*
11. [ ] **Izveštaj o protivniku ide kroz postojeću rutu.**
    `GET /games/openings/leaks?subject=<protivnik>` mora da radi bez ijedne nove
    rute — to je bio ceo argument da se sekcija 7 gradi posle sekcije 1. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 11.*
12. [ ] **AI opis: ime ne izlazi sa servera.** Ovo se ne vidi iz odgovora nego
    ...
    uživo treba videti jednom. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 12.*
...
14. [ ] **Bez ključa nema rečenice, ali ima izveštaja.** Ukloniti
    ...
    `reason: 'model-unavailable'`. — *prepisano 25.9.2026 u novi spisak: Server i alati — Arhiva partija i izveštaji, stavka 13.*
...
1. [ ] **Boja stiže kao „w", ne „white".** Ovo je uhvaćeno pri pregledu i
   ...
   Isto važi za zasejavanje. — **prevaziđeno (25.9.2026):** Ekran za poređenje repertoara sa arhivom je u potpunosti prepravljen u prost, read-only izveštaj (RepertoireDiffScreen): dva tastera White/Black koji uvek šalju boju (bug sa „w"/„white" više ne može da se javi jer nema puta bez boje), nema više dryRun/„zasejavanje" (dugme za izvlačenje repertoara iz partija je uklonjeno), i nema drila koji igra potez iz poređenja — samo spisak „Prepared" naspram „Played" po poziciji. Zasejavanje (seeding) je u celini izbačeno iz aplikacije.
2. [ ] **Izveštaj bez boje ne puca.** `color: null` sa servera znači „obe
   boje", ne „nedostaje polje". — **prevaziđeno (25.9.2026):** Ekran za poređenje repertoara sa arhivom je u potpunosti prepravljen u prost, read-only izveštaj (RepertoireDiffScreen): dva tastera White/Black koji uvek šalju boju (bug sa „w"/„white" više ne može da se javi jer nema puta bez boje), nema više dryRun/„zasejavanje" (dugme za izvlačenje repertoara iz partija je uklonjeno), i nema drila koji igra potez iz poređenja — samo spisak „Prepared" naspram „Played" po poziciji. Zasejavanje (seeding) je u celini izbačeno iz aplikacije.
3. [ ] **Greška bez `best_uci` se ne nudi kao zadatak.** Filtriranje postoji u
   kodu; uživo treba videti da drill ne prikaže poziciju na koju nema odgovora. — *prepisano 25.9.2026 u novi spisak: Practise — My mistakes, stavka 5.*
4. [ ] **Ocena pomera rok.** Oceniti isti nalaz sa „Dobro" pa proveriti da je
   ...
   (`description`), a ne da je sastavljena iz broja. — *prepisano 25.9.2026 u novi spisak: Practise — My mistakes, stavka 6.*
5. [ ] **Tablebase nalaz nema centipione.** Za `kind = 'tablebase'` ne sme da
   piše „0 centipoena" — taj nalaz taj broj nema. — *prepisano 25.9.2026 u novi spisak: Practise — My mistakes, stavka 7.*
6. [ ] **Ponavljanja se ne mešaju.** Motivi i završnice su dve liste; ništa se
   ne rangira preko obe. — *prepisano 25.9.2026 u novi spisak: Practise — My mistakes, stavka 8.*
7. [ ] **Zasejavanje prvo pokazuje plan.** `dryRun` mora da se vidi pre nego
   što se bilo šta upiše, i drugi pritisak da bude svestan. — **prevaziđeno (25.9.2026):** Ekran za poređenje repertoara sa arhivom je u potpunosti prepravljen u prost, read-only izveštaj (RepertoireDiffScreen): dva tastera White/Black koji uvek šalju boju (bug sa „w"/„white" više ne može da se javi jer nema puta bez boje), nema više dryRun/„zasejavanje" (dugme za izvlačenje repertoara iz partija je uklonjeno), i nema drila koji igra potez iz poređenja — samo spisak „Prepared" naspram „Played" po poziciji. Zasejavanje (seeding) je u celini izbačeno iz aplikacije.
8. [ ] **`uci` stiže u poređenju.** Dodat na backendu 30.8.2026 baš zbog ovog
   ...
   `unplayable` bude nula. — **prevaziđeno (25.9.2026):** Ekran za poređenje repertoara sa arhivom je u potpunosti prepravljen u prost, read-only izveštaj (RepertoireDiffScreen): dva tastera White/Black koji uvek šalju boju (bug sa „w"/„white" više ne može da se javi jer nema puta bez boje), nema više dryRun/„zasejavanje" (dugme za izvlačenje repertoara iz partija je uklonjeno), i nema drila koji igra potez iz poređenja — samo spisak „Prepared" naspram „Played" po poziciji. Zasejavanje (seeding) je u celini izbačeno iz aplikacije.
...
3. [ ] **Provera završnica se pokreće i ne obara aplikaciju.** Ovo je original
   ...
   celini. — **prevaziđeno (25.9.2026):** Provera se odnosila na kvar u „Proveri završnice" (stavka 54), a ta funkcija je u celini uklonjena 31.8.2026 (isti dan, stavka 69.9 ovog dokumenta to potvrđuje: na ekranu arhive više nema tog dugmeta). Scenario koji je stavka 61.4 tražila (taj konkretan pad procesa) se više ne može izazvati, pa provera CrashBreadcrumbService-a preko njega nema smisla; sam servis i dalje postoji u aplikaciji za druge padove.
4. [ ] **Trag posle pada.** `CrashBreadcrumbService` hvata Dart izuzetke.
   ...
   propust: znači da uzrok nije Dart izuzetak. — **prevaziđeno (25.9.2026):** Provera se odnosila na kvar u „Proveri završnice" (stavka 54), a ta funkcija je u celini uklonjena 31.8.2026 (isti dan, stavka 69.9 ovog dokumenta to potvrđuje: na ekranu arhive više nema tog dugmeta). Scenario koji je stavka 61.4 tražila (taj konkretan pad procesa) se više ne može izazvati, pa provera CrashBreadcrumbService-a preko njega nema smisla; sam servis i dalje postoji u aplikaciji za druge padove.
...
1. [ ] **Linija piše iznad table.** Otvoriti repertoar napravljen *posle* ove
   ...
   numerisana kao u knjizi. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 75.*
2. [ ] **Stari repertoar ne laže.** Otvoriti repertoar napravljen *pre* ove
   ...
   (`4...Nc6 5.Nf3`). Ne sme da se pojavi „1." ako partija tu nije počela. — **prevaziđeno (25.9.2026):** Provera se odnosila na razliku između repertoara napravljenih pre i posle jedne izmene od 31.8.2026 (root_path prazan kod starih). Vlasnik je 15.9.2026 odlučio da se svi tadašnji (probni) repertoari obrišu pre prelaska na novi način izgradnje (P0 plana), pa scenario „stari repertoar bez root_path" više ne postoji — svaki repertoar na serveru je sada napravljen posle promene.
3. [ ] **Nastavlja se tamo gde je stalo.** Ući u izgradnju, uzeti odgovore za
   ...
   potez — ako skoči, granica se ne izvodi nego se ponovo kupuje. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 76.*
4. [ ] **Glavna linija ide prva.** Pri povratku prva ponuđena pozicija treba da
   ...
   glavnoj liniji pretekne pliću stranputicu. — **prevaziđeno (25.9.2026):** Pravilo ređanja reda za izgradnju je promenjeno: red više ne ređa pozicije po `reach` (proizvod udela knjige), nego plića pozicija ide prva, a među jednako plitkim — redosled kojim ih je šetnja srela. Tvrdnja da „glavna linija ide prva jer ima najveći reach" više ne važi po dizajnu.
5. [ ] **Pozicija koja čeka odgovore to i kaže.** Izabrati potez i izaći **ne**
   ...
   prazno pitanje. — **prevaziđeno (25.9.2026):** U novom modelu ne postoji međukorak „izabran potez, ali nije pritisnuto 'Dalje'" — svaki odigrani potez se upisuje odmah, bez posebne potvrde. Nema više pozicije koja „čeka da se uzmu odgovori".
6. [ ] **Ugašen server ne izgleda kao gotov posao.** Ugasiti backend i otvoriti
   ...
   repertoara", nikako ekran „Nema više pozicija u redu". — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 77.*
7. [ ] **Brojevi u zaglavlju imaju smisla.** „odlučeno / otvoreno / bez odgovora
   ...
   grade linije koje se zaista sreću. — **prevaziđeno (25.9.2026):** Zaglavlje izgradnje više ne prikazuje procente „odlučeno/otvoreno/bez odgovora" — otkako je izbačen brojač neodgovorenih pozicija (16.9.2026), zaglavlje pokazuje samo prost broj „decided N".
8. [ ] **Telefon.** Sve gore na 360 dp: linija poteza može da bude duga, pa
   ...
   pruga. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 75.*
...
1. [ ] **Moji potezi se vide na tabli.** U poziciji u kojoj već imam izabran
   ...
   se glavni razaznaje **bez gledanja u boju** — zvezdica i debljina linije. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 73.*
2. [ ] **Procenat uz moj potez.** Kad je knjiga otvorena (posle odigranog
   ...
   ne sme da se pomeri** zbog crtanja strelice. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 74.*
3. [ ] **`Dalje` staje umesto da preskoči.** Posle `Dalje` ekran mora da pokaže
   ...
   `Sledeća pozicija`. Ranije je odmah prelazio na sledeću poziciju. — **prevaziđeno (25.9.2026):** Stavke opisuju dvokoračni tok „odigran potez → 'Dalje' → panel 'Odgovori protivnika' sa listom i procentima → 'Sledeća pozicija'", uključujući zaključavanje table u tom stanju. Otkad je repertoar prepravljen da se gradi na tabli (15.9.2026), protivnikov potez se ili igra ručno na tabli ili se najigraniji odgovor upiše odmah uz sopstveni potez — nema više posebnog „zaustavljenog" stanja sa zaključanom tablom niti panela sa procentima po odgovoru koji čeka pritisak na 'Dalje'.
4. [ ] **Tabla je zaključana u tom stanju.** Pokušati povući potez dok su
   odgovori na tabli — ne sme da se odigra ništa. — **prevaziđeno (25.9.2026):** Stavke opisuju dvokoračni tok „odigran potez → 'Dalje' → panel 'Odgovori protivnika' sa listom i procentima → 'Sledeća pozicija'", uključujući zaključavanje table u tom stanju. Otkad je repertoar prepravljen da se gradi na tabli (15.9.2026), protivnikov potez se ili igra ručno na tabli ili se najigraniji odgovor upiše odmah uz sopstveni potez — nema više posebnog „zaustavljenog" stanja sa zaključanom tablom niti panela sa procentima po odgovoru koji čeka pritisak na 'Dalje'.
5. [ ] **Linija poteza uključuje moj potez.** U stanju odgovora linija iznad
   table mora da se završava mojim potezom, jer je tabla pomerena za njega. — **prevaziđeno (25.9.2026):** Stavke opisuju dvokoračni tok „odigran potez → 'Dalje' → panel 'Odgovori protivnika' sa listom i procentima → 'Sledeća pozicija'", uključujući zaključavanje table u tom stanju. Otkad je repertoar prepravljen da se gradi na tabli (15.9.2026), protivnikov potez se ili igra ručno na tabli ili se najigraniji odgovor upiše odmah uz sopstveni potez — nema više posebnog „zaustavljenog" stanja sa zaključanom tablom niti panela sa procentima po odgovoru koji čeka pritisak na 'Dalje'.
...
7. [ ] **Telefon, 360 dp.** Panel „Odgovori protivnika" ima dug pasus i red po
   odgovoru. Proveriti u *release* build-u, gde nema žuto-crnih pruga. — **prevaziđeno (25.9.2026):** Stavke opisuju dvokoračni tok „odigran potez → 'Dalje' → panel 'Odgovori protivnika' sa listom i procentima → 'Sledeća pozicija'", uključujući zaključavanje table u tom stanju. Otkad je repertoar prepravljen da se gradi na tabli (15.9.2026), protivnikov potez se ili igra ručno na tabli ili se najigraniji odgovor upiše odmah uz sopstveni potez — nema više posebnog „zaustavljenog" stanja sa zaključanom tablom niti panela sa procentima po odgovoru koji čeka pritisak na 'Dalje'.
...
1. [ ] **Nova linija pretiče staru stranputicu.** Ući u izgradnju gde u redu
   ...
   tek otvorena, ako je njen procenat veći — ne ona koja je u redu duže. — **prevaziđeno (25.9.2026):** Ceo mehanizam ove stavke — red ređan po dometu (reach), i „Ne spremam ovo" (odsecanje grane) sa vraćanjem odsečenog — je uklonjen odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, odluka 4: „'Do not prepare this' (the cut) and its restore: removed."). U tekućem kodu ekrana za izgradnju ne postoji nijedan trag dugmeta za odsecanje/vraćanje, tabela `repertoire_skips` više nije referencirana, a legenda stabla ne poznaje oznaku makaza.
2. [ ] **Isti red posle izlaska.** Zapamtiti prve tri linije u redu, izaći na
   ...
   0** dok se ne odigra potez. — **prevaziđeno (25.9.2026):** Ceo mehanizam ove stavke — red ređan po dometu (reach), i „Ne spremam ovo" (odsecanje grane) sa vraćanjem odsečenog — je uklonjen odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, odluka 4: „'Do not prepare this' (the cut) and its restore: removed."). U tekućem kodu ekrana za izgradnju ne postoji nijedan trag dugmeta za odsecanje/vraćanje, tabela `repertoire_skips` više nije referencirana, a legenda stabla ne poznaje oznaku makaza.
3. [ ] **„Ne spremam ovo" postoji i nestaje na korenu.** Dugme se vidi na svakoj
   poziciji osim na korenu repertoara — tamo ga ne sme biti. — **prevaziđeno (25.9.2026):** Ceo mehanizam ove stavke — red ređan po dometu (reach), i „Ne spremam ovo" (odsecanje grane) sa vraćanjem odsečenog — je uklonjen odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, odluka 4: „'Do not prepare this' (the cut) and its restore: removed."). U tekućem kodu ekrana za izgradnju ne postoji nijedan trag dugmeta za odsecanje/vraćanje, tabela `repertoire_skips` više nije referencirana, a legenda stabla ne poznaje oznaku makaza.
4. [ ] **Rez odnosi i ono ispod.** Odseći granu koja u redu ima potomke (liniju
   ...
   reda, i te pozicije se ne smeju kasnije pojaviti. — **prevaziđeno (25.9.2026):** Ceo mehanizam ove stavke — red ređan po dometu (reach), i „Ne spremam ovo" (odsecanje grane) sa vraćanjem odsečenog — je uklonjen odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, odluka 4: „'Do not prepare this' (the cut) and its restore: removed."). U tekućem kodu ekrana za izgradnju ne postoji nijedan trag dugmeta za odsecanje/vraćanje, tabela `repertoire_skips` više nije referencirana, a legenda stabla ne poznaje oznaku makaza.
5. [ ] **Odsečeno se broji odvojeno.** U zaglavlju mora da se pojavi
   ...
   procenat odsečenog je udeo partija koje se i dalje igraju. — **prevaziđeno (25.9.2026):** Ceo mehanizam ove stavke — red ređan po dometu (reach), i „Ne spremam ovo" (odsecanje grane) sa vraćanjem odsečenog — je uklonjen odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, odluka 4: „'Do not prepare this' (the cut) and its restore: removed."). U tekućem kodu ekrana za izgradnju ne postoji nijedan trag dugmeta za odsecanje/vraćanje, tabela `repertoire_skips` više nije referencirana, a legenda stabla ne poznaje oznaku makaza.
6. [ ] **Rez preživi izlazak.** Izaći na Nazad i vratiti se: odsečena grana se ne
   sme vratiti u red sama od sebe. Ovo je jedina provera koja stvarno gleda bazu. — **prevaziđeno (25.9.2026):** Ceo mehanizam ove stavke — red ređan po dometu (reach), i „Ne spremam ovo" (odsecanje grane) sa vraćanjem odsečenog — je uklonjen odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, odluka 4: „'Do not prepare this' (the cut) and its restore: removed."). U tekućem kodu ekrana za izgradnju ne postoji nijedan trag dugmeta za odsecanje/vraćanje, tabela `repertoire_skips` više nije referencirana, a legenda stabla ne poznaje oznaku makaza.
7. [ ] **Vraćanje radi, i sa praznog ekrana.** Pritisnuti `Vrati odsečenu granu`
   ...
   vidi se ekran „Nema više pozicija": dugme mora biti i tamo. — **prevaziđeno (25.9.2026):** Ceo mehanizam ove stavke — red ređan po dometu (reach), i „Ne spremam ovo" (odsecanje grane) sa vraćanjem odsečenog — je uklonjen odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, odluka 4: „'Do not prepare this' (the cut) and its restore: removed."). U tekućem kodu ekrana za izgradnju ne postoji nijedan trag dugmeta za odsecanje/vraćanje, tabela `repertoire_skips` više nije referencirana, a legenda stabla ne poznaje oznaku makaza.
8. [ ] **Potez u odsečenoj poziciji nije izgubljen.** Ako je u odsečenoj poziciji
   ...
   sprema, ne šta se zaboravlja. — **prevaziđeno (25.9.2026):** Ceo mehanizam ove stavke — red ređan po dometu (reach), i „Ne spremam ovo" (odsecanje grane) sa vraćanjem odsečenog — je uklonjen odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, odluka 4: „'Do not prepare this' (the cut) and its restore: removed."). U tekućem kodu ekrana za izgradnju ne postoji nijedan trag dugmeta za odsecanje/vraćanje, tabela `repertoire_skips` više nije referencirana, a legenda stabla ne poznaje oznaku makaza.
9. [ ] **Ugašen server ne laže o rezu.** Ugasiti backend i pritisnuti „Ne spremam
   ovo": mora da piše da grana **nije** odsečena i pozicija ostaje na ekranu. — **prevaziđeno (25.9.2026):** Ceo mehanizam ove stavke — red ređan po dometu (reach), i „Ne spremam ovo" (odsecanje grane) sa vraćanjem odsečenog — je uklonjen odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, odluka 4: „'Do not prepare this' (the cut) and its restore: removed."). U tekućem kodu ekrana za izgradnju ne postoji nijedan trag dugmeta za odsecanje/vraćanje, tabela `repertoire_skips` više nije referencirana, a legenda stabla ne poznaje oznaku makaza.
10. [ ] **Telefon, 360 dp.** Traka sada ima peto dugme. Proveriti u *release*
    build-u, gde nema žuto-crnih pruga. — **prevaziđeno (25.9.2026):** Ceo mehanizam ove stavke — red ređan po dometu (reach), i „Ne spremam ovo" (odsecanje grane) sa vraćanjem odsečenog — je uklonjen odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, odluka 4: „'Do not prepare this' (the cut) and its restore: removed."). U tekućem kodu ekrana za izgradnju ne postoji nijedan trag dugmeta za odsecanje/vraćanje, tabela `repertoire_skips` više nije referencirana, a legenda stabla ne poznaje oznaku makaza.
...
1. [ ] **Pitanje stiže na kraju linije.** Umesto gole table mora da piše
   ...
   od N do pitanja". — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 68.*
2. [ ] **Protivnik odgovara sam.** Posle vašeg poteza protivnikov odgovor se
   odigra bez pitanja, i linija iznad table poraste za oba poteza. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 69.*
3. [ ] **Ponavljanje se ne ocenjuje.** Namerno odigrati **pogrešan** potez u
   ...
   to", „Vraća se za..."). — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 70.*
4. [ ] **Na kraju linije je pravo pitanje.** Kad se prefiks potroši, ekran kaže
   „Šta igrate belim/crnim?" i tek taj potez se ocenjuje. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 71.*
5. [ ] **Kreće od poznatog.** Uvežbati jednu poziciju do tri tačna ponavljanja
   ...
   napamet", a ne od početka repertoara. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 72.*
6. [ ] **Preskakanje radi.** Dugme „Preskoči ponavljanje" vodi pravo na pitanje,
   a linija iznad table i dalje pokazuje ceo put. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 73.*
7. [ ] **Blok iz jednog čvora.** U izgradnji, na nekoj poziciji, pritisnuti
   ...
   da pozicija iz druge grane ne dođe na red. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 72.*
8. [ ] **Prazna grana to i kaže.** Isto dugme na poziciji ispod koje još nema
   ...
   da se vežba". — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 74.*
9. [ ] **Odsečena grana se ne ponavlja.** Odseći granu (stavka 64), pa otvoriti
   vežbu: nijedna pozicija ispod reza ne sme da bude pitanje. — **prevaziđeno (25.9.2026):** Provera je zahtevala da se prvo napravi „odsečena grana" (stavka 64), a taj mehanizam odsecanja je u celini uklonjen 15.9.2026 — scenario se više ne može postaviti.
10. [ ] **Ugašen server ne ćuti.** Ugasiti backend i otvoriti vežbu: ili prazan
    ...
    ekran koji izgleda kao da je sve naučeno. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 75.*
11. [ ] **Telefon, 360 dp.** Linija iznad table može da bude duga. Proveriti u
    *release* build-u, gde nema žuto-crnih pruga. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 76.*
...
1. [ ] **Grane se vide, najigranija prva.** Svaka nosi liniju numerisanu kao u
   knjizi, ime otvaranja ako ga knjiga zna, i „igra se u X% partija". — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — pokrivenost, stavka 3.*
2. [ ] **Tri broja, i sva tri pišu.** „spremljeno X% · bez odgovora Y%", i
   ...
   odsečeno mora biti 100% po grani. — **prevaziđeno (25.9.2026):** Radar pokrivenosti (sada „Gaps in repertoire") više ne prikazuje tri procenta koji zajedno daju 100% (spremljeno/bez odgovora/odsečeno) — plan od 15.9.2026 je zamenio procente prostim brojevima („N decided · M open"), a kategorija „odsečeno" (sa makazama) više ne postoji jer je odsecanje grane ukinuto.
3. [ ] **Retka grana se ne hvali.** Napraviti granu koja se igra u malom
   ...
   zato što kroz nju ide malo partija. — **prevaziđeno (25.9.2026):** Radar pokrivenosti (sada „Gaps in repertoire") više ne prikazuje tri procenta koji zajedno daju 100% (spremljeno/bez odgovora/odsečeno) — plan od 15.9.2026 je zamenio procente prostim brojevima („N decided · M open"), a kategorija „odsečeno" (sa makazama) više ne postoji jer je odsecanje grane ukinuto.
4. [ ] **Odsečena grana nije gotova grana.** Odseći granu (stavka 64) i otvoriti
   mapu: mora da stoji „odsečeno 100%" i makaze, nikako kvačica i „spremljeno". — **prevaziđeno (25.9.2026):** Radar pokrivenosti (sada „Gaps in repertoire") više ne prikazuje tri procenta koji zajedno daju 100% (spremljeno/bez odgovora/odsečeno) — plan od 15.9.2026 je zamenio procente prostim brojevima („N decided · M open"), a kategorija „odsečeno" (sa makazama) više ne postoji jer je odsecanje grane ukinuto.
5. [ ] **Bez boje se sve razaznaje.** Pogledati ekran i proveriti da se stanje
   ...
   nijedna informacija ne postoji samo kao boja. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — pokrivenost, stavka 4.*
6. [ ] **Obe vrata rade.** „Gradi ovde" otvara izgradnju baš u toj grani;
   „Vežbaj granu" otvara vežbu koja pita samo pozicije iz nje. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — pokrivenost, stavka 5.*
7. [ ] **Grana bez ijedne odluke nema dugme za vežbu.** Tamo nema šta da se
   pita, pa se dugme ne nudi. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — pokrivenost, stavka 6.*
8. [ ] **Prazan repertoar i ugašen server izgledaju različito.** Nov repertoar
   ...
   nije mogla da se pročita", nikako prazna mapa. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — pokrivenost, stavka 7.*
9. [ ] **Dubina ima smisla.** „do N. poteza posle korena" mora da raste kako se
   grana produbljuje. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — pokrivenost, stavka 8.*
10. [ ] **Telefon, 360 dp.** Linija grane može da bude duga i ispod nje stoje dva
    dugmeta. Proveriti u *release* build-u, gde nema žuto-crnih pruga. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — pokrivenost, stavka 9.*
...
1. [ ] **Prazna vežba kaže kada se vraća.** Uzeti granu u kojoj je sve već
   ...
   sutra / za N dana", a ne samo da ničega nema. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 64.*
2. [ ] **„Vežbaj ipak" postoji i radi.** Dugme se vidi kad ima šta da se vežba a
   ništa nije dospelo; klik otvara pitanje, a u zaglavlju piše „van rasporeda". — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 65.*
3. [ ] **Vežba van rasporeda se ne upisuje.** Odgovoriti tačno, pa se vratiti:
   ...
   za N dana". Ovo je jedina provera koja stvarno gleda bazu. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 66.*
4. [ ] **Prazna grana i dalje nema to dugme.** U grani u kojoj nikad ništa nije
   izgrađeno „Vežbaj ipak" se ne nudi. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 67.*
5. [ ] **Stablo se otvara sa radara.** Ikonica stabla u zaglavlju „Pokrivenost". — **prevaziđeno (25.9.2026):** Ove stavke se odnose na poseban, celoekranski ekran za stablo repertoara, otvaran preko ikonice u zaglavlju ekrana pokrivenosti, sa karticama koje mogu nositi oznaku „…" (izabran, nepotvrđen potez) i „✂" (odsečeno), i sa dugmadima „Gradi odavde"/„Vežbaj ovu granu" po kliku na karticu. Stablo je od 31.8.2026/15.9.2026 ugrađeno direktno u ekran izgradnje (stavka 70 ovog dokumenta, isti dan), nema više posebnog ekrana niti ikonice u zaglavlju „Gaps in repertoire", legenda kartica sad zna samo za „★", procenat i „?" (nema više „…" ni „✂"), dodir na karticu samo pomera tablu (nema posebnih dugmadi „Gradi odavde"/„Vežbaj ovu granu" sa te kartice), i nema korisnički podesivog prekidača dubine crteža (8/24 poluporeza) — samo automatska poruka da je crtež skraćen.
6. [ ] **Potez bez uzetih odgovora se vidi na crtežu.** Otvoriti stablo
   ...
   da bude kartica sa `…`, ne da nedostaje. — **prevaziđeno (25.9.2026):** Ove stavke se odnose na poseban, celoekranski ekran za stablo repertoara, otvaran preko ikonice u zaglavlju ekrana pokrivenosti, sa karticama koje mogu nositi oznaku „…" (izabran, nepotvrđen potez) i „✂" (odsečeno), i sa dugmadima „Gradi odavde"/„Vežbaj ovu granu" po kliku na karticu. Stablo je od 31.8.2026/15.9.2026 ugrađeno direktno u ekran izgradnje (stavka 70 ovog dokumenta, isti dan), nema više posebnog ekrana niti ikonice u zaglavlju „Gaps in repertoire", legenda kartica sad zna samo za „★", procenat i „?" (nema više „…" ni „✂"), dodir na karticu samo pomera tablu (nema posebnih dugmadi „Gradi odavde"/„Vežbaj ovu granu" sa te kartice), i nema korisnički podesivog prekidača dubine crteža (8/24 poluporeza) — samo automatska poruka da je crtež skraćen.
7. [ ] **Kartice kažu stanje bez boje.** Proveriti da se na crtežu razaznaju
   `★` (glavni), procenat uz protivnikov potez, `?`, `…` i `✂`. — **prevaziđeno (25.9.2026):** Ove stavke se odnose na poseban, celoekranski ekran za stablo repertoara, otvaran preko ikonice u zaglavlju ekrana pokrivenosti, sa karticama koje mogu nositi oznaku „…" (izabran, nepotvrđen potez) i „✂" (odsečeno), i sa dugmadima „Gradi odavde"/„Vežbaj ovu granu" po kliku na karticu. Stablo je od 31.8.2026/15.9.2026 ugrađeno direktno u ekran izgradnje (stavka 70 ovog dokumenta, isti dan), nema više posebnog ekrana niti ikonice u zaglavlju „Gaps in repertoire", legenda kartica sad zna samo za „★", procenat i „?" (nema više „…" ni „✂"), dodir na karticu samo pomera tablu (nema posebnih dugmadi „Gradi odavde"/„Vežbaj ovu granu" sa te kartice), i nema korisnički podesivog prekidača dubine crteža (8/24 poluporeza) — samo automatska poruka da je crtež skraćen.
8. [ ] **Dubina radi.** Prebaciti na 8 poluporeza: crtež se skrati i pojavi se
   rečenica da je skraćen. Vratiti na 24 i proveriti da se produbi. — **prevaziđeno (25.9.2026):** Ove stavke se odnose na poseban, celoekranski ekran za stablo repertoara, otvaran preko ikonice u zaglavlju ekrana pokrivenosti, sa karticama koje mogu nositi oznaku „…" (izabran, nepotvrđen potez) i „✂" (odsečeno), i sa dugmadima „Gradi odavde"/„Vežbaj ovu granu" po kliku na karticu. Stablo je od 31.8.2026/15.9.2026 ugrađeno direktno u ekran izgradnje (stavka 70 ovog dokumenta, isti dan), nema više posebnog ekrana niti ikonice u zaglavlju „Gaps in repertoire", legenda kartica sad zna samo za „★", procenat i „?" (nema više „…" ni „✂"), dodir na karticu samo pomera tablu (nema posebnih dugmadi „Gradi odavde"/„Vežbaj ovu granu" sa te kartice), i nema korisnički podesivog prekidača dubine crteža (8/24 poluporeza) — samo automatska poruka da je crtež skraćen.
9. [ ] **Velik repertoar ne obara ekran.** Otvoriti stablo nad zasejanim
   ...
   zumiranje radi. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 71.*
10. [ ] **Obe vrata sa crteža.** Klik na protivnikov potez → „Gradi odavde" i
    ...
    dugmadi stoji rečenica da je tamo protivnik na potezu. — **prevaziđeno (25.9.2026):** Ove stavke se odnose na poseban, celoekranski ekran za stablo repertoara, otvaran preko ikonice u zaglavlju ekrana pokrivenosti, sa karticama koje mogu nositi oznaku „…" (izabran, nepotvrđen potez) i „✂" (odsečeno), i sa dugmadima „Gradi odavde"/„Vežbaj ovu granu" po kliku na karticu. Stablo je od 31.8.2026/15.9.2026 ugrađeno direktno u ekran izgradnje (stavka 70 ovog dokumenta, isti dan), nema više posebnog ekrana niti ikonice u zaglavlju „Gaps in repertoire", legenda kartica sad zna samo za „★", procenat i „?" (nema više „…" ni „✂"), dodir na karticu samo pomera tablu (nema posebnih dugmadi „Gradi odavde"/„Vežbaj ovu granu" sa te kartice), i nema korisnički podesivog prekidača dubine crteža (8/24 poluporeza) — samo automatska poruka da je crtež skraćen.
11. [ ] **Ugašen server.** Stablo mora da kaže da nije moglo da se pročita, ne
    da je repertoar prazan. — **prevaziđeno (25.9.2026):** Ove stavke se odnose na poseban, celoekranski ekran za stablo repertoara, otvaran preko ikonice u zaglavlju ekrana pokrivenosti, sa karticama koje mogu nositi oznaku „…" (izabran, nepotvrđen potez) i „✂" (odsečeno), i sa dugmadima „Gradi odavde"/„Vežbaj ovu granu" po kliku na karticu. Stablo je od 31.8.2026/15.9.2026 ugrađeno direktno u ekran izgradnje (stavka 70 ovog dokumenta, isti dan), nema više posebnog ekrana niti ikonice u zaglavlju „Gaps in repertoire", legenda kartica sad zna samo za „★", procenat i „?" (nema više „…" ni „✂"), dodir na karticu samo pomera tablu (nema posebnih dugmadi „Gradi odavde"/„Vežbaj ovu granu" sa te kartice), i nema korisnički podesivog prekidača dubine crteža (8/24 poluporeza) — samo automatska poruka da je crtež skraćen.
...
1. [ ] **Spisak se otvara i sklapa.** U izgradnji, posle „Dalje", ispod rečenice
   ...
   nepokrivenih poteza sa procentom i brojem partija; ponovni klik ga sklapa. — **prevaziđeno (25.9.2026):** Cela stavka opisuje „spremanje" (pripremanje) protivnikovog poteza iz spiska nepokrivenih poteza knjige, ređanog po broju partija/procentu, pre nego što postane pravo pitanje. Od 15.9.2026 protivnikovi potezi se igraju direktno na tabli (ili se najigraniji upisuje automatski uz sopstveni potez) — nema više liste „Van pripreme još N poteza" ni dugmeta „Spremi"; `repertoire_extra_replies` sad znači ceo protivnički niz upisanih poteza, ne „pripremljene" rezervne odgovore.
2. [ ] **„Spremi" radi i kaže šta je uradio.** Klik na dugme uz jedan potez →
   poruka „U pripremi je i X" i red se produži za jedan. — **prevaziđeno (25.9.2026):** Cela stavka opisuje „spremanje" (pripremanje) protivnikovog poteza iz spiska nepokrivenih poteza knjige, ređanog po broju partija/procentu, pre nego što postane pravo pitanje. Od 15.9.2026 protivnikovi potezi se igraju direktno na tabli (ili se najigraniji upisuje automatski uz sopstveni potez) — nema više liste „Van pripreme još N poteza" ni dugmeta „Spremi"; `repertoire_extra_replies` sad znači ceo protivnički niz upisanih poteza, ne „pripremljene" rezervne odgovore.
3. [ ] **Ulazi po dometu, ne na vrh.** Ako je potez redak, ne sme odmah da bude
   ...
   pozicija ostane ona sa većim procentom. — **prevaziđeno (25.9.2026):** Cela stavka opisuje „spremanje" (pripremanje) protivnikovog poteza iz spiska nepokrivenih poteza knjige, ređanog po broju partija/procentu, pre nego što postane pravo pitanje. Od 15.9.2026 protivnikovi potezi se igraju direktno na tabli (ili se najigraniji upisuje automatski uz sopstveni potez) — nema više liste „Van pripreme još N poteza" ni dugmeta „Spremi"; `repertoire_extra_replies` sad znači ceo protivnički niz upisanih poteza, ne „pripremljene" rezervne odgovore.
4. [ ] **Preživljava izlazak — ovo je jedina provera koja stvarno gleda bazu.**
   ...
   poteze. — **prevaziđeno (25.9.2026):** Cela stavka opisuje „spremanje" (pripremanje) protivnikovog poteza iz spiska nepokrivenih poteza knjige, ređanog po broju partija/procentu, pre nego što postane pravo pitanje. Od 15.9.2026 protivnikovi potezi se igraju direktno na tabli (ili se najigraniji upisuje automatski uz sopstveni potez) — nema više liste „Van pripreme još N poteza" ni dugmeta „Spremi"; `repertoire_extra_replies` sad znači ceo protivnički niz upisanih poteza, ne „pripremljene" rezervne odgovore.
5. [ ] **Dodat potez se vidi i na stablu i na radaru.** Otvoriti stablo: nova
   ...
   je pripremljeno više nego ranije a odgovora još nema. — **prevaziđeno (25.9.2026):** Cela stavka opisuje „spremanje" (pripremanje) protivnikovog poteza iz spiska nepokrivenih poteza knjige, ređanog po broju partija/procentu, pre nego što postane pravo pitanje. Od 15.9.2026 protivnikovi potezi se igraju direktno na tabli (ili se najigraniji upisuje automatski uz sopstveni potez) — nema više liste „Van pripreme još N poteza" ni dugmeta „Spremi"; `repertoire_extra_replies` sad znači ceo protivnički niz upisanih poteza, ne „pripremljene" rezervne odgovore.
6. [ ] **Dvaput isti potez nije greška.** Ako se isti potez spremi dvaput (npr.
   ...
   je već u pripremi. — **prevaziđeno (25.9.2026):** Cela stavka opisuje „spremanje" (pripremanje) protivnikovog poteza iz spiska nepokrivenih poteza knjige, ređanog po broju partija/procentu, pre nego što postane pravo pitanje. Od 15.9.2026 protivnikovi potezi se igraju direktno na tabli (ili se najigraniji upisuje automatski uz sopstveni potez) — nema više liste „Van pripreme još N poteza" ni dugmeta „Spremi"; `repertoire_extra_replies` sad znači ceo protivnički niz upisanih poteza, ne „pripremljene" rezervne odgovore.
7. [ ] **Ugašen server ne laže.** Ugasiti backend i pritisnuti „Spremi": mora da
   piše da potez **nije** dodat, i red ne sme da poraste. — **prevaziđeno (25.9.2026):** Cela stavka opisuje „spremanje" (pripremanje) protivnikovog poteza iz spiska nepokrivenih poteza knjige, ređanog po broju partija/procentu, pre nego što postane pravo pitanje. Od 15.9.2026 protivnikovi potezi se igraju direktno na tabli (ili se najigraniji upisuje automatski uz sopstveni potez) — nema više liste „Van pripreme još N poteza" ni dugmeta „Spremi"; `repertoire_extra_replies` sad znači ceo protivnički niz upisanih poteza, ne „pripremljene" rezervne odgovore.
8. [ ] **Tuđa priprema ostaje tuđa.** Ovo se ne može proveriti sa jednim
   ...
   šta drugi nalog vidi kao pokriveno. — **prevaziđeno (25.9.2026):** Cela stavka opisuje „spremanje" (pripremanje) protivnikovog poteza iz spiska nepokrivenih poteza knjige, ređanog po broju partija/procentu, pre nego što postane pravo pitanje. Od 15.9.2026 protivnikovi potezi se igraju direktno na tabli (ili se najigraniji upisuje automatski uz sopstveni potez) — nema više liste „Van pripreme još N poteza" ni dugmeta „Spremi"; `repertoire_extra_replies` sad znači ceo protivnički niz upisanih poteza, ne „pripremljene" rezervne odgovore.
9. [ ] **Telefon, 360 dp.** Red repa ima potez, procenat, broj partija i dugme.
   Proveriti u *release* build-u, gde nema žuto-crnih pruga. — **prevaziđeno (25.9.2026):** Cela stavka opisuje „spremanje" (pripremanje) protivnikovog poteza iz spiska nepokrivenih poteza knjige, ređanog po broju partija/procentu, pre nego što postane pravo pitanje. Od 15.9.2026 protivnikovi potezi se igraju direktno na tabli (ili se najigraniji upisuje automatski uz sopstveni potez) — nema više liste „Van pripreme još N poteza" ni dugmeta „Spremi"; `repertoire_extra_replies` sad znači ceo protivnički niz upisanih poteza, ne „pripremljene" rezervne odgovore.
...
1. [ ] **Menija ima na svakom redu.** U spisku repertoara, uz dugme sa tegom
   ...
   Obriši repertoar. — **prevaziđeno (25.9.2026):** Meni sa četiri stavke (Pokrivenost, Stablo poteza, Očisti poteze iz uvoza, Obriši repertoar) je opisan za isti dan (31.8.2026), ali ga je kasnija izmena istog dana (stavka 70 ovog dokumenta) prestigla: stablo je premešteno u ekran izgradnje i stavka „Stablo poteza" je uklonjena iz menija. Tekući meni „More" na kartici repertoara ima šest stavki (Explore repertoire, Gaps in repertoire, Which move it goes through, Export as PGN, Clean imported moves, Delete repertoire) i nijedna se ne zove „Move tree"/„Stablo poteza".
2. [ ] **Stablo se otvara odatle.** Ovo je i odgovor na „ne vidim stablo" —
   ranije je bilo samo u zaglavlju Pokrivenosti. — **prevaziđeno (25.9.2026):** Meni sa četiri stavke (Pokrivenost, Stablo poteza, Očisti poteze iz uvoza, Obriši repertoar) je opisan za isti dan (31.8.2026), ali ga je kasnija izmena istog dana (stavka 70 ovog dokumenta) prestigla: stablo je premešteno u ekran izgradnje i stavka „Stablo poteza" je uklonjena iz menija. Tekući meni „More" na kartici repertoara ima šest stavki (Explore repertoire, Gaps in repertoire, Which move it goes through, Export as PGN, Clean imported moves, Delete repertoire) i nijedna se ne zove „Move tree"/„Stablo poteza".
3. [ ] **Brojanje pre brisanja.** „Očisti poteze iz uvoza" prvo javlja koliko
   ...
   to procena**. Odustajanje ne sme ništa da obriše. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 34.*
4. [ ] **Brisanje smanjuje graf.** Posle potvrde, broj poteza u spisku (redak
   „N poteza u grafu") mora da padne, i to za obe kartice iste boje. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 35.*
5. [ ] **Ono što ste sami izabrali ostaje.** Pre čišćenja izgraditi ručno bar
   jednu poziciju; posle čišćenja ona mora i dalje da bude tu, sa zvezdicom. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 36.*
6. [ ] **Nijedna pozicija ne ostaje bez glavnog poteza.** Otvoriti drill posle
   čišćenja: mora da pita normalno, bez pozicija na koje nema odgovora. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 70.*
7. [ ] **Brisanje repertoara ne dira poteze.** Obrisati „Iz mojih partija —
   beli": kartica nestaje, a drugi repertoar iste boje i dalje ima svoje poteze. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 37.*
8. [ ] **Nema više dugmeta za sejanje.** Na ekranu „Repertoar iz partija" nema
   ...
   repertoar ne upisuju. — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 7.*
9. [ ] **Nema više provere završnica.** Na ekranu arhive i posle uvoza nema
   ...
   nalaze iz završnica koji su ranije upisani. — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 8.*
...
1. [ ] **Na Windows-u su tabla i stablo jedno pored drugog.** Otvoriti
   ...
   sada nosi stablo. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 61.*
2. [ ] **Tabla je veća nego ranije** na punom prozoru, ali pitanje ispod nje se
   i dalje vidi bez skrolovanja. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 62.*
3. [ ] **Traka ispod table.** Roditelj → trenutna pozicija → deca, sa oznakama
   (★, procenat, ?, …, ✂). Dodir na stavku vodi tamo. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 63.*
4. [ ] **Dodir na protivnikov potez vodi tablu na tu poziciju**, i linija iznad
   table se produži. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 64.*
5. [ ] **Dodir na svoj potez stavlja tablu posle njega**, a ispod stoji
   ...
   odigran. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 65.*
6. [ ] **Red nije poremećen.** Posle skakanja po stablu, „Preskoči" i „Dalje"
   i dalje rade, i „Još N u redu" se nije promenio zbog samog skakanja. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 66.*
7. [ ] **Crtež prati tablu.** Posle „Uzmi" i „Dalje", stablo se osveži i nova
   grana se vidi bez ručnog osvežavanja. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 67.*
8. [ ] **Telefon, 360 dp, release build.** Panel je ispod kontrola, sklopljen.
   ...
   se ništa ne seče, naročito naslov „Stablo Varijanti". — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 68.*
9. [ ] **Analiza i dalje radi.** Isti panel se koristi u Analizi; otvoriti je i
   proveriti da zaglavlje izgleda normalno na širokom prozoru. — *prepisano 25.9.2026 u novi spisak: Practise — Practise — ostalo, stavka 1.*
10. [ ] **Nema više zasebnog ekrana za stablo.** U spisku repertoara u ⋮ meniju
    ...
    stabla — jer je stablo tamo gde se gradi. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 33.*
11. [ ] **Dodir na poziciju na kojoj tabla već stoji ne briše ništa.** Pitati
    motor, sačekati linije, pa dodirnuti tu istu karticu: linije ostaju. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 69.*
...
1. [ ] **Postojeći potezi su i dalje vaši.** Otvoriti repertoar napravljen
   ...
   provera da je to zaista tako u vašoj bazi. — **prevaziđeno (25.9.2026):** Nacrt (draft) potezi, njihova potvrda i traka jačine protivnika (1400/1600/1800/2000) koja je birala knjigu su u celini uklonjeni odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, odluka 2: „Unconfirmed (drafted) moves: gone"). U tekućem kodu ekrana za izgradnju i spiska repertoara ne postoji ni traka rejtinga ni ijedan trag reči „draft"/„nacrt" niti brojača upita.
2. [ ] **Traka rejtinga postoji i pamti se.** U zaglavlju spiska repertoara,
   ...
   Promeniti na 1800, izaći iz aplikacije i vratiti se: izbor je zapamćen. — **prevaziđeno (25.9.2026):** Nacrt (draft) potezi, njihova potvrda i traka jačine protivnika (1400/1600/1800/2000) koja je birala knjigu su u celini uklonjeni odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, odluka 2: „Unconfirmed (drafted) moves: gone"). U tekućem kodu ekrana za izgradnju i spiska repertoara ne postoji ni traka rejtinga ni ijedan trag reči „draft"/„nacrt" niti brojača upita.
3. [ ] **Traka menja knjigu.** Sa 1400 pa sa 2000, na istoj poziciji otvoriti
   ...
   traka nije stigla do zahteva. — **prevaziđeno (25.9.2026):** Nacrt (draft) potezi, njihova potvrda i traka jačine protivnika (1400/1600/1800/2000) koja je birala knjigu su u celini uklonjeni odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, odluka 2: „Unconfirmed (drafted) moves: gone"). U tekućem kodu ekrana za izgradnju i spiska repertoara ne postoji ni traka rejtinga ni ijedan trag reči „draft"/„nacrt" niti brojača upita.
4. [ ] **Brojač upita.** Promena trake znači novu knjigu, pa prvi zahtev u novoj
   traci troši upit; drugi put na istoj poziciji ne sme. — **prevaziđeno (25.9.2026):** Nacrt (draft) potezi, njihova potvrda i traka jačine protivnika (1400/1600/1800/2000) koja je birala knjigu su u celini uklonjeni odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, odluka 2: „Unconfirmed (drafted) moves: gone"). U tekućem kodu ekrana za izgradnju i spiska repertoara ne postoji ni traka rejtinga ni ijedan trag reči „draft"/„nacrt" niti brojača upita.
5. [ ] **Nacrt se vidi kao nacrt.** Ovo se može proveriti tek kad postoji
   auto-kičma (korak 3). Do tada je dovoljno da ništa ne piše „predlog". — **prevaziđeno (25.9.2026):** Nacrt (draft) potezi, njihova potvrda i traka jačine protivnika (1400/1600/1800/2000) koja je birala knjigu su u celini uklonjeni odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, odluka 2: „Unconfirmed (drafted) moves: gone"). U tekućem kodu ekrana za izgradnju i spiska repertoara ne postoji ni traka rejtinga ni ijedan trag reči „draft"/„nacrt" niti brojača upita.
6. [ ] **Zaglavlje broji nacrte odvojeno.** Kad ih bude, u redu „odlučeno · …"
   pojavljuje se i „nacrt N", i taj broj se ne sabira sa „odlučeno". — **prevaziđeno (25.9.2026):** Nacrt (draft) potezi, njihova potvrda i traka jačine protivnika (1400/1600/1800/2000) koja je birala knjigu su u celini uklonjeni odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, odluka 2: „Unconfirmed (drafted) moves: gone"). U tekućem kodu ekrana za izgradnju i spiska repertoara ne postoji ni traka rejtinga ni ijedan trag reči „draft"/„nacrt" niti brojača upita.
...
1. [ ] **Dugme postoji na svakoj poziciji.** U izgradnji, „Napravi kičmu" →
   dijalog sa 4 / 6 / 8 / 10 / 12 poteza i rečenicom da su to predlozi. — **prevaziđeno (25.9.2026):** Auto-kičma (dugme „Napravi kičmu" koje je Lichess tokenom pisalo do 12 poteza unapred kao nacrte) je u celini uklonjena odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, tačka 7: „'Suggest main line' and breadth go."). U tekućem ekranu izgradnje ne postoji dugme za auto-kičmu niti trag reči „spine"/„kičma"/„predlog".
2. [ ] **Prazan repertoar dobije deblo.** Napraviti nov repertoar i pustiti
   ...
   liniju numerisanu kao u knjizi. — **prevaziđeno (25.9.2026):** Auto-kičma (dugme „Napravi kičmu" koje je Lichess tokenom pisalo do 12 poteza unapred kao nacrte) je u celini uklonjena odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, tačka 7: „'Suggest main line' and breadth go."). U tekućem ekranu izgradnje ne postoji dugme za auto-kičmu niti trag reči „spine"/„kičma"/„predlog".
3. [ ] **Sve što je upisala piše „predlog".** U „Vaši potezi ovde" svaki takav
   potez ima „predlog — nije još vaš izbor" i dugme „Potvrdi". — **prevaziđeno (25.9.2026):** Auto-kičma (dugme „Napravi kičmu" koje je Lichess tokenom pisalo do 12 poteza unapred kao nacrte) je u celini uklonjena odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, tačka 7: „'Suggest main line' and breadth go."). U tekućem ekranu izgradnje ne postoji dugme za auto-kičmu niti trag reči „spine"/„kičma"/„predlog".
4. [ ] **Vežba ih ne pita.** Odmah posle kičme otvoriti vežbu: ne sme da traži
   nijedan potez koji niste potvrdili. Ako pita — filter po `source` ne radi. — **prevaziđeno (25.9.2026):** Auto-kičma (dugme „Napravi kičmu" koje je Lichess tokenom pisalo do 12 poteza unapred kao nacrte) je u celini uklonjena odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, tačka 7: „'Suggest main line' and breadth go."). U tekućem ekranu izgradnje ne postoji dugme za auto-kičmu niti trag reči „spine"/„kičma"/„predlog".
5. [ ] **Potvrda menja to.** Potvrditi jedan potez pa otvoriti vežbu: sada sme
   da ga pita. — **prevaziđeno (25.9.2026):** Auto-kičma (dugme „Napravi kičmu" koje je Lichess tokenom pisalo do 12 poteza unapred kao nacrte) je u celini uklonjena odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, tačka 7: „'Suggest main line' and breadth go."). U tekućem ekranu izgradnje ne postoji dugme za auto-kičmu niti trag reči „spine"/„kičma"/„predlog".
6. [ ] **Ponovno pokretanje ne gazi.** Odigrati svoj potez na nekoj poziciji
   ...
   potez mora da ostane, i kičma mora da nastavi kroz njega. — **prevaziđeno (25.9.2026):** Auto-kičma (dugme „Napravi kičmu" koje je Lichess tokenom pisalo do 12 poteza unapred kao nacrte) je u celini uklonjena odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, tačka 7: „'Suggest main line' and breadth go."). U tekućem ekranu izgradnje ne postoji dugme za auto-kičmu niti trag reči „spine"/„kičma"/„predlog".
7. [ ] **Staje i kaže zašto.** Pustiti kičmu na 12 poteza u nekoj retkoj liniji:
   poruka mora da kaže da je stalo jer je pretanko, sa brojem partija i pragom. — **prevaziđeno (25.9.2026):** Auto-kičma (dugme „Napravi kičmu" koje je Lichess tokenom pisalo do 12 poteza unapred kao nacrte) je u celini uklonjena odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, tačka 7: „'Suggest main line' and breadth go."). U tekućem ekranu izgradnje ne postoji dugme za auto-kičmu niti trag reči „spine"/„kičma"/„predlog".
8. [ ] **Bez tokena kaže da nema tokena**, ne „greška na serveru". — **prevaziđeno (25.9.2026):** Auto-kičma (dugme „Napravi kičmu" koje je Lichess tokenom pisalo do 12 poteza unapred kao nacrte) je u celini uklonjena odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, tačka 7: „'Suggest main line' and breadth go."). U tekućem ekranu izgradnje ne postoji dugme za auto-kičmu niti trag reči „spine"/„kičma"/„predlog".
9. [ ] **Brojač upita raste.** „upita:" u zaglavlju mora da poraste otprilike
   dvostruko od broja poteza koje je napisala. — **prevaziđeno (25.9.2026):** Auto-kičma (dugme „Napravi kičmu" koje je Lichess tokenom pisalo do 12 poteza unapred kao nacrte) je u celini uklonjena odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, tačka 7: „'Suggest main line' and breadth go."). U tekućem ekranu izgradnje ne postoji dugme za auto-kičmu niti trag reči „spine"/„kičma"/„predlog".
10. [ ] **Traka rejtinga se poštuje.** Ista pozicija na 1400 i na 2000 ume da
    da različitu kičmu — proveriti bar da se prvi potez ili procenti razlikuju. — **prevaziđeno (25.9.2026):** Auto-kičma (dugme „Napravi kičmu" koje je Lichess tokenom pisalo do 12 poteza unapred kao nacrte) je u celini uklonjena odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, tačka 7: „'Suggest main line' and breadth go."). U tekućem ekranu izgradnje ne postoji dugme za auto-kičmu niti trag reči „spine"/„kičma"/„predlog".
11. [ ] **Telefon, 360 dp.** Traka kontrola sada ima sedam dugmadi. Proveriti u
    *release* build-u, gde nema žuto-crnih pruga. — **prevaziđeno (25.9.2026):** Auto-kičma (dugme „Napravi kičmu" koje je Lichess tokenom pisalo do 12 poteza unapred kao nacrte) je u celini uklonjena odlukom vlasnika od 15.9.2026 (PLAN-REPERTOAR-RUCNO.md, tačka 7: „'Suggest main line' and breadth go."). U tekućem ekranu izgradnje ne postoji dugme za auto-kičmu niti trag reči „spine"/„kičma"/„predlog".
...
1. [ ] **Uklanjanje poteza odnese nacrte iza njega.** Pustiti kičmu, pa ukloniti
   ...
   do kojih se više nije moglo stići", i stablo se skrati. — **prevaziđeno (25.9.2026):** Stavka opisuje brisanje nacrta (draft poteza koje je upisala auto-kičma) kad se obriše potez iznad njih. Auto-kičma i nacrti su u celini uklonjeni 15.9.2026, pa scenario „ukloni potez i odnesi nacrte iza njega" više ne postoji — orphan-detekcija sad radi samo nad stvarno odigranim (odlučenim) potezima, što pokrivaju stavke 73.2-73.4.
2. [ ] **Vaši potezi se ne brišu bez pitanja.** Napraviti ručno bar dva poteza
   ...
   pitanje „Ostalo je bez veze" sa brojem, i „Ostavi" ne sme ništa da obriše. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 56.*
3. [ ] **„Obriši i njih" briše.** Isto, ali potvrditi: potezi nestaju iz stabla. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 57.*
4. [ ] **Transpozicija preživi.** Ovo je poenta cele stavke. Napraviti dve
   ...
   potez sa jedne: zajednička pozicija i sve ispod nje moraju da ostanu. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 58.*
5. [ ] **Odsečena grana se ne briše.** Odseći granu, pa ukloniti neki potez
   drugde: rad iza reza mora da ostane, jer rez nije brisanje. — **prevaziđeno (25.9.2026):** Provera je zahtevala postojanje „odsečene grane" (stavka 64), a mehanizam odsecanja grane je u celini uklonjen 15.9.2026 — scenario se više ne može postaviti.
6. [ ] **Uklanjanje bez posledica ćuti.** Ukloniti potez iza koga nema ničega:
   nema poruke o orezivanju i nema pitanja. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 59.*
7. [ ] **Nijedna pozicija ne ostaje bez glavnog poteza.** Posle svega otvoriti
   vežbu: mora da pita normalno. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 60.*
...
1. [ ] **Panel stoji sam od sebe.** U izgradnji, na poziciji gde već imate
   ...
   Nije potrebno pritisnuti „Dalje". — **prevaziđeno (25.9.2026):** Poseban panel „Posle X — šta igra protivnik" sa dugmadima „Idi"/„Spremi" po odgovoru i cenom u upitima je zamenjen (15.9.2026, „book is simply there — no 'Open book (1 query)', no query counter") kombinacijom reda čipova knjige (dodir odmah igra potez) i strelica sa procentima na samoj tabli — bez ikakvog troška u upitima, jer knjiga sad dolazi sa lokalnog servera bez ograničenja.
2. [ ] **Ne troši upit.** Brojač „upita:" ne sme da poraste ni za jedan dok se
   samo krećete kroz pozicije koje su ranije otvarane. — **prevaziđeno (25.9.2026):** Poseban panel „Posle X — šta igra protivnik" sa dugmadima „Idi"/„Spremi" po odgovoru i cenom u upitima je zamenjen (15.9.2026, „book is simply there — no 'Open book (1 query)', no query counter") kombinacijom reda čipova knjige (dodir odmah igra potez) i strelica sa procentima na samoj tabli — bez ikakvog troška u upitima, jer knjiga sad dolazi sa lokalnog servera bez ograničenja.
3. [ ] **Neotvorena pozicija nudi da se otvori.** Na poziciji koju niko nije
   ...
   Pritisak poveća brojač tačno za jedan, i lista se pojavi. — **prevaziđeno (25.9.2026):** Poseban panel „Posle X — šta igra protivnik" sa dugmadima „Idi"/„Spremi" po odgovoru i cenom u upitima je zamenjen (15.9.2026, „book is simply there — no 'Open book (1 query)', no query counter") kombinacijom reda čipova knjige (dodir odmah igra potez) i strelica sa procentima na samoj tabli — bez ikakvog troška u upitima, jer knjiga sad dolazi sa lokalnog servera bez ograničenja.
4. [ ] **„Idi" vodi tablu.** Klik na „Idi" uz pripremljen odgovor pomeri tablu
   na poziciju posle njega, i linija iznad table poraste za dva poteza. — **prevaziđeno (25.9.2026):** Poseban panel „Posle X — šta igra protivnik" sa dugmadima „Idi"/„Spremi" po odgovoru i cenom u upitima je zamenjen (15.9.2026, „book is simply there — no 'Open book (1 query)', no query counter") kombinacijom reda čipova knjige (dodir odmah igra potez) i strelica sa procentima na samoj tabli — bez ikakvog troška u upitima, jer knjiga sad dolazi sa lokalnog servera bez ograničenja.
5. [ ] **„Spremi" dodaje u pripremu.** Klik uz odgovor van pripreme: red poraste
   i taj odgovor sledeći put nosi „Idi" umesto „Spremi". — **prevaziđeno (25.9.2026):** Poseban panel „Posle X — šta igra protivnik" sa dugmadima „Idi"/„Spremi" po odgovoru i cenom u upitima je zamenjen (15.9.2026, „book is simply there — no 'Open book (1 query)', no query counter") kombinacijom reda čipova knjige (dodir odmah igra potez) i strelica sa procentima na samoj tabli — bez ikakvog troška u upitima, jer knjiga sad dolazi sa lokalnog servera bez ograničenja.
6. [ ] **Posle „Dalje" nema dve iste liste.** Kad su odgovori talasa na ekranu,
   ovaj panel se ne prikazuje. — **prevaziđeno (25.9.2026):** Poseban panel „Posle X — šta igra protivnik" sa dugmadima „Idi"/„Spremi" po odgovoru i cenom u upitima je zamenjen (15.9.2026, „book is simply there — no 'Open book (1 query)', no query counter") kombinacijom reda čipova knjige (dodir odmah igra potez) i strelica sa procentima na samoj tabli — bez ikakvog troška u upitima, jer knjiga sad dolazi sa lokalnog servera bez ograničenja.
7. [ ] **Telefon, 360 dp.** Red ima potez, procenat, broj partija i dugme.
   Proveriti u *release* build-u. — **prevaziđeno (25.9.2026):** Poseban panel „Posle X — šta igra protivnik" sa dugmadima „Idi"/„Spremi" po odgovoru i cenom u upitima je zamenjen (15.9.2026, „book is simply there — no 'Open book (1 query)', no query counter") kombinacijom reda čipova knjige (dodir odmah igra potez) i strelica sa procentima na samoj tabli — bez ikakvog troška u upitima, jer knjiga sad dolazi sa lokalnog servera bez ograničenja.
...
1. [ ] **Ocena ostaje.** U izgradnji pritisnuti „Pitaj motor", sačekati, otići
   ...
   datum". Zatvoriti ekran i otvoriti ga ponovo — i dalje piše. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 51.*
2. [ ] **Dubina i datum se vide.** Oboje u istom redu sa ocenom, i datum je
   današnji. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 52.*
3. [ ] **Plića ocena ne gazi dublju.** Postaviti dubinu na 30, pitati motor;
   pa na 12 i pitati opet. Broj i „dubina 30" moraju ostati. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 53.*
4. [ ] **„Evaluiraj celu liniju (N pozicija)".** N je broj pozicija bez ocene
   ...
   ocenjena" i ne može da se pritisne. — **prevaziđeno (25.9.2026):** Prolaz „Evaluiraj celu liniju (N pozicija)" sa dugmetom „Zaustavi" i tekstom napretka je deo analize celog repertoara/linije koja je obrisana 3.9.2026 iz vlasnikovog razloga da je sudija otvaranja bolje pitanje za repertoar od drugog mišljenja motora (STANJE-RADA.md, odeljak „Tri prijave o repertoaru").
5. [ ] **Prolaz može da se zaustavi.** Tokom prolaza piše „Ocenjujem liniju:
   ...
   je pozicije stao. — **prevaziđeno (25.9.2026):** Prolaz „Evaluiraj celu liniju (N pozicija)" sa dugmetom „Zaustavi" i tekstom napretka je deo analize celog repertoara/linije koja je obrisana 3.9.2026 iz vlasnikovog razloga da je sudija otvaranja bolje pitanje za repertoar od drugog mišljenja motora (STANJE-RADA.md, odeljak „Tri prijave o repertoaru").
6. [ ] **Brojač „upita:" se ne miče.** Ni za jedan, ni pri pojedinačnom pitanju
   ni tokom celog prolaza — ovo je lokalni motor. — **prevaziđeno (25.9.2026):** Brojač „upita:" u zaglavlju izgradnje je u celini uklonjen 15.9.2026 (knjiga više ne troši upite) — nema više brojača čiju nepomerenost treba proveriti.
7. [ ] **Ocene su na karticama stabla.** Posle prolaza kartice u grafičkom
   stablu nose broj u zagradi. — **prevaziđeno (25.9.2026):** Kartice u ugrađenom stablu namerno ne nose broj ocene motora („No engine number on the card. The drawing's job is to show the holes."), a spisak „Gde se motor ne slaže" sortiran po ceni neslaganja je bio deo prolaza za celu liniju/repertoar koji je obrisan 3.9.2026 zajedno sa analizom celog repertoara.
8. [ ] **„Gde se motor ne slaže".** Otvara spisak sortiran po ceni neslaganja;
   ...
   je napisala kičma, a ne vi. — **prevaziđeno (25.9.2026):** Kartice u ugrađenom stablu namerno ne nose broj ocene motora („No engine number on the card. The drawing's job is to show the holes."), a spisak „Gde se motor ne slaže" sortiran po ceni neslaganja je bio deo prolaza za celu liniju/repertoar koji je obrisan 3.9.2026 zajedno sa analizom celog repertoara.
9. [ ] **Tri različite tišine.** Pre bilo kakvog računanja spisak kaže „motor
   još nije pitan"; kad se sve slaže, kaže da se slaže i sa koliko od koliko. — **prevaziđeno (25.9.2026):** Kartice u ugrađenom stablu namerno ne nose broj ocene motora („No engine number on the card. The drawing's job is to show the holes."), a spisak „Gde se motor ne slaže" sortiran po ceni neslaganja je bio deo prolaza za celu liniju/repertoar koji je obrisan 3.9.2026 zajedno sa analizom celog repertoara.
10. [ ] **Nema druge presude na kartici.** Uz potez i dalje stoji samo ono što
   kaže sudija otvaranja; ocena motora nigde ne nosi „dobar"/„loš". — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 54.*
11. [ ] **Telefon, 360 dp.** Panel motora, dugme sa brojem i dijalog spiska —
   proveriti u *release* build-u da ništa nije odsečeno. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 55.*
...
1. [ ] **„Šta se ovde igra" stoji samo od sebe**, na svakoj poziciji, i brojač
   „upita:" se ne miče dok se krećete kroz pozicije koje je neko otvarao. — **prevaziđeno (25.9.2026):** Panel „What is played here" (nezavisan od table) i brojač upita „upita:" su ukinuti kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli — knjiga je sada red čipova koji se dodiruje, bez odvojenog „otvaranja" pozicije za jedan upit.
2. [ ] **„Igraj" iz liste** ponudi potez na isti način kao potez povučen po
   tabli — sa sudijom i sa „Uzmi X". — **prevaziđeno (25.9.2026):** Spisak poteza sa dugmetom „Play" i „Uzmi X" (Take) je ukinut; knjiga se sada crta kao red čipova (`OpeningExplorerPanelWidget`-oliki prikaz) i dodir na čip odmah odigra potez — nema više posebnog koraka „uzimanja" poteza sa sudijom kao međukorakom.
3. [ ] **Dugmeta „Ne znam" nema.** Neotvorenu poziciju i dalje otvara „Otvori
   knjigu (1 upit)", i brojač poraste tačno za jedan. — **prevaziđeno (25.9.2026):** Dugme „Open book (1 query)" i brojač upita su izbačeni u celini; nova gradnja nema pojam „neotvorene" pozicije niti trošenja upita — knjiga za svaku poziciju stoji odmah, iz lokalne baze (od 15.9.2026 nije više ni Lichess upit).
4. [ ] **Dva panela se razlikuju.** „Šta se ovde igra" (pozicija na tabli) i
   ...
   izgledaju isto ni da nose isto dugme. — **prevaziđeno (25.9.2026):** Oba panela („What is played here" i „After X — what does the opponent play") koja su se razlikovala izgledom i dugmetom su uklonjena zajedno sa starim tokom upita; ekran gradnje sada ima jedno pitanje („What do you play as White/Black?") i knjigu ispod table.
5. [ ] **Desni klik na moj potez u stablu.** „Unapredi u glavnu liniju" zaista
   promeni glavni potez (zvezdica se pomeri), „Obriši ovu varijantu" ga ukloni. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 20.*
6. [ ] **Desni klik na protivnikov potez.** „Obriši ovu varijantu" odseče granu
   (ista poruka kao „Ne spremam ovo"), a „Unapredi" kaže da to nije vaš potez. — **prevaziđeno (25.9.2026):** Meki „rez" grane sa porukom nalik „Ne spremam ovo" i mogućnošću vraćanja je ukinut zajedno sa starim tokom; brisanje protivnikovog poteza je sada trajno (uz dijalog o tome koliko sopstvenih poteza ide sa njim), a `Promote` na protivnikovom potezu i dalje odbija porukom da to nije korisnikov potez — ali to je samo delimično potvrđivanje stare stavke.
7. [ ] **Odsečena grana nestane iz crteža**, a iznad stabla piše „Prikaži
   odsečene grane (N)". Klik je vrati, klik ih opet sakrije. — **prevaziđeno (25.9.2026):** Mehanizam „odseci pa vrati" granu (session sa brojačem „Prikaži odsečene grane (N)") je izbačen; brisanje poteza je sad trajno, uz dijalog upozorenja pre brisanja, bez ikakvog naknadnog vraćanja iz stabla.
8. [ ] **Paleta ispod table.** Strelice napred/nazad/početak/kraj rade, i
   **tastatura** takođe (←, →, Home, End). — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 32.*
9. [ ] **Numeracija počinje od prave pozicije.** Repertoar građen od četvrtog
   poteza crta `4. c3`, ne `1. c3`. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 21.*
10. [ ] **Ivice kartica.** Potezi belog i crnog imaju različito svetle ivice;
    izabrana kartica se i dalje razaznaje bez ikakve sumnje. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 22.*
11. [ ] **Telefon, 360 dp, release build.** Ekran je dobio dva panela i paletu
    ...
    ništa ne seče. — **prevaziđeno (25.9.2026):** Provera je pravljena da proveri da dva stara panela („What is played here" i „After X") plus paleta stanu na telefonu bez sečenja; oba panela su ukinuta 16.9.2026, pa provera u ovom obliku više nema šta da proveri — telefonski raspored gradnje ima drugi sadržaj (knjiga kao čipovi, traka linije, komentar, AI dugme).
...
1. [ ] **Potez koji je već u repertoaru.** Odigrati na tabli potez koji tu već
   ...
   ispod je „Posle X — šta igra protivnik". Brojač „upita:" se ne miče. — **prevaziđeno (25.9.2026):** „Uzmi X" (Take), brojač „upita:" i panel „After X — what does the opponent play" ne postoje više; odigran potez koji je već u repertoaru se odmah prepoznaje bez ikakvog međukoraka uzimanja.
2. [ ] **Samo jedna Lichess lista.** Posle odigranog i uzetog poteza ne sme da
   ...
   ne za dva. — **prevaziđeno (25.9.2026):** Lichess panel („jedna lista") je ukinut 15.9.2026 (knjiga je od tada lokalna baza, ne Lichess explorer), a „Uzmi X" i njegov posebni upit su ukinuti 16.9.2026 zajedno sa celim starim tokom gradnje — nema više dva panela sa istim potezima niti brojanja upita „za dva".
3. [ ] **Navigacija u granatoj poziciji.** Na poziciji sa više nastavaka,
   ...
   tom granom. Gde grananja nema, ide se bez pitanja. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 33.*
4. [ ] **Desni klik javi šta je uradio.** Posle „Unapredi", „Obriši" i reza na
   protivnikovom potezu pojavi se poruka na dnu ekrana. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 36.*
5. [ ] **Strelice na tabli.** Najviše četiri, ništa ispod 2% — a lista ispod
   table i dalje ima sve poteze. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 26.*
6. [ ] **Telefon, 360 dp, release build.** List za izbor grane i poruke
   `AppFeedback`-a ne smeju ništa da preklope ni da iseku. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 34.*
...
1. [ ] **Repertoar.** Na poziciji sa više nastavaka „napred" (dugme i strelica
   desno) otvori „Odavde ide više linija — kojom?"; izbor vodi tablu tom granom. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 33.*
...
6. [x] **„Na kraj" ne pita.** Dugme „|>" ide do kraja linije bez pitanja na
   usputnim račvanjima. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
7. [ ] **Miš i tastatura se slažu.** Isto ponašanje na dugmetu i na strelici
   desno. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 23.*

## 79. Biranje otvaranja sa spiska — 1.9.2026, nije viđeno uživo

1. [x] **„Izaberi otvaranje" otvara spisak.** Odmah, bez kucanja, stoji spisak
   otvaranja po abecedi (od „Alekhine Defense"). — ✅ vlasnik, u alatu za proveru, 3.9.2026.
2. [x] **Otvaranje se otvara u svoje varijante.** Klik na otvaranje daje spisak
   njegovih linija, prva je „Osnovna linija", a iznad stoji ime sa strelicom
   nazad. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
3. [x] **Izbor varijante popuni ekran.** Tabla ode na tu poziciju, linija se
   ispiše, ime repertoara se predloži, boja se postavi po strani na potezu. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
4. [x] **Kucanje seče popreko.** Ukucati „Najdorf" dok je otvoreno neko drugo
   otvaranje: rezultati su svi Najdorf redovi, a povratna strelica nestaje. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
5. [x] **Drugi put je odmah.** Zatvoriti i ponovo otvoriti izbor — spisak je tu
   bez treptaja „Učitavanje…". — ✅ vlasnik, u alatu za proveru, 3.9.2026.
6. [ ] **Telefon, 360 dp, release build.** Duga imena varijanti se seku sa „…",
   ne prelivaju. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 24.*

## 80. Grana kao sesija i sparing — 1.9.2026, nije viđeno uživo

1. [ ] **Ikonica grane u zaglavlju drila** otvara spisak: „Ceo repertoar" i
   grane, svaka sa „dospelo N od M". — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 41.*
2. [ ] **Izbor grane sužava dril.** Posle izbora pitanja dolaze samo iz te
   grane; „Ceo repertoar" vraća sve. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 42.*
3. [ ] **▶ pokreće sparing.** Tabla ode na početak grane, iznad piše
   „Sparing: e4 c5 · odigrano N". — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 43.*
4. [ ] **Protivnik odgovara sam**, i ne uvek isto — pustiti istu granu dvaput i
   videti da li se negde razišla. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 44.*
5. [ ] **Tačan potez vodi dalje sam od sebe**, posle kratke pauze u kojoj se
   vidi protivnikov odgovor. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 45.*
6. [ ] **Greška zaustavlja trku** i ostaje na toj poziciji, sa „Pokaži" i
   „Nastavi liniju". — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 46.*
7. [ ] **Kraj grane kaže šta je bilo**: „Grana odigrana do kraja. Odigrano N,
   greške: M." i nudi „Druga grana" / „Nazad na red". — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 47.*
8. [ ] **Raspored se ne pomera bez razloga.** Pustiti sparing kroz granu u
   kojoj ništa nije dospelo, pa proveriti da se brojevi dospelog nisu promenili. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 48.*
9. [ ] **Telefon, 360 dp, release build.** List sa granama i red „Sparing…" —
   ništa da se ne seče. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 49.*
...
1. [ ] **Linija kroz alternativu se najavljuje.** Naći poziciju u kojoj su
   ...
   linija ide kroz alternativu, ne kroz glavni." Potez se **ne** imenuje. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 29.*
2. [ ] **Linija kroz glavni potez ne kaže ništa.** Ista provera na liniji koja
   ide kroz glavni: te rečenice nema. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 30.*
3. [ ] **Svoj drugi potez nije greška.** Odigrati u toj poziciji glavni potez
   ...
   i to **plavo**, ne narandžasto. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 31.*
4. [ ] **Tuđi potez je i dalje samo pogrešan**, narandžasto, sa „Ponavljanje se
   ne ocenjuje." — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 32.*
5. [ ] **Ispravka se vidi.** Potez linije ostaje sam na tabli, sa strelicom na
   ...
   figura osvitala na polju na koje ništa nije viđeno da ide. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 33.*
6. [ ] **Tačan odgovor vodi dalje sam.** Bez klika, posle pauze u kojoj se
   pročita presuda. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 34.*
7. [ ] **Presuda ide sa šetnjom.** Iznad sledećeg pitanja: „Tačno — Nc6 ·
   protivnik Nf3 · vraća se za 6 dana." — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 35.*
8. [ ] **Greška zaustavlja šetnju** i tek tu se pojavljuje „Nastavi liniju". — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 36.*
9. [ ] **Nepokriven protivnikov odgovor takođe zaustavlja**, sa „to niste
   pokrili" i ponudom da se pozicija izgradi. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 37.*
10. [ ] **Kraj knjige ne nudi „Nastavi liniju".** Kad protivnik nema odgovor,
    dugmeta nema — ranije je vodilo u pitanje u poziciji u kojoj nisi na potezu. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 38.*
11. [ ] **Raspored se ne pomera bez razloga.** Prošetati kroz nekoliko pozicija
    ...
    pozicija koja nikad nije ponavljana **treba** da se upiše. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 39.*
12. [ ] **Telefon, 360 dp, release build.** Red sa presudom je najduža rečenica
    na ekranu — ne sme da se seče. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 40.*
...
1. [ ] **„Druga odluka" stoji samo na račvi.** U poziciji sa jednim zadržanim
   potezom dugmeta nema; u poziciji sa dva stoji. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 15.*
2. [ ] **Ništa se ne imenuje dok se ne pritisne.** Pre pritiska nigde ne piše
   koji je drugi potez — sa dve odluke to bi odalo i onu koja se traži. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 16.*
3. [ ] **List nudi „Vežbaj d4"** (po jedan red za svaki drugi potez). — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 17.*
4. [ ] **Izbor menja liniju.** Posle izbora vežbanje ide kroz izabrani potez, a
   iznad table stoji „Vežbate liniju kroz d4." — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 18.*
5. [ ] **„Nazad na red" vraća raspored** i uklanja tu rečenicu. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 19.*
6. [ ] **Ništa se ne upisuje dok je put izabran** — proveriti da se brojevi
   dospelog nisu pomerili posle nekoliko odgovora na izabranom putu. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 20.*
7. [ ] **„Druga linija" daje drugu liniju.** Pritisnuti dva-tri puta zaredom i
   videti da pitanje **nije** isto. Ovo je popravka: ranije se vraćalo isto. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 21.*
8. [ ] **„Preskoči" nad pitanjem isto tako** — pozicija se ne vraća odmah. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 22.*
9. [ ] **Kad se sve preskoči, gomila se okrene** — ekran ne sme da kaže „Ništa
   nije na redu" posle preskakanja svega; pitanja kreću ispočetka. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 23.*
10. [ ] **Grana i sparing brišu izabrani put.** Izabrati račvu, pa otvoriti
    ...
    nema. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 24.*
11. [ ] **Telefon, 360 dp, release build.** Red „Vežbate liniju kroz… / Nazad
    na red" i list sa odlukama — ništa da se ne seče. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 28.*
12. [ ] **Izabrani potez se imenuje na račvi.** Posle „Vežbaj d4", na toj
    ...
    račve obe linije čitaju identično, pa se nije video. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 25.*
13. [ ] **Rečenica o alternativi se tu gasi** — ne stoje obe odjednom. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 26.*
14. [ ] **Put bez ičega iza sebe to kaže.** Izabrati potez iza kog nije
    ...
    se vežba"), sa dugmetom „Nazad na red" — a **ne** „Ništa nije na redu". — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 27.*
...
1. [ ] **Poruka „to niste pokrili" se više ne pojavljuje.** Odigrati dvadesetak
   poteza kroz dril i sparing — nijednom. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 11.*
2. [ ] **Protivnik i dalje ne igra uvek isto.** Ista grana dvaput mora negde da
   se raziđe; ako uvek ide istim potezom, izvlačenje je palo na jedan red. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 12.*
3. [ ] **Kraj pripreme je kraj linije.** U poziciji u kojoj nije pokriven
   ...
   kaže „Grana odigrana do kraja". — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 13.*
4. [ ] **„Izgradi ovu poziciju" i dalje postoji.** Doći do pozicije koja jeste
   ...
   nestanu sa ovom izmenom. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 14.*
5. [ ] **Potez „spremi i ovo" se računa.** Dodati jedan protivnikov odgovor
   ...
   pokriven. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 27.*
...
1. [x] **Brisanje repertoara i dalje podrazumevano ostavlja poteze.** Obrisati
   jedan repertoar bez kvadratića i otvoriti drugi iste boje — potezi su tu. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
2. [ ] **Broj pre pitanja.** U dijalogu za brisanje piše koliko poteza u koliko
   ...
   izabrali". — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 20.*
3. [ ] **Deljene pozicije se ne broje.** Napraviti dva repertoara iste boje koji
   ...
   ostaju jer ih drži još neki repertoar. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 21.*
4. [x] **Kvadratić „Obriši i poteze" stvarno briše.** Posle brisanja sa
   kvadratićem, novi repertoar iz iste pozicije **ne** zna te poteze. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
5. [ ] **Komentari ostaju.** Isti test kao gore, sa napisanim komentarom na
   ...
   Sa uključenim drugim kvadratićem — nije. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 22.*
6. [x] **Pražnjenje boje radi i kad nema nijednog repertoara.** Obrisati sve
   repertoare, pa iz gornje trake („Brisanje poteza iz baze") obrisati poteze za
   tu boju; zatim „Novi" — stablo je prazno. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
7. [ ] **Repertoari preživljavaju pražnjenje boje.** Sa bar jednim repertoarom:
   posle pražnjenja ime i početna pozicija su i dalje na spisku. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 9.*
8. [ ] **Prazan spisak objašnjava.** Kad nema nijednog repertoara, na ekranu
   piše da su potezi sačuvani uz boju i gde se brišu. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 8.*
9. [x] **Komentar se piše i vidi.** Ispod table pritisnuti dugme za komentar,
   napisati nešto, sačuvati — tekst se pojavi ispod table. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
10. [x] **Komentar preživi povratak.** Izaći iz ekrana, vratiti se i doći do iste
    pozicije: komentar je tu. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
11. [ ] **Transpozicija ga nosi.** Doći do iste pozicije drugim redosledom
    poteza — komentar je i tamo. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 19.*
12. [ ] **Prazan tekst briše.** Obrisati sav tekst i sačuvati: kartica komentara
    nestaje (i ispod table i u koloni). — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 28.*
13. [x] **Windows, širok prozor (≥1200 dp):** komentar je u trećoj koloni, desno
    od stabla, i **nije** istovremeno ispod table. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
14. [x] **Windows, sužen prozor (oko 1000 dp):** komentar se seli ispod table,
    tabla ne postaje manja, ništa se ne preklapa. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
15. [ ] **Telefon, 360 dp, release build.** Traka ispod table sa dva nova
    ...
    polje za pisanje (list se podiže). — *prepisano 25.9.2026 u novi spisak: ?.*
16. [ ] **„Pitaj AI o poziciji".** Odgovor se pojavi; „U moj komentar" otvara
    ...
    „Sačuvaj". Bez ključa za model odgovor je i dalje smislen (rezervni tekst). — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 31.*
17. [x] **Kvota se troši samo na AI dugme.** Pisanje i čitanje komentara ne
    dodiruje `ai_comments`. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
...
1. [x] **Postojećem repertoaru se postavlja kapija.** Na kartici: „Kroz koji
   potez ide" → potez koji se već igra stoji na vrhu i označen je → izabrati ga.
   Na kartici posle toga piše „kroz <potez>". — ✅ vlasnik, u alatu za proveru, 3.9.2026.
2. [ ] **Stablo se očisti.** Otvoriti taj repertoar: u stablu nema poteza iz
   drugog otvaranja iz iste pozicije, ni bilo čega ispod njega. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 13.*
3. [ ] **Ekran kaže da je filtriran** — „Ovaj repertoar ide kroz … — ostalo iz
   ove pozicije se ne prikazuje." — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 14.*
4. [ ] **Red za odlučivanje je isto sužen.** Brojevi („još N u redu",
   pokrivenost) ne računaju pozicije iz druge grane. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 15.*
5. [x] **Drugi repertoar iz iste pozicije pokazuje svoje.** Postaviti mu kapiju
   na njegov potez i proveriti da su dva ekrana zaista dva otvaranja. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
6. [ ] **Radar pokrivenosti** za taj repertoar prikazuje samo grane iz kapije. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 16.*
7. [ ] **Vežbanje je suženo.** „Izaberi granu" nudi samo grane te kapije, a
   „Ceo repertoar" ne postavlja pitanja iz drugog otvaranja. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 10.*
8. [ ] **Novi repertoar iz pozicije koja već ima poteze** nudi izbor kapije
   ...
   samo onima koji su već izabrani. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 23.*
9. [ ] **Kapija se može skinuti** („Bez ograničenja") i tada je sve kao pre. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 17.*
10. [ ] **Skok na drugu poziciju ne nasleđuje kapiju.** Iz radara ili drila
    ...
    ništa nije skriveno. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 18.*
11. [ ] **„Vežbaj X" na račvi sada stvarno menja liniju** (popravka): posle
    izbora dva-tri pitanja moraju biti iz izabrane grane. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 11.*
12. [ ] **„Druga linija" daje drugu liniju** — pritisnuti tri puta zaredom. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 12.*
13. [ ] **Lista neslaganja se otvara.** Ranije je padala na svaki poziv;
    proveriti da vraća listu (ili pošteno „nema neslaganja"), a ne grešku. — **prevaziđeno (25.9.2026):** Spisak „gde se motor ne slaže" (analiza cele linije lokalnim motorom, sa kaznom po poziciji) je obrisan 3.9.2026, dan posle nego što je ova stavka pisana — vlasnikov razlog (sudija knjige je bolje pitanje za repertoar od drugog mišljenja motora) i dalje važi 16.9.2026. Dugme, spisak i ekran sa tim sadržajem ne postoje ni na jednom ekranu repertoara u trenutnom kodu.
14. [ ] **Telefon, 360 dp, release build.** List za izbor kapije i rečenica o
    kapiji — ništa isečeno. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 19.*
...
1. [x] **Protivnik ne igra u odsečenu granu.** Odseći jedan odgovor
   ...
   bira nasumično po učestalosti, pa jedan prolaz ne dokazuje ništa. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
2. [x] **Protivnik ne izlazi iz pripremljenog.** Igra samo odgovore posle kojih
   vi imate izabran potez. Ako odigra nešto na šta nemate odgovor, ovo je pao. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
3. [x] **Sparing bez ijednog takvog odgovora se završava rečenicom**, ne
   pitanjem: „Grana odigrana do kraja." ili „Dovde ide grana — dalje nema vašeg
   poteza." — ✅ vlasnik, u alatu za proveru, 3.9.2026.
4. [x] **Vraćanje grane vraća i protivnika.** Potvrditi ranije odsečenu poziciju
   (kroz pregled nacrta) i proveriti da je protivnik ponovo igra. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
5. [x] **Pitanja se nisu promenila.** Red za vežbu i dalje pita isto što i pre —
   ovaj posao dira samo protivnikov potez, ne izbor pitanja. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
...
1. [ ] **Širina se pamti.** Napraviti kičmu sa „Široko (95%)", ugasiti
   ...
   se ovakav izbor vraćao na 80% sledeće sesije, bez ijedne reči na ekranu. — **prevaziđeno (25.9.2026):** Podešavanje širine repertoara („Samo glavni odgovor" / „Uobičajeno 80%" / „Široko 95%") je u celini izbačeno kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli — nema više dijala širine niti bilo kog broja koji o njoj zavisi. Stavka je ranije bila potvrđena kao ispravljena, ali sama funkcija koju je proveravala (pamćenje širine preko restarta) više ne postoji jer širina više ne postoji.
2. [ ] **Tri širine daju tri različita broja.** Isti repertoar sa „Samo glavni odgovor", „Uobičajeno (80%)" i „Široko (95%)" — broj u redu za odlučivanje i
   pokrivenost moraju stvarno da se razlikuju. — **prevaziđeno (25.9.2026):** Podešavanje širine repertoara („Samo glavni odgovor" / „Uobičajeno 80%" / „Široko 95%") je u celini izbačeno kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli — nema više dijala širine niti bilo kog broja koji o njoj zavisi. Popravka iz 9809a25 (slanje širine u svakom pozivu) je postala nepotrebna kad je sama širina uklonjena iz modela.
3. [ ] **Tuđa širina se ne oseća.** Drugi repertoar iste boje ostaje na svojoj
   ...
   tabelu. — **prevaziđeno (25.9.2026):** Podešavanje širine repertoara („Samo glavni odgovor" / „Uobičajeno 80%" / „Široko 95%") je u celini izbačeno kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli — nema više dijala širine niti bilo kog broja koji o njoj zavisi.
4. [ ] **Dva broja o nacrtima se razlikuju, i to je namerno.** Značka na kartici
   ...
   čita kao greška. — **prevaziđeno (25.9.2026):** Podešavanje širine repertoara („Samo glavni odgovor" / „Uobičajeno 80%" / „Široko 95%") je u celini izbačeno kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli — nema više dijala širine niti bilo kog broja koji o njoj zavisi. Broj na kartici je bio broj nepotvrđenih poteza (badge), a taj koncept je takođe izbačen — vidi sekciju 89.
5. [ ] **„Odigraj drugi potez" je jedan potez, ne dva.** Posle njega u stablu
   ...
   odluke koje se dohvataju drugim putem ostaju. — **prevaziđeno (25.9.2026):** Podešavanje širine repertoara („Samo glavni odgovor" / „Uobičajeno 80%" / „Široko 95%") je u celini izbačeno kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli — nema više dijala širine niti bilo kog broja koji o njoj zavisi. „Odigraj drugi potez" je opisivao odbijanje ponuđenog nacrta iz starog toka spine/wave — ta mašinerija je obrisana; sad se svaki potez odigrava direktno na tabli.
6. [ ] **Ugašen server ne ostavlja pola upisa.** Ugasiti backend pa pokušati isto:
   ...
   nedirnuto. — **prevaziđeno (25.9.2026):** Podešavanje širine repertoara („Samo glavni odgovor" / „Uobičajeno 80%" / „Široko 95%") je u celini izbačeno kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli — nema više dijala širine niti bilo kog broja koji o njoj zavisi. Scenario „isto" se oslanjao na akciju iz stavke 87.5 koja više ne postoji u tom obliku; server-down otpornost bi trebalo proveriti na novom toku (direktan potez na tabli), ali to je nova stavka, ne ponavljanje ove.
...
7. [ ] **Crtež kaže na čemu je nacrtan.** Iznad stabla stoje dve rečenice —
   ...
   široko 95%". Menjaju se kad se promeni podešavanje. — **prevaziđeno (25.9.2026):** Podešavanje širine repertoara („Samo glavni odgovor" / „Uobičajeno 80%" / „Široko 95%") je u celini izbačeno kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli — nema više dijala širine niti bilo kog broja koji o njoj zavisi. Obe rečenice („Book: …" i „Breadth: …") su izbačene 15.9.2026 i 16.9.2026.
8. [ ] **Traka se bira iz zaglavlja Repertoara** (ikona sa ljudima, „Rejting
   ...
   odgovara iz partija od N naviše." — **prevaziđeno (25.9.2026):** Podešavanje širine repertoara („Samo glavni odgovor" / „Uobičajeno 80%" / „Široko 95%") je u celini izbačeno kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli — nema više dijala širine niti bilo kog broja koji o njoj zavisi. Traka „Opponent rating" iz zaglavlja Repertoara je uklonjena 15.9.2026 zajedno sa celim rejting-filterom.
9. [ ] **Promena trake ništa ne uništava.** Prebaciti na 2000+ — stablo omršavi
   ...
   povratku troše upiti, keš po traci ne radi. — **prevaziđeno (25.9.2026):** Podešavanje širine repertoara („Samo glavni odgovor" / „Uobičajeno 80%" / „Široko 95%") je u celini izbačeno kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli — nema više dijala širine niti bilo kog broja koji o njoj zavisi. Prebacivanje između traka rejtinga više ne postoji — knjiga je jedna, lokalna, bez rejting-opsega.
10. [ ] **Traka je po uređaju, ne po repertoaru.** Windows i telefon mogu da
    ...
    iznad stabla to i kaže), ne da se ispravlja. — **prevaziđeno (25.9.2026):** Podešavanje širine repertoara („Samo glavni odgovor" / „Uobičajeno 80%" / „Široko 95%") je u celini izbačeno kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli — nema više dijala širine niti bilo kog broja koji o njoj zavisi. Traka je bila po uređaju upravo zato što je čitala Lichess rejting-opseg po lokalnom podešavanju; taj ceo mehanizam je uklonjen.
...
1. [ ] **Izgradnja pokazuje poslednji potez.** Odigrati potez: polje sa kog je
   pošao i polje na koje je došao su označena, oba, i uglovima a ne samo bojom. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 11.*
2. [ ] **Vežba isto.** — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 12.*
3. [ ] **Oznaka nestaje kad tabla skoči.** Skok iz radara ili otvaranje drugog
   repertoara: nema oznake sa pozicije koja više nije na ekranu. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 13.*
4. [ ] **Oznaka preživi crtanje strelica.** Uključiti crtanje i proveriti da
   oznaka i dalje stoji — crta je drugi sloj i ranije ga je gasio. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 14.*
5. [ ] **Traka iznad table piše ECO i ime** („C60 · Ruy Lopez…"). — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 15.*
6. [ ] **Ime se ne gubi u dubini.** Prošetati liniju osam do deset poteza duboko:
   ...
   pravilo postoji. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 16.*
7. [ ] **Drugo otvaranje menja traku.** — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 17.*
8. [ ] **Telefon, 360 dp, release build.** Traka iznad table i tabla ispod nje —
   ništa isečeno, tabla se i dalje cela vidi. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 18.*
...
1. [ ] **Značka na kartici.** Repertoar sa nepotvrđenim potezima ima žutu
   pilulu sa brojem i ikonicom; bez njih je nema. — **prevaziđeno (25.9.2026):** Ceo koncept „nepotvrđenih" (unconfirmed) poteza — žuta značka sa brojem nepotvrđenih poteza na kartici repertoara — je izbačen kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli: svaki uneti potez je od tada odmah „potvrđen" jer ga je korisnik sam odigrao, pa nema šta da se pregleda ili potvrđuje naknadno.
2. [ ] **Dodir na značku vodi na prvu nepotvrđenu poziciju**, ne na koren. — **prevaziđeno (25.9.2026):** Ceo koncept „nepotvrđenih" (unconfirmed) poteza — dodir na značku koji vodi na prvu nepotvrđenu poziciju — je izbačen kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli: svaki uneti potez je od tada odmah „potvrđen" jer ga je korisnik sam odigrao, pa nema šta da se pregleda ili potvrđuje naknadno.
3. [ ] **Traka u izgradnji** piše „N nepotvrđenih u grafu" i nudi „Pregledaj nepotvrđene". — **prevaziđeno (25.9.2026):** Ceo koncept „nepotvrđenih" (unconfirmed) poteza — traka u izgradnji „N nepotvrđenih u grafu" i dugme „Pregledaj nepotvrđene" — je izbačen kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli: svaki uneti potez je od tada odmah „potvrđen" jer ga je korisnik sam odigrao, pa nema šta da se pregleda ili potvrđuje naknadno.
4. [ ] **„Pregledaj nepotvrđene" vodi tablu, ne otvara list.** Tabla izgradnje
   ...
   **„Potvrdi"**. Ako se pojavi zaseban list sa naslovom „Pregled nacrta", to
   je stari ekran i nalaz je. — **prevaziđeno (25.9.2026):** Ceo koncept „nepotvrđenih" (unconfirmed) poteza — poseban ekran/pregled nacrta sa dugmetom „Potvrdi" — je izbačen kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli: svaki uneti potez je od tada odmah „potvrđen" jer ga je korisnik sam odigrao, pa nema šta da se pregleda ili potvrđuje naknadno.
5. [ ] **Svaki odgovor se upisuje sam za sebe.** Potvrditi jedan, pa otići sa
   ...
   dovrši. — **prevaziđeno (25.9.2026):** Ceo koncept „nepotvrđenih" (unconfirmed) poteza — pojedinačno upisivanje svakog potvrđenog odgovora u pregledu nacrta — je izbačen kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli: svaki uneti potez je od tada odmah „potvrđen" jer ga je korisnik sam odigrao, pa nema šta da se pregleda ili potvrđuje naknadno.
6. [ ] **Brisanje pita.** Ukloniti (×) predlog ispod kog stoje vaše odluke:
   ...
   ne obriše ništa. — **prevaziđeno (25.9.2026):** Ceo koncept „nepotvrđenih" (unconfirmed) poteza — dijalog „Obrisati vaše odluke?" pri brisanju predloga koji ima sopstvene poteze pod sobom — je izbačen kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli: svaki uneti potez je od tada odmah „potvrđen" jer ga je korisnik sam odigrao, pa nema šta da se pregleda ili potvrđuje naknadno.
7. [ ] **Kad se sve reši:** „Nema više nepotvrđenih poteza." — **prevaziđeno (25.9.2026):** Ceo koncept „nepotvrđenih" (unconfirmed) poteza — poruka „Nema više nepotvrđenih poteza." kad se sve reši — je izbačen kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli: svaki uneti potez je od tada odmah „potvrđen" jer ga je korisnik sam odigrao, pa nema šta da se pregleda ili potvrđuje naknadno.
8. [ ] **Vežba više ne laže da nema posla.** U repertoaru u kome su svi potezi
   ...
   repertoaru." i nudi „Pregledaj nepotvrđene". — **prevaziđeno (25.9.2026):** Ceo koncept „nepotvrđenih" (unconfirmed) poteza — poruka u vežbi da još N nepotvrđenih poteza čeka — je izbačen kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli: svaki uneti potez je od tada odmah „potvrđen" jer ga je korisnik sam odigrao, pa nema šta da se pregleda ili potvrđuje naknadno.
9. [ ] **Dijalog „Predloži glavnu liniju odavde"** ima naslov „Koliko odgovora
   ...
   neće pitati dok se ne potvrde. — **prevaziđeno (25.9.2026):** Ceo koncept „nepotvrđenih" (unconfirmed) poteza — dijalog „Predloži glavnu liniju odavde" (Suggest main line / spine) — je izbačen kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli: svaki uneti potez je od tada odmah „potvrđen" jer ga je korisnik sam odigrao, pa nema šta da se pregleda ili potvrđuje naknadno.
10. [ ] **Svetla tema, traka sa nepotvrđenim potezima.** Tekst na žutoj podlozi
    ...
    svetloj temi nije razlikovalo od podloge iza sebe. Pogledati u obe teme. — **prevaziđeno (25.9.2026):** Ceo koncept „nepotvrđenih" (unconfirmed) poteza — kontrast dugmeta na žutoj traci sa nepotvrđenim potezima u svetloj temi — je izbačen kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli: svaki uneti potez je od tada odmah „potvrđen" jer ga je korisnik sam odigrao, pa nema šta da se pregleda ili potvrđuje naknadno.
11. [ ] **Telefon, 360 dp, release build.** Traka „N nepotvrđenih u grafu" i
    panel „Vaši potezi ovde" sa dugmetom „Potvrdi" — ništa isečeno. — **prevaziđeno (25.9.2026):** Ceo koncept „nepotvrđenih" (unconfirmed) poteza — traka „N nepotvrđenih u grafu" i panel sa dugmetom „Potvrdi" na telefonu — je izbačen kad je gradnja repertoara prepravljena da radi isključivo odigravanjem poteza na tabli: svaki uneti potez je od tada odmah „potvrđen" jer ga je korisnik sam odigrao, pa nema šta da se pregleda ili potvrđuje naknadno.
...
1. [x] **Dugme postoji i ne puca.** U izgradnji, u redu ispod table, ikona
   grananja („Izdvoji u novo otvaranje") otvara dijalog. Otvoriti aplikaciju
   normalno, ne kroz test: baš tu je pucalo. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
2. [x] **Ime je popunjeno iz knjige** („C60 · Ruy Lopez"), i može da se izmeni. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
3. [ ] **Pozicija koju knjiga ne zna ostavlja prazno polje** sa kursorom u njemu,
   bez izmišljenog imena. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 29.*
4. [ ] **Kapija se bira** kroz isti izbornik kao svuda, i sme da se preskoči. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 30.*
5. [x] **Ništa se ne kopira.** Posle izdvajanja: stari repertoar ima sve poteze
   koje je imao, novi vidi iste poteze ispod svog korena, i „N poteza u grafu"
   se **ne udvostručuje**. Ako je broj skočio, negde se pisalo u graf. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
6. [x] **Novo otvaranje je u listi**, sa svojim imenom i svojom kapijom. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
7. [x] **Izbor više otvaranja.** Dugi pritisak na karticu ulazi u izbor,
   čekboksi se vide na svim karticama, dole stoji „Vežbaj izabrane (N)". — ✅ vlasnik, u alatu za proveru, 4.9.2026.
8. [x] **Izabrano je izabrano čekboksom, ne bojom** — kartica se ne razlikuje
   samo nijansom. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
9. [ ] **Dve boje se odbijaju rečenicom:** „Jedna sesija može da pita samo o
   jednoj strani.", i brojač ostaje isti. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 2.*
10. [ ] **Sesija pita samo iz izabranih otvaranja.** Ovo je kvar zbog kog je
    ...
    dolazi spolja. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 3.*
11. [ ] **„Izaberi granu" radi i u kombinovanoj sesiji**, i svaka grana nosi ime
    otvaranja iz kog je došla. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 4.*
12. [ ] **Dva otvaranja koja počinju istim potezima su dva reda.** Sicilijanka i
    ...
    sa dva imena; štikliranje jednog ne sme da štiklira drugi. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 5.*
13. [ ] **Rečenica o zajedničkom rasporedu** — „Pozicija koju oba otvaranja
    ...
    skrolovanja. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 6.*
14. [ ] **Jedan dodir na granu i dalje pokreće tu granu.** Čekboks je za više
    njih; dodir na red je ono što je oduvek radio. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 7.*
15. [ ] **Više štikliranih grana je jedna sesija.** Kad se prva isprazni, vežba
    prelazi na sledeću umesto da kaže da je gotovo. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 8.*
16. [ ] **Pozicija koju oba otvaranja dostižu pita se jednom.** Odgovoriti je u
    prvom otvaranju i proveriti da se u istoj sesiji ne pojavi ponovo. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 9.*
17. [ ] **Telefon, 360 dp, release build.** Tri mesta koja su bila preširoka:
    ...
    Ništa isečeno i ništa van ekrana. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 50.*
...
1. [ ] **Pregled nacrta uopšte nalazi nacrte.** `minRating` je odlazio prazan
   ...
   mora da ponudi tih N, a ne „Nema više nepotvrđenih poteza." — **prevaziđeno (25.9.2026):** Ova stavka je regresioni test za popravku kvara u ekranu „Pregled nacrta" (pregled nepotvrđenih poteza, gde je `minRating=` prazno slao 0 pa se pitalo van pravog opsega). I ekran „Pregled nacrta" i ceo pojam nepotvrđenih poteza su obrisani 16.9.2026 (sekcija 89), a parametar `minRating` je u celini izbačen iz repertoara i knjige 15.9.2026 — kvar koji je ovde popravljen više nema u čemu da postoji.
2. [x] **Traka se osveži kad se pregled zatvori.** Potvrditi jedan nacrt, pa
   ...
   urađen — a jedini način da se to sazna bio je da se pritisne. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
3. [x] **Isto u vežbi.** Rečenica „Još N nepotvrđenih poteza čeka" posle
   pregleda pokazuje novi broj. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
4. [x] **Širina stvarno menja crtež.** Postaviti „Samo glavni odgovor" pa
   ...
   `standard` 23, `broad` 48. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
5. [x] **Dijalog kičme se otvara na već izabranoj širini.** Repertoar na „Samo glavni odgovor" → „Predloži glavnu liniju" → mora da bude štiklirana glavna linija.
   Ranije je uvek pisalo „Uobičajeno (80%)", pa je svako otvaranje dijaloga
   tiho vraćalo repertoar na 80%. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
6. [x] **Prazan red nije ćorsokak.** Otvoriti repertoar u kome je red za
   ...
   rečenica govorila da se vratite na neku poziciju i uzmete još odgovora. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
...
1. [x] **Ugašeno je stvarno ugašeno.** Ući u vežbu bez diranja podešavanja:
   ništa se ne izgovara, nijedan panel nije pomeren, pitanje stoji gde je i
   stajalo. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
2. [x] **Prekidač u zaglavlju radi bez izlaska iz ekrana.** Zvučnik u traci
   vežbe i izgradnje: pritisak ga pali, ikona se menja, sledeće pitanje se
   izgovori. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
3. [ ] **Izgovara se ono što piše.** Pitanje („Šta igrate crnim?" plus rečenica
   ...
   rečima: „skakač c šest". Ako se čuje nešto što na ekranu ne piše, to je nalaz. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 10.*
4. [x] **Samo pitanje i presuda govore sami od sebe.** Baner „N nepotvrđenih u
   grafu", završni ekran izgradnje i „Još nema šta da se vežba." ćute dok se ne
   pritisne njihov zvučnik. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
10. [x] **I izgradnja čita svoje pitanje.** Ovo je bio drugi nalaz od 3.9.2026 —
    ...
    pitanje glasi „Posle <potez> — ovo igra protivnik" i važi isto. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
11. [x] **Ono što se ne izgovara nije ni obuhvaćeno.** Ispod pitanja u izgradnji
    ...
    obuhvata rečenicu koju ne čita je nalaz. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
5. [x] **Zvučnik nikad nije mrtvo dugme.** Sa ugašenim govorom pritisnuti
   zvučnik pored rečenice: pali govor **i** izgovara je. Ovo je pravilo iz faze
   0 i najlakše ga je slučajno pokvariti. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
6. [x] **Gašenje ućutkuje odmah.** Dok rečenica traje, pritisnuti prekidač u
   zaglavlju: glas prestaje na mestu, ne dovršava rečenicu. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
7. [ ] **Mašina bez glasa.** Na Windowsu bez srpskog glasa: svi paneli se crtaju,
   ...
   samo u logu. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 35.*
8. [x] **Telefon, 360 dp, release build.** Zaglavlje vežbe sada nosi i zvučnik:
   ...
   **ceo vidljiv i čitljiv**. U testu je 360 dp prelivalo za jedan piksel bez
   ...
   ekranu izgradnje, gde brojač „upita: N" namerno **nije** smanjivan. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
9. [x] **Paljenje čita ono što je već na ekranu.** Kvar koji je vlasnik našao
   ...
   poziciji. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
...
1. [ ] **Meni je tamo gde je dugme bilo.** Proći ekrane koji su imali dugme za
   ...
   ovde, ova stavka je tražila da se potvrdi upravo ono što je bio kvar. — *prepisano 25.9.2026 u novi spisak: Practise — Practise — ostalo, stavka 4.*
2. [x] **Koordinate i dalje rade.** Uključiti i isključiti: slova i brojevi oko
   table se pojave i nestanu, i to ostaje posle izlaska i povratka. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
3. [x] **Prekidač za vaše poteze.** U izgradnji repertoara isključiti „vaši
   ...
   umesto da preskoči svoj izvor obriše i sve ispod sebe. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
4. [ ] **Prekidač za statistiku.** Isto, obrnuto: statistika ode, vaši potezi i
   motor ostanu. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 25.*
5. [ ] **Prekidač za motor.** Isto u Analysis Studiju: strelice motora nestaju,
   ostalo stoji. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 12.*
6. [x] **Ekran vežbe sluša isti prekidač.** „Vežba" je ekran drila — onaj koji se
   ...
   **jeste vaš izabrani potez**, pa je gasi prekidač „Strelice odabranog
   poteza" — ne „Strelice motora" i ne „Strelice sa statistikom". — ✅ vlasnik, u alatu za proveru, 4.9.2026.
7. [x] **Tabla se precrta bez izlaska sa ekrana.** Prekidač se pomera dok se
   ...
   jednom u polje i to je nalaz. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
8. [x] **Preživi restart.** Ugasiti dva od tri prekidača, ubiti aplikaciju,
   pokrenuti ponovo: ista dva su i dalje ugašena. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
9. [x] **Uključeno se vidi bez boje.** Vlasnik ne razlikuje boje na koje se ovakvi
   prekidači obično oslanjaju: položaj prekidača mora da se čita kao uključen po
   **obliku i položaju**, ne po nijansi. Ako se razlika svodi na boju, to je nalaz. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
10. [x] **Telefon, 360 dp, release build.** Meni otvoren preko table: ništa nije
    isečeno, sve tri stavke se vide cele, i zatvaranje menija vraća tablu kakva
    je bila. — ✅ vlasnik, u alatu za proveru, 3.9.2026.
...
11. [ ] **AI Studio ima prekidače.** Otvoriti zadatak sa uključenom „Prikaži
    ...
    prekidača. Isključiti „Strelice motora" — strelice nestaju, tabla ostaje. — *prepisano 25.9.2026 u novi spisak: Practise — AI Studio i zagonetke, stavka 1.*
12. [ ] **Soba za čas ima prekidače.** Isto tamo gde trener pusti motor: meni
    ...
    postojao način da se sklone. — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 1.*
13. [x] **Replay ništa ne izgubi.** U replayu snimka strelice lekcije se i dalje
    vide — one nisu motorove i prekidač ih ne dira. (Lista strelica motora tamo
    se nikad nije ni punila, pa je obrisana.) — ✅ vlasnik, u alatu za proveru, 4.9.2026.
...
1. [ ] **Početna, red o ponavljanju.** Sa 1 pozicijom: „1 pozicija čeka na
   ...
   više: „5 pozicija čeka na ponavljanje." — **prevaziđeno (25.9.2026):** Aplikacija je od 8-9.9.2026 u potpunosti na engleskom (bez i18n sloja), pa srpska množina u ove tri rečenice više ne postoji ni na jednom ekranu — serbian_plural.dart je obrisan.
2. [ ] **Izgradnja, poruka posle uzimanja odgovora.** „Dodata 1 pozicija.",
   ...
   sa imenicom, što je i bio ceo kvar. — **prevaziđeno (25.9.2026):** Aplikacija je od 8-9.9.2026 u potpunosti na engleskom (bez i18n sloja), pa srpska množina u ove tri rečenice više ne postoji ni na jednom ekranu — serbian_plural.dart je obrisan.
3. [ ] **Izgradnja, poruka posle „Ne spremam ovo".** Kad ispod grane ima još
   ...
   pozicije", „**izašlo** još 5 pozicija". — **prevaziđeno (25.9.2026):** Aplikacija je od 8-9.9.2026 u potpunosti na engleskom (bez i18n sloja), pa srpska množina u ove tri rečenice više ne postoji ni na jednom ekranu — serbian_plural.dart je obrisan.
4. [ ] **Jedanaest do četrnaest.** Ako se negde zatekne takav broj: „12
   pozicija čeka", nikako „12 pozicije čekaju". Ovo je oblik koji svi
   promaše. — **prevaziđeno (25.9.2026):** Aplikacija je od 8-9.9.2026 u potpunosti na engleskom (bez i18n sloja), pa srpska množina u ove tri rečenice više ne postoji ni na jednom ekranu — serbian_plural.dart je obrisan.
...
3. [x] **Poruke u izgradnji se čuju.** Sa uključenim govorom, u izgradnji
   ...
   kao siv tekst i nikad se nije čula. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
4. [x] **„Nema više nepotvrđenih poteza" je istina kad se kaže.** Repertoar čija
   ...
   da ih nema. Mereno uživo 4.9.2026 na „Druga": 21 nacrt, walk ih je video 0. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
5. [x] **Dijalog kaže čemu širina pripada.** „Predloži glavnu liniju odavde" →
   ...
   više ne crta, poruka ispod table mora to da kaže i da imenuje izbor. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
...
7. [x] **Brojevi ispod table kažu šta broje.** Rečenica ispod pitanja sada glasi
   ...
   razlikuju za jedan su tačna; prijava je bila da se ne zna koji je koji. — ✅ vlasnik, u alatu za proveru, 4.9.2026.

8. [x] **Vaši potezi se vide i na „Samo glavni odgovor".** Repertoar sa kičmom
   ...
   niste ništa odlučili, to je nalaz — pravilo sme da doda samo vaše. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
9. [x] **Vežba nije proširena.** Ista promena, druga strana: broj pozicija u
   vežbi za taj repertoar ostaje isti, jer nacrt nije odluka i dril ga ne pita.
   („Druga" ima 4 i pre i posle.) — ✅ vlasnik, u alatu za proveru, 4.9.2026.
...
1. [x] **Nijedna povučena reč ne stoji na ekranu.** Proći sedam ekrana
   ...
   je gde se najlakše sakrilo. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
2. [x] **Reč koja mora da ostane.** Na tabli je i dalje „Nacrtaj strelicu" — to
   ...
   ekranu, pa se ne proverava odavde.) — ✅ vlasnik, u alatu za proveru, 4.9.2026.
3. [x] **Traka na telefonu, 360 dp, release build.** „N nepotvrđenih u grafu" i
   ...
   jedno ispod drugog, popravka je otišla na drugu stranu. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
4. [x] **Dugmad u izgradnji.** „Predloži glavnu liniju", „Pregledaj
   nepotvrđene", „Vežbaj ovu granu", „Ne spremam ovo", „Ipak spremi ovu granu" —
   i u punom prozoru i na 360 dp, gde se prelamaju u dva reda umesto da se seku. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
5. [x] **Radar.** U ⋮ meniju kartice piše „Rupe u repertoaru", a zaglavlje
   ekrana je „Rupe u repertoaru — <ime>". Po granama: „ne spremam" umesto
   „odsečeno", uz iste makaze. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
6. [x] **Dijalog za glavnu liniju.** Naslov „Predloži glavnu liniju odavde",
   nad izborima „Koliko odgovora spremamo", tri izbora „Samo glavni odgovor",
   „Uobičajeno (80%)", „Široko (95%)". Isti izbori istim redom kao pre. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
7. [x] **Stablo.** U legendi „✂ grana koju ne spremam", iznad „Koliko odgovora:
   uobičajeno 80%", i dugme „Prikaži/Sakrij grane koje ne spremam (N)". — ✅ vlasnik, u alatu za proveru, 4.9.2026.
8. [x] **Rečenice ispod table.** Posle uzimanja odgovora „Spremno je X% onoga
   ...
   pozicija, 2 pozicije, 5 pozicija. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
9. [x] **Ono što se čuje je ono što piše.** Sa uključenim govorom (faza 2), sve
   ...
   postoji da spreči. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
10. [x] **Brisanje i dalje kaže šta odnosi.** U spisku, brisanje nacrta i
    brisanje boje: „Idu i grane koje ne spremate, dodati odgovori, raspored za
    vežbanje…", i „Ispod tog predloga su N vaše odluke. Obrisati i njih?" — ✅ vlasnik, u alatu za proveru, 4.9.2026.
11. [x] **Vežba, prazna stanja.** „Ovu granu ne spremam ili u njoj još nema
    vaših poteza.", „Još N nepotvrđenih poteza čeka u ovom repertoaru." i dugme
    „Pregledaj nepotvrđene". — ✅ vlasnik, u alatu za proveru, 4.9.2026.
...
1. [ ] **Rupa bode oči u tamnoj temi.** Otvoriti stablo repertoara sa bar jednom
   ...
   po ivici koja je punom jačinom i deblja (3.0) od svih ostalih. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 48.*
2. [ ] **Ivica i dalje kaže ko je na potezu.** Uporediti dve rupe — jednu posle
   ...
   strani koja je na potezu, i to je nalaz. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 49.*
3. [ ] **Svetla tema nije pokvarena.** Ista slika u svetloj temi: rupa je i dalje
   samo deblja, ne i tamnija mrlja. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 50.*
...
1. [x] **Ulaz postoji i vodi tamo.** Na kartici repertoara, meni „Još" → prva
   stavka „Upoznaj repertoar". Otvara tablu sa prvim potezom već odigranim. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
2. [x] **Traka i strelice voze turu.** Napred ide potez po potez; na kraju
   linije **penje se nazad do račvanja** i izlazi drugom granom. Nazad poništava
   tačno taj korak — ne vodi na roditelja. Levo/desno na tastaturi rade isto. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
3. [x] **Na protivnikovom potezu se vidi lista.** Kartica kaže „Odavde protivnik
   ...
   vidi bez otvaranja lista, to je nalaz. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
4. [x] **Rupa nudi vrata.** Na `?` čvoru: „Na <potez>, X% partija, nemate
   odgovor." i dugme „Napravi odgovor" koje otvara izgradnju **u toj poziciji**,
   ne u korenu. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
5. [x] **Na Windowsu stablo stoji pored table i prati turu.** Označena kartica
   se pomera kako tura ide; dodir na karticu u stablu vodi turu tamo. Na
   telefonu stabla nema. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
6. [x] **Na telefonu (360 dp) ništa nije odsečeno.** Račvanje sa više odgovora:
   svi čipovi se vide, red se prelama. U release buildu prelivanje se ne crta,
   pa se gleda da li poslednji čip postoji. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
7. [x] **Dugme za okretanje table okreće tablu.** Bilo je vezano za praznu
   funkciju; sada mora da radi u oba smera. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
8. [x] **Vaša napomena se vidi.** Pozicija o kojoj ste nešto napisali: ispod
   rečenice stoji „Vaša napomena:" i tekst. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
9. [x] **Tura ništa ne upisuje.** Proći celu turu, izaći, pa otvoriti izgradnju:
   ništa nije dodato, obrisano ni promenjeno. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
...
1. [x] **Glavna linija ćuti.** Proći nekoliko poteza kroz liniju bez račvanja i
   bez rupa: tabla se pomera, kartica piše, **ništa se ne čuje**. Ako se čuje
   svaki potez, faza je promašila ono zbog čega postoji. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
2. [x] **Račvanje govori i imenuje odgovore.** Na svom potezu ispod kog
   protivnik ima više odgovora: čuje se „Odavde protivnik ima N odgovora: …" sa
   procentima, i rupa je u toj rečenici označena sa „bez odgovora". — ✅ vlasnik, u alatu za proveru, 4.9.2026.
3. [x] **Rupa govori.** Na `?` čvoru se čuje „Na <potez>, X% partija, nemate
   odgovor." — ✅ vlasnik, u alatu za proveru, 4.9.2026.
4. [x] **Napomena se čuje poslednja**, i počinje sa „Vaša napomena:". — ✅ vlasnik, u alatu za proveru, 4.9.2026.
5. [x] **Izgovoreno je ono što piše.** Sve što se čuje mora da stoji na
   kartici. Ako se čuje nešto čega nema na ekranu, to je nalaz. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
6. [x] **Rečenica se ne preseca.** Krenuti dalje dok govori: nova rečenica
   dolazi na red, aplikacija ne puca i ne ućuti zauvek. (Na Windowsu je ovo
   mesto na kome je `stop()` ranije obarao proces.) — ✅ vlasnik, u alatu za proveru, 4.9.2026.
7. [ ] **Sa isključenim govorom se ne gubi ništa** osim zvuka — sve rečenice su
   i dalje na kartici. — **prevaziđeno (25.9.2026):** Prekidač koji je vlasnik tražio (gašenje govora za ceo pregled, ne samo ispod table) je dodat u zaglavlje ekrana 'Tour your repertoire' istog dana (stavka 101.1) — sada postoji `SpeechToggleButton` u zaglavlju koji gasi govor za ceo pregled, a dugme ispod table nestaje kad je glavni prekidač ugašen.
...
1. [x] **Na račvanju stoje strelice.** Na svom potezu ispod kog protivnik ima
   ...
   se to dvoje razlikuje. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
2. [x] **Rupa se na strelici poznaje bez boje.** Značka rupe ima `?` pored
   procenta. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
3. [x] **Jedan odgovor ne dobija strelicu.** Tabla ionako ide tamo sledećim
   pritiskom. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
4. [x] **Kraj linije vraća na račvanje.** Posle poslednjeg poteza linije jedan
   ...
   samo tekst — figure moraju da budu tamo gde su bile. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
5. [x] **Nazad poništava tačno taj korak.** Sa takta povratka jedan nazad vraća
   na poslednji potez prethodne linije. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
6. [x] **Na taktu povratka traka ne pita „kojom linijom".** Tura je upravo
   rekla kojom ide; pritisak napred mora da ide tamo, a ne da otvori list. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
7. [x] **Tura dolazi do kraja.** Proći celu turu do poslednjeg poteza. Ako
   dugme napred u nekom trenutku prestane da radi, to je ovaj kvar ponovo. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
8. [x] **Meni na tabli nudi samo prekidač koji radi.** „Prikaz na tabli" na
   ovom ekranu ima „Koordinate" i „Strelice sa statistikom" — i ništa više.
   Isključivanje tog prekidača skida strelice. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
...
1. [x] **Prekidač u zaglavlju gasi govor za ceo pregled.** „Upoznaj repertoar",
   ...
   **ništa se ne izgovara ni na jednom stajanju**. Ranije je zvučnik ispod
   table ćutao samo do sledeće pozicije u kojoj ima šta da se kaže. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
2. [x] **Dok je gore isključeno, ispod table nema zvučnika.** Da se ne pritisne
   nešto što ne može da proizvede zvuk. Kad se gore uključi, zvučnik ispod
   table se vrati i ponavlja rečenicu. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
3. [x] **Rupa u tamnoj temi, drugi pokušaj.** Ivica je sada svetla (ne više
   ...
   teško uočava; ovo je zamena, ne dorada. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
4. [x] **Pokriven odgovor nije počeo da liči na rupu.** Prazna pilula, tanka
   ivica, bez ispune — i dalje jasno drugačija od oprane. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
...
1. [x] **Pritisnuti „Pregledaj nepotvrđene" nekoliko puta zaredom, potvrđujući
   ...
   Ranije je nakon svake potvrde skakalo u drugu granu na istoj dubini. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
2. [x] **Redosled se poklapa sa stablom na ekranu.** Otvoriti grafičko stablo i
   ...
   sopstvena slika i jedini način da se redosled proveri bez čitanja koda. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
3. [x] **Moja alternativa ide posle cele glavne grane**, čak i kad je odgovor na
   nju češći od svega u glavnoj. Vidi se u repertoaru gde ima drugi prvi potez. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
4. [x] **Isto iz sva tri ulaza.** Traka na ekranu za gradnju, „Idi na nacrte" u
   drilu, i otvaranje kartice sa liste (kartica sa značkom nacrta vodi na prvu
   nepotvrđenu poziciju). Sva tri traže isti prvi element sa servera. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
5. [x] **Brojka u traci se nije promenila.** Redosled je izmenjen, skup nije —
   „N nepotvrđenih" mora da bude isti broj kao pre potvrđivanja minus potvrđeno. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
6. [x] **Odsečena grana i dalje ćuti.** Odseći granu u kojoj ima nacrta, pa
   proći pregled do kraja: ništa iz nje se ne nudi na potvrdu. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
...
1. [x] **Analysis Studio, AI Studio i soba imaju isti panel.** Otvoriti sva tri
   ...
   odgovara i da je ocena iz ugla belog. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
2. [ ] **Dubina je na svakom redu (`d20`), a ne u baneru iznad.** Banera
   `Eval: +0.35 (depth: 20)` i naslova „Top 3 Linije" više nema. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 17.*
3. [x] **Prekidač „Prikaži evaluaciju" i dalje pali i gasi motor**, na sva tri
   ekrana. Ovo je izričito zadržano — nije zamenjeno dugmetom. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
4. [x] **Dodir linije i dalje otvara pun pregled** (`EngineLineDialog`), a ne
   odigrava potez. Takođe zadržano namerno. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
5. [x] **„Ubaci liniju kao varijaciju" radi tamo gde ga ima.** Ikonica sa
   račvom, na ekranima koji imaju stablo poteza. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
6. [ ] **Na telefonu (360 dp) ništa nije isečeno.** Naročito red „Prikaži
   ...
   sme da nestane iza ivice. Isto proveriti sa uvećanim sistemskim fontom. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 13.*
7. [ ] **Vrteška se vrti dok motor ćuti i nestane kad stignu linije.** Ne sme da
   se vrti dok je evaluacija ugašena. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 14.*
8. [ ] **Zaključan motor kaže „Zaključano od strane trenera"** i ništa ne
   računa iza te poruke. — **prevaziđeno (25.9.2026):** Poruka „Locked by trainer” i dalje postoji u kodu panela motora, ali nijedan trenutni poziv panela je više ne može prikazati: van sobe je `isAllowedToUseEngine` uvek `true`, a u sobi se ceo panel motora sakriva (ne crta se uopšte, ni sa porukom) čim korisnik nije voditelj sobe — pa se `Locked by trainer` panel danas nigde ne može izazvati uživo.
...
9. [ ] **Na kartici u stablu nema broja.** Ni u Analysis Studiju ni u
   ...
   zagradi. Nema ni obojene tačkice pored natpisa. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 27.*
10. [ ] **U alatnici grafičkog stabla nema dugmeta za filter.** Ikonice
    ...
    su tu. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 28.*
11. [ ] **Izvezeni PGN nema `[%eval …]`.** Izvesti partiju sa komentarima i
    oznakama i pogledati tekst: komentar i NAG jesu unutra, evaluacije nema. — *prepisano 25.9.2026 u novi spisak: Analyse — PGN i postavka pozicije, stavka 11.*
12. [ ] **Strelice motora pokazuju potez, ne broj.** Posle „auto analize" na
    tabli se crtaju strelice — na njima piše SAN (npr. `Nf3`), ne `+0.35`. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 11.*

**Šta mora da preživi:**

13. [x] **Traka evaluacije i panel motora rade kao pre.** Brisanje je bilo u
    čvoru, a ne u prikazu uživo — `Prikaži evaluaciju` i evaluaciona linija
    ispod table i dalje pokazuju broj za poziciju na ekranu. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
14. [ ] **Pregled cele partije i dalje piše komentare i oznake.** Pusti
    ...
    više ne postoji. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 32.*
15. [x] **Komentar se i dalje može upisati ručno**, i to je sada jedino mesto
    gde ocena može da ostane zapamćena uz potez. Upisati npr. „+0.35, motor
    d20", zatvoriti i otvoriti stablo — tekst je tu. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
16. [x] **Staro sačuvano stablo se i dalje otvara.** Ako postoji stablo
    sačuvano pre ove izmene (u kursu ili lekciji), otvoriti ga: mora da se
    učita normalno, samo bez brojeva na karticama. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
17. [x] **AI komentar se i dalje generiše.** „Generiši AI komentar" na potezu
    ...
    zabeležiti; to je poznata posledica, ne kvar. — ✅ vlasnik, u alatu za proveru, 4.9.2026.
...
13. [x] **Dugme „Pregledaj nepotvrđene" se i dalje lako pogađa prstom.** Ovo je
    jedina stvar koju je sažimanje moglo da pokvari: dugme je sada niže (32 px
    umesto 48). Ako je nezgodno pogoditi ga, reci — vraća se u jednom redu. — ✅ vlasnik, u alatu za proveru, 5.9.2026.
...
24. [ ] **Isto pravilo važi i na telefonu** — tabla i tamo uzima pola visine.
    Proveri da nije ispalo premala na malom ekranu. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 46.*
...
25. [ ] **Na širokom prozoru (preko 1200 dp) i ime otvaranja i „N nepotvrđenih"
    ...
    **Prvo napravi nepotvrđene poteze** („Predloži glavnu liniju"), inače se
    ...
    da prijavi. Kontrola: red ispod table tada ne kaže „nepotvrđeno N". — **prevaziđeno (25.9.2026):** Ceo sistem „nepotvrđenih” poteza i predloga (`UnconfirmedBanner`, dijalog širine, „uzmi/odbaci”) je obrisan 16.9.2026 kad je repertoar prešao na građenje potez-po-potez na tabli — banera „N nepotvrđenih” više nema ni u zaglavlju ni ispod table, ostao je samo baner sa imenom otvaranja.
...
28. [ ] **Ime otvaranja ne nestaje pri promeni veličine prozora.** Ovo je jedina
    ...
    prozora preko 1200 dp gore-dole. Ime mora da ostane. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 47.*
29. [ ] **U zaglavlju nema zvučnika uz „N nepotvrđenih".** Namerno: ta ikonica ne
    ...
    baš te rečenice, reci. — **prevaziđeno (25.9.2026):** Baner „N nepotvrđenih” pored kog nije smeo da stoji zvučnik je u međuvremenu u potpunosti obrisan (16.9.2026, novi način građenja repertoara), pa pitanje o zvučniku uz njega više nema predmet — u zaglavlju danas stoji samo baner sa imenom otvaranja (bez ikone) i zaseban `SpeechToggleButton`.
30. [ ] **Na telefonu (uspravno i položeno) ništa se nije promenilo** — oba su i
    ...
    praga. — **prevaziđeno (25.9.2026):** Provera je pretpostavljala dva banera iznad table na telefonu (ime otvaranja i „N nepotvrđenih”); drugi baner je obrisan 16.9.2026, pa na telefonu danas postoji samo baner sa imenom otvaranja, iznad table kao i pre.
...
33. [x] **„Resetuj pogled", `+`, `−`, kolo miša i pinch rade kao pre.** — ✅ vlasnik, u alatu za proveru, 5.9.2026.
34. [x] **Isto u Analizi, ne samo u repertoaru.** Otvori Analysis Studio,
    uzumiraj stablo i prođi partiju strelicama. — ✅ vlasnik, u alatu za proveru, 5.9.2026.
...
35. [x] **Uzumiraj stablo, pa vuci desnu ivicu prozora preko 840 dp gore-dole.**
    Veličina kartica ostaje ista i posle prelaska, u oba smera. Ranije se
    vraćala na 100%. — ✅ vlasnik, u alatu za proveru, 5.9.2026.
36. [x] **I pomeraj (pan) ostaje.** Odvuci crtež u stranu pre prelaska; posle
    ...
    unutra — to je pravilo iz dela G, ne resetovanje. — ✅ vlasnik, u alatu za proveru, 5.9.2026.
37. [x] **Prekidač „graf / notacija" ostaje kako si ga ostavio.** Prebaci na
    notaciju, pa pređi prag: i dalje je notacija. — ✅ vlasnik, u alatu za proveru, 5.9.2026.
38. [x] **Stablo je na ekranu tačno jednom pri svakoj širini.** Vuci ivicu polako
    kroz 840 dp: nema trenutka u kome se vide dva crteža, i nema crvenog ekrana
    sa greškom. — ✅ vlasnik, u alatu za proveru, 5.9.2026.
39. [x] **Ime otvaranja i dalje preživi svoj prag (1200 dp)** — deo F, stavka 28.
    Ova izmena je istog oblika i ne sme da ga pokvari. — ✅ vlasnik, u alatu za proveru, 5.9.2026.
...
6. [ ] **„Upoznaj repertoar" na poziciji gde protivnik ima više odgovora i ni na
   ...
   („Odavde protivnik ima N odgovora: …"). — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 30.*
7. [ ] **Usamljena rupa se i dalje pokazuje.** Pozicija sa **tačno jednim**
   ...
   nemate odgovor." Ovo je izuzetak koji je namerno zadržan. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 31.*
8. [x] **Mešana pozicija.** Gde je jedan odgovor odgovoren a drugi nije: u
   odgovoreni se ulazi kao i pre, a neodgovoreni ostaje kao stajanje (jer je
   sam). — ✅ vlasnik, u alatu za proveru, 5.9.2026.
9. [ ] **Govor je ređi nego ranije** na takvim mestima — jedna rečenica umesto
   pet. Ako ti se čini da se i dalje ponavlja, zabeleži gde. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 32.*
...
5. [ ] **Ništa nije upisano.** Nijedan nov potez se nije pojavio u stablu, a red
   ...
   uvek. — **prevaziđeno (25.9.2026):** Ceo mehanizam „koliko odgovora spremamo” (dijalog širine, red „odlučeno N · otvoreno M” i „nepotvrđeno K”) je obrisan 16.9.2026 kad je repertoar prešao na građenje potez-po-potez na tabli — protivnikovi potezi se više ne dodaju automatski po širini, nego ih igrač sam bira, a knjiga samo savetuje.
...
1. [ ] **Dodirni svoj potez u stablu**, pa u spisku „Posle <potez> — šta igra
   protivnik" pritisni **„Idi"** na odgovoru koji je već u pripremi. — **prevaziđeno (25.9.2026):** Spisak „Posle <potez> — šta igra protivnik” sa dugmetom „Idi” je deo starog sistema predloga koji je obrisan 16.9.2026; danas se protivnikov sledeći potez bira tako što se odigra na tabli ili preuzme iz predloga knjige, a kartica u stablu se označava dodirom na nju.
...
1. [ ] **Skenirana knjiga** → poruka kaže da je knjiga slika i da u njoj nema
   teksta. Ne sme da pomene font. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 7.*
2. [ ] **Knjiga sa tekstom, dijagrami slike** → poruka kaže da teksta ima ali da
   su dijagrami slike. Ni ovde se font ne pominje. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 8.*
3. [ ] **PDF veći od 25 MB** → poruka imenuje granicu („veća od 25 MB") i kaže
   da se PDF podeli. Ranije je pisalo „Skeniranje nije uspelo (500)". — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 9.*
4. [ ] **Knjiga koja radi i dalje radi.** `chessboard.pdf`, strane 1–40: 31
   ...
   proverava da popravka nije ništa pokvarila. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 10.*
5. [ ] **Nijedna poruka se ne pojavi dvaput** i nijedna ne ostane na ekranu
   posle sledećeg skeniranja. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 11.*
...
17. [ ] **Dva dugmeta postoje u Analitičkom studiju**, pored „Izvezi PGN":
    ...
    meniju — jedno od njih je bilo ubačeno na prvo mesto i tiho ga izbacilo. — *prepisano 25.9.2026 u novi spisak: Analyse — Tutorijal iz partije, stavka 1.*
...
25. [ ] **Pitanje „Odakle počinje korak?"** iskoči kad ne stojiš na početnoj
    ...
    Kad stojiš na korenu, pitanja nema. — **prevaziđeno (25.9.2026):** Pitanje „Odakle počinje korak?” (od početka linije / odavde, sa upozorenjem za sporednu varijantu) je uklonjeno — „Find the move”/„Choose the answer” danas seku deo tačno na poziciji na kojoj trener stoji, bez ikakvog pitanja, i to važi isto na glavnoj i na sporednoj liniji (demonstracija se sama preusmeri kroz stvarno pitanu poziciju).
...
29. [ ] **Korak koji počinje drugde se ne otvara sam.** Ako sledeći korak stoji
    na nekoj **drugoj** poziciji, čitanje stane na kraju linije i čeka dete. — **prevaziđeno (25.9.2026):** Pravilo da narisano čitanje staje i čeka dete kad sledeći deo počinje na drugoj poziciji je promenjeno sledećeg dana (7.9.2026), na vlasnikovu prijavu da je izgledalo pokvareno: `Play tutorial` sada automatski prelazi i preko delova koji se ne nastavljaju sa iste pozicije (uz kratku pauzu pre učitavanja nove table) i staje samo na račvanju ili na sledećem pitanju — ne čeka ručni pritisak na „Next part”.
...
1. [x] **Vrata postoje tamo gde treba.** U Analiznom studiju na Windowsu, u
   traci alata, stoji „Kreiraj interaktivni tutorijal". **Na telefonu ga
   nema** — ni u traci, ni u meniju „Još alata". — ✅ vlasnik, u alatu za proveru, 6.9.2026.
2. [x] **Pozicija se prenosi.** Stani na neku poziciju bez nastavka i otvori
   vrata: novi ekran se otvori na **toj** poziciji, sa istom stranom table. — ✅ vlasnik, u alatu za proveru, 6.9.2026.
3. [x] **Cela linija se prenosi.** Stani na potez iza kojeg ima nastavka i
   varijanti; na pitanje odgovori „Celu liniju". U stablu novog ekrana su svi
   ti potezi i sve varijante. — ✅ vlasnik, u alatu za proveru, 6.9.2026.
4. [x] **Analiza se ne menja.** Vrati se u Analizni studio i proveri da je
   stablo tamo netaknuto — potez odigran u tutorijalu ga ne sme dirati. — ✅ vlasnik, u alatu za proveru, 6.9.2026.
5. [x] **Grananje pita.** Na novom ekranu odigraj potez, vrati se nazad, pa
   odigraj **drugi** potez iz iste pozicije. Vrati se na početak i pritisni
   „Sledeći potez": pojavi se izbor sa oba poteza, ne šeta u prvi sam. — ✅ vlasnik, u alatu za proveru, 6.9.2026.
6. [ ] **Nacrt preživi zatvaranje.** Odigraj par poteza i **zatvori prozor
   ...
   videla samo ako se zatvori u prvoj sekundi. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 38.*
7. [ ] **Strelice na tastaturi šetaju liniju**, kao u Analiznom studiju. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 16.*
...
1. [ ] **Napiši tutorijal od dva primera u jednom dahu.** Ime tutorijala, pa
   ...
   „Tačan potez: …", a potez **se ne dodaje u liniju**. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 35.*
...
1. [ ] **Premesti korak.** Otvori tutorijal sa tri koraka, stani na treći,
   ...
   tutorijal: redosled je zapamćen. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 8.*
2. [ ] **Dodaj korak.** Stani na neki korak, „Dodaj korak" — novi se pojavi
   **odmah ispod** njega, na istoj poziciji, prazan (bez pitanja i bez rešenja).
   Daj mu naziv, sačuvaj, pa ponovo otvori: tu je, pod tim nazivom. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 33.*
...
5. [ ] **Poslednji korak se ne briše.** Na tutorijalu sa jednim korakom
   „Obriši korak" kaže da ne može i ništa ne pita. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 22.*
6. [ ] **Strelice na krajevima su ugasene** — gore na prvom, dole na poslednjem. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 10.*

## 113. Panel „Delovi tutorijala" — 6.9.2026, nije viđeno uživo

P5a (batch 57), u studiju za tutorijale. Ide uz tačku 111.

1. [x] **Izbor pomera sve.** Napravi dva dela, u svakom po jedan potez i po
   ...
   postoji; ako red posivi a tabla ostane, sve ostalo je nevažno. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
2. [x] **Ništa ne ide na server dok ne pritisneš „Sačuvaj tutorijal".**
   Dodavanje, pomeranje, kloniranje i brisanje su lokalni. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
3. [x] **„+ Dodaj deo" pita gde počinje.** „Nastavi odavde" otvara deo na
   poziciji na kojoj se prethodnom linija završila; „Nova pozicija" na praznoj
   tabli; „Otkaži" ne dodaje ništa. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
4. [x] **Spojnica.** Posle „Nastavi odavde" drugi deo nosi znak lanca sa
   ...
   zbog kog spojnica postoji: da autor vidi šta je razmeštanjem pokvario.** — ✅ vlasnik, u alatu za proveru, 7.9.2026.
5. [x] **Poslednji deo se ne briše.** Na tutorijalu sa jednim delom „Obriši
   deo" kaže rečenicu i ništa ne pita. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
6. [x] **Brisanje pita.** Na dva dela „Obriši deo" pita „Brisanje dela";
   „Odustani" ga ostavlja. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
7. [x] **Kloniranje ostavlja tebe na kopiji**, i kopija nosi rečenicu
   originala. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
8. [x] **Numeracija prati redosled i posle čuvanja.** Pomeri deo, sačuvaj,
   ...
   je crtao tačne reči preko netačnih podataka.) — ✅ vlasnik, u alatu za proveru, 7.9.2026.
9. [x] **Pogledaj kontraste, jer ih kapija nije merila.** Izabrani red se
   razlikuje od neizabranog i po podlozi i po debljini slova, a znak lanca ima
   svoj oblik — ništa ne sme da zavisi od boje same. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
...
1. [x] **Dve polovine, dva skrola.** Otvori tutorijal sa nekoliko delova, pa
   ...
   poljima, ništa drugo nije važno. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
2. [x] **Tabla raste sa prozorom, polja ne.** Razvuci prozor — tabla postaje
   veća, desna kolona ostaje iste širine. Suzi ga nazad; ništa se ne iseca. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
3. [x] **Tabla stoji na sredini svoje polovine**, a ne uz levu ivicu, kad je
   prozor širok (tada je tabla ograničena visinom pa ostaje prazan prostor). — ✅ vlasnik, u alatu za proveru, 7.9.2026.
4. [x] **„Sačuvaj tutorijal" je u traci na vrhu** i vidi se uvek, bez obzira
   koliko skrolovao. Sačuvaj tutorijal bez naziva: poruka o grešci se pojavi na
   dnu i **ne prekriva dugme** — to je i razlog zašto je dugme gore. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
5. [x] **Uzak prozor.** Suzi prozor ispod ~840 px: raspored se vraća na tablu
   gore i jednu kolonu ispod, kao pre. Ništa se ne iseca i ne vidi se žuto-crna
   traka. Sačuvaj je i dalje u traci na vrhu. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
6. [x] **Spisak delova sa mnogo delova.** Na tutorijalu sa desetak delova gornja
   polovina skroluje **unutar sebe**, a donja ostaje gde je bila. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
...
1. [x] **„Tok" je ono što se otvori.** Otvori sačuvan tutorijal: dole stoje dve
   kartice, „Tok" je napred, i linija se čita odozgo nadole — „Polazna
   pozicija", pa „posle 1. e4", pa dalje. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
2. [x] **Rečenica stoji između dva poteza.** Na taktu na kome si nešto napisao,
   tekst je **ispod** naslova a **iznad** „pa se igra: …". Tako to dete i dobija:
   prvo mu se kaže šta da vidi, pa se onda odigra potez. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
3. [x] **Brojevi poteza su tačni**, i na delu koji počinje iz sredine partije —
   napravi deo iz pozicije sa, recimo, 12. potezom i proveri da piše „posle
   12. …", a ne „posle 1. …". — ✅ vlasnik, u alatu za proveru, 7.9.2026.
4. [x] **Klik na karticu pomera tablu.** Klikni na neki takt: tabla ode na tu
   poziciju, a oznaka tekućeg takta se preseli na tu karticu. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
5. [x] **Grananje.** Na delu sa sporednom linijom, na taktu grananja stoje čipovi
   sa oba odgovora. Pritisni onaj koji nije uzet — **hronologija se precrta niz
   tu granu**, a stara se više ne vidi. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
6. [x] **„Stablo" je i dalje tu.** Prebaci na „Stablo": stablo je isto kao pre.
   Zumiraj ga, prebaci na „Tok" pa nazad — **zum je ostao**. (To je razlog zbog
   kog obe kartice ostaju napravljene.) — ✅ vlasnik, u alatu za proveru, 7.9.2026.
7. [x] **Pogledaj oznake.** Tekući takt i uzeti čip razlikuju se po podlozi,
   okviru, debljini slova i ikonici — ništa ne sme da zavisi od same boje. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
...
1. [x] **Polja su otišla iz kolone.** Iznad kartica „Tok"/„Stablo" stoje samo
   naziv tutorijala i spisak delova. Nigde drugde nema polja za rečenicu ni za
   pitanje. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
2. [x] **Svaka kartica ima svoje polje.** Napiši različitu rečenicu na tri
   uzastopna takta, sačuvaj, zatvori i otvori tutorijal ponovo — **svaka
   rečenica je na svom potezu**. (Ovo je jedina tačka koju vredi uraditi dvaput.) — ✅ vlasnik, u alatu za proveru, 7.9.2026.
3. [x] **Klik u tuđe polje ne guta kucanje.** Stani na jedan takt, pa **klikni
   ...
   si kliknuo. (Ovo je popravljeno na sluh testom, ali se vidi tek uživo.) — ✅ vlasnik, u alatu za proveru, 7.9.2026.
4. [x] **Nalepnica „Komentar za trenutni potez" stoji samo na tekućoj kartici.**
   Ostale kartice imaju polje bez nalepnice. Ako ti izgleda golo, reci — to je
   odluka o tekstu, ne o kodu. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
5. [x] **Pitanje je na kraju linije.** Kartica sa „Tip zadatka" stoji **ispod
   poslednjeg takta**, jednom, i nigde drugde. Promeni tip na „Traži odgovor iz
   liste": tu se pojave i zadatak i ponuđeni odgovori. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
6. [x] **Pitanje preživi čuvanje.** Postavi pitanje sa dva odgovora, sačuvaj,
   otvori ponovo — tip, zadatak i odgovori su tu. (Do 7.9.2026 nisu bili; vidi
   tačku 111.) — ✅ vlasnik, u alatu za proveru, 7.9.2026.
7. [x] **Grananje nosi i polja.** Na delu sa sporednom linijom pritisni čip
   neuzete grane: kartice se precrtaju niz tu granu i **u poljima je tekst te
   grane**, a ne rečenice linije koju si napustio. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
8. [x] **Duga linija.** Napravi deo od desetak poteza i proveri da se donja
   polovina skroluje do kartice sa pitanjem — ništa ne sme da ostane
   nedohvatljivo ispod ivice. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
...
1. [x] **Traka je ispod table**, iznad dugmadi za kretanje kroz poteze: „Strelica",
   „Polje", pet krugova sa bojama i „Obriši oznake". — ✅ vlasnik, u alatu za proveru, 7.9.2026.
2. [x] **Strelica.** Pritisni „Strelica" (dugme se oboji), pa klikni dva polja —
   strelica se nacrta. Klikni ista dva polja opet — nestane. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
3. [x] **Brisanje ne gleda boju.** Nacrtaj zelenu strelicu, promeni boju na
   crvenu, pa klikni ista dva polja — strelica **mora** da nestane. (Namerno je
   tako: ispravlja se „pogrešna strelica", ne „pogrešna boja".) — ✅ vlasnik, u alatu za proveru, 7.9.2026.
4. [x] **Polje.** Pritisni „Polje" pa klikni polje — nacrta se prsten. Klikni
   isto polje opet — nestane. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
5. [x] **Dok crtaš, figure se ne pomeraju.** U režimu crtanja povuci figuru —
   ništa se ne sme odigrati. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
6. [x] **Oznake stoje na potezu na kome si ih nacrtao.** Nacrtaj strelicu na
   trećem taktu, prošetaj napred-nazad po hronologiji — strelica se vidi samo na
   tom taktu. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
7. [ ] **Polunacrtana strelica ne preskače na drugu poziciju.** Klikni prvo
   ...
   pojavi nikakva strelica. Crtanje ostaje uključeno. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 7.*
8. [x] **Oznake na polaznoj poziciji.** Napravi deo bez ijednog poteza, nacrtaj
   na njemu polje i strelicu, sačuvaj, otvori ponovo — sve je tu. („Pogledaj
   polje d5" je ceo deo lekcije.) — ✅ vlasnik, u alatu za proveru, 7.9.2026.
9. [x] **Dete to vidi.** Otvori isti tutorijal kao učenik i proveri da su
   strelice i polja na tabli, na istim potezima. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
10. [x] **Boje.** Krugovi imaju slova (C, N, Z, P, Lj) i izabrani ima prsten —
    proveri da razlikuješ izabranu boju **bez** oslanjanja na samu boju. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
...
1. [ ] **Dete vidi strelicu.** Uđi u sobu sa druge mašine (ili drugog naloga)
   kao učenik. Trener nacrta strelicu — **pojavi se i kod deteta**, iste boje. — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 2.*
2. [ ] **Brisanje stigne do deteta.** Trener pritisne „Poništi strelicu" pa
   „Izbriši sve strelice" — kod deteta nestaju. — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 3.*
3. [ ] **Snimak.** Snimi kratak čas u kome nacrtaš strelicu, pa pusti reprodukciju
   — strelica se pojavljuje u trenutku u kom je nacrtana. — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 23.*
4. [ ] **Prazan „Izbriši sve" ne pravi takt.** Pritisni „Izbriši sve strelice"
   ...
   ponašanja u P7b.) — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 24.*
5. [x] **Boja i poništavanje.** Nacrtaj zelenu pa crvenu strelicu, „Poništi
   strelicu" skida crvenu; nacrtaj zelenu i sa izabranom crvenom klikni ista dva
   polja — zelena nestaje (brisanje ne gleda boju). — ✅ vlasnik, u alatu za proveru, 7.9.2026.
6. [ ] **Crtanje i potezi.** Uključi crtanje, klikni jedno polje, pa odigraj
   potez — polunacrtana strelica se zaboravlja, a crtanje ostaje uključeno. — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 21.*
...
1. [x] **Pitanje sa linijom se ne čuva, i kaže se koji deo.** Napravi deo sa
   ...
   linija je netaknuta. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
2. [x] **„Ukloni liniju i postavi pitanje"** briše poteze, ostavlja polaznu
   poziciju, komentar i nacrtane oznake na njoj. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
3. [x] **Pitanje sa strelicom se čuva.** Napravi deo bez poteza, napiši
   ...
   procenjivao po izvezenom tekstu, a ne po tome ima li poteza.) — ✅ vlasnik, u alatu za proveru, 7.9.2026.
4. [x] **Stari tutorijal koji curi kaže to na otvaranju.** Otvori tutorijal koji
   ima `ask_move` deo sa linijom — gore stoji crvena traka koja imenuje taj deo. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
5. [x] **Ponuđeni odgovori.** Jedan odgovor se odbija, pet se odbija, dva bez
   ijednog tačnog se odbija, dva sa jednim tačnim prolazi. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
6. [x] **„Pregledaj kao učenik"** otvara tutorijal onako kako ga dete vidi, i
   **ništa ne šalje na server** — odgovori u pregledu ne upisuju pokušaj. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
7. [x] **„Uredi" na Windows-u otvara studio**, a ne stari editor koraka. Na
   Android telefonu isti tutorijal se i dalje uređuje starim editorom. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
...
1. [x] **Tab pokazuje deo.** Otvori deo sa nekoliko poteza i komentarom: u tabu
   „PGN" stoji tekst sa tim potezima i komentarom u vitičastim zagradama. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
2. [x] **Legenda.** Iznad polja piše šta su `[%cal]` i `[%csl]` i koje slovo je
   koja boja — proveri da ih ima **pet**. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
3. [x] **Kucanje ništa ne menja dok ne pritisneš „Primeni".** Ukucaj drugu
   liniju, pređi na „Tok" — stara linija je i dalje tamo; vrati se na „PGN" —
   tvoj tekst je i dalje tu, i piše „izmenjeno". — ✅ vlasnik, u alatu za proveru, 7.9.2026.
4. [x] **Primeni.** Pritisni „Primeni": „Tok" i tabla pokazuju novu liniju, a
   oznaka pređe na „primenjeno". — ✅ vlasnik, u alatu za proveru, 7.9.2026.
5. [ ] **Odbijanje.** Ukucaj liniju sa potezom koji se ne može odigrati —
   poruka kaže **koliko** poteza, i deo ostaje nepromenjen. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 46.*
6. [ ] **Nalepi pravu partiju.** Uzmi anotiranu partiju sa komentarima i
   ...
   varijante moraju da prežive**. Pa je pogledaj kroz „Pregledaj kao učenik". — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 47.*
7. [x] **Crtanje i tekst se slažu.** Nacrtaj strelicu po tabli pa pogledaj tab
   „PGN": u tekstu stoji `[%cal ...]` na tom potezu. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
8. [x] **Deo bez poteza.** Deo koji ima samo komentar prikazuje se u tabu kao
   zaglavlje i `{ … }` — i primena takvog teksta ga ne prazni. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
9. [x] **Karet bira potez.** Klikni mišem unutar nekog poteza u tekstu — tabla
   ode na tu poziciju, a u „Toku" se tekući takt preseli na taj potez. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
10. [x] **I obrnuto.** Klikni karticu u „Toku" pa se vrati na „PGN" — karet
    stoji na tom potezu (potez je označen). — ✅ vlasnik, u alatu za proveru, 7.9.2026.
11. [x] **Desni klik.** Desni klik unutar poteza daje tri stavke: „Dodaj
    strelicu", „Označi polje", „Dodaj komentar". U praznini između poteza ih
    nema, kao ni dok tekst piše „izmenjeno". — ✅ vlasnik, u alatu za proveru, 7.9.2026.
12. [x] **Strelica iz menija.** „Dodaj strelicu" postavi kursor na taj potez i
    uključi crtanje — nacrtaj je na tabli i proveri da je u tekstu `[%cal ...]`
    baš na tom potezu. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
13. [x] **Komentar iz menija.** „Dodaj komentar" otvara polje sa postojećim
    tekstom tog poteza; „Odustani" ne menja ništa. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
14. [ ] **Nalepljena partija iz druge pozicije.** Nalepi PGN koji nosi svoj
    ...
    poruku; „Odustani" ne uradi ništa i **ne** javlja grešku. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 48.*
15. [ ] **Isti položaj, drugi satovi.** PGN čiji se `[FEN]` razlikuje samo po
    brojačima ne sme ništa da pita. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 49.*
...
1. [ ] **Zvezdica zalepljena za poslednji potez.** U tab „PGN" ukucaj liniju
   ...
   Ranije je javljalo „1 potez ne može da se odigra" za sasvim legalnu liniju. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 45.*
2. [x] **Isto sa razmakom** (`Nxb4 *`) i dalje radi, kao i `1-0`. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
3. [x] **Crtanje se gasi kad promeniš takt.** Uključi „Strelica", pa klikni
...
6. [x] **Stari tutorijal se ne prevrće.** Otvori tutorijal napravljen pre ove
   ...
   tiha i videla bi se tek kod deteta. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
...
1. [x] **Tri dugmeta.** U panelu piše „Sadržaj tutorijala", a ne „Delovi
   tutorijala", i stoje tri dugmeta: „Novi prikaz", „Traži potez na tabli",
   „Traži odgovor iz liste". Nema više „+ Dodaj deo". — ✅ vlasnik, u alatu za proveru, 7.9.2026.
2. [x] **Presecanje.** Odigraj `1. e4 e5 2. Nf3 Nc6 3. Bb5`, vrati se na
   ...
   ikonicu lanca — nadovezuju se. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
3. [x] **Ostaješ na pitanju.** Posle presecanja si u delu koji pita, sa poljem
   „Zadatak za učenika" pred sobom. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
4. [x] **Kod deteta je jedna tabla.** „Pregledaj kao učenik": demonstracija,
   pitanje na istoj poziciji **bez ponovnog postavljanja figura**, pa
   nastavak. Ovo je cela poenta — ako tabla trepne, javi. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
5. [x] **Grana se ne gubi.** Uradi isto na delu koji ima sporednu liniju posle
   poteza koji pitaš — sporedna linija mora da bude u trećem delu. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
6. [x] **Pitanje na sporednoj liniji.** Stani na potez iz sporedne linije pa
   pitaj: prvi deo mora da **vodi do te pozicije** (ta linija postaje glavna),
   a ne do stare glavne. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
7. [x] **Prazan deo.** Na delu bez ijednog poteza „Traži potez na tabli" ne
   pravi nove delove — deo prosto postane pitanje. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
8. [x] **Nazivi.** Deo se u spisku zove po prvoj rečenici koju nosi (ili po
   zadatku, ako pita). Bez ijedne reči — „Deo 1". — ✅ vlasnik, u alatu za proveru, 7.9.2026.
9. [x] **Preimenuj.** Olovka otvara „Naziv"; upisano ime pobeđuje sve. Isprazni
   polje pa sačuvaj — vraća se naziv po rečenici. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
10. [x] **Ime stiže do deteta.** Isti naziv koji vidiš u spisku mora da stoji i
    kad tutorijal otvoriš kao učenik. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
11. [x] **„Novi prikaz"** pita „Odakle počinje?" — „Odavde" nastavlja tamo gde
    je stala linija (ikonica lanca), „Nova tabla" počinje iz početne pozicije. — ✅ vlasnik, u alatu za proveru, 7.9.2026.
12. [x] **Uzak prozor.** Suzi prozor studija na oko 840 dp: panel sa sadržajem
    ne sme da preliva (u release buildu se preliv ne vidi, samo se dugmad ne
    mogu pritisnuti). — ✅ vlasnik, u alatu za proveru, 7.9.2026.
...
1. [x] **Oba poteza stoje na ekranu.** Otvori kao učenik tutorijal čiji korak
   ima sporednu liniju: ispod komentara piše „Odavde ide više linija — kojom?"
   i stoje dva čipa sa potezima. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
2. [x] **Presečen tutorijal.** Uradi „Traži potez na tabli" na poziciji iz koje
   ide više odgovora, pa „Pregledaj kao učenik": treći deo se **otvara** sa oba
   poteza na ekranu. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
3. [x] **Klik vodi u tu liniju.** Pritisni čip sporedne linije — tabla i
   komentar su te grane, i čipova više nema jedan potez niže. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
4. [x] **Bez račve nema pitanja.** Korak sa jednom linijom nema ni rečenicu ni
   čipove — to je pravilo iz serije 52 i ono se ne sme izgubiti. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
5. [x] **Glavna linija se poznaje po obliku.** Prvi čip nosi zvezdicu, ostali
   strelicu — razlika ne sme da zavisi od boje. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
6. [x] **Traka i dalje pita.** Strelica „Sledeći potez" na račvi i dalje otvara
   list sa istim potezima. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
...
1. [x] **Iz „Toka".** Svaka kartica koja jeste potez ima dugme sa gumicom
   (`Obriši ovaj potez`) u zaglavlju. Kartica „Polazna pozicija" ga **nema** —
   to nije potez, i za nju postoji „Obriši deo". — ✅ vlasnik, u alatu za proveru, 8.9.2026.
2. [x] **Go potez ne pita.** Odigraj tri poteza i obriši poslednji — nestaje
   odmah, bez pitanja. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
3. [x] **Potez sa napisanim ne ide bez pitanja.** Napiši rečenicu na potez (ili
   nacrtaj strelicu, ili igraj dalje od njega) pa ga obriši — pita „Obriši
   potez?" i imenuje ga. „Odustani" ne menja ništa. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
4. [x] **Tabla ne ostaje na obrisanoj poziciji.** Stani na potez, pa obriši
   potez **iznad** njega — tabla i „Tok" se vrate na potez pre obrisanog. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
5. [x] **Iz stabla.** U tabu „Stablo" desni klik (ili dugi pritisak) na potez
   daje isti izbor, i „Obriši Ovu Varijantu" sada zaista briše. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
6. [x] **Glavna linija se bira.** Napravi sporednu liniju, desni klik na njen
   prvi potez, „Unapredi u Glavnu Liniju" — od tada „Tok" ide tom granom i
   dete se vodi njome. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
7. [x] **Nigde više mrtvog menija.** Ako neki ekran ne nudi te akcije, meni se
   ne otvara prazan — ne sme da postoji dugme koje ne radi ništa. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
8. [x] **Sačuvaj pa otvori ponovo** — obrisani potez se nije vratio. — ✅ vlasnik, u alatu za proveru, 8.9.2026.

## 125. Dve popravke iz žive provere — 7.9.2026, nije viđeno uživo

Obe su iz stavke 121, gde su zapisane kao „dobro je, ali…".

1. [x] **Posle „Primeni" stojiš na poslednjem potezu.** U tabu „PGN" dopiši
   potez na kraj linije i pritisni „Primeni" — u „Toku" je tekuća **poslednja**
   kartica, a tabla je na toj poziciji. Ranije te je vraćalo na polaznu. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
2. [x] **Novi deo počinje kako si ostavio tablu.** Okreni tablu, pa „Novi
   ...
   prevrne baš tu. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
3. [x] **Isto i za „Nova tabla".** Ko piše iz ugla crnog, piše iz ugla crnog i
   na sledećem dijagramu. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
4. [x] **Stari deo se ne dira.** Otvori sačuvan tutorijal sa delom koji je
   okrenut i delom koji nije, sačuvaj bez izmena — obe orijentacije su ostale
   kakve su bile. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
...
1. [x] **Spisak.** Biblioteka → „Sačuvani tutorijali": svaki red ima naziv i
   dve ikonice — avionče („Pošalji učeniku") i kantu („Obriši tutorijal"). — ✅ vlasnik, u alatu za proveru, 8.9.2026.
2. [x] **Otvaranje je i dalje tu.** Klik na naziv otvara tutorijal u studiju,
   kao i pre. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
3. [x] **Brisanje pita i imenuje.** Kanta pita „Obriši tutorijal?" i u pitanju
   stoji naziv; „Odustani" ne briše ništa. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
4. [x] **Posle brisanja spisak ostaje otvoren**, bez obrisanog reda, pa možeš
   da obrišeš i drugi. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
5. [x] **Obrisan je stvarno obrisan.** Zatvori pa opet otvori spisak — nema ga. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
6. [x] **Slanje.** Avionče nudi spisak tvojih učenika; u njemu su **samo oni
   koji su prihvatili poziv**. Izaberi jednog — poruka kaže da je poslato. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
7. [x] **Kod deteta.** Uloguj se kao taj učenik: tutorijal stoji u zadacima i
   otvara se. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
8. [x] **Bez učenika.** Nalog bez ijednog prihvaćenog učenika dobija rečenicu,
   a ne prazan spisak. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
...
1. [x] **Dugme kaže šta radi.** Ispod table piše „Pusti tutorijal", ne
   „Pročitaj mi liniju". — ✅ vlasnik, u alatu za proveru, 8.9.2026.
2. [x] **Dva prikaza su jedna šetnja.** Tutorijal sa dva „prikaži" dela, drugi
   iz svoje pozicije: pritisni play jednom — pročita prvi deo, pa **sam pređe**
   u drugi i pročita i njega. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
3. [x] **Tabla se ne postavlja ispod rečenice.** Na prelazu u deo koji počinje
   drugde sačeka se kratko pre nego što se figure prerasporede. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
4. [x] **Pitanje i dalje zaustavlja.** Deo koji nešto pita: pitanje se pročita
   i šetnja stane, da dete odgovori. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
5. [x] **Račva i dalje zaustavlja.** Na račvi šetnja stane i čipovi sa oba
   poteza stoje na ekranu (stavka 123). — ✅ vlasnik, u alatu za proveru, 8.9.2026.
6. [x] **Kraj je kraj.** Na poslednjem delu šetnja stane i dugme se vrati na ▶. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
7. [x] **Stop radi u svakom trenutku**, i posle prelaska u sledeći deo. — ✅ vlasnik, u alatu za proveru, 8.9.2026.
...
1. [ ] **Pita kad ima šta da ponudi.** Otvori deo koji stoji na nekoj
   ...
   pritisni „Primeni" — pojavi se „Tekst ne počinje odavde". — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 39.*
2. [ ] **„Uzmi početnu poziciju"** prebaci deo na početnu poziciju i linija se
   odigra cela. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 40.*
3. [ ] **„Zadrži postojeću"** odbije tekst, i poruka kaže **da tekst nema svoju
   polaznu poziciju** — to je rečenica koja je nedostajala. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 41.*
4. [ ] **„Odustani"** ne menja ništa i **ne** javlja grešku; tvoj tekst ostaje
   u polju. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 42.*
5. [ ] **Tekst koji ne ide nigde.** Nalepi liniju koja se ne može odigrati ni
   ...
   svoju polaznu poziciju. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 43.*
6. [ ] **Ništa se ne pita kad nema zašto.** Fragment koji se uredno igra iz
   ...
   ijednog pitanja, kao i pre. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 44.*
...
1. [ ] **Soba.** „Postavi poziciju (Board Setup)" otvara isti dijalog kao
   Analiza, i **na poziciji koja je na tabli**, ne iz početne. — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 22.*
2. [ ] **Studio za tutorijal.** Ikonica „Unos pozicije" daje **dve** kartice —
   „FEN String" i „Ručno Slaganje". Nema više „Otvaranja" ni uvoza. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 50.*
3. [ ] **Analiza.** I dalje ima svih pet kartica i uvoz radi kao pre. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 21.*
4. [ ] **Figure se vide.** U paleti crne figure stoje na svetlom polju —
   ...
   deblji okvir, ne samo drugu podlogu. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 22.*
5. [ ] **Rokade se čitaju.** Piše „Beli O-O", „Beli O-O-O", „Crni O-O", „Crni
   O-O-O" umesto `K`, `Q`, `k`, `q`. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 23.*
6. [ ] **Na uskom prozoru.** Suzi prozor (ili otvori na telefonu): kartica
   ...
   pritisnuti. Na širokom se ne skroluje ništa. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 24.*
7. [ ] **Tri načina brisanja polja** i dalje rade: klik na naoružanu figuru,
   dugi pritisak, desni klik. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 25.*
...
1. [ ] **Početni ekran.** Kartica „Priprema" piše „Vaše sačuvane pozicije i
   ...
   razlika. — **prevaziđeno (25.9.2026):** Provera je poredila dve susedne kartice na početnom ekranu — „Priprema” i „Analiza” — sa kratkim opisima. Reorganizacijom školjke 18-21.9.2026 „Analiza” je postala pun tab (`Analyse`), a ne kartica sa opisom pored „Priprema”, pa poređenje dva teksta jedne pored druge više nije moguće na tom mestu; kartica `Preparation` i dalje postoji, sada sa tekstom „Your board, your library, no student.”
2. [ ] **Biblioteka.** Dugmad su „Otvori Pripremu sa praznom tablom" i „Otvori
   Analizu". — **prevaziđeno (25.9.2026):** Dugmad „Otvori Pripremu sa praznom tablom” i „Otvori Analizu” u Biblioteci su uklonjena istom reorganizacijom — vrata do Preparation su sada kartica na tabu Teach (`Open`), a poseban ulaz u praznu Analizu iz Biblioteke ne postoji (Biblioteka otvara Analizu samo preko postojećeg zapisa analize).
3. [ ] **U samom ekranu.** Naslov sobe bez učenika je „Priprema"; desni panel
   ...
   isključena". — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 20.*
4. [ ] **Analiza** se u zaglavlju zove „Analiza", a u podešavanjima piše
   „Paneli u Analizi:". — **prevaziđeno (25.9.2026):** Deo provere o Podešavanjima je zastareo: kontrola panela Analize je 17.9.2026 preseljena iz Podešavanja u sopstveni meni `Panels` unutar Analysis Studija, pa u Podešavanjima danas uopšte nema reda o panelima Analize da se pročita. Naslov ekrana Analize u zaglavlju i dalje kaže „Analiza” (na engleskom „Analysis”).
5. [ ] **Reč „studio"** se sreće još samo u „Studio za tutorijal". — *prepisano 25.9.2026 u novi spisak: Podešavanja i izgled — Cela aplikacija, stavka 1.*
6. [ ] **Ništa se nije prelomilo** — proveri da naslovi staju u zaglavlje i na
   užem prozoru. — *prepisano 25.9.2026 u novi spisak: Podešavanja i izgled — Cela aplikacija, stavka 5.*
...
1. [ ] **Obaveštenja i pozivnice.** Napravi novu vezu trener–učenik i pogledaj
   ...
   to je očekivano. — *prepisano 25.9.2026 u novi spisak: Nalog i prijava — Veza trener–učenik i roditelj, stavka 3.*
2. [ ] **Greške koje ekran crta doslovno.** Zadaj domaći bez izabranog učenika,
   ...
   „Instance of…" i ne prazan SnackBar. — *prepisano 25.9.2026 u novi spisak: Teach — Učenici, grupe i obaveštenja, stavka 6.*
3. [ ] **Zagonetke i skener.** Otvori PDF koji nije knjiga sa dijagramima:
   ...
   dijagrama / nepoznat font), na engleskom. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 6.*
4. [ ] **Završnice.** Katalog piše `rook and two pawns versus rook`, ne
   ...
   familija su „Rook endgames", „Pawn endgames"… — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 13.*
5. [ ] **Roditeljski izveštaj.** Otvori link izveštaja: naslov, legenda, imena
   ...
   a brojevi i procenti nepromenjeni. — *prepisano 25.9.2026 u novi spisak: Teach — Domaći i napredak učenika, stavka 12.*
6. [ ] **AI objašnjenje pozicije.** „Objasni poziciju" i AI komentar poteza sada
   **odgovaraju na engleskom** — parametar `userLanguage` je obrisan sa oba
   kraja. Ako se vrati srpski tekst, model ignoriše prompt i to je nalaz. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 15.*
7. [ ] **Repertoar.** „Vežbaj" liniju do greške (npr. potez koji nije u
   repertoaru) — poruke su engleske i koriste reč **drill**, ne „practice". — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 63.*
8. [ ] **Priprema protiv protivnika.** Pusti pripremu sa Lichess-a: rečenica o
   ...
   pojavi, pogledaj log servera pre nego što prijaviš da je pokvarena. — **prevaziđeno (25.9.2026):** Priprema protiv protivnika (uvoz sa Lichess-a, rečenica sa procentima o protivniku) je isključena — u `chess_app/lib` ne postoji nijedna referenca na taj put (nijedan ekran ga više ne otvara), iako servisni kod za nju još postoji na serveru neiskorišćen.
...
1. [ ] **Vrata.** „Sačuvani tutorijali" → svaki red ima tri ikonice: video,
   ...
   vide i da se svaka može pogoditi prstom, i kod tutorijala sa dugim imenom. — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 25.*
2. [ ] **Prazan tutorijal** kaže „This tutorial has nothing to show yet." i
   **ne** šalje ništa serveru. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 34.*
...
5. [ ] **U videu:** rečenica ispod table je čitljiva do kraja; strelice i
   ...
   **bez** osvetljenog poteza iz prvog; deo pisan sa crne strane je okrenut. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 23.*
...
8. [ ] **Izvoz snimka časa** (`Replay` → izvoz MP4) i dalje izgleda isto kao
   ...
   geometriju. — *prepisano 25.9.2026 u novi spisak: Home — Reprodukcija snimka, stavka 5.*
9. [ ] **Kvota.** Posle izvoza, „Moj nalog" prikazuje potrošenu MP4 kvotu; izvoz
   koji padne ne sme da je potroši. — *prepisano 25.9.2026 u novi spisak: Podešavanja i izgled — Settings, stavka 3.*
...
11. [ ] **Traka napretka se pomera u koracima od 10 %** i pored procenta piše
    ...
    render odmiče, a na kraju kaže „almost done" umesto da broji do nule. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 24.*
12. [ ] **Izvoz snimka časa nema više izbor kompleta figura** — u dijalogu su
    ...
    izlazi u figurama iz aplikacije. — *prepisano 25.9.2026 u novi spisak: Home — Reprodukcija snimka, stavka 6.*
...
14. [ ] **Server odgovara dok renderuje.** Dok traje izvoz, otvori bilo šta
    ...
    pomerala. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 25.*
15. [ ] **Video bez glasa to i kaže.** Ako je glas tražen a nije stigao (npr.
    ...
    narration: …". Do 9.9.2026 je takav izvoz izgledao kao svaki drugi. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 26.*
16. [ ] **Dva renderovanja u isto vreme.** Pokreni izvoz na dva naloga (ili dva
    ...
    traku sa procentima kad dođe na red. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 27.*
...
17. [ ] **Potezi se izgovaraju, ne slovkaju.** Napiši u komentaru „Bd5", „O-O"
    ...
    „Bd5"** — menja se samo ono što se izgovara. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 28.*
...
1. [ ] **Zatvori aplikaciju usred izvoza.** Pokreni izvoz dugog tutorijala i
   ...
   released`, i to **u roku od nekoliko sekundi**, ne na kraju filma. — **prevaziđeno (25.9.2026):** Mehanizam koji je ova stavka proveravala — da se crtanje prekine kad klijent ode (`abortOnDisconnect`) — obrisan je 10.9.2026, dan posle nego što je stavka napisana, kad je izvoz tutorijala prešao na model iz stavke 143: server odgovara 202 pre nego što se ijedan kadar nacrta, soket se zatvara odmah posle toga i to više ne znači da je klijent otišao. Crtanje sada prekida samo eksplicitni `Cancel render`; zatvaranje aplikacije ili gašenje mreže dok traje izvoz više ne zaustavlja render — film se dovrši i javi obaveštenjem, tačno suprotno od onoga što ova stavka traži da se vidi. Preživeli deo provere (da se ne troši kvota na neuspeo render, da se ne zove piper kad se otkine) pokriva stavka 143 (i1171-i1180).
2. [ ] **Nijedan fajl ne ostaje.** Posle toga u `chess_backend/exports/` ne sme
   da bude novog MP4 za taj tutorijal, ni polovičnog `.wav` iz naracije. — **prevaziđeno (25.9.2026):** Mehanizam koji je ova stavka proveravala — da se crtanje prekine kad klijent ode (`abortOnDisconnect`) — obrisan je 10.9.2026, dan posle nego što je stavka napisana, kad je izvoz tutorijala prešao na model iz stavke 143: server odgovara 202 pre nego što se ijedan kadar nacrta, soket se zatvara odmah posle toga i to više ne znači da je klijent otišao. Crtanje sada prekida samo eksplicitni `Cancel render`; zatvaranje aplikacije ili gašenje mreže dok traje izvoz više ne zaustavlja render — film se dovrši i javi obaveštenjem, tačno suprotno od onoga što ova stavka traži da se vidi. Preživeli deo provere (da se ne troši kvota na neuspeo render, da se ne zove piper kad se otkine) pokriva stavka 143 (i1171-i1180).
3. [ ] **Sledeći trener odmah dolazi na red.** Dok prvi izvoz još „traje", sa
   ...
   da čeka do kraja napuštenog filma. — **prevaziđeno (25.9.2026):** Mehanizam koji je ova stavka proveravala — da se crtanje prekine kad klijent ode (`abortOnDisconnect`) — obrisan je 10.9.2026, dan posle nego što je stavka napisana, kad je izvoz tutorijala prešao na model iz stavke 143: server odgovara 202 pre nego što se ijedan kadar nacrta, soket se zatvara odmah posle toga i to više ne znači da je klijent otišao. Crtanje sada prekida samo eksplicitni `Cancel render`; zatvaranje aplikacije ili gašenje mreže dok traje izvoz više ne zaustavlja render — film se dovrši i javi obaveštenjem, tačno suprotno od onoga što ova stavka traži da se vidi. Preživeli deo provere (da se ne troši kvota na neuspeo render, da se ne zove piper kad se otkine) pokriva stavka 143 (i1171-i1180).
4. [ ] **Kvota nije potrošena.** Napušteni izvoz se **ne knjiži** — proveri da
   broj renderovanja na nalogu nije porastao. — **prevaziđeno (25.9.2026):** Mehanizam koji je ova stavka proveravala — da se crtanje prekine kad klijent ode (`abortOnDisconnect`) — obrisan je 10.9.2026, dan posle nego što je stavka napisana, kad je izvoz tutorijala prešao na model iz stavke 143: server odgovara 202 pre nego što se ijedan kadar nacrta, soket se zatvara odmah posle toga i to više ne znači da je klijent otišao. Crtanje sada prekida samo eksplicitni `Cancel render`; zatvaranje aplikacije ili gašenje mreže dok traje izvoz više ne zaustavlja render — film se dovrši i javi obaveštenjem, tačno suprotno od onoga što ova stavka traži da se vidi. Preživeli deo provere (da se ne troši kvota na neuspeo render, da se ne zove piper kad se otkine) pokriva stavka 143 (i1171-i1180).
5. [ ] **Nginx tajmaut, ne samo zatvoren laptop.** Isto ponovi tako što pustiš
   ...
   isto kao gore. Ovo je jedini deo koji lokalno ne može da se proveri. — **prevaziđeno (25.9.2026):** Mehanizam koji je ova stavka proveravala — da se crtanje prekine kad klijent ode (`abortOnDisconnect`) — obrisan je 10.9.2026, dan posle nego što je stavka napisana, kad je izvoz tutorijala prešao na model iz stavke 143: server odgovara 202 pre nego što se ijedan kadar nacrta, soket se zatvara odmah posle toga i to više ne znači da je klijent otišao. Crtanje sada prekida samo eksplicitni `Cancel render`; zatvaranje aplikacije ili gašenje mreže dok traje izvoz više ne zaustavlja render — film se dovrši i javi obaveštenjem, tačno suprotno od onoga što ova stavka traži da se vidi. Preživeli deo provere (da se ne troši kvota na neuspeo render, da se ne zove piper kad se otkine) pokriva stavka 143 (i1171-i1180).
6. [ ] **Naracija.** Sa instaliranim piperom prekini vezu **dok traje sinteza**
   ...
   prekida koji nije pokriven testom, nego samo konstrukcijom. — **prevaziđeno (25.9.2026):** Mehanizam koji je ova stavka proveravala — da se crtanje prekine kad klijent ode (`abortOnDisconnect`) — obrisan je 10.9.2026, dan posle nego što je stavka napisana, kad je izvoz tutorijala prešao na model iz stavke 143: server odgovara 202 pre nego što se ijedan kadar nacrta, soket se zatvara odmah posle toga i to više ne znači da je klijent otišao. Crtanje sada prekida samo eksplicitni `Cancel render`; zatvaranje aplikacije ili gašenje mreže dok traje izvoz više ne zaustavlja render — film se dovrši i javi obaveštenjem, tačno suprotno od onoga što ova stavka traži da se vidi. Preživeli deo provere (da se ne troši kvota na neuspeo render, da se ne zove piper kad se otkine) pokriva stavka 143 (i1171-i1180).
...
1. [x] **Tri kadra.** „Preview" na tutorijalu sa više delova daje tri slike —
   početak, sredina, kraj — kroz koje se prelazi strelicama. — ✅ vlasnik, u alatu za proveru, 10.9.2026.
2. [x] **Rezolucija se poštuje.** Uključi „Higher quality (1080p)" pa pusti
   pregled: naslov kaže „Preview · 1080p", a tekst natpisa je vidno oštriji
   nego na 720p. — ✅ vlasnik, u alatu za proveru, 10.9.2026.
3. [x] **Ništa nije renderovano.** Posle pregleda u `chess_backend/exports/`
   nema novog fajla, a broj renderovanja na nalogu nije porastao. — ✅ vlasnik, u alatu za proveru, 10.9.2026.
4. [x] **Dijalog za izvoz ostaje.** Zatvaranje pregleda vraća trenera u isti
   dijalog, sa prekidačima kako ih je ostavio. — ✅ vlasnik, u alatu za proveru, 10.9.2026.
5. [ ] **Pregled odgovara i dok se nešto drugo renderuje.** Pusti dug izvoz sa
   ...
   pregled namerno **nije** u redu za renderovanje. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 61.*
6. [x] **Slika je ono što će film biti.** Uporedi kadar iz pregleda sa istim
   taktom u gotovom videu: ista tabla, iste strelice, ista rečenica, isti
   raspored. — ✅ vlasnik, u alatu za proveru, 10.9.2026.
...
1. [x] **Izvezi pa zatvori dijalog.** Ne pritiskaj „Download". Zatvori spisak,
   otvori ga ponovo: na tom redu stoji ikonica za preuzimanje i daje isti film. — ✅ vlasnik, u alatu za proveru, 10.9.2026.
2. [x] **Kasnije, ili sa drugog uređaja.** Isti nalog, drugi uređaj — dugme
   radi, jer se link kuje u trenutku kad se pita. — ✅ vlasnik, u alatu za proveru, 10.9.2026.
3. [x] **Jedan film po tutorijalu.** Izvezi isti tutorijal drugi put pa
   pogledaj `chess_backend/exports/`: stari fajl više ne postoji, novi je tu.
   Do sada je svaki izvoz ostavljao svoj fajl. — ✅ vlasnik, u alatu za proveru, 10.9.2026.
4. [x] **Red bez filma nema to dugme.** Tutorijal koji nikad nije izvezen ima
   samo kameru, „pošalji" i kantu. — ✅ vlasnik, u alatu za proveru, 10.9.2026.
5. [ ] **Film koji je zastareo.** (Pre četrnaest dana se izaziva ručnim
   ...
   save space. Export it again", i dugme **nestaje** sa reda. — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 21.*
6. [ ] **Telefon od 360 dp.** Red sa filmom ima četiri ikonice i dug naslov —
   proveri na uskom telefonu da su sve dohvatljive. — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 22.*
...
1. [ ] **Tri izvoza sa istog naloga.** Treći mora da bude odbijen rečenicom
   ...
   „The server is rendering other videos right now". — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 56.*
2. [ ] **Drugi nalog i dalje prolazi.** Dok prvi trener ima svoja dva, sa
   drugog naloga pusti izvoz: mora da uđe u red, ne da bude odbijen. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 57.*
3. [ ] **Red poštuje smenu.** Trener A pusti izvoz pa odmah još jedan; trener B
   pusti svoj posle toga. Kad se prvi zavrsi, **B ide pre A-ovog drugog**. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 58.*
4. [ ] **Broj u traci je tačan.** Onaj ko čeka vidi mesto koje se obistini —
   ako ga neko pretekne po pravilu smene, broj mu poraste, i to vidi. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 59.*
5. [ ] **Kvota nije potrošena na odbijanje.** Posle odbijenog trećeg izvoza broj
   renderovanja na nalogu nije porastao. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 60.*
...
1. [x] **Vrata.** U studiju, na **sačuvanom** tutorijalu, ikonica mikrofona
   pored „Export video" otvara ekran „Record narration". Na nesačuvanom kaže
   „Save the tutorial first, then record it." i ništa ne otvara. — ✅ vlasnik, u alatu za proveru, 10.9.2026.
2. [x] **Snimanje.** „Record", pričaj, razmak za svaki sledeći takt. Tabla i
   rečenica prate; red „Next: …" tačno kaže šta će razmak postaviti. — ✅ vlasnik, u alatu za proveru, 10.9.2026.
3. [ ] **Pauza nema rupu.** Pauziraj pet sekundi, **pritisni razmak dok je
   ...
   nastavlja, bez tišine od pet sekundi. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 49.*
4. [x] **Utišan mikrofon.** Utišaj mikrofon u Windowsu i pritisni „Record": za
   ...
   kaže da je nem. — ✅ vlasnik, u alatu za proveru, 10.9.2026.
5. [ ] **Kraj se ne razilazi.** Snimi ceo tutorijal od bar dva minuta sa jednom
   ...
   proverava, i baš tu bi zidni sat pogrešio. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 50.*
6. [ ] **Ponovno otvaranje.** Zatvori ekran i otvori ga opet: „Recorded … ·
   m:ss · N of M beats" i „Listen" radi. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 51.*
7. [ ] **Novi pokušaj i odbacivanje.** „Record again" pa „Discard": stari snimak
   je i dalje tu. „Record again" pa „Stop": novi je zamenio stari. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 52.*
8. [ ] **Izlazak usred snimanja.** Strelica nazad dok se snima pita „Discard this
   recording?"; „Discard and leave" izlazi i ništa ne ostaje. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 53.*
9. [ ] **Držanje razmaka.** Drži razmak dve sekunde: pomera se **jedan** takt. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 54.*
10. [ ] **Izmenjen tutorijal.** Posle snimka dodaj potez u studiju i otvori ekran:
    mora da kaže „This recording was made when the tutorial had N beats…". — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 55.*
11. [ ] **Fajl.** U direktorijumu podrške aplikacije
    ...
    `ffprobe` daje isto trajanje koje piše na ekranu. — *prepisano 25.9.2026 u novi spisak: Server i alati — Govor i renderovanje, stavka 8.*
...
1. [ ] **Pitanje.** Posle celog snimka, „Export video" u studiju ili u „Sačuvani
   ...
   ovo je bio prekidač „Use my recording"; vidi stavku 141.) — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 42.*
2. [ ] **Prvi izvoz.** Pojavi se „Uploading your recording", pa traka
   ...
   razmak — proveri početak, sredinu i **poslednja tri takta**. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 43.*
3. [ ] **Drugi izvoz bez novog snimka.** Nema „Uploading" — server već ima baš
   taj snimak. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 44.*
4. [ ] **Novi snimak, pa izvoz.** „Uploading" se opet pojavi, i film ima novi
   glas. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 45.*
5. [ ] **Drugi odgovor.** Izaberi „No voice", ili „Synthesised voice" ako server
   ...
   oba**. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 46.*
6. [ ] **Izmenjen tutorijal.** Dodaj potez, pa „Export video": umesto odgovora
   „My recording" stoji „Your recording was made when the tutorial had N beats…". — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 47.*
7. [ ] **Brisanje.** Obriši tutorijal iz biblioteke: fajl u
   `chess_backend/uploads/narration/` nestaje. — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 24.*
8. [ ] **Nije javno.** `…/uploads/narration/<ime>.wav` u pregledaču daje 404. — *prepisano 25.9.2026 u novi spisak: Server i alati — Govor i renderovanje, stavka 7.*
9. [ ] **Petnaest minuta.** Snimanje blizu granice samo stane na 14:59 i kaže
   zašto; izvoz tog snimka prolazi. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 48.*
...
1. [ ] **Prepravljena rečenica.** Snimi ceo tutorijal, pa u studiju **izmeni
   ...
   was made…" sa dva dugmeta. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 65.*
2. [ ] **Broj taktova je isti.** Na ekranu za snimanje piše i dalje „N of N
   ...
   has been edited since this was recorded". — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 41.*
3. [ ] **„Record again".** Dugme iz trake otvara ekran za snimanje. Snimi ponovo
   do kraja i vrati se: **traka je nestala**. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 1.*
4. [ ] **„Export without your voice".** Iz trake otvara dijalog za izvoz; umesto
   ...
   voice" ili „No voice". Film se napravi sintetizovan ili tih. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 1.*
5. [ ] **Preimenovanje ništa ne košta.** Preimenuj **tutorijal** i preimenuj
   **deo**: traka se ne pojavljuje, izvoz i dalje bira „My recording". Ovo je
   pola faze — sat vremena snimanja ne sme da propadne zbog naslova. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 68.*
6. [ ] **Strelica i krug ništa ne koštaju.** Nacrtaj strelicu i oboj polje na
   nekom taktu: traka se ne pojavljuje, izvoz i dalje nudi snimak. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 66.*
7. [ ] **Stariji snimak.** Snimak napravljen pre ove verzije (nema potpis) sudi
   ...
   tutorijalu. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 67.*
8. [ ] **Server ne pušta.** Ako se izmena nekako provuče do izvoza, server
   odgovara 409 sa rečenicom o izmeni i **ne troši slot za renderovanje**. — *prepisano 25.9.2026 u novi spisak: Server i alati — Govor i renderovanje, stavka 6.*
...
1. [ ] **Sva tri.** Tutorijal sa snimkom, server sa piperom: pod „Narration" su
   tri odgovora, izabran je „My recording", i nema liste glasova. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 35.*
2. [ ] **„Synthesised voice".** Izaberi ga: pojavi se lista glasova i „A narrated
   export takes longer." Film ima sintetizovan glas i ništa tvoje. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 36.*
3. [ ] **„No voice" je tih film** i kad server ima piper — ranije je isključen
   snimak na takvom serveru značio sintetizovan glas. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 37.*
4. [ ] **Pamti se ono što nije snimak.** Izvezi jednom sa „Synthesised voice",
   ...
   izvoz: izabran je „Synthesised voice", a ne „No voice". — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 38.*
5. [ ] **Nema pitanja sa jednim odgovorom.** Bez snimka i bez pipera nema
   ...
   samo rečenica zašto snimak ne važi. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 39.*
6. [ ] **Nizak prozor.** Tutorijali postoje samo na Windowsu (stavka 136, korak
   ...
   prekidač bi stajao ispod dugmadi. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 40.*
...
1. [ ] **Predug tutorijal.** Izvezi `big-40-parts` (36 minuta) na 720p: odgovor
   ...
   novog fajla i broj renderovanja na nalogu nije porastao. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 32.*
2. [ ] **1080p.** `medium-12-parts` (10,5 minuta) na 1080p: odbijen, a rečenica
   nudi „export it at 720p". Isti na 720p prolazi. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 33.*
3. [ ] **Snimak.** Tutorijal sa snimkom od desetak minuta, izvezen na 1080p:
   ...
   snimka stao. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 34.*
4. [ ] **Red bez vremena.** Pusti `medium-12-parts` sa jednog naloga, pa odmah
   ...
   N minutes", **ne** „The server is rendering other videos right now". — **prevaziđeno (25.9.2026):** Kako je već zapisano u samom odeljku 142 docs/TODO-provera.md (posle stavke 143, 10.9.2026): ovaj odgovor (Try again in about N minutes umesto reda) više ne važi za tutorijal, jer otkad se film crta posle odgovora nijedna veza ne čeka njegov film — drugi zahtev samo čeka svoj red (stavka 137). Ta rečenica sada stiže jedino izvozu snimljenog časa, koji se i dalje crta unutar zahteva — to pokriva stavka 143.10 (i1180), koja ostaje u proveri.
5. [ ] **Kratak i dalje ulazi.** Dok se `medium-12-parts` renderuje, pusti
   `concurrent-a` (2 minuta) sa drugog naloga: ulazi u red i završi se. — **prevaziđeno (25.9.2026):** Isti razlog kao 142.4 (i1168): otkad tutorijal izlazi iz zahteva (stavka 143), ništa ne čeka njegov film na vezi, pa nema više scenarija u kome bi kratak izvoz bio odbijen zbog vremena — on samo čeka svoj red kao i inače (stavka 137, i1122/i1123). Ova specifična tvrdnja (da kratak izvoz i dalje ulazi dok se dugačak crta) i danas važi, ali kao posledica reda po nalogu iz stavke 137, ne mehanizma iz ove stavke — pokriveno tamo (i1122).
6. [ ] **Droplet: izmeri brzinu.** Na dropletu izrenderuj `medium-12-parts`
   ...
   podrazumevane vrednosti (12 i 6) su procena o drugoj mašini. — *prepisano 25.9.2026 u novi spisak: Server i alati — Govor i renderovanje, stavka 5.*
...
1. [ ] **Ekran se više ne zamrzava.** Izvezi `medium-12-parts`. Traka ima dva
   ...
   renderuje, a aplikacija radi normalno dok server crta. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 25.*
2. [ ] **Pronađi ga ponovo.** Otvori „Saved tutorials" dok se film crta: red tog
   ...
   otvara istu traku, sa pravim procentom. — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 20.*
3. [ ] **Obaveštenje.** Kad se film završi, na zvoncetu je „Your video of … is
   ready" sa ikonom filma, a „Download video" na redu radi. — *prepisano 25.9.2026 u novi spisak: Home — Home i obaveštenja, stavka 3.*
4. [ ] **Drugi izvoz istog tutorijala.** Dok se film crta, u studiju pritisni
   ...
   već renderuje i prikazuje se traka tog filma — drugi se ne pokreće. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 26.*
5. [ ] **Prekid.** Pokreni izvoz i pritisni „Cancel render": dugme kaže
   ...
   novog fajla, broj renderovanja na nalogu nije porastao, i nema obaveštenja. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 27.*
6. [ ] **Prekid dok čeka u redu.** Sa naloga A pusti dugačak film, sa naloga B
   ...
   (A-ov ide dalje), i B može odmah da izveze ponovo. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 28.*
7. [ ] **Restart servera usred rendera.** Pusti film, pa zaustavi i ponovo pokreni
   ...
   bila otvorena kaže to isto umesto da stoji. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 29.*
8. [ ] **Telefon na 360 dp.** Traka sa oba dugmeta staje na ekran (ovo važi tek kad
   ...
   planu). — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 30.*
9. [ ] **Snimak od 30 minuta.** U studiju otvori „Record narration": studio prvo
   ...
   14:59 — namerno kraće, jer se kraći snimak uvek prima. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 31.*
10. [ ] **Snimljeni čas i dugačak tutorijal.** Sa naloga A pusti izvoz dugačkog
    ...
    minutes" — umesto da visi 300 s dok ga nginx ne preseče. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 2.*
...
1. [ ] **Naracija zaista govori.** Izvezi bilo koji tutorijal sa „Narrate this
   ...
   rendered successfully…" bez ijedne rečenice o naraciji. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 23.*
2. [ ] **Kad motora nema, prekidača nema.** Privremeno pokvari `PIPER_PYTHON` u
   ...
   „piper voices are installed but the engine cannot start". — *prepisano 25.9.2026 u novi spisak: Server i alati — Govor i renderovanje, stavka 3.*
3. [ ] **Rečenica koja razlikuje dva kvara.** Sa pokvarenim `PIPER_PYTHON`
   ...
   venv putanju i restartuj. — *prepisano 25.9.2026 u novi spisak: Server i alati — Govor i renderovanje, stavka 4.*
4. [ ] **Vraćanje u normalu.** Posle vraćanja `.env`-a prekidač „Narrate this
   video" je opet tu, sa punim spiskom glasova. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 24.*
...
3. [ ] **Srpski izgovor poteza.** Ako srpski glas postoji:
   ...
   mora reći „lovac d pet" i „mala rokada", a ne da slovka „be de pet". — *prepisano 25.9.2026 u novi spisak: Server i alati — Govor i renderovanje, stavka 2.*
...
5. [ ] **Rečenica sa `&` ili `<`.** Napiši u nekom taktu „Nimzo & Bogo" ili
   ...
   logu nema `Azure refused`. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 21.*
6. [ ] **Filter po jeziku.** Otvori izvozni list sa Azure provajderom: prvo se
   ...
   `docs/STANJE-RADA.md`. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 22.*
...
7. [ ] **Piper i dalje radi.** Vrati `TTS_PROVIDER=piper`, restartuj backend,
   izvezi film sa naracijom: govori kao pre. Rezerva mora da ostane rezerva. — *prepisano 25.9.2026 u novi spisak: Server i alati — Govor i renderovanje, stavka 10.*
...
2. [ ] **Ćirilički glas.** `node scripts/tts-probe.js "Odigraj Bc4."
   ...
   zapisati. — *prepisano 25.9.2026 u novi spisak: Server i alati — Govor i renderovanje, stavka 1.*
3. [ ] **Dijakritike u filmu.** Izvezi tutorijal čiji natpis ima č, ć, š, đ i ž
   ...
   natpisu. Ranije je svako bilo kvadratić. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 18.*
4. [ ] **Brojevi redova na tabli.** U istom filmu, uz levu ivicu table stoje
   brojevi 1–8, a uz donju slova a–h. Brojevi su nedostajali od 9.9.2026. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 19.*
5. [ ] **Slušanje glasa pre renderovanja.** U izvoznom listu, pored padajuće
   ...
   renderuje**. Promeni glas pa pritisni ponovo — čuje se novi glas. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 20.*
6. [ ] **Glas koji server nema.** (Za onoga ko dira `.env`.) Sa `TTS_PROVIDER`
   ...
   može da se izabere. — *prepisano 25.9.2026 u novi spisak: Server i alati — Govor i renderovanje, stavka 9.*
...
1. [x] **Jedan fajl, pogled pre čuvanja.** Biblioteka → Interaktivni tutorijali
   ...
   otvori „Sačuvani tutorijali" — tutorijala nema. — ✅ vlasnik, u alatu za proveru, 11.9.2026.
2. [x] **Isti fajl, pa sačuvan.** Ponovi, ali u studiju pritisni „Sačuvaj
   tutorijal". Sada je u „Sačuvani tutorijali", otvara se ponovo i delovi su
   isti. — ✅ vlasnik, u alatu za proveru, 11.9.2026.
...
5. [x] **Više fajlova odjednom.** Izaberi svih 27 iz `fixed/` (Ctrl+A u
   ...
   the library". Poruka kaže koliko ih je uvezeno. — ✅ vlasnik, u alatu za proveru, 12.9.2026.
6. [x] **Oznake filtriraju.** Otvori „Sačuvani tutorijali": iznad liste stoji
   ...
   Ukucaj deo imena u pretragu — lista se suzi. — ✅ vlasnik, u alatu za proveru, 12.9.2026.
7. [x] **Oznaka iz studija.** Otvori jedan tutorijal, u polju „Labels" dopiši
   „, rook", sačuvaj, vrati se na listu: čip „rook" postoji i taj tutorijal je
   pod njim. — ✅ vlasnik, u alatu za proveru, 12.9.2026.
8. [x] **Opis preživi čuvanje.** (Ovo je greška koja je popravljena usput.)
   ...
   tu. Ranije bi oboje nestalo. — ✅ vlasnik, u alatu za proveru, 12.9.2026.
9. [x] **Dete vidi tutorijal.** Pošalji jedan uvezen tutorijal đaku („pošalji"
   na redu liste) i prođi ga kao dete: delovi se smenjuju, pitanje traži potez,
   i **odgovor se ne vidi unapred** ni na jednom pitanju. — ✅ vlasnik, u alatu za proveru, 12.9.2026.
...
1. [x] **Ispis i govor se završavaju zajedno.** Otvori tutorijal sa dužim
   ...
   odjednom. — ✅ vlasnik, u alatu za proveru, 11.9.2026.
2. [x] **Klizač za brzinu govora se poštuje.** Podešavanja → brzina na
   ...
   i to je bila polovina greške. — ✅ vlasnik, u alatu za proveru, 11.9.2026.
3. [x] **Promena glasa ne vuče staru brzinu.** Ako uređaj ima dva glasa: pusti
...
1. [x] **Studio: izbor jezika.** Polje „Language" stoji u redu sa nazivom i
   ...
   „Serbian (Latin)". — ✅ vlasnik, u alatu za proveru, 12.9.2026.
...
7. [ ] **Izvoz videa.** Za tutorijal na „Serbian (Latin)" dijalog za izvoz se
   ...
   **ne** nudi kao srpski. Sa piper-om, koji nema srpski glas, dijalog se
   otvara kao ranije. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 17.*
8. [ ] **Aplikacija i dalje govori engleski.** Tamo gde aplikacija čita svoj
   ...
   otvorenog tutorijala. — *prepisano 25.9.2026 u novi spisak: Podešavanja i izgled — Cela aplikacija, stavka 2.*
9. [ ] **Uputstvo govori istinu.** `docs/UPUTSTVO-STUDIO.md`, odeljak 8 opisuje
   baš ovo što si video. — *prepisano 25.9.2026 u novi spisak: Server i alati — Sajt i priručnik, stavka 7.*
...
1. [ ] **Obrisan deo se vraća.** Obriši deo, pa Undo (zakrivljena strelica gore
   ...
   otvori ponovo — deo je tu. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 62.*
2. [x] **Rečenica je jedan korak.** Otkucaj rečenicu u komentar bez pauze: jedan
   ...
   ostaje. — ✅ vlasnik, u alatu za proveru, 12.9.2026.
3. [x] **Redo.** Ctrl+Y vraća ono što je Undo uklonio. Nova izmena posle Undo-a
   gasi Redo. — ✅ vlasnik, u alatu za proveru, 12.9.2026.
4. [x] **Pitanje pri otvaranju.** Obriši deo, **ne čuvaj**, zatvori studio.
   ...
   nema, a „Discard changes" (sat sa strelicom, pored Undo/Redo) svetli. — ✅ vlasnik, u alatu za proveru, 12.9.2026.
5. [x] **Bez izmena nema pitanja.** Otvori sačuvan tutorijal, prošetaj po
   taktovima i delovima bez menjanja, zatvori, otvori ponovo: ništa ne pita, a
   „Discard changes" je siva. — ✅ vlasnik, u alatu za proveru, 12.9.2026.
6. [ ] **Discard changes.** Odigraj potez, pa „Discard changes": potez nestaje;
   Ctrl+Z ga vraća. Posle „Save tutorial" dugme je sivo. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 63.*
7. [x] **Vlasnikov primer.** Pozicija `8/3k4/1n3b2/8/8/8/2PK4/2R5 w - - 0 1`,
   ...
   posle `Kc6`, i svaki komentar i oznaka su na svom potezu. — ✅ vlasnik, u alatu za proveru, 12.9.2026.
8. [x] **Rez se vraća.** Ponovi rez, pa jedan Ctrl+Z: opet je jedan deo, sa
   celom linijom. — ✅ vlasnik, u alatu za proveru, 12.9.2026.
9. [x] **Ikonica je samo gde ima smisla.** Na kartici takta na kome stojiš — da;
   na ostalim karticama, na delu bez poteza i na pitanju — ne. — ✅ vlasnik, u alatu za proveru, 12.9.2026.
...
12. [x] **Uputstvo govori istinu.** `docs/UPUTSTVO-STUDIO.md`, odeljci 2, 5
    (crtanje se gasi na novom taktu) i 7 opisuju baš ovo što si video. — ✅ vlasnik, u alatu za proveru, 12.9.2026.
...
1. [ ] **Link iz aplikacije.** Settings → sekcija „HELP" → red
   ...
   proveri samo da se pregledač otvara i da je adresa tačna. — *prepisano 25.9.2026 u novi spisak: Podešavanja i izgled — Settings, stavka 8.*
2. [ ] **Sadržaj vodi kuda kaže.** Na `index.html` svaka od trinaest stavki
   otvara svoju stranicu, i sa svake se vraća na sadržaj. — *prepisano 25.9.2026 u novi spisak: Server i alati — Sajt i priručnik, stavka 1.*
3. [ ] **Uradi tri zadatka po uputstvu.** Bez znanja iz glave: otvori stranicu i
   ...
   uputstva, ne tvoja — zapiši gde. — *prepisano 25.9.2026 u novi spisak: Server i alati — Sajt i priručnik, stavka 2.*
4. [ ] **Stranice za igrače i učenike.** „Practise on your own",
   ...
   vidiš na ekranu. — *prepisano 25.9.2026 u novi spisak: Server i alati — Sajt i priručnik, stavka 3.*
5. [ ] **Stranica za roditelje.** „For parents" — da li je to ono što bi hteo da
   ...
   servira. — *prepisano 25.9.2026 u novi spisak: Server i alati — Sajt i priručnik, stavka 4.*
6. [ ] **Stranica proizvoda.** `site/mislisha.html` — opis aplikacije je
   ...
   to opis pod kojim bi je objavio. — *prepisano 25.9.2026 u novi spisak: Server i alati — Sajt i priručnik, stavka 5.*
7. [ ] **Ništa ne fali.** Ako ti nedostaje zadatak koji radiš često, a nema ga
   u sadržaju — to je sledeća stranica. — *prepisano 25.9.2026 u novi spisak: Server i alati — Sajt i priručnik, stavka 6.*
...
1. [ ] **Vraćanje se vidi.** Izvezi taj tutorijal i gledaj granicu trećeg i
   ...
   stoji dok se ne odigra prvi potez tog dela. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 12.*
2. [ ] **Spoj ništa ne kaže.** Na granici prvog i drugog dela — gde se tabla ne
   ...
   „Starting position" i potez pod tablom se gasio. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 13.*
3. [ ] **Takt se vidi dovoljno dugo.** U **nemom** filmu (u izvoznom listu „No
   ...
   natpis pročita. U filmu sa glasom dužinu odlučuje glas, kao i inače. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 14.*
4. [ ] **Snimljena naracija ostaje važeća.** Ako imaš snimak preko tog
   ...
   Potpis liste taktova o ovome namerno ne zna ništa. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 15.*
5. [ ] **Izvoz snimljenog časa izgleda isto.** `Replay` → izvoz MP4: pod tablom
   ...
   `init` bez spoja i ovo pravilo ga ne dotiče. — *prepisano 25.9.2026 u novi spisak: Home — Reprodukcija snimka, stavka 2.*
6. [ ] **Deo koji se otvara na poziciji koju niko nije dosegao.** Napravi
   ...
   nema. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 16.*
7. [ ] **Dečji ekran još ne kaže ništa** (P2 nije rađen). U đakovom pregledu se
   ...
   sledeća faza i treba da pozove isto pravilo, a ne novo. — *prepisano 25.9.2026 u novi spisak: Practise — Svoji zadaci i domaći, stavka 2.*
...
1. [ ] **Film i studio se slažu.** Izvezi bilo koji tutorijal i uporedi kadar
   ...
   naslov, sat i kolona sa rečenicom stoje gde su i stajali. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 11.*
2. [ ] **Izvoz snimljenog časa.** `Replay` → izvoz MP4: isto tako. Ovaj izvoz
   ...
   izvozu. — *prepisano 25.9.2026 u novi spisak: Home — Reprodukcija snimka, stavka 1.*
3. [ ] **Ugašene oznake.** U dijalogu za izvoz snimljenog časa isključi
   elemente sa oznakama: tabla uzima ceo prostor natrag, bez praznog pojasa. — *prepisano 25.9.2026 u novi spisak: Home — Reprodukcija snimka, stavka 3.*
4. [ ] **Traka stoji (širok prozor).** U studiju, na prozoru preko 840 dp,
   skroluj kartice u donjoj polovini: „Flow / Tree / PGN" ostaje na mestu. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 2.*
5. [ ] **Traka stoji (uzak prozor).** Suzi prozor pod 840 dp, skroluj stranu
   ...
   prikačena pre nego što dođe do vrha, i to je tačno ono što je traženo. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 3.*
6. [ ] **Kartica ne prosijava kroz traku.** Dok kartica prolazi ispod trake,
   traka mora da je prekrije — bez šava i bez teksta koji se vidi kroz nju. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 4.*
7. [ ] **Uzak prozor, skrolovanje mišem.** Prevlačenje prstom/mišem **preko
   ...
   tabli. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 5.*
...
1. [ ] **Prva reč se čuje.** Film počinje sa 0,4 s tišine pa „Checkmating…".
   ...
   `LEAD_SECONDS`, ne traženje odsečenih semplova. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 4.*
2. [ ] **Ispis se završava sa glasom.** Gledaj bilo koji takt sa dužom
   ...
   a ne posle njega. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 5.*
3. [ ] **Posle glasa se ne čeka dugo.** Pauza između dva takta treba da bude
   oko sekunde, ne dve. Ako je i dalje predugo, broj je `BREATH_SECONDS`. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 6.*
4. [ ] **Film je kraći.** Isti tutorijal je po meri sa 168 s na oko 147 s, a
   ništa nije izbačeno — samo je prestalo da se dva puta plaća rep snimke. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 7.*
5. [ ] **Nemi film je nedirnut.** Izvezi isti tutorijal sa „No voice": ispis i
   dužina taktova su kao pre (dvanaest slova u sekundi, tri četvrtine takta). — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 8.*
6. [ ] **Film bez natpisa, sa glasom.** „Comments beside the board" isključeno,
   ...
   sekundi, pa se zaokružuje na celu sekundu). — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 9.*
7. [ ] **Trenerov snimak.** Izvoz sa „My recording" ide drugim putem (markeri iz
   snimanja) i ovim se ne menja — proveri da zvuk i tabla i dalje idu zajedno. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 10.*
...
1. [ ] **Dijalog se otvara odmah.** Tekst PGN-a je na ekranu čim se pritisne
   ...
   dijalog pojavljuje sa zastojem, promena nije odradila posao. — *prepisano 25.9.2026 u novi spisak: Analyse — PGN i postavka pozicije, stavka 1.*
2. [ ] **„Copied" i dalje znači kopirano.** Nalepi u Notepad odmah po otvaranju
   dijaloga: tekst treba da bude tu, isti kao na ekranu. — *prepisano 25.9.2026 u novi spisak: Analyse — PGN i postavka pozicije, stavka 2.*
3. [ ] **„Save as .pgn" otvara sistemski dijalog za snimanje**, sa ponuđenim
   imenom `analysis-2026-09-12.pgn` (današnji datum) i filterom na `.pgn`. — *prepisano 25.9.2026 u novi spisak: Analyse — PGN i postavka pozicije, stavka 3.*
4. [ ] **Fajl postoji i sadrži ono što je bilo na ekranu** — komentari,
   `[%cal]` strelice, `[%csl]` polja i sve varijante. Uporedi sa tekstom iz
   dijaloga; to je isti string. — *prepisano 25.9.2026 u novi spisak: Analyse — PGN i postavka pozicije, stavka 4.*
5. [ ] **Fajl se otvara u drugom programu.** Uvezi ga u ChessBase, Lichess
   ...
   put napolje i nazad. — *prepisano 25.9.2026 u novi spisak: Analyse — PGN i postavka pozicije, stavka 5.*
6. [ ] **Naša slova prežive.** Napiši komentar sa „š, đ, č, ć, ž", izvezi,
   ...
   vide kao smeće, čitač je taj koji ne zna UTF-8, pa reci u kom programu. — *prepisano 25.9.2026 u novi spisak: Analyse — PGN i postavka pozicije, stavka 6.*
7. [ ] **Poruka kaže gde je fajl.** Posle snimanja dijalog se zatvara i dole se
   ...
   trener traži fajl po disku. — *prepisano 25.9.2026 u novi spisak: Analyse — PGN i postavka pozicije, stavka 7.*
8. [ ] **Odustajanje ne radi ništa.** Pritisni „Save as .pgn" pa zatvori
   sistemski dijalog: nema poruke, dijalog sa tekstom ostaje otvoren. — *prepisano 25.9.2026 u novi spisak: Analyse — PGN i postavka pozicije, stavka 8.*
9. [ ] **Neuspeh se prijavi.** Ako uspeš da izazoveš grešku (npr. snimanje na
   ...
   dijalog da ostane otvoren — tekst je i dalje tu da se kopira. — *prepisano 25.9.2026 u novi spisak: Analyse — PGN i postavka pozicije, stavka 9.*
10. [ ] **Na telefonu.** Android ide drugim putem kroz plugin (fajl upisuje on,
    ...
    umesto da se seče. — *prepisano 25.9.2026 u novi spisak: Analyse — PGN i postavka pozicije, stavka 10.*
...
1. [ ] **Birač fajlova nudi `.pgn`.** „Uvezi iz fajla" → u sistemskom dijalogu
   se vide i `.json` i `.pgn` fajlovi. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — uvoz iz fajla, stavka 1.*
2. [ ] **Jedna partija, jedan tutorijal.** Uvezi fajl sa dve-tri partije:
   ...
   ne ime fajla. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — uvoz iz fajla, stavka 2.*
3. [ ] **Velika baza se preseče i to piše.** Uzmi svoj Lichess izvoz (4126
   ...
   prvih 50. Ako ništa ne piše, presek je tih — a to je greška. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — uvoz iz fajla, stavka 3.*
...
9. [ ] **Pokvaren fajl kaže šta je pokvareno.** Preimenuj neki tekst u `.pgn` i
   ...
   govori o JSON-u, ne o partiji. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — uvoz iz fajla, stavka 6.*
...
1. [ ] **Dijalog kaže kako se tutorijal deli.** Otvori tutorijal čiji se delovi
   ...
   delom na sasvim drugoj poziciji: „… 2 games". — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 52.*
2. [ ] **Rečenica o gubitku je tu i tačna** — šta deo pita, odgovor, primljeni
   ...
   tutorijalu, ne u fajlu. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 53.*
3. [ ] **Ime fajla je naslov tutorijala** (razmaci u crtice), a bez naslova
   `tutorial-2026-09-13.pgn`. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 54.*
...
8. [ ] **Izvozi se ono što je na ekranu.** Napiši novu rečenicu u delu, **ne**
   pritiskaj „Save tutorial", pa izvezi: rečenica mora da bude u fajlu. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 59.*
9. [ ] **Odustajanje ne radi ništa**, a posle snimanja se dijalog zatvara i
   piše „Saved: <putanja>". — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 60.*
10. [ ] **Traka studija i dalje staje.** Dugme je osmo u traci; na uskom
    ...
    Studio" skraćuje sa tri tačke umesto da gura dugmad van ekrana. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 61.*
...
1. [x] **„Review entire game" piše rečenice.** U Analizi pusti pregled cele
   partije: komentari moraju biti obične rečenice sa tačkom, bez „Watch out",
   „Resolved" i uspravne crte. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
2. [x] **Izmena komentara vraća štiklirane nalaze.** Na potezu sa dva nalaza
   ...
   ponovo — beleška je u slobodnom polju, nalazi i dalje štiklirani. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
3. [x] **Stari komentar ne nestaje.** Otvori analizu sačuvanu pre ovoga (sa
   „Pin: … | Resolved — …"): ceo stari tekst mora da stoji u slobodnom polju. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
4. [x] **Glas čita komentar kao govor.** Uvezi pregledanu partiju kao tutorijal
   i pusti ga: između dva nalaza mora da se čuje pauza rečenice, a ne „vertical
   bar" ili „pipe". — ✅ vlasnik, u alatu za proveru, 15.9.2026.
5. [x] **Jedan pogled šahista.** Na tri partije iz `tools/game_annotate/input/`
   pročitaj nekoliko regenerisanih komentara: viljuška navodi samo ono što može
   da osvoji, a „weak" boja polja je ona koju pešaci ne pokrivaju. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
...
1. [ ] **Dugme je tamo gde je partija.** Na Windows-u otvori partiju u Analizi
   ...
   Na poziciji bez poteza isto dugme kaže da nema poteza, i ništa se ne pokreće. — *prepisano 25.9.2026 u novi spisak: Analyse — Tutorijal iz partije, stavka 7.*
2. [ ] **Dubina sa vremenom, i zapamćena.** Izbor nudi 18 / 20 / 22 sa vremenom
   ...
   *(Od 14.9.2026 isti dijalog nosi i klizač za prag — vidi stavku 13.)* — *prepisano 25.9.2026 u novi spisak: Analyse — Tutorijal iz partije, stavka 2.*
3. [ ] **Napredak govori istinu.** Posle nekoliko pozicija piše „N of M
   ...
   jednom-dvaput. Uporedi ukupno vreme sa tabelom faze 0 (dubina 18: 39–109 s). — *prepisano 25.9.2026 u novi spisak: Analyse — Tutorijal iz partije, stavka 8.*
4. [x] **Odustajanje gasi motor.** Tokom analize pritisni Cancel: dijalog piše
   ...
   već analizirane pozicije se ne traže ponovo (brojač skače brzo). — ✅ vlasnik, u alatu za proveru, 15.9.2026.
5. [ ] **Dva tutorijala, jedan otvoren.** Na kraju se nudi „Key moments" i
   ...
   koja se mogu rešiti na tabli. Ako je nešto „to check", lista je razumljiva. — *prepisano 25.9.2026 u novi spisak: Analyse — Tutorijal iz partije, stavka 9.*
6. [ ] **Sa arhive u Analizu.** U arhivi otvori grešku („Mistake drill") i
   ...
   (`e1h1`) mora da se odigra do kraja. — *prepisano 25.9.2026 u novi spisak: Practise — My mistakes, stavka 4.*
7. [ ] **Svako odbijanje je rečenica.** (a) Bez Stockfish-a: poruka i dugme koje
   ...
   analize: posle buđenja nastavlja, ne javlja grešku motora. — *prepisano 25.9.2026 u novi spisak: Analyse — Tutorijal iz partije, stavka 10.*
8. [x] **Ime igrača ne izlazi sa uređaja.** Uz partiju sa pravim imenima u
   zaglavlju, u logu servera (ili u zahtevu) partija ide samo kao potezi. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
...
9. [x] **Tabla se ne okreće usred tutorijala.** Napravi tutorijal: **svaki** deo
   ...
   okreće se u studiju ili u „Preview tutorial" — stavke 18 i 19.)* — ✅ vlasnik, u alatu za proveru, 15.9.2026.
10. [x] **Odgovor ne kaže isti potez dvaput.** U delu sa odgovorom uvodna
    ...
    počinjale isto („White should have played Qe3…"). — ✅ vlasnik, u alatu za proveru, 15.9.2026.
11. [x] **Povratak na partiju se kaže.** Posle svake sporedne linije sledeći deo
    ...
    nema). — ✅ vlasnik, u alatu za proveru, 15.9.2026.
12. [ ] **Linija ne staje usred žrtve.** Nađi deo u kom najbolja linija nešto
    ...
    pokrenula popravku — „beli je bolji a ne vidi se zašto". — *prepisano 25.9.2026 u novi spisak: Analyse — Tutorijal iz partije, stavka 11.*
13. [x] **Prag i broj grešaka.** (a) U prvom dijalogu klizač „Teach a move that
    ...
    preostalih tutorijala je isti kao pre. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
14. [ ] **Kritičan momenat i rekapitulacija.** U „Whole game" **poslednji** deo
    ...
    momenat zaista onaj na kom se partija prelomila. — *prepisano 25.9.2026 u novi spisak: Analyse — Tutorijal iz partije, stavka 12.*
15. [ ] **Drugi najbolji potez.** Tamo gde najbolja linija nešto žrtvuje, posle
    ...
    zaseban deo, a ne varijanta. — *prepisano 25.9.2026 u novi spisak: Analyse — Tutorijal iz partije, stavka 13.*
16. [ ] **Reči na novim delovima.** Pošto su dodati novi slotovi, proveri da
    ...
    pozivu model piše sve ponuđene slotove. Ako ih ima mnogo, to je nalaz. — *prepisano 25.9.2026 u novi spisak: Analyse — Tutorijal iz partije, stavka 14.*
...
17. [x] **Uzimanje nazad nije „figura bez odbrane".** U partiji sa razmenom
    ...
    („Review entire game" ili novi tutorijal), jer su stari komentari sačuvani. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
18. [x] **Flip u studiju okreće sve delove.** U studiju sa tutorijalom od više
    ...
    otvaranja. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
19. [x] **„Preview tutorial" okreće jedan deo.** U pregledu dugme sa strelicama
    ...
    potezima). Kod učenika tog dugmeta nema, a flip ispod table je samo pogled. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
20. [x] **Za učenike ili za video.** U poslednjem dijalogu („The same words made
    two tutorials") izbor „For students" / „For a video". Za video broj delova
    se odmah smanjuje, a otvoreni tutorijal nema nijedan deo sa pitanjem; ništa
    se ne plaća ponovo. Za učenike je kao do sada. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
...
1. [ ] **Prvi dijalog.** „Make a tutorial" iz Analysis: nema više klizača
   ...
   imao 18). Izaberi drugu dubinu, zatvori, otvori ponovo: pamti je. — *prepisano 25.9.2026 u novi spisak: Analyse — Tutorijal iz partije, stavka 2.*
2. [ ] **Tok.** Posle analize se vidi korak „Checking which moves are
   mistakes, the way a game review does." — *prepisano 25.9.2026 u novi spisak: Analyse — Tutorijal iz partije, stavka 3.*
3. [ ] **Drugi dijalog.** „What the engine found": „N mistakes and M moves
   ...
   partiji bez grešaka: „Nothing to teach from at depth 20", Write ugašen. — *prepisano 25.9.2026 u novi spisak: Analyse — Tutorijal iz partije, stavka 4.*
4. [ ] **Iste greške kao pregled.** Na istoj partiji „Review entire game" sa
   ...
   8 momenata). — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 36.*
...
1. [ ] **Pokretanje.** `pokreni.ps1` → `[5] Tablebase`: otvori se tab i u njemu
   `added … tables from D:\syzygy\3-4-5`, bez greške. — *prepisano 25.9.2026 u novi spisak: Server i alati — Server, stavka 9.*
2. [ ] **Pregled sa dugom završnicom.** U Analysis otvori svoju partiju koja
   ...
   delu primetno brži nego ranije. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 33.*
3. [ ] **Kad naše tabele ne rade.** Zatvori tab sa tablebase-om i ponovi
   ...
   Lichess`. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 1.*
4. [ ] **Telefon.** Isto na telefonu, prijavljen, sa backendom na mreži:
   pregled pita server (u logu backenda se vide pozicije), ne Lichess. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 2.*
...
1. [ ] **Kućica.** U „Review entire game" kućica „Comment key moments with AI"
   ...
   nije štiklirana. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 3.*
2. [ ] **Komentari u partiji.** Partija sa greškom (najbolje online, sa `%clk`),
   ...
   koji je bio jedini dobar i nađen — rečenica, bez oznake. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 4.*
3. [ ] **Tvoj komentar ostaje.** Napiši svoj komentar na potez koji će biti
   označen, pa ponovi pregled sa kućicom: tvoj komentar je isti. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 5.*
4. [ ] **Nijedan potez koji ne postoji.** Pročitaj komentare: nijedan ne
   ...
   ga model napisao, aplikacija ga odbija — ispod piše „N comments left out".) — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 6.*
5. [ ] **Zagonetke dobijaju objašnjenje.** Isto sa „Extract puzzles" + kućica,
   ...
   rečenica objašnjenja. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 35.*
6. [ ] **Kad ne ide.** Na nalogu bez Premium plana (ili sa ugašenim serverom)
   ...
   `[REVIEW-WORDS]`). — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 7.*
...
1. [ ] **Čuvanje.** „Review entire game" sa zagonetkama na partiji sa
   ...
   nemaju linije — pokazuju samo „Correct" / „Not quite", kao ranije.) — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 8.*
2. [ ] **Pre poteza ništa.** U Library → „Solve" na jednoj: vidi se samo
   ...
   nigde se ne pominje potez iz partije. — *prepisano 25.9.2026 u novi spisak: Practise — Svoji zadaci i domaći, stavka 3.*
3. [ ] **Pogrešan odgovor.** Odigraj pogrešan potez: ispod presude pločice
   ...
   zadatka. Na Windows-u i strelice na tastaturi. — *prepisano 25.9.2026 u novi spisak: Practise — Svoji zadaci i domaći, stavka 4.*
4. [ ] **Tvoj potez.** Ako je tvoj pogrešan potez baš druga linija engine-a,
   ...
   this move." — nikad tuđa linija ispod tvog poteza. — *prepisano 25.9.2026 u novi spisak: Practise — Svoji zadaci i domaći, stavka 5.*
5. [ ] **Tačan odgovor** na drugoj zagonetki: iste pločice, bez rečenice o
   tvom potezu. — *prepisano 25.9.2026 u novi spisak: Practise — Svoji zadaci i domaći, stavka 6.*
6. [ ] **Na telefonu**, 360 dp uspravno: sve pločice i traka se čitaju cele. — *prepisano 25.9.2026 u novi spisak: Practise — Svoji zadaci i domaći, stavka 7.*
...
1. [ ] **Strana i za zagonetke.** U „Review entire game" uključi samo
   ...
   Izaberi svoju boju — sve nađene zagonetke su tvoji potezi. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 9.*
2. [ ] **Pozicija pre greške.** U listi posle pregleda sličica je pozicija
   *pre* tvog lošeg poteza, red kaže potez („23. Qe7 · lost N") i „Answer: …". — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 10.*
3. [ ] **Manje, ali jasnih.** Zagonetki je manje nego ranije; pogledaj dve —
   ...
   podjednako dobrih. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 11.*
4. [ ] **Jedini potezi posebno.** Ako ih ima, ispod naslova „Only moves the
   player found", bez kvačice; „Keep" broji samo označene. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 12.*
5. [ ] **Sačuvan zadatak.** Sačuvaj jednu grešku i jedan jedini potez. U
   ...
   „The player found the only good move here. Find it." — *prepisano 25.9.2026 u novi spisak: Practise — Svoji zadaci i domaći, stavka 1.*
6. [ ] **Bez zagonetki kaže to.** Pregled čiste partije sa uključenim
   zagonetkama završava sa „No puzzle found in this game." — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 13.*
7. [ ] **Trajanje na telefonu.** Pregled sa zagonetkama traje malo duže nego
   ...
   vremena za istu partiju. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 14.*
...
1. [ ] **Nema klizača u pešacima.** U „Review entire game" više nema
   „Blunder threshold: N pawns". — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 15.*
2. [ ] **Prozor se zatvara, pregled ide dalje.** Pokreni pregled (Blunder
   ...
   review done", gde god da si — a u partiji u Analysis su `??` oznake. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 16.*
3. [ ] **Ponovo otvoren, pokazuje isti pregled.** Tokom rada ponovo otvori
   ...
   Posle kraja pokazuje rezultat dok ne klikneš Close; zagonetke se tu čuvaju. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 17.*
4. [ ] **Kraj kaže brojeve.** Na kom broju dubine pregled stoji, koliko je
   ...
   bez greške: „No mistake found at depth N." — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 18.*
5. [ ] **Motor je zauzet, i to se kaže.** Dok pregled radi, u Analysis uključi
   ...
   pregled završi, Analysis ponovo računa sam. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 34.*
6. [ ] **Izlazak iz Analysis ne kvari pregled.** Pokreni pregled, pa pređi na
   ...
   šetanja). — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 19.*
7. [ ] **Cancel.** Cancel zatvara prozor; posle par sekundi engine je slobodan,
   nema oznaka ni poruke „Game review done". — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 20.*
8. [ ] **Promenjena partija.** Pokreni pregled, zatvori prozor, učitaj drugu
   ...
   oznake nisu upisane — a nova partija je netaknuta. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 21.*
9. [ ] **Odjava usred pregleda.** Pokreni pregled, odjavi se, prijavi (ili
   drugi nalog): nema poruke „Game review done" i nema oznaka u nacrtu. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 22.*
...
1. [ ] **Drugi put brzo.** „Review entire game" na jednoj partiji (Blunder
   ...
   treba da prođe za par sekundi, sa istim `??` oznakama. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 23.*
2. [ ] **I posle restarta.** Zatvori aplikaciju, otvori, ponovi pregled iste
   partije: opet par sekundi — odgovori su na disku, ne u memoriji. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 24.*
3. [ ] **Plića dubina od dublje.** Pregled na dubini 20 posle pregleda na 22:
   ...
   kao prvi put. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 25.*
4. [ ] **Odjava briše.** Odjavi se i prijavi (ili drugi nalog): isti pregled
   traje kao prvi put. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 26.*
...
1. [ ] **Bez izbora nema starta.** Kad se otvori, Blunder Alert i zagonetke su
   ...
   or puzzles — without either, the review has nothing to show." — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 27.*
2. [ ] **Jedno je dosta.** Uključi samo jedno od dvoje — dugme se pali,
   rečenica nestaje. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 28.*
3. [ ] **Tekst ne obećava komentare.** Uvodna rečenica kaže da pregled ne piše
   komentar pod potez i upućuje na „Generate AI comment". — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 29.*
4. [ ] **Kraj kaže šta je nađeno.** Posle pregleda: „Done — reviewed N
   positions." i „Tagged N blunders." — a u partiji su `??` oznake na tim
   potezima. — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 30.*
...
1. [x] **Suđenje.** Practise → My games → „View opening leaks" (Beli):
   ...
   ih ima, koliko nije moglo da se presudi ili koliko je server odbio. — ✅ vlasnik, u alatu za proveru, 25.9.2026.
2. [ ] **Presude.** Pod označenim pozicijama, za svaku naviku: „Your move holds —
   ...
   24.9. skoro sve označene pozicije treba da kažu „holds" (82 od 84). — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 1.*
3. [ ] **Skrivene navike.** Odeljak „Losing habits your score doesn't show":
   ...
   Otvori dve i proveri u Analysis da li je bolji potez zaista bolji. — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 2.*
4. [ ] **Ponovo.** Pritisni dugme još jednom: ne treba da traje ponovo (sve je
   već presuđeno na dubini 20) — poruka „Judged 0 moves.". — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 3.*
5. [ ] **Crni i Cancel.** Prebaci na Crne, pokreni pa posle nekoliko pozicija
   **Cancel**: staje, a ono što je poslato ostaje (ponovni ulazak pokazuje
   presude za te pozicije). — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 4.*
6. [ ] **Bez engine-a.** Na telefonu (ili bez preuzetog engine-a) dugme je
   sivo i piše zašto. — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 5.*
7. [ ] **U dril** (faza 9.4). Ispod navika dugme „Drill these N losing
   ...
   Ponovni pritisak: „N were already there." — ništa dvaput. — *prepisano 25.9.2026 u novi spisak: Practise — My games — arhiva, izveštaj o otvaranjima, profil, stavka 6.*
...
1. [x] **Fritz knjige.** Teach → Scan a book, redom `7809.pdf`,
   ...
   knjigom. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
2. [x] **Knjiga bez mape.** `Grandmaster-Codex-Complete.pdf` (table nacrtane
   ...
   pregledu, isečene čisto. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
3. [x] **Čitanje.** Postavi kalibraciju (dve-tri table dok tabela figura nije
   puna), pročitaj ostale: pozicije tačne, sumnjiva polja označena. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
4. [x] **Knjiga sa slikama se ne menja.** `1001_Winning_Chess…pdf` radi kao
   pre (stavke 225–229), bez vidljivog usporenja. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
5. [ ] **New In Chess.** `9087.pdf` iz `D:\chess\pdf_books`: skener ga vodi
   ...
   celoj knjizi; na strani 3 početna pozicija, na strani 4 `2r1k2r/…`). — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 12.*
...
1. [x] **Play na kartici.** Biblioteka → Exercises → tvoj zadatak „Win" /
   ...
   „Side to move not set". — ✅ vlasnik, u alatu za proveru, 23.9.2026.
2. [x] **Pobeda.** Odigraj „Win" do mata: „Goal met". Na Practise se kartica
   „My exercises" ne menja (partije nisu u redu za rešavanje), ali je pokušaj
   upisan. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
3. [x] **„Draw or better" za N poteza** sa malo figura: posle N poteza sud
   daje tablebase — „Goal met" ili „Goal not met". Ako tablebase ne odgovori:
   „Not judged yet" i rečenica da partija nije uračunata. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
4. [x] **„Play N moves".** Posle N poteza piše „Played", i nigde se ne pominje
   trener. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
5. [x] **Domaći se ne dira.** Ista partija kao domaći i dalje ide treneru kao
   pre; sama odigrana ne menja nijedan domaći. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
...
1. [x] **Review entire game** sa uključenim „Extract puzzles…": posle
   ...
   partija ima, inače „Game of dd.mm.yyyy") i „Keep N as exercises". — ✅ vlasnik, u alatu za proveru, 23.9.2026.
2. [x] **Čuvanje.** Odštikliraj jednu i sačuvaj: poruka „Kept N exercises";
   u Biblioteci pod Exercises → „From mistakes" su tačno one, sa imenom
   „…, move N", i zadatkom „White/Black just played …". — ✅ vlasnik, u alatu za proveru, 23.9.2026.
3. [x] **Rešavanje.** „Solve" na jednoj od njih: odgovor motora je tačan
   odgovor; drugi potez nije. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
4. [ ] **Poslednji potez partije** kao greška: i ona ima odgovor (motor je
   pitan još jednom), ili piše „No answer found — cannot be kept". — *prepisano 25.9.2026 u novi spisak: Analyse — Pregled partije (Review entire game), stavka 31.*
5. [x] **Nema više setova.** U Biblioteci nema čipa „Puzzle sets" (šest
   čipova), a u Analizi nema „Saved puzzle sets" među alatima. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
...
1. [x] **Posle skeniranja** poruka kaže „In the Library: …", a „View" otvara
   Biblioteku na toj knjizi (Exercises ako većina tabli ima rešenje, inače
   Positions), sa izabranim izvorom. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
2. [x] **Zadatak na mestu.** Na skeniranoj poziciji bez rešenja „Make
   ...
   kopije pod Positions. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
3. [x] **Izvor i „Needs attention".** Pod Exercises i Positions je izbor
   izvora („All sources" / ime knjige) i, kad ima takvih, „Needs attention
   (n)". Pod ostalim čipovima ih nema. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
4. [x] **Pretraga** nalazi po imenu knjige, po broju dijagrama iz knjige i po
   rečima zadatka, ne samo po naslovu. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
5. [x] **„Assign to student"** se ne vidi na nalogu bez prihvaćenog učenika; na
   trenerovom nalogu se vidi. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
6. [ ] **Telefon uspravno.** Biblioteka → Exercises: filteri i kartice se
   ...
   od ekrana i kartica nije bilo). — *prepisano 25.9.2026 u novi spisak: Practise — Svoji zadaci i domaći, stavka 11.*
...
1. [x] **Knjiga u fontu.** Position Scanner → skeniraj opseg gde knjiga ne kaže
   ...
   pokretanja **nema** predlog. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
2. [x] **Slike.** Isto na knjizi sa slikama posle kalibracije, ispod dugmadi
   „Select shown…". Tabla koja nije pozicija se ne pita. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
3. [x] **Prihvatanje.** „Set side" menja stranu i skida oznaku „check"; „Set
   ...
   („Solve", stavka 231). — ✅ vlasnik, u alatu za proveru, 23.9.2026.
4. [x] **Stop** zaustavlja posle table koja se računa; predlozi koji su stigli
   ostaju. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
5. [ ] **Telefon (font).** Posle skeniranja na telefonu table se vide, jedna
   po redu — do sada je mreža bila visoka 0 px ispod panela i zbira. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 4.*
6. [x] **Rukom okrenuta strana na fontu** se čuva kao postavljena (bez oznake
   za proveru), kao na slikama. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
7. [ ] **Merenje (§7 plana):** koliko traje ceo paket slika na dubini 16 (upiši
   broj tabli i vreme), i koliko „confident" predloga si okrenuo rukom. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 5.*
...
1. [x] **Faza 0: zadatak-partija se dodeljuje.** Biblioteka → Exercises →
   ...
   kao do sada). Sačuvaj, pošalji učeniku — stiže mu kao partija. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
2. [x] **Faza 0: samo prihvaćeni učenici.** „Assign to student" na Find
   zadatku: u listi „Student" nema nikoga ko još nije prihvatio vezu. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
3. [x] **Solve iz Biblioteke.** Na kartici svog Find zadatka (ne na poziciji,
   ...
   „Correct" ili „Not quite" sa rešenjem, i tabla više ne prima poteze. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
4. [x] **„Open" posle odgovora** vodi na ekran tog zadatka (rešenje, reči,
   oznake). — ✅ vlasnik, u alatu za proveru, 23.9.2026.
5. [x] **Practise → Tactics → „My exercises".** Kartica postoji samo ako
   ...
   osvežen. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
6. [x] **Domaći se ne menja.** Isti zadatak rešen sam ne označava ništa u
   domaćem koji ga sadrži; učenik i dalje rešava domaći kao pre. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
...
1. [x] **Biblioteka pokazuje oznaku.** Kartica takve pozicije počinje sa „Side to
   move not set · …"; pozicija sa poznatom stranom nema tu oznaku. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
2. [x] **Otvaranje.** Tap na takvu karticu pita „Who is to move?"; posle
   odgovora otvara Analysis sa tom stranom, a kartica gubi oznaku. Pozicija sa
   poznatom stranom se otvara odmah, bez pitanja. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
3. [x] **Make exercise.** Prvo pitanje, pa tek onda prozor za vežbu, i vežba je
   na odabranoj strani. „Cancel" ne otvara ništa. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
4. [x] **Add to tutorial.** Iz Biblioteke i iz Saved Positions: prvo pitanje, pa
   izbor tutorijala; deo tutorijala ima odabranu stranu. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
5. [x] **Soba.** Tap na takvu poziciju u koloni sobe pita pre nego što je stavi
   na zajedničku tablu, i tabla je na odabranoj strani. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
...
1. [ ] **Drugi korisnik dobija table.** Nalog A kalibriše knjigu (npr. Back to
   ...
   svaka sa „Set up by another user: check it against the picture". — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 13.*
2. [ ] **Ne računaju se dok se ne provere.** Na B tabela ostaje prazna dok se na
   ...
   dok ima neproverenih; posle provere tabla se pamti na B-ovom nalogu. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 14.*
3. [ ] **Samo ono što fali.** Nalog sa sopstvenom nedovršenom kalibracijom (npr.
   bez crne dame) dobija samo tablu koja to dodaje, ne sve A-ove. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 15.*
4. [ ] **Ime se ne vidi.** Nigde se ne pojavljuje ko je postavio table. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 16.*
...
1. [ ] **Knjiga sa slikama se prepozna sama.** Skener → Select PDF → Back to
   ...
   završenom kalibracijom). Nigde se ne pitaju strane pre kalibracije. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 17.*
2. [ ] **Knjiga u fontu ide kao pre.** Knjiga sa dijagramima u šahovskom fontu
   ...
   i „Scan", kao ranije. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 18.*
3. [ ] **Strane.** „Choose the pages to read": 60 do 50 kaže „The last page is
   ...
   šalje; 1 do 40 čita. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 19.*
4. [ ] **Ažuriranje kalibracije.** Na izboru strana „Update the calibration"
   otvara tabelu sa zapamćenim tablama; „Done — choose pages" vraća na strane. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 20.*
5. [ ] **Druge strane.** Posle čitanja, dole „Other pages" vraća na izbor
   strana bez diranja kalibracije; na telefonu (360) oba dugmeta stanu. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 21.*
6. [ ] **Nazad na skener.** Izađi iz kalibracije: skener pokazuje „The diagrams
   in this book are pictures" i „Continue", bez polja za strane. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 22.*
...
1. [x] **Prazna tabela.** Nova knjiga sa slikama (ili „Improve the calibration"
   ...
   dok ne pritisneš to dugme. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
2. [x] **Listanje knjige.** „Find a board in the book" otvara prozor „Choose a
   ...
   these pages." Tabla koju si već izabrao je bleda i ne može se izabrati ponovo. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
3. [x] **Tabela prati table.** Izaberi tablu i postavi je: ćelije te figure
   ...
   figura nije viđena ni na jednoj boji polja. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
4. [x] **„Adds".** Na drugoj i sledećim tablama piše šta dodaju; tabla koja ne
   dodaje ništa kaže „Shows nothing the other boards do not." i ima „Remove". — ✅ vlasnik, u alatu za proveru, 23.9.2026.
5. [x] **Tabla sa bilo koje strane.** Na Silmanu nađi damu (ili šta tabela
   traži) daleko od strana koje čitaš; posle „Read" čitanje radi, i ta tabla je
   zapamćena sa ostalima (sledeće skeniranje čita odmah). — ✅ vlasnik, u alatu za proveru, 23.9.2026.
6. [ ] **„No … in this book".** Čim je jedna tabla postavljena, ispod rečenice
   ...
   topovi, pešaci): šest dugmadi, sva uključena, i „Read" radi. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 23.*
7. [ ] **Popravka kalibracije.** Na ekranu pročitanih tabli „Improve the
   ...
   ponovo. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 24.*
8. [ ] **Figura koju skener nikad nije video.** Stara kalibracija bez neke
   ...
   prolazilo neoznačeno). — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 25.*
9. [ ] **Kalibracija se pamti dok se postavlja.** Postavi jednu ili dve table
   ...
   pamti šest „No …" i ne pita ponovo. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 26.*
10. [ ] **Listanje ne troši skeniranja.** Prelistaj knjigu kroz desetak prozora
   ...
   time". — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 27.*
...
1. [x] **Kalibracija ostaje.** Skener → knjiga sa slikama → „Read the pictures" →
   ...
   dugme „Edit"). Isto za sve tri; zatim „Read 3 boards" čita knjigu. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
2. [x] **Velika knjiga.** Silman (preko 25 MB) se sada skenira; granica je 100 MB. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
3. [x] **Fritz font.** `D:\chess books\pawnvsking.pdf`, strane 1–21 → „Scan".
   Umesto poruke o slikama dolazi 16 pozicija (kraljevi i pešaci), 14 sa brojem
   dijagrama; prva, sa strane 13: crni kralj e8, beli kralj f6, beli pešak e5. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
4. [x] **Brisanje bez poruke.** Obriši nekoliko snimaka zaredom (Library i Home),
   ...
   dalje stoji. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
5. [x] **Zvuk lekcije na telefonu.** Nov APK. Na telefonu (učenik, pa i trener)
   ...
   mesta na tabli. Na Windowsu i dalje radi kao pre. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
6. [x] **Tekst skenera.** Prazan ekran skenera kaže da se čitaju i dijagrami u
   fontu i dijagrami-slike; knjiga u kojoj nema ni jednog ni drugog dobija
   poruku koja to kaže, bez „only reads … chess font". — ✅ vlasnik, u alatu za proveru, 23.9.2026.
7. [x] **Brisanje pozicije i vežbe.** Library: kartica pozicije ima kantu
   ...
   učenik. Kad se domaći završi ili povuče, brisanje prolazi. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
8. [x] **Tutorijal sa videom.** Brisanje tutorijala koji ima video: dijalog kaže
   ...
   kolone; tamo pozicija pita „Delete position?", ne „Delete tutorial?". — ✅ vlasnik, u alatu za proveru, 23.9.2026.
9. [x] **Brisanje partija.** My games: na kartici igrača kanta; dijalog kaže
   ...
   porukom. Ponovni uvoz ih vraća. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
10. [ ] **Greška iz drila.** Mistake drill: „Remove from drill" pita, pa
    prelazi na sledeću grešku; ta se više ne vraća. Partija ostaje u arhivi. — *prepisano 25.9.2026 u novi spisak: Practise — My mistakes, stavka 3.*
11. [x] **Obaveštenja.** Zvonce: svako obaveštenje ima × i nestane; „Clear all"
    briše sva, a zahtev koji čeka odgovor ostaje. Posle zatvaranja i ponovnog
    otvaranja obrisana se ne vraćaju. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
12. [x] **Editor u skeneru ne pita ko je na potezu.** Kalibracija i „Fix" na
    ...
    se prihvata. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
13. [x] **Kartica zna knjigu.** Skeniraj Silman ili 1001 (kalibrisane 22.9):
    ...
    knjigu kartica i dalje objašnjava tri table. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
14. [x] **Kalibracija raste.** Silman: na tabli „to check" otvori editor, potvrdi
    ...
    samo štiklirana, bez editora, ne ulazi. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
15. [ ] **Strana na potezu bez Analize.** Saved Positions: na kartici bez potvrđene
    ...
    na samu poziciju i dalje prvo pita, pa otvara Analizu. — **prevaziđeno (25.9.2026):** Ekran „Saved Positions“, na koji se ova stavka odnosi, je ukinut 23.9.2026 — Biblioteka ga je u potpunosti preuzela (docs/PLAN-MATERIJAL.md, faza 3); provera strane-na-potezu za nepotvrđenu poziciju sada se radi kroz zajedničku „Who is to move?“ kapiju koju koristi Biblioteka.
16. [ ] **Filteri i izbor u skeneru slika.** Iznad tabli: „All / To check / Not a
    ...
    „Set up by you". Save onda čuva tačno njih. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 28.*
...
1. [x] **Vrata.** Position Scanner → Silman, strane 40–60 → „Scan". Umesto
   ...
   (npr. `completechesscoursexcerpt.pdf`) kartice nema, sken radi kao i pre. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
2. [ ] **Kalibracija.** „Read the pictures" → tri predložene table, svaka sa
   ...
   „Choose a different board" nudi ostale table. — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 29.*
3. [x] **Čitanje.** Posle tri table → „Read N boards" → svaka tabla kao slika
   ...
   ispravi dodirom na tablu. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
4. [x] **Pamćenje.** Isti PDF, druge strane (npr. 61–80) → posle „Read the
   pictures" nema kalibracije, ide pravo na čitanje. Isto na **drugom uređaju**
   sa istim nalogom (kalibracija je na nalogu, ne na uređaju). — ✅ vlasnik, u alatu za proveru, 22.9.2026.
5. [x] **Čuvanje.** „Save (N)" → „In Saved Positions: …". U Saved Positions:
   table čiji potez nije menjan su označene za proveru, one gde je potez
   postavljen nisu. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
6. [x] **Napomena o pogađanju.** Ako tri table ne pokazuju neku figuru na nekoj
   boji polja, iznad tabli stoji napomena koja je imenuje („a white rook on a
   light square") i nudi „Set up again". — ✅ vlasnik, u alatu za proveru, 23.9.2026.
7. [x] **Previše tabli.** *Back to Basics*, strane 41–80 (izmereno: 72
   ...
   drugom porukom.) — ✅ vlasnik, u alatu za proveru, 22.9.2026.

## 224. Skener na Teach — 22.9.2026, nije viđeno uživo

**Samo aplikacija** (nov build, server bez izmena).

1. [x] **Kartica postoji.** Teach: pored „Preparation" i „New session" stoji
   „Scan a book" sa dugmetom „Scan"; na širokom prozoru sve tri u jednom redu,
   iste visine; na telefonu jedna ispod druge, „Scan a book" poslednja. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
2. [x] **Vodi u skener.** „Scan" otvara ekran skenera; „Back" vraća na Teach. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
3. [x] **Stara vrata rade.** U Analizi „Scan a book" (na telefonu iza ⋮) i
   dalje otvara isti ekran. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
...
1. [x] **Dupli klik.** Teach → New session → „Start" dvaput što brže. Otvara se
   jedan ekran sobe; „Back" vodi na Teach, ne u drugu sobu. Na Home učenika je
   jedna sesija tog trenera. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
2. [x] **Dugme čeka.** Dok soba ne odgovori, „Start" je sivo sa kružićem (vidi
   se najlakše sa ugašenim serverom: posle poruke o grešci dugme je ponovo
   „Start"). — ✅ vlasnik, u alatu za proveru, 22.9.2026.
3. [x] **Druga kopija na Windowsu.** Pokreni Mislisha dok je već otvorena
   (prečica, ili dvaput `Mislisha.exe`). Nova kopija se ne otvara; postojeći
   prozor dođe napred, i ako je bio minimizovan — vrati se. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
4. [x] **Posle zatvaranja.** Zatvori aplikaciju, pokreni je ponovo — otvara se
   normalno. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
...
1. [x] **Library → Recordings.** Na kartici snimka pored „Play" je crvena kanta;
   pita „Delete recording?", „Cancel" ne briše ništa, „Delete" skida karticu i
   kaže „Recording deleted.". Posle „Refresh" snimak se ne vraća. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
2. [x] **Home → Recordings.** Isto na svom snimku; na snimku koji je trener
   podelio sa tobom (nalog učenika) kante nema. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
3. [x] **Kod učenika nestaje.** Snimak koji je bio podeljen sa učenikom posle
   brisanja više nije u njegovoj listi. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
4. [x] **Zvuk je obrisan.** Pre brisanja zapiši ime fajla (najnoviji
   `lesson_<id>_….wav` u `chess_backend/uploads/lessons/`); posle brisanja tog
   fajla više nema, a ostali snimci se i dalje puštaju sa zvukom. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
...
1. [ ] **Nema panela.** U Analizi nema „Tactical motifs" ni „Positional factors";
   ...
   Engine analysis panel — bez prekidača za automatski komentar. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 19.*
2. [x] **Potez bez komentara.** Odigraj nekoliko poteza (i jednu viljušku): nijedan
   ne dobija komentar sam od sebe. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
3. [x] **Urednik je tekst.** „Add Comment" / „Add / Edit Comment" otvara samo polje
   za tekst, bez dve liste za štikliranje; sačuvan tekst stoji ispod poteza. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
4. [x] **AI komentar radi.** „Generate AI comment" na potezu vraća rečenicu u isto
   polje za tekst, i ona se čuva na „Save". — ✅ vlasnik, u alatu za proveru, 22.9.2026.
5. [ ] **Review i Auto Analysis.** „Review entire game" stavlja oznake (?, ?!), ali
   ...
   Analysis gradi linije bez komentara. — **prevaziđeno (25.9.2026):** Od faze 3 plana docs/PLAN-ZAGONETKE-IZ-PARTIJE.md (25.9.2026) „Review entire game“ ponovo može da piše AI komentare ispod poteza, ali samo kad je uključena kućica „Comment key moments with AI“ (isključena po podrazumevanom) — ova stavka (od 22.9.2026) tvrdi da pregled nikad ne piše komentare, što više ne važi; provera opt-in AI komentara je u ovoj slici pod sekcijom 243.
6. [x] **Tutorijal iz partije** i dalje priča o motivima (viljuška, vezivanje…) kao
   do sada — oni mu stižu iz Review-a, ne sa table. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
...
1. [x] **Klizači rade mišem.** Board view → Board size (Preparation i Analiza),
   ...
   ga vuče, a iznad palca se vidi broj dok se vuče. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
2. [x] **Izgledaju prihvatljivo.** Traka, palac i podeoci na klizačima sa
   koracima; isključen klizač je siv. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
3. [x] **Tastatura.** Tab do klizača, strelice levo/desno pomeraju ga za jedan korak. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
4. [x] **Težina u domaćem i u Create assignment.** Umesto dvostrukog klizača:
   „From [−] 1200 [+]  To [−] 1800 [+]", korak 100, 400–2800. „From" ne može preko
   „To" (dugme se isključi), a poslati domaći nosi baš te brojeve. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
5. [x] **Build za izdanje.** Isto kao gore u release buildu (`Mislisha.exe`) sa
   Narratorom: posle desetak minuta rada nema pada u Event Logu (Application,
   „Application Error", `flutter_windows.dll`). — ✅ vlasnik, u alatu za proveru, 22.9.2026.
...
1. [x] **Jedno „New session".** Teach → New session otvara sobu odmah, bez
   dijaloga za biranje prijatelja. U sobi si trener; poziv se šalje iznutra
   („Invite friends to session"). — ✅ vlasnik, u alatu za proveru, 21.9.2026.
2. [ ] **Oba u istoj sobi.** Učenik prihvati poziv → u spisku „Present in
   classroom" na oba uređaja stoje oba imena, i kôd sobe u naslovu je isti. — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 4.*
3. [x] **GLAS — ovo je glavno, i prvi put se gleda.** Oboje „Turn on voice" /
   ...
   `[AUDIO]`). Od ovog odgovora zavisi obim faze 4. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
4. [x] **„End session" završava za sve.** Trener ima „End session" (crveni
   stop), učenik „Leave session". Trener potvrdi → oba uređaja se vrate na
   Home sa „The session has ended.", a „Resume session" se ne nudi nijednom. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
5. [x] **Stari poziv nije vrata.** Posle 4, učenik otvori zvonce: na tom pozivu
   piše „This session has ended." i **nema dugmeta Join**. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
6. [x] **Nova sesija gasi staru.** Trener otvori sesiju A, učenik uđe; trener
   izađe na Home (strelica nazad, ne End) i pokrene New session → učenik u A
   dobija „The session has ended." i vraća se na Home; poziv za A više nema Join. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
7. [x] **Zapamćena mrtva soba ne blokira.** (Stanje od danas popodne.) Uređaj
   koji je pamtio staru sobu: posle otvaranja Home „Resume session" nestane sam,
   i Join na novom pozivu ulazi bez dijaloga o aktivnoj sesiji. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
8. [x] **Živa tuđa sesija se napušta pitanjem.** Učenik je u živoj sesiji,
   ...
   ulazi. *Ako nema drugog trenera, preskoči.* — ✅ vlasnik, u alatu za proveru, 23.9.2026.
9. [x] **Gosti.** Room access (ikona grupe u sobi): nema prekidača „Room allows
   guests". — ✅ vlasnik, u alatu za proveru, 21.9.2026.
10. [x] **Trainer panel** nema odeljak „Today". — ✅ vlasnik, u alatu za proveru, 21.9.2026.
11. [x] **„Leave voice" ne izlazi iz sobe** (popravka posle prve probe; restart
    ...
    trenera se menja. Isto sa zamenjenim ulogama (učenik napusti glas). — ✅ vlasnik, u alatu za proveru, 21.9.2026.
12. [x] **Poziv stiže i posle sobe.** Učenik uđe u sesiju, izađe strelicom na
    ...
    registered" za isti nalog. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
13. [x] **Soba kaže ko je tu** (faza 2, nov build). U traci sobe, ispod „Room:
    …": trener sam → peščani sat i „Nobody has joined yet"; učenik sam →
    „Waiting for the trainer"; oboje → ikona ljudi i „With <ime>". Telefon
    položen: isto, u jednom redu pored koda sobe. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
14. [ ] **Učenik pravi sesiju i zove trenera** (prijava 21.9: „trener ne dobija
    ...
    kaže zašto — a ne „successfully sent". — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 16.*
15. [x] **Nema kucanja koda** (nov build, restart servera). Na Home više nema
    ...
    poziva. Kad trener završi sesiju i učenik se vrati na Home, kartice nema. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
16. [x] **Poziv grupi.** U sobi „Invite students to session": iznad spiska su
    ...
    Telefon položen: spisak se skroluje i ime može da se štiklira. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
17. [x] **Vrata su jednosmerna.** Učenik pokrene svoju sesiju: treneru se na Home
    **ne** pojavljuje „In a session now" za nju, a u učenikovom dijalogu za
    poziv trenera nema. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
18. [x] **Jedan voditelj, dva stanja table** (faza 3; nov build, restart
    ...
    potezi rade. Nigde ne piše `host_only` ni „Permission status". — ✅ vlasnik, u alatu za proveru, 21.9.2026.
19. [x] **Trener otvara sobu sa belima dole**, učenik sa crnima — bez ručnog
    okretanja. (Od „New session" je trener otvarao sa crnima dole.) — ✅ vlasnik, u alatu za proveru, 21.9.2026.
20. [x] **Nema unapređivanja.** U spisku „Present in classroom" pored učenika
    nema menija ⋮ („Promote to Host" / „Demote to User"). — ✅ vlasnik, u alatu za proveru, 21.9.2026.
21. [x] **„Grant / Revoke microphone" stiže učeniku u sobi** (faza 4, samo
    ...
    radi. (Do sada poruka nije stizala dok je učenik u sobi.) — ✅ vlasnik, u alatu za proveru, 21.9.2026.
22. [x] **Glas koji ne krene kaže zašto** (faza 4, aplikacija; nov build).
    ...
    samo vratio na „off" bez reči — ili se vrteo beskonačno. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
23. [x] **„*Ime* is in voice — Join voice".** Trener uključi glas, učenik ne.
    ...
    stoji). Kod trenera trake nema dok je sam u glasu. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
24. [x] **Traka nestaje kad poslednji izađe** (traži server — tačka 27).
    ...
    poslednje ime ostajalo na ekranu dok se soba ne zatvori. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
25. [x] **Glas preživi restart servera.** Oboje u glasu; restartuj server
    ...
    „[Trainer]" — bez ponovnog pritiskanja dugmeta. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
26. [x] **Windows bez mikrofona.** Na Windowsu isključi mikrofon (Device
    ...
    dugmad ostaju. Priključi mikrofon i uđi ponovo: poruke nema. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
27. [x] **Kratak prekid veze ne skida nikoga sa spiska** (server). Učenik u
    ...
    brisao mesto koje je novi već zauzeo.) — ✅ vlasnik, u alatu za proveru, 22.9.2026.
28. [x] **Soba se ne snima** (faza 5a; nov build, restart servera). Trener sam
    ...
    „End session" ne pitaju ništa o snimku („Recording in progress" ne postoji). — ✅ vlasnik, u alatu za proveru, 22.9.2026.
29. [x] **Stari snimci su tu.** Home → Recordings (i Library na Teach): snimci
    od ranije se otvaraju i puštaju, razmaknica pušta i pauzira, a dugme videa
    („Export to MP4 Video")
    pravi video kao pre. U `chess_backend/uploads/` ništa nije nestalo. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
30. [x] **Traka sobe** (faza 6; nov build, restart servera). Telefon uspravno,
    ...
    „Session", i vrata umesto stopa. Proveri i položeno i na Windowsu. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
31. [x] **Ikona glasa kaže stanje.** Isključen glas → precrtane slušalice;
    ...
    Classroom". — ✅ vlasnik, u alatu za proveru, 22.9.2026.
32. [x] **Panel Session.** Trener dodirne klizače: „Present in classroom" sa
    ...
    pojavi bez zatvaranja panela. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
33. [x] **Učenik odgovara ispod table.** Telefon uspravno: odmah ispod table
    ...
    isto, na vrhu kolone pored table. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
34. [x] **Učenik nema motor.** U sobi učenik nema panel „Engine" ni traku
    ocene; trener ima oba. U panelu Session nema „Allow Stockfish for
    student". — ✅ vlasnik, u alatu za proveru, 22.9.2026.
35. [x] **Spuštena ruka.** Učenik u glasu, utišan: „Raise hand to speak" →
    kod trenera obaveštenje; zatim „Lower hand" → dugme se vrati na „Raise
    hand to speak", i sledeće podizanje opet javlja treneru. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
36. [x] **Nema „Mute all students".** Trener utišava učenike jednog po jednog,
    ikonom zvučnika u njihovom redu u panelu „Voice". — ✅ vlasnik, u alatu za proveru, 22.9.2026.
37. [x] **Snimanje u Preparation** (faza 5b; nov build, restart servera —
    ...
    ne počinje. Punoletan: ispod trake traka sa satom, Pause, Stop, Discard. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
38. [x] **Glas i tabla zajedno.** Snimi par minuta: pričaj, učitaj poziciju iz
    ...
    je tačno. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
39. [x] **Video lekcije.** U plejeru „Export to MP4 Video": video prati tablu
    kroz učitane pozicije i korake, glas je ceo. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
40. [x] **Ne izlazi se usred snimanja.** Dok snima, strelica nazad ne izlazi i
    piše „Stop or discard the recording first."; posle Discard izlazi.
    Isključi mrežu pa Save: „Try again" posle uključivanja pošalje lekciju. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
41. [ ] **Deljenje.** U plejeru svoje lekcije „Share with students…": čipovi
    ...
    sobe dugmeta za deljenje nema. — *prepisano 25.9.2026 u novi spisak: Home — Reprodukcija snimka, stavka 4.*
42. [x] **Video za učenika.** Učenik u plejeru „Download video": pre nego što
    ...
    učenik nema. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
43. [x] **Deljenje prestaje sa vezom.** Kad trener ukloni učenika, lekcija
    nestaje sa učenikovog Home → Recordings; skidanje svih kvačica u
    „Share with students…" isto. — ✅ vlasnik, u alatu za proveru, 22.9.2026.
...
1. [x] **Telefon: motor radi.** Analyse → uključi motor na početnoj poziciji:
   pojavljuju se tri linije i ocena, dubina raste kao ranije. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
2. [x] **Telefon: pozicija koju 19 ne prima ne gasi aplikaciju.** Analyse →
   ...
   otvorena. Isto sa `4k3/8/8/8/8/8/8/4K3 w - - 40000 1`. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
3. [x] **Windows: „Download engine" radi.** Settings → motor → preuzimanje:
   završi se bez greške, a u logu piše `stockfish-windows-x86-64-universal`.
   (Do sada je od 5.9.2026 svaki pokušaj bio 404.) — ✅ vlasnik, u alatu za proveru, 21.9.2026.
4. [x] **Poredjenje 18 i 19** (po želji vlasnika): isti položaji na telefonu,
   dubina i brzina (`nps`) u oba builda. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
...
1. [x] **Čip grupe.** Teach → Homework → neki domaći → „Send": iznad liste
   učenika stoje čipovi grupa. Pritisak na grupu štiklira njene članove koji
   su prihvatili poziv, i samo njih. Ponovni pritisak ih odštiklira. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
2. [x] **Ko nije prihvatio** se ne štiklira, i ispod čipova to piše imenom. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
3. [x] **Ko već ima taj domaći** ima u listi „already has it", a čip ga
   **ne** štiklira (piše i to, imenom). Pošalji grupi, dodaj nekog u grupu,
   pa pošalji opet: dobija ga samo novi član, a ostali ne dobijaju drugu kopiju. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
4. [x] **Ručno se i dalje može** štiklirati i onaj ko ga već ima, ako se to
   hoće namerno. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
5. [x] **Isto ime analize.** Analyse → sačuvaj analizu pod imenom koje već
   ...
   otvorena ima nove poteze. „Keep both" pravi drugu, kao ranije. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
6. [x] **Isto iz Preparation** („Save analysis" u sobi): isto pitanje. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
7. [x] **Soba koju je otvorio učenik** (Windows, širok prozor, i telefon):
   ...
   „Make exercise" i akcije tutorijala. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
8. [x] **Trener otvori sobu pre nego što učenik udje**: „Make exercise" je tu od
   početka. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
9. [x] **Učenik u trenerovoj sobi**: nema „Make exercise" ni akcija tutorijala. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
10. [x] **Preparation** je nepromenjena: sve je tu. — ✅ vlasnik, u alatu za proveru, 23.9.2026.
...
1. [x] **Potez ostaje na tabli.** Preparation, postavi poziciju, „Make
   ...
   tabla ne prima potez. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
2. [x] **Pa se vraća i traži alternativu.** Posle dve sekunde tabla je opet na
   početnoj poziciji i piše „Play another move that should also count, or
   Save.". Odigraj alternativu: isto, sa „… is accepted as well.". — ✅ vlasnik, u alatu za proveru, 21.9.2026.
3. [x] **Odbijen potez se ne zadržava.** Odigraj isti potez drugi put: tabla se
   odmah vraća i crveno piše zašto. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
4. [x] **Rešenje ima ×.** Ispod linije je i rešenje kao čip „Qh5 · answer" sa ×.
   Skini ga: prva alternativa postaje rešenje (linija piše samo nju). Skini i
   nju: ekran opet traži potez, a „Save" je sivo. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
5. [x] **„Start over" i dalje briše sve odjednom.** — ✅ vlasnik, u alatu za proveru, 21.9.2026.
6. [x] **Sačuvan zadatak.** Library → „Exercises" → svoj „Find the move"
   ...
   rešenje je ono novo. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
7. [x] **Telefon, uspravno i položeno**: čipovi i rečenice staju, ništa se ne
   seče. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
...
1. [x] **Brisanje seta zagonetki iz Biblioteke.** Teach → Library → čip
   ...
   set deleted.". — ✅ vlasnik, u alatu za proveru, 21.9.2026.
2. [ ] **Važi svuda** (ovo je bila stavka 211.4). Posle brisanja na jednom
   uredjaju, osveži Library na drugom (isti nalog): seta nema. — **prevaziđeno (25.9.2026):** Puzzle sets (Saved puzzles) su u potpunosti ukinuti 23.9.2026 kao deo faze 4 plana docs/PLAN-MATERIJAL.md — tabela puzzle_sets, njena ruta, spremište i sinhronizacija po uređaju su obrisani; zagonetke iz „Review entire game“ se sada čuvaju kao Find zadaci u Biblioteci. Provera brisanja seta koje se ne prenosi na drugi uređaj se više ne odnosi ni na šta u aplikaciji.
3. [x] **Brisanje analize iz Biblioteke.** Čip „Analyses": na kartici je kanta,
   isto pitanje, i analiza nestaje; Analyse → ikona oblaka je više ne nudi. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
4. [x] **Server nedostupan.** Ugasi backend pa pokušaj da obrišeš set: kartica
   **ostaje**, a crvena poruka kaže da nije obrisan. Upali backend, osveži:
   ...
   učitavanju). Isto u Analizi → „Saved puzzle sets". — ✅ vlasnik, u alatu za proveru, 21.9.2026.
5. [x] **Pozicija nema „Assign".** Čip „Positions": sken iz knjige **bez**
   rešenja i pozicija sačuvana iz sobe imaju „Add to tutorial" i **„Make
   exercise"** (ikona kvačice), a nemaju „Assign to student". — ✅ vlasnik, u alatu za proveru, 21.9.2026.
6. [ ] **Zadatak i dalje ima „Assign".** Čip „Exercises": sken sa rešenjem i
   ...
   exercise". — *prepisano 25.9.2026 u novi spisak: Practise — Svoji zadaci i domaći, stavka 12.*
7. [x] **„Make exercise" sa kartice.** Otvara isti list kao „Make exercise" u
   ...
   pozicija je i dalje pod „Positions". — ✅ vlasnik, u alatu za proveru, 21.9.2026.
8. [x] **Oznake i jezik na telefonu.** Teach → Tutorials → New tutorial,
   telefon uspravno: ⋮ „More" → **„Details…"** otvara list sa „Labels" i
   „Language". Upiši oznake, izaberi jezik, „Done", sačuvaj tutorijal. U
   Library ga nalaziš po toj oznaci; na Windows-u otvoren pokazuje isti jezik. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
9. [x] **Isto položeno**, i sa otvorenom tastaturom: list se skroluje, ništa se
   ne seče. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
...
1. [x] **Windows prvo.** Otvori Library → čip „Puzzle sets". Setovi su tu kao
   i pre. *Prvo otvaranje ih tiho prebacuje na server; ništa se ne briše.* — ✅ vlasnik, u alatu za proveru, 21.9.2026.
2. [x] **Pa telefon.** Isti nalog, Library → „Puzzle sets": **sada se vide
   isti setovi**. Kucni jedan — otvara se u Analizi (to je stavka 207 A). — ✅ vlasnik, u alatu za proveru, 21.9.2026.
3. [x] **Novi set sa telefona.** U Analizi na telefonu uradi „Review entire
   game" nad nekom partijom. Set se pojavi i **na Windows-u** posle osvežavanja. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
4. [ ] **Brisanje važi svuda.** Obriši set u „Saved puzzles" na jednom
   uredjaju; posle osvežavanja ga nema ni na drugom. — **prevaziđeno (25.9.2026):** Ista promena kao 215.2: puzzle sets (Saved puzzles) su ukinuti 23.9.2026 (docs/PLAN-MATERIJAL.md, faza 4) — nema više seta koji bi se brisao ni uređaja između kojih bi brisanje moralo da se prenese.
5. [x] **Bez servera se ne gubi ništa.** Ugasi backend pa otvori „Puzzle sets"
   na Windows-u: setovi tog uredjaja se i dalje vide. *Nedostupan server ne
   sme da se pročita kao „nalog je prazan".* — ✅ vlasnik, u alatu za proveru, 21.9.2026.
6. [x] **Ne duplira se.** Otvori i zatvori Library nekoliko puta, na oba
   uredjaja: broj setova ostaje isti. *Dizanje na server ide upsert-om baš
   zbog ovoga.* — ✅ vlasnik, u alatu za proveru, 21.9.2026.
7. [x] **Stari setovi su preživeli.** Nijedan set koji si imao na Windows-u
   pre ove izmene nije nestao. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
...
1. [x] **Windows: tabela, ne kartice.** Zaglavlje sa pet kolona — **White ·
   Black · Date · Result · First moves** — i ispod njega vrste visoke oko 38
   px. Nema kartica, nema dve linije po partiji. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
2. [x] **Kolone se poklapaju.** Ime belog stoji tačno ispod „White", datum
   ispod „Date" i tako redom, na svakoj vrsti. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
3. [x] **Vidi se mnogo više partija nego ranije.** Prebroj grubo: treba da ih
   stane bar dvostruko više nego pre (bilo je oko osam). — ✅ vlasnik, u alatu za proveru, 21.9.2026.
4. [x] **Potezi bez satova.** U koloni „First moves" piše `1. e4 c5 2. Nf3…`,
   **nigde** `{ [%clk 0:03:00] }`. *Ovo je popravljeno u fazi 1b, koju još
   nisi video — build koji si testirao 20.9. je stariji od nje.* — ✅ vlasnik, u alatu za proveru, 21.9.2026.
5. [x] **Filter po rezultatu.** Ispod pretrage stoje čipovi **All · 1-0 · ½-½
   · 0-1**. Pritisni „1-0" — ostaju samo partije koje je beli dobio. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
6. [x] **Filter i pretraga rade zajedno.** Upiši ime u pretragu pa pritisni
   čip: lista se suzi po **oba**, ne samo po čipu. Isključi čip („All") —
   vraća se ono što pretraga daje. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
7. [x] **Brojač u naslovu prati.** „… — N of 4126" se menja i sa pretragom i
   sa čipom. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
8. [x] **Klik na vrstu bira partiju** i dijalog se zatvara. Nema posebnog
   dugmeta „Izaberi" u vrsti — cela vrsta je meta, namerno. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
9. [ ] **Telefon.** Umesto tabele dve zbijene linije po partiji: „Beli vs
   ...
   tu isto. Ništa nije odsečeno. — *prepisano 25.9.2026 u novi spisak: Analyse — Choose a game, stavka 1.*
10. [x] **Dijalog je veći nego pre** na širokom prozoru (do 900 px širine),
    ali ne preko celog ekrana. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
11. [x] **Telefon na boku.** *Ovo si prijavio 21.9.2026: „ne vidi se lista
    ...
    za same partije. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
...
1. [x] **Windows, širok prozor.** Practise → Repertoire. Desno stoji okno sa
   rečenicom „Choose a repertoire to see where it starts." — ✅ vlasnik, u alatu za proveru, 20.9.2026.
2. [x] **Kucni vrstu.** U oknu: ime, red sa bojom / „via" potezom / brojem
   poteza, **linija do korena** („1. d4 Nf6 2. c4 c5 3. d5 e6"), tabla te
   pozicije, pa „Open" i „Drill". — ✅ vlasnik, u alatu za proveru, 20.9.2026.
3. [x] **Obeležena je samo jedna vrsta**, i to **okvirom** (ne bojom). — ✅ vlasnik, u alatu za proveru, 21.9.2026.
...
4. [ ] **Tabla je okrenuta ka tvojoj strani.** Za repertoar za crnog crni je
   dole. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 25.*
5. [ ] **Repertoar bez zapamćene linije** (stariji, ili napravljen iz
   nalepljene pozicije) piše „From the start" umesto izmišljenog otvaranja. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 26.*
6. [x] **„Open" otvara** taj repertoar; **„Drill"** pokreće vežbu nad njim. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
7. [ ] **Dugi pritisak i dalje bira više njih** za „Drill selected (N)", i
   dok je taj režim uključen kucanje **čekira** umesto da bira za okno. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 27.*
8. [ ] **Uzak prozor.** Suzi do najmanjeg — kucanje na vrstu opet **otvara**
   repertoar, okna nema. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 28.*
9. [x] **Telefon.** Sve kao i pre: jedna kolona, kucanje otvara. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
10. [ ] **Ništa se ne učitava iznova.** Biranje raznih repertoara u oknu ne
    ...
    ijednog novog zahteva ka serveru. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 29.*
...
1. [x] **Windows, širok prozor.** Teach → Library. Desno stoji okno sa
   rečenicom „Tap a board to see it here." Police su levo i i dalje pune
   kartica. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
2. [x] **Kucni sličicu.** Tabla se pojavi **u oknu**, veća, sa imenom iznad,
   rečenicom ko je na potezu (i zadatkom ako je zadatak) i dugmetom „Open".
   **Dijalog se ne otvara.** — ✅ vlasnik, u alatu za proveru, 20.9.2026.
3. [x] **Kucni drugu sličicu.** Okno pokaže tu drugu. Uvek je obeležena samo
   jedna kartica, **okvirom** (ne bojom). — ✅ vlasnik, u alatu za proveru, 20.9.2026.
4. [x] **Kucni karticu, ne sličicu.** Otvara se sama stvar, kao i pre — okno
   nije promenilo to. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
5. [x] **„Open" u oknu** otvara ono što je u oknu. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
6. [x] **Suzi prozor ispod pola ekrana.** Okno nestaje i kucanje na sličicu
   opet otvara **dijalog**, sa „Close" kao i ranije. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
7. [x] **Soba je netaknuta.** Otvori sobu (STUDIO) na širokom prozoru i u
   koloni „Library" kucni sličicu — otvara se **dijalog**, ne okno. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
8. [x] **Telefon.** Biblioteka kao i pre: jedna kolona, sličica otvara
   dijalog. — ✅ vlasnik, u alatu za proveru, 20.9.2026.

**Ovo ispod je popravka greške koja je postojala i ranije** (od faze 3b), a
faza 5 je na nju naletela:

10. [x] **Sličica na kartici je cela.** Na **Windows-u** pogledaj kartice
    ...
    48 × 48 svuda, dakle **malo manja nego pre** na telefonu.* — ✅ vlasnik, u alatu za proveru, 21.9.2026.

9. [x] **Najmanji mogući prozor.** Suzi prozor do kraja — Windows ga ne pušta
   ...
   kartici nije odsečeno. — ✅ vlasnik, u alatu za proveru, 21.9.2026.
...
1. [x] **Kucni set u Biblioteci.** Teach → Library → čip „Puzzle sets", pa
   kucni karticu. Otvara se Analiza sa **tom** zagonetkom: tabla, a dole
   poruka sa temom („🧩 fork" i slično). — ✅ vlasnik, u alatu za proveru, 20.9.2026.
2. [x] **Baš taj set.** Sa dva ili više setova kucni **drugi po redu** —
   otvara se on, ne najnoviji. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
3. [x] **Skica se ne meša.** Ako si ostavio nezavršenu analizu, otvaranje seta
   je ne vraća preko zagonetke. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
4. [x] **Telefon.** Isto radi u jednoj koloni. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
5. [x] **Prazan set.** Ako ga imaš, kucanje kaže da nema zagonetki umesto da
   otvori prazan ekran. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
...
6. [x] **Prekidač pomera broj.** Practise → Endgames → bilo koja kartica.
   Uključi „Include online games": „Selected: N positions" u dnu se **poveća**.
   Isključi: **vrati se** na staro. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
7. [x] **Kvačice preživljavaju.** Skini kvačicu sa jedne porodice, pa okreni
   prekidač: ta porodica je i dalje bez kvačice. Ne vraća se sve na početak. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
8. [x] **Broj je iskren.** Suzi izbor na nešto malo, upamti broj, pritisni
   „Start" i prodji kroz zadatke — ne sme da se desi da trening kaže da nema
   pozicija dok je pisalo da ih ima. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
9. [x] **Nivo i dalje radi** uz uključen prekidač: čip nivoa menja broj. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
...
10. [x] **Telefon položeno, soba.** Otvori sobu (STUDIO) na telefonu **na
    boku**. ☰ gore levo se pogadja iz prve, više puta zaredom. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
11. [x] **Otvara ono što je otvarao.** Iza njega je i dalje leva kolona sa
    „Library", i kucanje na tutorijal ga stavlja na tablu. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
12. [x] **Uspravno je nepromenjeno.** Isti ekran uspravno: ☰ radi kao i pre.
    *Ovo je jedino od trojeg što nije potvrdjeno merenjem nego pretpostavkom —
    ...
    dijagnozu.* — ✅ vlasnik, u alatu za proveru, 20.9.2026.
...
1. [x] **Windows, širok prozor.** Porodice stoje **dve, tri ili četiri u
   redu**, ne jedna preko celog ekrana. Na svakoj: kvačica, ime, red ispod
   („1769 positions, 13 types") i strelica za otvaranje. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
2. [x] **Zaglavlje je i dalje jedno.** „Level" sa čipovima i prekidač
   „Include online games" idu preko cele širine, **iznad** kolona — nisu
   postali jedna od kartica. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
3. [x] **Otvaranje ne pomera susede.** Otvori topovske završnice (trinaest
   oblika). Porodica koja stoji **desno od nje** ostaje tamo gde je bila,
   ne skače naniže. Otvori još jednu u drugoj koloni — isto. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
4. [x] **Ništa nije odsečeno.** Sa otvorenom najvećom porodicom suzi prozor
   ...
   upozorenja o prelivanju — seče se tiho, zato je ovo pogled a ne test.* — ✅ vlasnik, u alatu za proveru, 20.9.2026.
5. [x] **Brojevi se i dalje slažu.** Skidanje kvačice sa jedne porodice
   menja „Selected: N positions" u dnu; čip nivoa isto. „Start" je siv kad
   je sve skinuto. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
6. [x] **Telefon.** Jedna porodica u redu, kao i pre. Otvaranje topovskih
   završnica se skroluje normalno i ništa se ne preliva. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
7. [x] **Kratak prozor.** Na Windowsu smanji **visinu** prozora na otprilike
   pola pa otvori najveću porodicu: lista se skroluje, ništa se ne seče. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
...
1. [x] **Windows, Biblioteka na širokom prozoru.** Stoje **tri ili četiri
   ...
   „saved position"…) i dugmad te vrste. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
2. [x] **Suzi prozor.** Broj kolona pada sam — 4, 3, 2, pa 1. Nigde
   žuto-crnih traka i nijedno dugme nije odsečeno. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
3. [ ] **Dugmad su na svojoj kartici.** Kod tutorijala: video, pošalji, kanta
   ...
   dugme ne radi nad **susednom** karticom. — *prepisano 25.9.2026 u novi spisak: Practise — Svoji zadaci i domaći, stavka 10.*
4. [x] **Kartica nije prazna iznutra.** Sadržaj stoji uz vrh kartice; prazan
   prostor je ispod, ne između naslova i dugmadi. *Kartice su iste visine — to
   je mreža; ali kartica sa manje dugmadi ne sme da razvuče svoj sadržaj.* — ✅ vlasnik, u alatu za proveru, 20.9.2026.
5. [x] **Sličica table i pregled.** Kod zadatka i pozicije kartica vodi
   ...
   a kartica je veća meta nego stara vrsta. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
6. [x] **Čipovi, pretraga i etikete i dalje stoje iznad mreže**, i sužavaju
   je: „Exercises", pa „Win", pa upisana reč. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
7. [x] **Telefon, Biblioteka.** Jedna kolona, kao i pre. Kartica nije odsečena
   ni previsoka; dugmad stoje ispod naslova i mogu se pritisnuti. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
8. [ ] **Soba, leva kolona.** Otvori sobu (STUDIO) i pogledaj kolonu
   ...
   sa ostatkom sidebara, i kucanje na tutorijal ga i dalje stavlja na tablu. — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 17.*
9. [ ] **Prazna polica.** Bez ijedne stvari piše rečenica, a ne prazna kutija. — *prepisano 25.9.2026 u novi spisak: Practise — Svoji zadaci i domaći, stavka 13.*
...
1. [x] **Windows, spisak domaćih.** Na širokom prozoru stoje **dve ili tri
   kartice u redu**, ne jedna preko celog ekrana. Naslov, „N items", i „sent
   to M" gde je slato. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
2. [x] **Dugmad na kartici rade.** „Pošalji" otvara izbor učenika; kanta pita
   pre brisanja i piše šta brisanje **ne** dira. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
3. [x] **Suzi prozor.** Kako se prozor sužava, broj kolona pada sam — 3, pa 2,
   pa 1. Nigde žuto-crne trake. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
4. [x] **Telefon, spisak domaćih.** Jedna kolona, kao i pre. Kartica nije
   odsečena ni previsoka. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
5. [ ] **„Saved puzzles" na Windows-u, sa VIŠE skupova.** Dijalog je **širi
   ...
   i „Open". — **prevaziđeno (25.9.2026):** „Saved puzzles“ dijalog (puzzle sets) je u potpunosti ukinut 23.9.2026 zajedno sa čitavim puzzle-sets mehanizmom (docs/PLAN-MATERIJAL.md, faza 4) — zagonetke iz pregleda partije se sada čuvaju direktno kao Find zadaci u Biblioteci, bez posebnog dijaloga sa skupovima.
...
6. [x] **„Open" otvara baš taj skup** — zagonetke iz tog reda, ne iz nekog
   drugog. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
7. [ ] **„Saved puzzles" na telefonu.** *Ovo je popravka greške koja je
   ...
   mogu pritisnuti. — **prevaziđeno (25.9.2026):** Isti mehanizam kao 204.5 — „Saved puzzles“ (puzzle sets) je ukinut 23.9.2026; nesklad između Windows-a i Android-a na istom nalogu (koji je bio poslednji zabeleženi problem) više nema smisla proveravati jer ekrana i podataka koje bi opisivao više nema.
8. [ ] **Prazan slučaj.** Bez sačuvanih zagonetki dijalog i dalje kaže da ih
   nema, umesto prazne kutije. — **prevaziđeno (25.9.2026):** Isti razlog — dijalog „Saved puzzles“ na koji se ova stavka (prazan slučaj) odnosi je ukinut 23.9.2026 zajedno sa puzzle sets mehanizmom.
...
1. [x] **Dijalog se otvori sa kolekcijom.** Naslov kaže ukupan broj u
   zagradi, a polje za pretragu stoji iznad liste. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
2. [x] **Na Windows-u lista je viša nego pre.** Vidi se osetno više od pet
   vrsta; ako je i dalje niska, to je prijava. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
3. [x] **Pretraga po imenu igrača.** Upiši deo svog protivničkog imena — lista
   se suzi, a naslov kaže „X of 4126". — ✅ vlasnik, u alatu za proveru, 20.9.2026.
4. [x] **Pretraga po potezima.** Upiši npr. `Nf3` ili `1. d4` — nalazi partije
   po otvaranju. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
...
5. [ ] **Pretraga po datumu ili rezultatu ne radi, i to je namerno.** Upiši
   ...
   potezi — inače bi kucanje datuma tiho premeštalo listu. — *prepisano 25.9.2026 u novi spisak: Analyse — Choose a game, stavka 2.*
6. [x] **Ništa ne odgovara.** Upiši besmislicu — piše rečenica da nema
   partije, a ne prazna kutija. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
7. [x] **Izbor partije radi kao i pre.** Klik na vrstu zatvori dijalog i
   učita partiju — i na tabli i u Board Setup (gde tekst upadne u polje). — ✅ vlasnik, u alatu za proveru, 20.9.2026.
8. [x] **Telefon.** Isti dijalog na 360 dp: ništa ne izlazi iz ekrana, polje
   za pretragu se vidi, tastatura ne pojede listu. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
9. [x] **Podnaslov vrste.** Potezi ispod imena više ne staju usred poteza
   (npr. `2. N...`), nego se prekidaju na razmaku. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
10. [ ] **Nalepi PGN sa varijantama** (iz Analysis, „Setup Position / PGN") —
   u podnaslovu stoji samo glavna linija, bez poteza iz zagrada. — *prepisano 25.9.2026 u novi spisak: Analyse — Choose a game, stavka 3.*
...
1. [x] **Windows, ikona se vidi i otvara se.** Desno od „Tutorial contents"
   ...
   prijava, ne greška: znači da panel treba preurediti. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
2. [x] **Prozor oko 840 x 800.** Panel se i dalje vidi ceo, bez žuto-crnih
   traka, a u gornjoj traci „Preview tutorial" je **i dalje ispisano rečima**. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
3. [x] **Dodavanje delova.** Novi tutorijal (bez imena) → „Add parts from a
   ...
   koliko ih je došlo. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
4. [x] **Isto, ali u tutorijal koji već ima delove**: novi se dodaju **na kraj**,
   a ekran stoji na prvom pridošlom. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
5. [x] **Imenovan pa prazan.** Upiši ime tutorijala, ne diraj tablu, pa dodaj
   delove: prazan „Part 1" i tada nestaje, ime ostaje tvoje. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
6. [x] **Izvor ostaje ceo.** Otvori tutorijal iz koga su delovi uzeti — svi su
   tamo, nijedan nije nestao. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
7. [x] **Spajanje dva u treći.** Nov tutorijal → „Add parts…" iz A → „Add
   parts…" iz B → „Save tutorial". Redosled je A pa B, kako su dodavani. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
8. [x] **Izdvajanje.** „Take parts into a new tutorial…" → odčekiraj neke →
   upiši ime → „Create". Poruka kaže da je sačuvan i koliko delova ima, sa
   dugmetom „Open". Ekran **ne skače** — ostaješ u tutorijalu koji pišeš. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
9. [x] **„Open" iz te poruke** otvara nov tutorijal u studiju; izlazak iz njega
   vraća na onaj koji si pisao, nedirnut. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
10. [x] **Dugme je nedostupno dok nema imena** i dok nije čekiran nijedan deo. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
11. [x] **Novi tutorijal nasleđuje jezik i oznake** izvornog (Library ga nalazi
    po istim oznakama), ali **ne i opis**. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
12. [x] **Telefon.** „More" → oba ulaza su tu i rade isto. Lista delova u
    dijalogu se skroluje ako ih je mnogo. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
13. [x] **Isti tutorijal.** „Add parts…" pa izaberi tutorijal koji upravo
    uređuješ: kaže da je to taj i upućuje na „Clone part". — ✅ vlasnik, u alatu za proveru, 20.9.2026.
...
1. [x] **Windows, prozor oko 1200 x 800.** Otvoriti Preparation: vide se sva
   četiri reda **i** lista tutorijala ispod njih, bez skrolovanja panela.
   Natpisi na uparenim dugmadima nisu odsečeni (ovo release gradnja ne prijavljuje). — ✅ vlasnik, u alatu za proveru, 20.9.2026.
2. [x] **Telefon.** Isti panel je u fioci (ikona gore levo): oba nova dugmeta se
   vide i natpisi se ne prelamaju. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
3. [x] **Export PGN, prazna tabla.** Bez ijednog poteza: crvena poruka „There are
   no moves on this board to export yet.", dijalog se ne otvara. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
4. [x] **Export PGN, odigrana linija sa varijantom.** Odigrati liniju, napraviti
   ...
   varijanta i komentar, a gore stoji zaglavlje `[Event "Preparation"]`. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
5. [x] **Sačuvati kao fajl.** „Save as .pgn" nudi ime oblika
   `preparation-2026-09-20.pgn`. Otvoriti sačuvani fajl u Lichess uvozu (ili
   ponovo u aplikaciji, „Import PGN") — linija je cela, sa varijantom. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
6. [x] **Save analysis, prazna tabla.** Crvena poruka „There are no moves on this
   board yet…", i **ne** pita za ime. (Ime koje se traži pa se posle odbije je
   gore nego odmah rečeno „nema šta da se čuva".) — ✅ vlasnik, u alatu za proveru, 20.9.2026.
7. [x] **Save analysis, odigrana linija.** Traži naslov (ponuđen je „Analysis
   20.9.2026"), pa „Analysis … saved." — ✅ vlasnik, u alatu za proveru, 20.9.2026.
8. [x] **Otvoriti sačuvano.** Analyse tab → ikona oblaka („Saved analyses") →
   red sa tim naslovom → otvara se **cela** linija sa varijantama i komentarima,
   ne samo početna pozicija. Isto i u Library, red vrste „analyses". — ✅ vlasnik, u alatu za proveru, 20.9.2026.
9. [ ] **Postavljena pozicija, ne od početka.** „Set up position" (ili zalepljen
   ...
   (`[SetUp "1"]` i `[FEN …]`). — *prepisano 25.9.2026 u novi spisak: Sesija — Preparation, stavka 1.*
10. [ ] **Soba sa učenikom, ne samo Preparation.** Ista dva dugmeta stoje i u
    ...
    panel nema. — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 18.*
...
1. [ ] Normalan rad (Analysis, Preparation, partija protiv motora, „Play it out"):
   crvena poruka o motoru se **ne** pojavljuje, ni pri brzom prelistavanju poteza. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 26.*
2. [ ] Prelazak u drugu aplikaciju i nazad, i Back pa ponovno otvaranje: bez poruke. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 1.*
3. [ ] Ako motor ikad zaćuti (nema evaluacije): na ekranu piše „The engine is not
   ...
   par sekundi; posle potpunog zatvaranja aplikacije motor radi. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 2.*
4. [ ] Ako motor stane (u logu „Stockfish is not ready"): piše „The engine has
   ...
   pokreće novi motor. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 3.*
...
1. [x] **Na starom buildu** (pre ove izmene): uključi motor na bilo kom ekranu, izađi
   iz aplikacije dugmetom **Back** sa početnog ekrana, otvori je ponovo → motor
   ćuti (nema evaluacije). — ✅ vlasnik, u alatu za proveru, 20.9.2026.
2. [x] Na istom buildu: Settings → Apps → **Force stop**, pa otvori → motor radi. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
3. [x] **Na novom buildu**: ponovi tačku 1 → motor radi i posle povratka.
4. [x] Posle domaćeg sa partijom protiv motora („Play it out"), pa Back i ponovo
   otvaranje: evaluacija na Preparation i u Analizi se pojavljuje. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
...
5. [x] Prelazak u drugu aplikaciju i nazad (bez izlaska) ne gasi motor — evaluacija
   se nastavlja bez ponovnog pokretanja. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
...
1. [x] **Učenik**, „Find the move" zadatak u domaćem: tačan potez ostaje na tabli i
   piše „Correct"; prihvaćena alternativa je takođe tačna. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
2. [ ] Pogrešan potez se vraća, prikazuje se rešenje, i tabla više ne prima potez —
   nema „Try again", nema „Keep going". — *prepisano 25.9.2026 u novi spisak: Home — Domaći i lekcije (My Assignments), stavka 32.*
3. [ ] **Trener**, Library → Exercises → sačuvan „Find" zadatak: ispod naslova piše
   odgovor kao „Qh5 (or Qf3)" — bez rednog broja i bez čipova za korake. — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 4.*
4. [ ] Potez odigran na toj tabli postaje alternativa, „x" na čipu je uklanja,
   glavni potez nema „x"; „Save" šalje izmenu i lista je pokazuje. — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 5.*
5. [ ] „Make exercise" → „Find the move" → „Play the move" radi kao u stavci 196. — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 10.*
6. [ ] Pregled domaćeg (trener i učenik posle odgovora) prikazuje rešenje kao i pre. — *prepisano 25.9.2026 u novi spisak: Teach — Domaći i napredak učenika, stavka 11.*
...
6. [ ] Kontrola: arhiva grešaka → „otvori partiju u Analizi" radi kao i pre (deli
   ista vrata). — *prepisano 25.9.2026 u novi spisak: Practise — My mistakes, stavka 1.*
...
1. [x] **Učenik**: zadatak „Daj mat u jednom ili 2 poteza" poslat direktno otvara
   tablu sa pozicijom; `Qf7#` je tačno, a i `Qa7` se priznaje. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
2. [x] Isti zadatak **unutar domaćeg** („Daj mat u 1 ili 2 poteza") otvara tablu. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
3. [x] **Trener**, Teach → učenik → taj zadatak: ne piše „Assignment complete" dok
   učenik nije ništa odigrao. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
4. [x] **„Play it out", učenik je crni a beli je na potezu**: iznad table piše „The
   engine is thinking…" sa peščanim satom dok motor ne odigra, pa „Your move" sa
   rukom. Uspravno i položeno. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
5. [x] Posle kraja partije taj red nestaje. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
...
1. [x] **„Play it out" iz domaćeg**, uspravno i položeno: nigde nema dugmeta
   „Analysis", nema panela motora, a u meniju table nema prekidača za strelice
   motora. — ✅ vlasnik, u alatu za proveru, 19.9.2026.
2. [x] Ista partija **van domaćeg** (Practise) i dalje ima sve to. — ✅ vlasnik, u alatu za proveru, 19.9.2026.
3. [ ] Windows, **desni klik na tablu** u stavci sa pozicijama i u tutorijalu iz
   domaćeg: ništa se ne kopira, ne piše „FEN copied." — *prepisano 25.9.2026 u novi spisak: Home — Domaći i lekcije (My Assignments), stavka 23.*
4. [ ] Windows, **Ctrl+C** u bilo kojoj stavci domaćeg: u clipboard-u nije FEN. — *prepisano 25.9.2026 u novi spisak: Home — Domaći i lekcije (My Assignments), stavka 24.*
5. [ ] Slobodna taktika i Analiza: desni klik i Ctrl+C kopiraju FEN kao i do sada. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 33.*
6. [x] **Čim je partija iz domaćeg završena** (mat, remi, predaja): dugme „Analysis",
...
1. [x] **Library → „Exercises" → pritisak na svoj „Find the move" zadatak** otvara
   ekran zadatka, a ne Analizu: ime, zadatak rečima, tabla okrenuta na učenikovu
   stranu i rešenje kao linija („1. Qh5 (or Qf3) g6  2. Qxe5+"). — ✅ vlasnik, u alatu za proveru, 20.9.2026.
2. [x] **Potez odigran na tabli** na izabranom koraku pojavljuje se u liniji kao
   „(or …)". Isti potez drugi put, ili potez koji pozicija ne dozvoljava, ne menja
   ništa; za prvi piše zašto. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
3. [x] Izbor **drugog koraka** linije pomera tablu na poziciju koju učenik tamo vidi,
   i potez odigran tu postaje alternativa na tom koraku, ne na prvom. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
4. [x] Alternativa ima dugme za uklanjanje; **glavni potez ga nema**. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
5. [x] **Save** otvara list „Edit exercise" sa već upisanim imenom, uputstvom i
   oznakama; nema čipova „Win" / „Draw or better". Posle „Save" zadatak u Library
   nosi novo ime, a ponovo otvoren pokazuje dodate alternative. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
6. [x] **Učenik** kome je taj zadatak već poslat u domaćem: dodata alternativa mu se
   sada priznaje kao tačan potez. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
7. [ ] **Skenirani zadatak sa odštampanim rešenjem** otvara se i menja na isti način. — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 6.*
8. [x] **Partija („Win" / „Draw or better")**: ekran pokazuje tablu, „Save" otvara list
   sa već izabranim ciljem, brojem poteza, stranom i jačinom; nema čipa „Find the move". — ✅ vlasnik, u alatu za proveru, 20.9.2026.
9. [ ] **Zadatak mog trenera** i **sken bez rešenja** otvaraju se kao do sada (Analiza). — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 7.*
10. [ ] Izlazak sa ekrana sa nesačuvanom izmenom prvo pita; bez izmene ne pita. — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 8.*
11. [ ] **Preparation → Make exercise**, „Find the move" sa odigranom linijom: ispod
    rešenja piše da je varijanta na učenikovom potezu prihvaćena alternativa. — **prevaziđeno (25.9.2026):** Opisano ponašanje (odigrana linija u sobi čini varijantu na učenikovom potezu prihvaćenom alternativom rešenja) pripada mašineriji za više poteza. Faza 14 (20.9.2026, stavka 196.6, već potvrđena uživo) je za pravljenje Find zadatka iz sobe promenila poruku: ako je u sobi odigrano više od jednog poteza, dijalog danas kaže da se koristi samo prvi potez, a ostali se ne koriste.
12. [x] Telefon, uspravno i položeno: ništa nije odsečeno, „Save" se može dohvatiti. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
...
1. [x] **Library → „Exercises"**: skenirane pozicije **bez rešenja** više nisu tu;
   ostaju skenovi koji imaju odštampano rešenje, zadaci napravljeni u Preparation
   i partije („Win", „Draw or better"). — ✅ vlasnik, u alatu za proveru, 20.9.2026.
2. [x] **Library → „Positions"**: tu su sada i skenovi bez rešenja; red kaže knjigu i
   stranu, a **ne** „Find the move". — ✅ vlasnik, u alatu za proveru, 20.9.2026.
3. [x] **Domaći → Add → exercises**: u dijalogu više nema redova „has no solution, so
   an answer cannot be judged" — nude se samo zadaci. — ✅ vlasnik, u alatu za proveru, 20.9.2026.
4. [x] Zadatak označen „needs review" se i dalje vidi u tom dijalogu, siv, sa
   razlogom „is marked for review". — ✅ vlasnik, u alatu za proveru, 20.9.2026.
...
1. [x] **Trener, otvoren domaći učenika koji je sve uradio dobro**: ispod naslova
   svake odigrane partije piše „Goal met" sa ikonom pehara; kod učenika koji nije
   uspeo piše „Goal not met" sa ikonom zastavice. Dva učenika se više ne čitaju isto. — ✅ vlasnik, u alatu za proveru, 19.9.2026.
2. [x] Stavka sa pozicijama pokazuje „N of M correct"; tutorijal ne pokazuje ništa. — ✅ vlasnik, u alatu za proveru, 19.9.2026.
3. [ ] **Pritisak po sredini reda odigrane partije (kao trener)** otvara pregled
   partije, a ne Analizu ni tablu za igru. — *prepisano 25.9.2026 u novi spisak: Teach — Domaći i napredak učenika, stavka 1.*
4. [ ] U pregledu: zadatak rečima („Checkmate in N moves as White"), presuda,
   ...
   Nigde ne piše „board not available", „viewed" ni „correct 0". — *prepisano 25.9.2026 u novi spisak: Teach — Domaći i napredak učenika, stavka 2.*
5. [ ] „Draw or better, for N moves" sa **više od sedam figura**: uz „Goal met" piše
   da je provereno samo da učenik nije matiran i da je pozicija tvoja da je oceniš. — *prepisano 25.9.2026 u novi spisak: Teach — Domaći i napredak učenika, stavka 3.*
6. [ ] **Učenik** na svom domaćem vidi iste presude, i svoj pregled partije. — *prepisano 25.9.2026 u novi spisak: Home — Domaći i lekcije (My Assignments), stavka 27.*
7. [ ] Pregled partije na telefonu, uspravno i položeno: ništa nije odsečeno. — *prepisano 25.9.2026 u novi spisak: Teach — Domaći i napredak učenika, stavka 4.*
...
1. [x] **Preparation → „Make exercise" → „Win"**: drugi čip pod „How long?" glasi
   „Checkmate in N moves", a ispod piše da se cilj ispunjava samo matom u toliko
   učenikovih poteza. Pod „Draw or better" isti čip i dalje glasi „For N moves". — ✅ vlasnik, u alatu za proveru, 19.9.2026.
2. [x] Sa **punom tablom** (više od sedam figura) „Win" + „Checkmate in N moves" se
   čuva — ranije je „Save" bio ugašen. — ✅ vlasnik, u alatu za proveru, 19.9.2026.
3. [x] **Učenik, lista stavki domaćeg**: stavka sa brojem glasi „Play it out:
   checkmate in N moves", a stavka bez broja „Play it out: win it" — dve različite
   stavke se više ne čitaju isto. Iznad piše „0 of 3 items", ne „0 of 0 items". — ✅ vlasnik, u alatu za proveru, 19.9.2026.
4. [x] **Učenik, tabla**: traka iznad table kaže „You are White — checkmate in N
   moves · K left" i K opada posle svakog učenikovog poteza. — ✅ vlasnik, u alatu za proveru, 19.9.2026.
5. [x] Namerno prekorači broj poteza u dobijenoj poziciji (dama i kralj protiv
   kralja): dijalog kaže **„Goal not met"** i „The game ended: no checkmate in N
   moves." — odmah, bez „Not judged yet". Ranije je ovde pisalo „Goal met". — ✅ vlasnik, u alatu za proveru, 19.9.2026.
6. [x] Daj mat **tačno u N-tom potezu**: „Goal met". — ✅ vlasnik, u alatu za proveru, 19.9.2026.
7. [x] „Draw or better, for N moves" radi kao i pre: posle N poteza u nerešenoj
   poziciji „Goal met", a dijalog kaže „you were not beaten in N moves". — ✅ vlasnik, u alatu za proveru, 19.9.2026.
8. [x] **Trener, otvoren domaći**: iznad stavki piše „K of 3 items" sa pravim
   brojevima, isto što i lista domaćih. — ✅ vlasnik, u alatu za proveru, 19.9.2026.
...
1. [ ] **Pozicija sa ≤7 figura, „Find the move"**, odigran jedan od više poteza
   ...
   „(or …)". — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 11.*
2. [ ] Odigran potez koji **ispušta** dobitak: piše upozorenje, bez „Accept". — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 12.*
3. [ ] **„Win" na remi poziciji** (≤7 figura): piše da se protiv savršene
   odbrane ne može ispuniti; „Save" i dalje radi. — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 13.*
4. [ ] **Više od 7 figura**, potez slabiji od motorovog za više od pešaka i
   po: „The engine prefers …" sa „Accept". Dok motor misli, „Save" radi. — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 14.*
5. [ ] **Bez interneta**: „Checking…" nestane samo od sebe za desetak sekundi,
   ništa se ne prikaže, „Save" radi sve vreme. — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 15.*
6. [ ] Ako je u Preparation **uključena analiza motora**, provera je ne kvari:
   posle provere analiza table nastavlja kao pre. (Provera koristi isti motor.) — *prepisano 25.9.2026 u novi spisak: Teach — Preparation, stavka 1.*
7. [ ] Promena sa „Win" na „Draw or better" skida nalaz koji je važio za „Win". — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 16.*

## 186. Zadatak (Exercise), faze 3a–4: partija na N poteza, Biblioteka i sličice — 19.9.2026, nije viđeno uživo

1. [x] **Preparation → „Make exercise"**: prvo se bira šta se traži — „Find the
   ...
   se ne izabere), jačina. — ✅ vlasnik, u alatu za proveru, 19.9.2026.
2. [x] Ispod pitanja piše **ko sudi**: sa 7 ili manje figura i „For N moves" —
   tablebase; sa više figura — samo „not checkmated"; „Win" na N poteza sa
   više od 7 figura — odbijeno, „Save" ne radi. — ✅ vlasnik, u alatu za proveru, 19.9.2026.
3. [ ] Za partiju **ne treba** odigrana linija — samo pozicija. — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 17.*
4. [ ] **Biblioteka**: sedam čipova, „Exercises" posle „Tutorials"; ispod njega
   ...
   Preparation. Pod „Positions" tih redova **nema**. — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 2.*
5. [ ] Redovi pozicija i zadataka imaju **sličicu table**; zadatak za crnog je
   ...
   skroluje glatko na telefonu. — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 9.*
6. [ ] **Domaći → Add**: „A tutorial · Exercises · A puzzle set" — nema „Play
   ...
   jedan „game" zadatak daju **dva reda**. — *prepisano 25.9.2026 u novi spisak: Teach — Domaći i napredak učenika, stavka 7.*
7. [ ] **Učenik, „Win for 2 moves"** sa ≤7 figura: posle drugog poteza partija
   staje, i tek kad server odgovori piše „Goal met" ili „Goal not met". — *prepisano 25.9.2026 u novi spisak: Home — Domaći i lekcije (My Assignments), stavka 28.*
8. [ ] Isto to **bez interneta ka tablebase-u**: piše „not judged yet" (nije
   ...
   stavka je otključana; kad se domaći kasnije ponovo otvori, presuda stigne. — *prepisano 25.9.2026 u novi spisak: Home — Domaći i lekcije (My Assignments), stavka 29.*
9. [ ] U **sobi**, kolona biblioteke ima čip „Exercises" i zadatak se učitava
   na tablu kao ranije skenirana pozicija. — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 9.*
...
1. [ ] **Preparation → „Make exercise"** (pored „Save position"): sa praznom
   tablom piše da prvo treba odigrati rešenje i nema „Save". — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 18.*
2. [ ] Odigraj dva poteza belog sa odgovorom crnog, i jednu varijantu na
   **prvom belom** potezu: list pokazuje „1. … (or …) …  2. …", „Find the
   moves", i „Save" radi tek kad se upiše ime. — **prevaziđeno (25.9.2026):** Stavka je proveravala staru mašinu za nizove poteza (rešenje kao „1. … (or …) … 2. …“, „Find the moves“), koju je faza 16 (20.9.2026) u potpunosti obrisala — Find je danas svuda jedan potez.
3. [x] Ako glavna linija završava protivnikovim potezom, piše da taj potez
   nije deo rešenja. — ✅ vlasnik, u alatu za proveru, 19.9.2026.
4. [ ] Posle „Save": poruka „Exercise saved.", i zadatak je u Biblioteci među
   zadacima, pod svojim imenom (čip „Exercises", stavka 186.4). — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 19.*
5. [ ] **Domaći → Add → positions**: zadatak se bira i šalje kao i skenirana
   pozicija. — *prepisano 25.9.2026 u novi spisak: Teach — Domaći i napredak učenika, stavka 8.*
6. [ ] **Učenik**: prvi tačan potez → „Correct. Keep going.", na tabli je
   ...
   vraća, rešenje se **ne** prikazuje; poslednji tačan potez završava zadatak. — **prevaziđeno (25.9.2026):** Poruke „Correct. Keep going.“ i „Not that move. Try again.“ pripadaju staroj mašini za nizove poteza; faza 16 (20.9.2026) je zamenila taj tok jednim potezom koji se, ako je pogrešan, odmah otključava uz prikaz rešenja (stavka 198.2/i1605).
7. [ ] Učenik odigra **prihvaćenu alternativu**: tabla nastavlja od trenerovog
   poteza, pa odgovor. — **prevaziđeno (25.9.2026):** Nastavljanje table posle prihvaćene alternative na drugi (protivnikov) potez pripada staroj sekvenci od više poteza; Find danas ima tačno jedan potez i odmah se završava.
8. [ ] **Pregled**: posle pogrešnog pa tačnog, stavka ostaje „netačno" (pamti
   se prvi pokušaj), a trener vidi ceo niz. — **prevaziđeno (25.9.2026):** „Trener vidi ceo niz“ pretpostavlja da rešenje ima više poteza; pošto Find danas ima jedan potez, ne postoji niz koji bi trener pregledao na taj način.
9. [ ] U editoru domaćeg **nema** prekidača „Solved", a učenik ne vidi „must
   be solved". (Stavka 184.7 time otpada.) — *prepisano 25.9.2026 u novi spisak: Teach — Domaći i napredak učenika, stavka 5.*
...
1. [x] **Učenik**: „My Assignments" ima **jedan** red za domaći, sa „1 of 3
   items" (ne „0/0 completed"); otvaranje daje stavke u trenerovom
   redosledu, sa Done / Open / Locked. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
2. [x] **Zaključana stavka** se ne otvara na dodir i piše **ime** stavke
   koja je drži zatvorenu (ne „item #502"). — ✅ vlasnik, u alatu za proveru, 18.9.2026.
3. [x] **„Odigraj do kraja" se otvara iz domaćeg** — tabla sa zadatom
   ...
   prvi put i vidi. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
4. [x] **Trener** iz učenikovog napretka otvara isti ekran (ne prazan
   ...
   early". — ✅ vlasnik, u alatu za proveru, 18.9.2026.
5. [x] **Review po stavki** radi sa obe strane (roditelj ga nema). — ✅ vlasnik, u alatu za proveru, 18.9.2026.
6. [x] **Vraćanje sa stavke** osvežava stanje — sledeća stavka se otvara
   bez povlačenja liste nadole. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
...
0. [x] **Vrata**: kartica „Homework" na Teach tabu i vrata „Homework" u
   Biblioteci otvaraju istu listu; na telefonu se oboje vide bez skrolovanja
   udesno. „New homework" otvara prazan editor. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
...
1. [ ] **Prijavljeno uživo 18.9.2026, ispravljeno istog dana** — „ne mogu da
   ...
   Čuvari: `fen_completion_test`, `homework_play_it_out_fen_test`. — *prepisano 25.9.2026 u novi spisak: Teach — Domaći i napredak učenika, stavka 10.*
...
2. [x] **Pošalji jednom učeniku**: učenikova lista ima **jedan** red
   („Thursday", 0/4), ne četiri; jedno obaveštenje „New homework". — ✅ vlasnik, u alatu za proveru, 18.9.2026.
3. [ ] **Kvota** — **nema gde da se vidi u aplikaciji** (vlasnik, 18.9.2026:
   ...
   (pet stavki unutra ne menja ništa); odbijeno slanje ne troši ništa. — *prepisano 25.9.2026 u novi spisak: Server i alati — Server, stavka 10.*
4. [ ] **Pozicija pod revizijom**: obeleži jednu poziciju iz domaćeg kao
   ...
   dobija **ništa** (ni tutorijal koji je bio u redu). — *prepisano 25.9.2026 u novi spisak: Teach — Domaći i napredak učenika, stavka 6.*
5. [x] **Izmeni šablon posle slanja** (dodaj i obriši stavku): već poslati
   domaći se ne menja — isti naslov, iste stavke, isti napredak. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
6. [ ] **Uzak filter zagonetki** (tema + najviši rejting koji klizač daje):
   **ispravljeno u opisu 18.9.2026** — vlasnik: „mogu samo do 2800". Klizač u
   ...
   nema zagonetki po tim kriterijumima; ranije je vraćala 500. — *prepisano 25.9.2026 u novi spisak: Teach — Domaći i napredak učenika, stavka 9.*
7. [x] **Prozor za slanje**: nudi samo učenike koji su prihvatili poziv;
   izaberi dvoje, pošalji — obojica dobijaju po jedan red, a kvota se
   umanji za **dva**. Rok i napomena stignu do učenika. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
8. [x] **Odbijanje jednog učenika** (npr. potrošena kvota na drugom nalogu
   ili pozicija pod revizijom): rečenica imenuje tog učenika, a onaj drugi
   je i dalje dobio domaci. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
9. [x] **Slanje iz editora**: dugme je ugašeno dok domaci nije sačuvan; posle
   čuvanja radi, a ispod stavki piše šta je već poslato i dokle je stiglo. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
10. [x] **Dva čuvanja u istom sedenju** prave **jedan** domaci, ne dva (i
   posle drugog čuvanja stavke su iste, bez duplikata). — ✅ vlasnik, u alatu za proveru, 18.9.2026.
...
1. [x] **Telefon uspravno, „Basic mates"**: u app baru gore desno stoje
   ikonica robota („Engine opponent") i ikonica mreže („Board view") —
   ranije ih uspravno **nije bilo nigde**. Naslov se skraćuje sa „…" ako
   treba, ništa ne prelazi ivicu. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
2. [x] **Rečenica cilja** stoji nad tablom uspravno (npr. „Practice: …
   (Checkmate Stockfish)"), kao i položeno u zaglavlju. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
3. [x] **Nema više kartice „Back to selection"** ispod table — izlaz je
   strelica u app baru (i ona radi). — ✅ vlasnik, u alatu za proveru, 18.9.2026.
4. [x] **Zadata partija** (posle faze 4): tabla na trenerovoj poziciji i
   strani; **nema** ikonice robota; rečenica kaže cilj (pobeda / remi /
   preživi N poteza); „Resign" umesto „Try Again"/„Next Position". — ✅ vlasnik, u alatu za proveru, 18.9.2026.
5. [x] **Kraj partije**: dijalog kaže zbog čega je partija gotova i da li je
   cilj ispunjen; trener u pregledu vidi poteze i završetak; drugi pokušaj
   nije moguć. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
...
1. [x] **Pat vašim potezom** (npr. K+Q vs K: stavi damu tako da kralj nema
   ...
   ne vrti. Ranije: tišina. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
2. [x] **Nedovoljan materijal vašim potezom** (uzmi poslednju figuru tako da
   ostane K+B vs K ili K+N vs K): isti dijalog, „not enough material to
   mate". — ✅ vlasnik, u alatu za proveru, 18.9.2026.
3. [ ] **Pat potezom motora** (teško izazvati; ako se desi): dijalog umesto
   ranije poruke „Stalemate / Draw" pri dnu. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 4.*
4. [x] **Mat i dalje kao pre**: vaš mat → „VICTORY!", motorov mat →
   „Checkmate". Mate-in-N zagonetke nepromenjene. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
...
1. [x] **Settings**: u „Board and panel appearance" više nema „Board size"
   ni „Panels in Analysis"; ostaju koordinate, animacija poteza i ručni
   komentari. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
2. [ ] **Analiza**: ikonica mreže (Board view) → „Board size" sa klizačem
   ...
   **Prijavljeno uživo 18.9.2026, ispravljeno istog dana** („u landscape
   ...
   Analize; „Scan a book" se i dalje otvara iz ⋮. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 30.*
3. [ ] **Soba** (ikonica mreže pored flip-a) i **ekran vežbi** (meni u
   ...
   **Prijavljeno uživo 18.9.2026, ispravljeno istog dana** („moglo bi da se u
   ...
   ne procenjeno: `nav_strip_one_row_test` meri visinu palete na 360 dp. — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 6.*
4. [x] **Drugi ekrani** (npr. taktike, repertoar): u meniju table **nema**
   klizača. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
5. [ ] **Analiza → „Panels"** (na telefonu u ⋮ „More tools", na Windows-u
   ...
   **dva reda postala jedan**: potez na kome stojiš je natpis u sredini palete
   ...
   zaista nosi rečenicu. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 31.*
6. [x] **Upoznaj repertoar**: tabla sada ima slova i brojeve po ivici, a
   „Coordinates" u meniju ih pali i gasi (ranije prekidač nije radio ništa). — ✅ vlasnik, u alatu za proveru, 18.9.2026.
9. [ ] **Nema gornje trake ljuske** (18.9.2026, traženo uživo: „taj gornji deo
   ...
   u zaglavlju taba. — *prepisano 25.9.2026 u novi spisak: Home — Home i obaveštenja, stavka 4.*
...
7. [ ] **Komentari u Analizi**: „Manual comment selection" više nije u
   ...
   ne dobija. Važi i za Auto Analysis. — **prevaziđeno (25.9.2026):** Trajni prekidač koji je automatski komentarisao svaki odigran potez (i u Review entire game / Auto Analysis) više ne postoji — 22.9.2026 su motivski komentari postali isključivo na zahtev (dugme „Generate AI comment“ ili tutorijal); „Review entire game“ danas piše komentar samo kad je u tom dijalogu posebno uključen prekidač „Comment key moments with AI“ (podrazumevano isključen), ne za svaki novi potez uopšte.
8. [ ] **Dubina do 50, svaka vrednost**: meni „depth" na tabli Analize,
   ...
   50; „Check with engine" u sačuvanim pozicijama 12–50. — *prepisano 25.9.2026 u novi spisak: Analyse — Motor, linije i tablebase, stavka 6.*
9. [ ] **„Make a tutorial from this game"**: klizač dubine 18–50 umesto tri
   ...
   measured". Zapamćena dubina se vraća sledeći put. — *prepisano 25.9.2026 u novi spisak: Analyse — Tutorijal iz partije, stavka 18.*
10. [x] **Motor kao protivnik**: u Settings odeljak „Stockfish engine" više
    ...
    ostaju posle ponovnog pokretanja. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
...
1. [x] **Windows, nepromenjeno**: Tutorial Studio radi kao pre 6a — potez,
   komentar, deo, pitanje, undo/redo, „Discard changes", čuvanje, video,
   naracija, .pgn. (543 testa studija prošla neizmenjena; ovo je pogled.) — ✅ vlasnik, u alatu za proveru, 18.9.2026.
2. [ ] **Telefon, portret**: Teach → kartica „Tutorials" postoji (ranije
   ...
   **Prijavljeno uživo 18.9.2026, ispravljeno istog dana** („Ne vidim traku
   ...
   na prvi — tabla i tab „Line" moraju otići na njega. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 72.*
3. [x] **Line**: komentar na potez na kome stojite; „Insert a line here" i
   „Delete this move" gde imaju smisla; crtanje strelica i polja istom
   trakom kao u sobi; okretanje table. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
4. [x] **Task**: vrsta (Show only / Ask for move on board / Ask for answer
   from list), tekst zadatka, odgovori sa dodavanjem i brisanjem, „Correct
   move" posle poteza na tabli kod pitanja za potez. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
5. [x] **Parts**: „New part" sa tri vrste, lista delova, gore/dole/kloniraj/
   preimenuj/obriši, tap bira deo i tabla ga prati. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
6. [ ] **Prelivanje (⋮)**: Undo, Redo, Discard changes, Preview tutorial,
   Record narration, Export video, Save as .pgn, Position setup. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 71.*
7. [ ] **Telefon položeno**: tabla levo celom visinom, tabovi desno. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 69.*
8. [ ] **Isti sadržaj**: tutorijal sačuvan sa telefona otvara se na Windows-u
   sa istim delovima, komentarima i pitanjem — i obratno. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorial studio, stavka 70.*
9. [ ] **Soba na telefonu**: „Edit tutorial" na redu tutorijala otvara studio
   (ranije stari panel); Analiza → „Use in a tutorial" nudi i redove studija. — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 11.*
11. [ ] **„Saved tutorials" otvara Library** (prijave vlasnika 17.9.2026:
    ...
    - tap na red otvara studio; „Label Filter Matrix" i „Search" sužavaju. — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 28.*
10. [ ] **Priručnik** (write-a-tutorial, analysis, getting-started) više ne
    pominje Windows kao uslov. — *prepisano 25.9.2026 u novi spisak: Teach — Učenici, grupe i obaveštenja, stavka 8.*
...
1. [x] **Kolona**: pod „Board" isti tasteri kao pre (Set up position, Import
   ...
   i redom „N parts" / „saved position" / izvorom iz knjige. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
2. [x] **Tap na tutorijal** stavlja prvi deo na tablu i otvara traku delova
   ...
   na tablu isto. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
3. [x] **Radnje**: tutorijal ima ⋮ (Edit tutorial · Rename · Save as new
   version) i kantu; pozicija olovku i kantu. Kod učenika, trenerovi redovi
   (From trainer) nemaju ništa. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
4. [x] **Oznake**: uključi jednu oznaku u matrici — lista se sužava i za
   tutorijale i za pozicije (tutorijal nosi svoje oznake od ove faze); dugi
   pritisak isključuje. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
5. [x] **Pretraga** hvata i naslov i oznaku. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
6. [x] **Pad servera** dok se kolona puni: „The library could not be loaded."
   i „Try again", ne prazna lista. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
7. [x] **Library na Teach** sada ima istu matricu oznaka ispod čipova (ako
   imate oznake). — ✅ vlasnik, u alatu za proveru, 18.9.2026.
...
1. [x] **Četiri taba**, na Windows-u levo, na telefonu dole: Home, Practise,
   Analyse, Teach; „Settings" je zupčanik, ne tab. Ctrl+1…4 ih menja. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
...
4. [ ] **Analyse**: tabla je odmah tu, sa svojom trakom (Setup, motor, „Use in
   ...
   engin-om". Do tada je prvi ulazak pokretao motor sam.) — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 4.*
5. [x] **Teach**: kartica tutorijala (Windows), „Preparation" → „Open",
   ...
   Na telefonu se tab skroluje ceo, bez unutrašnjeg skrola. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
6. [ ] **Zvono** sa zahtevima: bedž na ikoni „Teach" (bio na „People"); zvono
   ...
   **Dopunjeno 18.9.2026** (vlasnik: „Ne razumem ovu notifikaciju na tabu
   ...
   crta na **Home** („Trainer panel / TO REVIEW"). — *prepisano 25.9.2026 u novi spisak: Teach — Učenici, grupe i obaveštenja, stavka 1.*
7. [x] **Telefon položeno** (stavka 174): naslov taba i zupčanik gore desno na
   Home, Practise i Teach; na Analyse je red sa „My games"/„Scan a book" pa
   traka Analize — zvono tu nije dostupno (poznato). — ✅ vlasnik, u alatu za proveru, 18.9.2026.
...
1. [x] **Kartice ćute dok nema ničega.** Nov nalog, tab Training: nijedna kartica
   ne piše „Solved 0" ni dugme „Retry failed". — ✅ vlasnik, u alatu za proveru, 18.9.2026.
2. [ ] **Linija posle prvog pokušaja.** Reši jedan mat u 2, promaši drugi, preskoči
   ...
   **Prijavljeno 18.9.2026 kao „Solved 1 · 1 to retry", nađeno i ispravljeno
   ...
   tačan bez odlaska na drugi ekran. — *prepisano 25.9.2026 u novi spisak: Practise — AI Studio i zagonetke, stavka 8.*
3. [x] **Retry servira baš te.** Pritisni „Retry failed (2)": naslov ima „— retry",
   stižu upravo promašena i preskočena zagonetka, po redu. Reši jednu; hub
   posle povratka kaže „Solved 2 · 1 to retry". — ✅ vlasnik, u alatu za proveru, 18.9.2026.
4. [ ] **Taktika, završnice, šetnja kroz partiju** pišu isto: po jedan pokušaj u
   ...
   **Prijavljeno uživo 18.9.2026, ispravljeno istog dana** („Malo zbunjuje,
   ...
   naslov kartice je ime. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 1.*
5. [x] **Osnovni matovi**: preset odigran do mata → linija na kartici; bez dugmeta. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
6. [ ] **Domaći zadatak nije dirnut.** Preskakanje u zadatku i dalje ne beleži
   ništa (jedan pokušaj, kao do sada). — *prepisano 25.9.2026 u novi spisak: Home — Domaći i lekcije (My Assignments), stavka 30.*
7. [ ] **Server**: `GET /api/puzzles/progress` sa tokenom vraća po izvoru
   `seen/solved/firstTry/failed/skipped/toRetry`; `mate_puzzle` ima
   `buckets` po dubini, `endgame` po režimu. — *prepisano 25.9.2026 u novi spisak: Server i alati — Server, stavka 7.*
...
1. [ ] **Analiza ima jedna vrata.** U traci je jedno dugme „Use in a tutorial"
   ...
   **Ispravljeno u opisu 18.9.2026** (vlasnik: „Ima 6 u windows-u, a tri u
   ...
   list mora imati šest. — *prepisano 25.9.2026 u novi spisak: Analyse — Tutorijal iz partije, stavka 16.*
2. [x] **Svaki red radi ono što piše**: „New tutorial from this line" otvara
   ...
   „Open a tutorial to edit…" otvara birač. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
3. [x] **Soba i Priprema**: leva kolona ima naslov „Board" (Set up position,
   Import PGN, Save position, FEN) pa „Library"; nema „Create tutorial
   (multiple positions)"; meni reda tutorijala nema „Edit positions".
   „Save position" dijalog: naslov „Save position", polje „Position name". — ✅ vlasnik, u alatu za proveru, 18.9.2026.
4. [x] **Priprema nije sesija.** Iz Pripreme na početni ekran: nema banera
   „Active session (code: STUDIO)" ni čipa „Resume session STUDIO". — ✅ vlasnik, u alatu za proveru, 18.9.2026.
5. [x] **Join proverava kod.** Na tabu Sessions ukucaj „12" i „Join": poruka
   „Enter a valid 6-digit code", ništa se ne otvara. — ✅ vlasnik, u alatu za proveru, 18.9.2026.
6. [ ] **Imena**: kartica „New session" (podnaslov „Open a room and invite your
   ...
   **Home**, „Scan a book" u redu iznad table na **Analyse**. Imena su ista,
   ekran nije. — *prepisano 25.9.2026 u novi spisak: Teach — Učenici, grupe i obaveštenja, stavka 7.*
7. [ ] **Biblioteka**: tab **Teach** → kartica „Library" („Everything you keep
   ...
   akcije (poznato, 3b). — *prepisano 25.9.2026 u novi spisak: Teach — Library i zadaci, stavka 3.*
8. [x] **Server nedostupan** u biblioteci kaže „The library could not be
   loaded." sa „Try again", ne „Nothing here yet.". — ✅ vlasnik, u alatu za proveru, 18.9.2026.

## 174. Četiri prijave: podešavanja, mat, obaveštenje — 16.9.2026, nije viđeno uživo

`docs/STANJE-RADA.md`, „Četiri prijave iste večeri".

1. [x] **Početni ekran položeno.** Zvono i zupčanik („Settings") su gore desno,
   u redu sa naslovom kartice; zupčanik otvara podešavanja. Naslov („Training")
   je ispod sata i baterije, ne preko njih. Okreni uspravno: sve kao pre. — ✅ vlasnik, u alatu za proveru, 16.9.2026.
2. [x] **Mat bez komentara.** U Analizi odigraj potez koji matira (ili učitaj
   partiju koja se završava matom i pusti „Review entire game"): ispod matnog
   poteza nema komentara. Potez koji nije mat i dalje dobija komentar. — ✅ vlasnik, u alatu za proveru, 16.9.2026.
3. [x] **Nema poruke o vraćenoj analizi.** Uđi u Analizu posle rada u njoj:
   stablo je tu, a dole nema „Your latest analysis has been restored". — ✅ vlasnik, u alatu za proveru, 16.9.2026.
...
1. [x] **Analiza, traka u jednom redu.** Sa uključenom eval trakom: svih devet
   dugmadi (početak, nazad, napred, kraj, okreni, komentar, AI, NAG, obriši) u
   jednom redu, i dugmad se lako pogađaju prstom. — ✅ vlasnik, u alatu za proveru, 16.9.2026.
2. [x] **Analiza bez sudije.** Nema panela „Move Verdict" ni dugmeta „Judge
   move", a u Settings nema prekidača „Move evaluation". — ✅ vlasnik, u alatu za proveru, 16.9.2026.
3. [x] **Gradnja repertoara.** „Ask engine", „Next position" i „Drill this
   branch" u jednom redu, čitljivi; traka iznad njih takođe u jednom redu.
   Presuda na tvom potezu i dalje stiže sama i ne pominje Lichess. — ✅ vlasnik, u alatu za proveru, 16.9.2026.
4. [x] **Uređivač delova, kartica Board.** Tabla levo, desno spisak delova sa
   ikonicama gore/dole/dodaj/obriši; izbor dela menja tablu; „Save step" i
   „Preview" dole desno. — ✅ vlasnik, u alatu za proveru, 16.9.2026.
5. [x] **Uređivač delova, kartica Text.** Naslov, zadatak i vrsta preko cele
   širine; kucanje ne zatvara tastaturu; naslov otkucan ovde se vidi u spisku
   na kartici Board. — ✅ vlasnik, u alatu za proveru, 16.9.2026.
6. [x] **Ništa pod sistemskom dugmadi** na desnoj (ili levoj) ivici, ni u
   uređivaču ni na drugim ekranima. — ✅ vlasnik, u alatu za proveru, 16.9.2026.
...
1. [ ] **Analiza.** Uključi eval traku: stoji uspravno levo od table, iste
   ...
   dostupno (skrolom ako treba), i kucanje FEN-a ne zatvara tastaturu. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 29.*
...
5. [ ] **Endšpil i greške iz partija:** „Tablebase findings" u drilu se otvara
   desno, ne kao donji list. — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 3.*
6. [ ] **Plejer snimka i AI vežbe:** kontrole plejera desno; u AI vežbama
   strelica nazad gore levo radi. — *prepisano 25.9.2026 u novi spisak: Home — Reprodukcija snimka, stavka 9.*
7. [ ] **Uređivač delova tutorijala (Android, „Edit tutorial steps").** Kucaj
   naslov dela: tastatura ostaje, ništa se ne preliva. — **prevaziđeno (25.9.2026):** Stari poseban ekran „Edit tutorial steps“ za Android, koji je vlasnik ovde ocenio kao prenatrpan, više ne postoji — od faze 6a-6c (17.9.2026, stavka 179) izmena delova tutorijala na telefonu ide kroz isti Tutorial Studio (tab `Parts`) kao na Windows-u, potvrđeno na 179.9-179.11 u ovoj istoj isporuci.
8. [x] **Okreni nazad uspravno** na bar dva ekrana usred rada: stanje ostaje
   (potez, stablo), raspored se vraća na stari. — ✅ vlasnik, u alatu za proveru, 16.9.2026.
9. [x] **Telefon sa notch-om:** ništa ne ulazi pod izrez sa strane. — ✅ vlasnik, u alatu za proveru, 16.9.2026.
...
1. [ ] **Prijavljeni fajl.** Otvori `D:\chess\Italian-Game-Evans-Gambit-Accepted-—-White.pgn`,
   ...
   Poruka „PGN loaded — 50 moves in tree", tabla stoji posle 14. Nxe5. — *prepisano 25.9.2026 u novi spisak: Analyse — PGN i postavka pozicije, stavka 14.*
2. [ ] **Varijante su u stablu.** Posle 5. c3 u stablu su Ba5, Be7 i Bc5; posle
   6. d4 je i 6... exd4 sa ugnježdenom 8... dxc3. — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 32.*
3. [ ] **Komentari su tu.** Na 4... Bxb4 stoji „This is Evans Gambit Accepted". — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 5.*
4. [ ] **Imena.** Iznad table piše „Repertoire — Opponent". — *prepisano 25.9.2026 u novi spisak: Analyse — Analysis, stavka 6.*
5. [ ] **Nazad i napred.** „Export PGN" iz Analize, pa taj tekst ponovo „PGN
   Uvoz": isto stablo, bez upozorenja. — *prepisano 25.9.2026 u novi spisak: Analyse — PGN i postavka pozicije, stavka 12.*
6. [ ] **Chess.com/Lichess** kartica i dalje učitava partiju (sa satom posle
   svakog poteza), bez komentara „0:02:59" u stablu. — *prepisano 25.9.2026 u novi spisak: Analyse — PGN i postavka pozicije, stavka 13.*
7. [ ] **Pokvaren potez se kaže.** Nalepi `1. e4 e5 2. Nf3 Qxz9 *`: učita se
   do 2. Nf3, a poruka kaže da je potez izostavljen (žuta, ne zelena). — *prepisano 25.9.2026 u novi spisak: Analyse — PGN i postavka pozicije, stavka 15.*
...
1. [ ] **Brojač je otišao.** Otvori gradnju repertoara: ispod pitanja („What do
   ...
   bez „open N". — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 9.*
2. [ ] **Govor ne broji.** Uključi govor i pređi kroz nekoliko pozicija: čuje se
   ...
   moves do you prepare?", čuje se nova rečenica. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 10.*
3. [ ] **Kartica u listi ne broji.** Na listi repertoara red ispod imena kaže
   ...
   traži `GET /repertoire/progress` uopšte.) — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 1.*
4. [ ] **Mapa i dalje broji.** „Gaps in repertoire" i dalje kaže koliko pozicija
   nema odgovor — to je namerno ostavljeno, jer se ta mapa otvara baš zbog toga. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — pokrivenost, stavka 1.*
5. [ ] **Motor posle sopstvenog poteza.** Odigraj svoj potez i sačekaj da tabla
   ...
   panel „Engine" pokazuje linije **za tu poziciju** (ne za onu iza nje). — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 1.*
6. [ ] **Motor kad knjiga ćuti.** Uđi u liniju u kojoj knjiga nema odgovor
   ...
   nijednu. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 2.*
7. [ ] **Ocena se pamti uz poziciju.** Posle pitanja motora, red „Saved: …"
   ...
   tu. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 7.*
8. [ ] **Izvoz u PGN postoji tamo gde je repertoar.** Lista repertoara → meni
   ...
   na klipbordu. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 5.*
9. [ ] **Fajl je repertoar.** U tekstu: glavna linija je tvoj glavni potez sa
   ...
   Nigde u fajlu nema ★ ni procenata. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 6.*
10. [ ] **Komentari su unutra.** Napiši komentar na neku poziciju u repertoaru,
    pa izvezi ponovo: rečenica stoji u vitičastim zagradama uz **taj** potez. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 2.*
11. [ ] **Fajl se snima pod imenom repertoara.** „Save as .pgn" nudi ime po
    ...
    potezi se odigravaju. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 7.*
12. [ ] **Repertoar koji počinje dublje.** Izvezi repertoar napravljen iz
    ...
    line: …"). — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 3.*
13. [ ] **Prazan repertoar se ne izvozi.** Na repertoaru bez ijednog poteza
    „Export as PGN" kaže da nema poteza i ne otvara prozor sa tekstom. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — spisak, nov, izvoz i tura, stavka 4.*

## 169. Ostatak revizije (blok C) — 16.9.2026, nije viđeno uživo

`docs/STANJE-RADA.md`, „Ostatak revizije (blok C)". Server restartovan.

1. [ ] **Trener završnica** piše „Position: draw" / „win" / „loss" — nigde „remi". — *prepisano 25.9.2026 u novi spisak: Practise — Završnice i greške iz partija, stavka 2.*
2. [ ] **Tablica u analizi** (Syzygy panel) piše „Win", „Probable win", „Unknown". — *prepisano 25.9.2026 u novi spisak: Analyse — Motor, linije i tablebase, stavka 5.*
3. [ ] **Registracija u logu servera**: registruj se i unesi kod; u logu nema
   adrese, samo id (u razvoju: kod uz maskiranu adresu `p***@domen`). — *prepisano 25.9.2026 u novi spisak: Server i alati — Server, stavka 11.*
4. [ ] **PGN sa ocenama u sobi**: učitaj partiju sa `??` i `!` u sobu i sačuvaj
   poziciju; u sačuvanom su oznake i dalje tu. — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 12.*
5. [ ] **Izvoz videa** i dalje prikazuje napredak i završava se normalno. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 62.*
6. [ ] **Skeniranje PDF-a** i dalje radi (običan broj pokušaja ne udara u granicu). — *prepisano 25.9.2026 u novi spisak: Teach — Position Scanner, stavka 2.*
...
1. [ ] **Tabla prati potez.** Trener odigra e4; učenikova **tabla** (ne samo
   ...
   ide za njim. — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 8.*
2. [ ] **Kasni ulazak.** Trener odigra nekoliko poteza, pa učenik uđe; učenik
   vidi poziciju sobe, ne početnu. — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 7.*
3. [ ] **Učitana pozicija.** Trener učita sačuvanu poziciju ili tutorijal i
   odigra potez; učenikovo stablo nije prazno i tabla je na istoj poziciji. — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 5.*
4. [ ] **Okretanje table.** „Force student board to Black" — učenikova tabla se
   okrene. — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 14.*
5. [ ] **Deljenje pozicije.** Učenik podeli poziciju treneru; treneru se otvori
   dijalog i „Load onto board" je učita. — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 15.*
6. [ ] **Poziv sa spiska učenika.** Trener pozove učenika koji je u aplikaciji;
   ...
   poruku o odbijanju, ne „Invitation sent". — *prepisano 25.9.2026 u novi spisak: Sesija — Ulazak u sesiju i pozivi, stavka 2.*
7. [ ] **Glas.** Oba uključe glas. Trener utiša učenika — učenik se zaista ne
   ...
   ruku — treneru stigne „wants to speak". — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 26.*
8. [ ] **Dozvola za motor.** Trener uključi motor za učenike, pa učenik uđe —
   prekidač motora mu je odmah dostupan. — **prevaziđeno (25.9.2026):** Studentov pristup motoru u sobi je posle ovog izveštaja sasvim ukinut, na vlasnikovu reč (faza 6 sesijskog plana, → 3711) — panel motora se danas crta samo za lidera sobe, nikad za učenika, pa prekidač koji bi trener „dao“ učeniku više ne postoji.
9. [ ] **Uloga.** Trener promoviše učenika — samo on dobije obaveštenje; pri
   običnom ulasku nema obaveštenja o ulozi. — **prevaziđeno (25.9.2026):** Promocija učenika u „ko-domaćina“ (drugu ulogu sa dodatnim pravima) je uklonjena fazom 3 sesijskog plana (21-22.9.2026) — sobom danas vodi tačno jedan lider (`leadsRoom`), bez ko-domaćina kome bi se uloga menjala.
10. [ ] **Save position.** Posle nekoliko poteza „Save position"; otvori
    sačuvano — svi potezi su tu. — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 13.*
11. [ ] **Edit positions.** Tutorijalu sa oznakama promeni redosled koraka i
    sačuvaj; oznake su ostale. — **prevaziđeno (25.9.2026):** Preuređivanje delova tutorijala sa oznakama („Edit positions“) je ubrzo posle ovog izveštaja uklonjeno sa menija reda tutorijala (stavka 175.3, 17.9.2026) — na svim uređajima se od faze 6a-6c (stavka 179) delovi preuređuju kroz Tutorial Studio (tab Parts, strelice gore/dole), a oznake se čuvaju preko polja Labels.
...
1. [ ] **Registracija i dalje radi.** Nova adresa → kod stiže → unos koda →
   ulaz u aplikaciju. Odjava, prijava istom lozinkom. — *prepisano 25.9.2026 u novi spisak: Nalog i prijava — Prijava i registracija, stavka 5.*
2. [ ] **Ponovna registracija menja lozinku.** Registruj adresu lozinkom A, ne
   ...
   lozinkom A ne prolazi, lozinkom B prolazi. — *prepisano 25.9.2026 u novi spisak: Nalog i prijava — Prijava i registracija, stavka 3.*
3. [ ] **Ulazak u sobu kodom.** Trener pravi sobu; učenik sa prihvaćenom vezom
   ...
   guest list" — isti tekst kao za kod koji ne postoji. — **prevaziđeno (25.9.2026):** Ulazak u sobu kucanjem koda je u potpunosti uklonjen (PLAN-SESIJA.md faza 2, 21-22.9.2026) — u aplikaciji više ne postoji polje za unos koda sobe; poziv u sobu ide isključivo kroz `Invite students to session` ili Home-ov „In a session now“.
4. [ ] **Potezi u sobi.** Trener odigra potez; nijedna crvena traka „no
   permission" nigde. U „Pripremi" (STUDIO) nekoliko poteza — takođe bez trake. — *prepisano 25.9.2026 u novi spisak: Sesija — Soba, stavka 10.*
5. [ ] **Snimak se i dalje čuva.** Odrasla osoba sama u svojoj sobi snimi kratko
   i sačuva; snimak je u listi i pušta se. — *prepisano 25.9.2026 u novi spisak: Teach — Tutorijal — glas i video, stavka 3.*
...
1. [x] **Nema dugmeta za prihvatanje.** Napravi repertoar za belog od početne
   ...
   unconfirmed", „Do not prepare this", „Next" ni „Back to …". — ✅ vlasnik, u alatu za proveru, 16.9.2026.
2. [x] **Najigraniji odgovor ide sa potezom.** Posle e4 u stablu je i c5 (ili
   ...
   Drugi odgovori (e5, e6…) **nisu** dodati. — ✅ vlasnik, u alatu za proveru, 16.9.2026.
3. [x] **Protivnikov potez se igra na tabli.** Klikni svoj potez e4 u stablu (ili
   ...
   stablo bez procenta. — ✅ vlasnik, u alatu za proveru, 16.9.2026.
4. [ ] **Ponovo odigran potez ne vraća obrisani odgovor.** Obriši c5 iz stabla
   ...
   početne pozicije. c5 se **ne** vraća. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 3.*
5. [x] **Knjiga su čipovi.** Ispod table je red čipova kao u Analizi, sa
   ...
   dugmićima „Play". — ✅ vlasnik, u alatu za proveru, 16.9.2026.
6. [ ] **Brisanje pita kad treba.** Obriši svoj potez posle kojeg postoje tvoji
   ...
   bez ičega iza sebe se briše bez pitanja. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 4.*
7. [ ] **Govor.** Uključi govor: ne čita se niz poteza, samo pitanje i kratka
   ...
   16.9.2026; uklonjen je — vidi stavku 170.) — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 5.*
8. [ ] **Pravilo je na ekranu.** Ispod pitanja stoji rečenica da je svaki potez u
   ...
   position; for the opponent, enter one or more." — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — izgradnja, stavka 6.*
9. [ ] **Dril.** „Drill" posle nekoliko poteza: protivnik igra samo poteze koje si
   uneo (i dodati najigraniji), nikad nešto što nije u stablu. — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — drill, stavka 1.*
10. [ ] **Pokrivenost.** Mapa repertoara prikazuje brojeve („3 decided · 1 open")
    umesto procenata, bez „not preparing". — *prepisano 25.9.2026 u novi spisak: Practise — Repertoar — pokrivenost, stavka 2.*
...
1. [x] **Panel u Analizi, prijavljen.** Otvori Analizu i odigraj 1. e4: naslov
   ...
   rejtinga ni pomena ChessDB-a. Klik na potez ga igra. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
2. [x] **Dublje od knjige.** Učitaj poziciju posle 26+ poteza neke partije: panel
   kaže „This position is deeper than the opening book goes.", a ne „No master
   game reached this position.". — ✅ vlasnik, u alatu za proveru, 15.9.2026.
3. [x] **Gost.** Odjavi se i otvori Analizu: panel kaže „Sign in to see the
   opening book." i ne prikazuje poteze. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
4. [x] **Server bez knjige.** Zakomentariši `MASTERS_BOOK_PATH`, restartuj:
   panel kaže „The opening book is not available on this server.". Vrati
   putanju. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
5. [x] **Settings.** Nema odeljka „OPENING EXPLORER" ni polja za Lichess token;
   ostatak ekrana stoji kako je stajao. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
6. [x] **Repertoar.** Na listi repertoara nema ikonice „Opponent rating", a
   ispod stabla u gradnji piše samo „Breadth: …", bez „Book: games from …+". — ✅ vlasnik, u alatu za proveru, 15.9.2026.
...
1. [x] **Nalog koji nikad nije video lichess.org.** (Posle faze 4 polja za
   token više nema, a sačuvan token se briše pri pokretanju.) U Analizi odigraj potez i pritisni
   „Judge …": presuda stiže, i nigde na panelu se ne pominje token. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
2. [x] **Repertoar od nule.** Istim nalogom napravi nov repertoar i pusti
   ...
   book ends", a ne jedno umesto drugog. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
3. [x] **Stari repertoar i dalje ima grane.** Otvori repertoar koji je postojao
   pre ove promene: stablo crta protivnikove odgovore kao i ranije, a drill ih
   igra. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
4. [x] **Server bez knjige.** Zakomentariši `MASTERS_BOOK_PATH` u `.env`,
   restartuj, i pritisni „Judge …": panel kaže „The opening book is not
   available on this server", a ne presudu. Vrati putanju. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
5. [x] **Izveštaj o rupama.** „Judge moves" u izveštaju o otvaranjima radi bez
   tokena i ne prikazuje baner o tokenu. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
...
1. [x] **„And the line goes on" više nema.** Kroz ceo tutorijal — u delu sa
   ...
   continues"). Tamo gde potez nema šta da kaže, tabla ćuti. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
2. [x] **Statistika stoji na pravoj poziciji.** Rečenica „Up to here the game
   ...
   se odigra potez koji je igrač odigrao. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
3. [x] **Strelice.** Na toj istoj poziciji nacrtane su **zelene strelice** za one
   poteze koje rečenica nabraja (jedan do tri), a ne za odigrani. Proveri i u
   videu. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
4. [x] **Broj se slaže.** N u rečenici je broj partija koje su stigle do pozicije
   na tabli, a ne do one posle poteza. Ako je moguće, uporedi sa Lichess
   masters explorer-om za tu poziciju. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
5. [x] **Studija, a ne cela partija.** Otvori u Analizi poziciju koja nije
   ...
   tutorijal i ništa se ne troši. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
...
1. [x] **Nema najave poteza.** Kroz ceo tutorijal nijedna rečenica ne počinje sa
   „White plays …" niti kaže „the queen from d8 to c7". — ✅ vlasnik, u alatu za proveru, 15.9.2026.
2. [ ] **Greška ide redom.** Na momentu greške: deo bez poteza koji kaže „In this
   ...
   Proveri i u videu da se strelica vidi. — *prepisano 25.9.2026 u novi spisak: Analyse — Tutorijal iz partije, stavka 19.*
3. [ ] **Početak i kraj.** Prva rečenica tutorijala kaže kakva partija sledi
   ...
   izašao kao pobednik i zašto. „The game ended here." se ne pojavljuje. — *prepisano 25.9.2026 u novi spisak: Analyse — Tutorijal iz partije, stavka 20.*
4. [x] **Prekretnice.** Tamo gde je partija promenila tok, rečenica to kaže
   („takes the chance", „lets the chance go", „the first mistake of the game…"),
   i to se slaže sa onim što se vidi na tabli. — ✅ vlasnik, u alatu za proveru, 15.9.2026.
5. [ ] **Rekapitulacija.** Poslednji deo „Looking back, the game turned on …" ne
   pominje pešake (cenu), a na tabli je plava strelica odigranog poteza. — *prepisano 25.9.2026 u novi spisak: Analyse — Tutorijal iz partije, stavka 21.*
6. [ ] **„Sentences to check".** U poslednjem dijalogu lista je kratka ili prazna;
   ako nije, pročitaj te rečenice — to je nalaz za proveru tvrdnji. — *prepisano 25.9.2026 u novi spisak: Analyse — Tutorijal iz partije, stavka 17.*
