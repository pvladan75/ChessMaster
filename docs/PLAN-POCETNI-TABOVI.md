...
| 5 | **Done 21.9.2026: the owner confirmed items 212 and 213 in full, and asked for the Practise hero card to go (§6) — removed the same day, with a case that fails if anything sits above the phases.** **Live pass** | owner | New items in `TODO-provera.md`, each tab on the phone and in a 1400 px window |
...
- **The Practise hero card** („Chess trainer and drills") was flagged here as a
  candidate for deletion; the owner said to delete it on 21.9.2026, and it
  was — the one item in this list that did not stay excluded.
